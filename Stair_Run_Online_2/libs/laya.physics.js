...
goog.provide = function(o) {
    ...
    if (!COMPILED) {
        ...
        for (var e = o; (e = e.substring(0, e.lastIndexOf("."))) && !goog.getObjectByName(e); ) goog.implicitNamespaces_[e] = !0;
    }
...
goog.DEPENDENCIES_ENABLED && (goog.dependencies_ = {
    ...
    if (goog.isDef(goog.global.CLOSURE_BASE_PATH)) goog.basePath = goog.global.CLOSURE_BASE_PATH; else if (goog.inHtmlDocument_()) for (var o = goog.global.document.getElementsByTagName("SCRIPT"), t = o.length - 1; 0 <= t; --t) {
        var e = o[t].src, r = -1 == (r = e.lastIndexOf("?")) ? e.length : r;
...
goog.importModule_ = function(o) {
    ...
    if ((o = goog.getPathFromDeps_(o)) && o in goog.dependencies_.requires) for (var t in goog.dependencies_.requires[o]) if (!goog.isProvided_(t) && !goog.isDeferredModule_(t)) return !1;
    return !0;
    ...
    try {
        ...
        }, goog.isFunction(o)) e = o.call(goog.global, {}); else {
    ...
    var t = goog.global.document, e = t.createElement("script");
    ...
    var t = [], e = {}, r = goog.dependencies_;
    for (function b(o) {
        if (!(o in r.written || o in r.visited)) {
            if (r.visited[o] = !0, o in r.requires) for (var i in r.requires[o]) if (!goog.isProvided_(i)) {
...
goog.normalizePath_ = function(o) {
    ...
    if (!COMPILED) {
        ...
        var e = goog.global.CLOSURE_IMPORT_SCRIPT || goog.writeScriptTag_, r = goog.loadFileSync_(o);
...
goog.getHashCode = goog.getUid, goog.removeHashCode = goog.removeUid, goog.cloneObject = function(o) {
    ...
    if (goog.global.execScript) goog.global.execScript(o, "JavaScript"); else {
        ...
        if (goog.evalWorksForGlobals_) goog.global.eval(o); else {
            var t = goog.global.document, e = t.createElement("SCRIPT");
...
goog.getMsg = function(o, t) {
    ...
    b = !1;
    for (var n = o.constructor; n; n = n.superClass_ && n.superClass_.constructor) if (n.prototype[t] === r) b = !0; else if (b) return n.prototype[t].apply(o, i);
    ...
    var e = t.constructor, r = t.statics;
    ...
    if (goog.defineClass.SEAL_CLASS_INSTANCES && Object.seal instanceof Function) {
        ...
        return function c() {
            ...
            return t[goog.UID_PROPERTY_] = t[goog.UID_PROPERTY_], this.constructor === c && Object.seal(t), 
            t;
        };
    }
    return o;
...
box2d.b2ParseInt = function(o) {
    ...
    var e = [];
    if ("function" == typeof t) for (var r = 0; r < o; ++r) e.push(t(r)); else for (r = 0; r < o; ++r) e.push(null);
    return e;
...
box2d.b2Vec3.prototype.Length = function() {
    var o = this.x, t = this.y, e = this.z;
...
box2d.b2Mat22.prototype.GetInverse = function(o) {
    var t = this.ex.x, e = this.ey.x, r = this.ex.y, i = this.ey.y, b = t * i - e * r;
...
box2d.b2Mat22.prototype.Solve = function(o, t, e) {
    var r = this.ex.x, i = this.ey.x, b = this.ex.y, n = this.ey.y, p = r * n - i * b;
...
box2d.b2Abs_M22 = function(o, t) {
    ...
    var r = o.ex.x, i = o.ex.y, b = o.ey.x;
    o = o.ey.y;
    var n = t.ex.x, p = t.ex.y, s = t.ey.x;
...
box2d.b2Mat33.prototype.Solve33 = function(o, t, e, r) {
    var i = this.ex.x, b = this.ex.y, n = this.ex.z, p = this.ey.x, s = this.ey.y, a = this.ey.z, d = this.ez.x, l = this.ez.y, x = this.ez.z, y = i * (s * x - a * l) + b * (a * d - p * x) + n * (p * l - s * d);
...
box2d.b2Mat33.prototype.GetSymInverse33 = function(o) {
    ...
    0 !== t && (t = 1 / t);
    var e = this.ex.x, r = this.ey.x, i = this.ez.x, b = this.ey.y, n = this.ez.y, p = this.ez.z;
...
box2d.b2Mul_X_V2 = function(o, t, e) {
    ...
    var r = o.q.c, i = o.q.s, b = t.x - o.p.x;
...
box2d.b2Simplex.prototype.ReadCache = function(o, t, e, r, i) {
    ...
    for (var b = this.m_vertices, n = 0; n < this.m_count; ++n) {
        ...
        var s = t.GetVertex(p.indexA), a = r.GetVertex(p.indexB);
...
box2d.b2Simplex.prototype.Solve2 = function() {
    var o = this.m_v1.w, t = this.m_v2.w, e = box2d.b2Sub_V2_V2(t, o, box2d.b2Simplex.s_e12);
...
box2d.b2Simplex.prototype.Solve3 = function() {
    var o = this.m_v1.w, t = this.m_v2.w, e = this.m_v3.w, r = box2d.b2Sub_V2_V2(t, o, box2d.b2Simplex.s_e12), i = box2d.b2Dot_V2_V2(o, r), b = box2d.b2Dot_V2_V2(t, r), n = (i = -i, 
    box2d.b2Sub_V2_V2(e, o, box2d.b2Simplex.s_e13)), p = box2d.b2Dot_V2_V2(o, n), s = box2d.b2Dot_V2_V2(e, n), a = (p = -p, 
    box2d.b2Sub_V2_V2(e, t, box2d.b2Simplex.s_e23)), d = box2d.b2Dot_V2_V2(t, a);
...
box2d.b2Simplex.s_e23 = new box2d.b2Vec2(), box2d.b2ShapeDistance = function(o, t, e) {
    ++box2d.b2_gjkCalls;
    var r = e.proxyA, i = e.proxyB, b = e.transformA, n = e.transformB, p = box2d.b2Distance.s_simplex;
    ...
    for (var s = p.m_vertices, a = box2d.b2Distance.s_saveA, d = box2d.b2Distance.s_saveB, l = 0, x = 0; 20 > x; ) {
        ...
        ++x, ++box2d.b2_gjkIters;
        var _ = !1;
        for (y = 0; y < l; ++y) if (c.indexA === a[y] && c.indexB === d[y]) {
            _ = !0;
            break;
        }
        if (_) break;
...
box2d.b2WorldManifold.prototype.Initialize = function(o, t, e, r, i) {
    if (0 !== o.pointCount) switch (o.type) {
      case box2d.b2ManifoldType.e_circles:
        ...
        var b = box2d.b2AddMul_V2_S_V2(t, e, this.normal, box2d.b2WorldManifold.prototype.Initialize.s_cA), n = box2d.b2SubMul_V2_S_V2(o, i, this.normal, box2d.b2WorldManifold.prototype.Initialize.s_cB);
...
box2d.b2GetPointStates = function(o, t, e, r) {
    for (var i = 0, b = e.pointCount; i < b; ++i) {
        ...
        for (var p = 0, s = r.pointCount; p < s; ++p) if (r.points[p].id.key === n) {
            o[i] = box2d.b2PointState.b2_persistState;
            break;
        }
    }
    for (b = box2d.b2_maxManifoldPoints; i < b; ++i) o[i] = box2d.b2PointState.b2_nullState;
    for (i = 0, b = r.pointCount; i < b; ++i) for (n = (n = r.points[i].id).key, t[i] = box2d.b2PointState.b2_addState, 
    p = 0, s = e.pointCount; p < s; ++p) if (e.points[p].id.key === n) {
...
box2d.b2AABB.prototype.RayCast = function(o, t) {
    var e = -box2d.b2_maxFloat, r = box2d.b2_maxFloat, i = t.p1.x, b = t.p1.y, n = t.p2.x - t.p1.x, p = t.p2.y - t.p1.y, s = box2d.b2Abs(n), a = box2d.b2Abs(p), d = o.normal;
...
box2d.b2AABB.prototype.TestOverlap = function(o) {
    var t = o.lowerBound.y - this.upperBound.y, e = this.lowerBound.y - o.upperBound.y;
...
box2d.b2TestOverlap_AABB = function(o, t) {
    var e = t.lowerBound.y - o.upperBound.y, r = o.lowerBound.y - t.upperBound.y;
...
box2d.b2CollideCircles.s_pB = new box2d.b2Vec2(), box2d.b2CollidePolygonAndCircle = function(o, t, e, r, i) {
    ...
    var b = 0, n = -box2d.b2_maxFloat;
    i = t.m_radius + r.m_radius;
    var p = t.m_count, s = t.m_vertices;
    t = t.m_normals;
    for (var a = 0; a < p; ++a) {
...
box2d.b2CollideEdgeAndCircle = function(o, t, e, r, i) {
    ...
    var b = t.m_vertex1, n = t.m_vertex2, p = box2d.b2Sub_V2_V2(n, b, box2d.b2CollideEdgeAndCircle.s_e), s = box2d.b2Dot_V2_V2(p, box2d.b2Sub_V2_V2(n, e, box2d.b2Vec2.s_t0)), a = box2d.b2Dot_V2_V2(p, box2d.b2Sub_V2_V2(e, b, box2d.b2Vec2.s_t0)), d = t.m_radius + r.m_radius;
...
box2d.b2EPCollider.prototype.Collide = function(o, t, e, r, i) {
    ...
    var b = box2d.b2Dot_V2_V2(this.m_normal1, box2d.b2Sub_V2_V2(this.m_centroidB, this.m_v1, box2d.b2Vec2.s_t0)), n = 0, p = 0, s = !1, a = !1;
    ...
    t.type !== box2d.b2EPAxisType.e_unknown && t.separation > this.m_radius))) {
        ...
        b = box2d.b2EPCollider.s_clipPoints1, p = box2d.b2EPCollider.s_clipPoints2, n = 0, 
...
box2d.b2EPCollider.prototype.ComputePolygonSeparation = function(o) {
    ...
    for (var t = box2d.b2EPCollider.s_perp.Set(-this.m_normal.y, this.m_normal.x), e = 0, r = this.m_polygonB.count; e < r; ++e) {
        var i = box2d.b2EPCollider.s_n.Copy(this.m_polygonB.normals[e]).SelfNeg(), b = box2d.b2Dot_V2_V2(i, box2d.b2Sub_V2_V2(this.m_polygonB.vertices[e], this.m_v1, box2d.b2Vec2.s_t0)), n = box2d.b2Dot_V2_V2(i, box2d.b2Sub_V2_V2(this.m_polygonB.vertices[e], this.m_v2, box2d.b2Vec2.s_t0));
...
box2d.b2FindMaxSeparation = function(o, t, e, r, i) {
    var b = t.m_count, n = r.m_count, p = t.m_normals;
...
box2d.b2FindIncidentEdge = function(o, t, e, r, i, b) {
    var n = t.m_count, p = t.m_normals, s = i.m_count;
...
box2d.b2CollidePolygons = function(o, t, e, r, i) {
    ...
    if (((c = box2d.b2CollidePolygons.s_edgeA)[0] = 0, !((a = box2d.b2FindMaxSeparation(c, t, e, r, i)) > b)) && ((s = box2d.b2CollidePolygons.s_edgeB)[0] = 0, 
    !((x = box2d.b2FindMaxSeparation(s, r, i, t, e)) > b))) {
        ...
        i = a.m_vertices;
        var s = n, a = (n + 1) % a.m_count, d = i[s], l = i[a];
        ...
        var x = box2d.b2Mul_R_V2(t.q, n, box2d.b2CollidePolygons.s_tangent), y = (n = box2d.b2Cross_V2_S(x, 1, box2d.b2CollidePolygons.s_normal), 
...
box2d.b2DynamicTree.prototype.Query = function(o, t) {
    if (null !== this.m_root) {
        ...
        for (e.Push(this.m_root); 0 < e.GetCount(); ) {
            var r = e.Pop();
            if (null !== r && r.aabb.TestOverlap(t)) if (r.IsLeaf()) {
                if (!o(r)) break;
...
box2d.b2DynamicTree.prototype.RayCast = function(o, t) {
    if (null !== this.m_root) {
        var e = t.p1, r = t.p2, i = box2d.b2Sub_V2_V2(r, e, box2d.b2DynamicTree.s_r);
        box2d.ENABLE_ASSERTS && box2d.b2Assert(0 < i.LengthSquared()), i.Normalize();
        i = box2d.b2Cross_S_V2(1, i, box2d.b2DynamicTree.s_v);
        var b = box2d.b2Abs_V2(i, box2d.b2DynamicTree.s_abs_v), n = t.maxFraction, p = box2d.b2DynamicTree.s_segmentAABB, s = e.x + n * (r.x - e.x), a = e.y + n * (r.y - e.y);
        ...
        for (d.Push(this.m_root); 0 < d.GetCount(); ) if (null !== (s = d.Pop()) && box2d.b2TestOverlap_AABB(s.aabb, p)) {
            a = s.aabb.GetCenter();
            var l = s.aabb.GetExtents();
            if (!(0 < box2d.b2Abs(box2d.b2Dot_V2_V2(i, box2d.b2Sub_V2_V2(e, a, box2d.b2Vec2.s_t0))) - box2d.b2Dot_V2_V2(b, l))) if (s.IsLeaf()) {
...
box2d.b2DynamicTree.prototype.CreateProxy = function(o, t) {
    var e = this.AllocateNode(), r = box2d.b2_aabbExtension, i = box2d.b2_aabbExtension;
...
box2d.b2DynamicTree.prototype.InsertLeaf = function(o) {
    if (++this.m_insertionCount, null === this.m_root) this.m_root = o, this.m_root.parent = null; else {
        var t = o.aabb;
        t.GetCenter();
...
box2d.b2DynamicTree.prototype.RemoveLeaf = function(o) {
    if (o === this.m_root) this.m_root = null; else {
        var t = o.parent, e = t.parent;
        if (o = t.child1 === o ? t.child2 : t.child1, e) for (e.child1 === t ? e.child1 = o : e.child2 = o, 
        ...
        t = t.parent; else this.m_root = o, o.parent = null, this.FreeNode(t);
    }
...
box2d.b2DynamicTree.prototype.Balance = function(o) {
    ...
    var t = o.child1, e = o.child2;
    if (1 < (r = e.height - t.height)) {
        var r = e.child1, i = e.child2;
...
box2d.b2DynamicTree.prototype.ValidateMetrics = function(o) {
    if (null !== o) {
        ...
        box2d.ENABLE_ASSERTS && box2d.b2Assert(0 === o.height); else t = 1 + box2d.b2Max(e.height, r.height), 
...
box2d.b2BroadPhase.prototype.TestOverlap = function(o, t) {
    var e = this.m_tree.GetFatAABB(o), r = this.m_tree.GetFatAABB(t);
...
box2d.b2BroadPhase.prototype.UpdatePairs = function(o) {
    for (var t = this.m_pairCount = 0; t < this.m_moveCount; ++t) {
        ...
        if (null !== e) {
            var r = this, i = this.m_tree.GetFatAABB(e);
    ...
    t = 0; t < this.m_pairCount; ) {
        ...
        var b = this.m_tree.GetUserData(i.proxyA), n = this.m_tree.GetUserData(i.proxyB);
...
box2d.b2CircleShape.prototype.ComputeDistance.s_center = new box2d.b2Vec2(), box2d.b2CircleShape.prototype.RayCast = function(o, t, e, r) {
    ...
    var b = box2d.b2Dot_V2_V2(e, r), n = box2d.b2Dot_V2_V2(r, r);
...
box2d.b2CircleShape.prototype.SetupDistanceProxy = function(o, t) {
    ...
    var i = b * b, b = (t = this.m_radius * this.m_radius) * (box2d.b2Asin(b / this.m_radius) + box2d.b2_pi / 2) + b * box2d.b2Sqrt(t - i);
...
box2d.b2EdgeShape.prototype.RayCast = function(o, t, e, r) {
    ...
    r = this.m_vertex1;
    var n = this.m_vertex2, p = box2d.b2Sub_V2_V2(n, r, box2d.b2EdgeShape.prototype.RayCast.s_e), s = o.normal.Set(p.y, -p.x).SelfNormalize();
...
box2d.b2ChainShape.prototype.CreateLoop = function(o, t) {
    ...
    box2d.ENABLE_ASSERTS && box2d.b2Assert(3 <= t), box2d.ENABLE_ASSERTS) for (var e = 1; e < t; ++e) box2d.b2Assert(box2d.b2DistanceSquared(o[e - 1], o[e]) > box2d.b2_linearSlop * box2d.b2_linearSlop);
...
box2d.b2ChainShape.prototype.CreateChain = function(o, t) {
    if (t = t || o.length, box2d.ENABLE_ASSERTS && box2d.b2Assert(null === this.m_vertices && 0 === this.m_count), 
    box2d.ENABLE_ASSERTS && box2d.b2Assert(2 <= t), box2d.ENABLE_ASSERTS) for (var e = 1; e < t; ++e) box2d.b2Assert(box2d.b2DistanceSquared(o[e - 1], o[e]) > box2d.b2_linearSlop * box2d.b2_linearSlop);
...
box2d.b2PolygonShape.prototype.SetAsBox = function(o, t, e, r) {
    ...
    this.m_centroid.SetZero(), e instanceof box2d.b2Vec2) for (r = "number" == typeof r ? r : 0, 
...
box2d.b2PolygonShape.prototype.Set = function(o, t, e) {
    ...
    for (var r = box2d.b2PolygonShape.prototype.Set.s_ps, i = 0, b = 0; b < t; ++b) {
        for (var n = o[e + b], p = !0, s = 0; s < i; ++s) if (box2d.b2DistanceSquared(n, r[s]) < .25 * box2d.b2_linearSlop * box2d.b2_linearSlop) {
            p = !1;
            break;
        }
        p && r[i++].Copy(n);
    ...
    for (i = box2d.b2PolygonShape.prototype.Set.s_hull, e = 0, b = o; ;) {
        for (i[e] = b, p = 0, s = 1; s < t; ++s) if (p === b) p = s; else {
            var a = box2d.b2Sub_V2_V2(r[p], r[i[e]], box2d.b2PolygonShape.prototype.Set.s_r), d = (n = box2d.b2Sub_V2_V2(r[s], r[i[e]], box2d.b2PolygonShape.prototype.Set.s_v), 
...
box2d.b2PolygonShape.prototype.TestPoint = function(o, t) {
    for (var e = box2d.b2MulT_X_V2(o, t, box2d.b2PolygonShape.prototype.TestPoint.s_pLocal), r = 0, i = this.m_count; r < i; ++r) if (0 < box2d.b2Dot_V2_V2(this.m_normals[r], box2d.b2Sub_V2_V2(e, this.m_vertices[r], box2d.b2Vec2.s_t0))) return !1;
    return !0;
...
box2d.b2PolygonShape.prototype.TestPoint.s_pLocal = new box2d.b2Vec2(), box2d.b2PolygonShape.prototype.ComputeDistance = function(o, t, e, r) {
    ...
    var i = -box2d.b2_maxFloat, b = box2d.b2PolygonShape.prototype.ComputeDistance.s_normalForMaxDistance.Copy(t);
...
box2d.b2PolygonShape.prototype.RayCast = function(o, t, e, r) {
    ...
    0), n = t.maxFraction, p = -1, s = 0, a = this.m_count; s < a; ++s) {
        var d = box2d.b2Dot_V2_V2(this.m_normals[s], box2d.b2Sub_V2_V2(this.m_vertices[s], r, box2d.b2Vec2.s_t0)), l = box2d.b2Dot_V2_V2(this.m_normals[s], i);
        if (0 === l) {
            if (0 > d) return !1;
...
box2d.b2PolygonShape.prototype.ComputeAABB.s_v = new box2d.b2Vec2(), box2d.b2PolygonShape.prototype.ComputeMass = function(o, t) {
    ...
    for (n = 0, p = this.m_count; n < p; ++n) {
        var s = box2d.b2Sub_V2_V2(this.m_vertices[n], b, box2d.b2PolygonShape.prototype.ComputeMass.s_e1), a = box2d.b2Sub_V2_V2(this.m_vertices[(n + 1) % p], b, box2d.b2PolygonShape.prototype.ComputeMass.s_e2), d = box2d.b2Cross_V2_V2(s, a);
        r = r + (l = .5 * d);
        e.SelfAdd(box2d.b2Mul_S_V2(l * (1 / 3), box2d.b2Add_V2_V2(s, a, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t1));
        var l = s.x, x = (s = s.y, a.x);
...
box2d.b2PolygonShape.prototype.Validate = function() {
    for (var o = 0; o < this.m_count; ++o) for (var t = o, e = (o + 1) % this.m_count, r = this.m_vertices[t], i = box2d.b2Sub_V2_V2(this.m_vertices[e], r, box2d.b2PolygonShape.prototype.Validate.s_e), b = 0; b < this.m_count; ++b) if (b !== t && b !== e) {
...
box2d.b2PolygonShape.prototype.SetupDistanceProxy = function(o, t) {
    ...
    var i = box2d.b2MulT_R_V2(e.q, o, box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_normalL), b = t - box2d.b2Dot_V2_V2(o, e.p), n = box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_depths, p = 0, s = -1;
    t = -1;
    var a = !1;
    o = 0;
...
box2d.b2PolygonShape.ComputeCentroid = function(o, t, e) {
    ...
    for (var r = 0, i = box2d.b2PolygonShape.ComputeCentroid.s_pRef.SetZero(), b = 0; b < t; ++b) {
        var n = i, p = o[b], s = o[(b + 1) % t], a = box2d.b2Sub_V2_V2(p, n, box2d.b2PolygonShape.ComputeCentroid.s_e1), d = box2d.b2Sub_V2_V2(s, n, box2d.b2PolygonShape.ComputeCentroid.s_e2);
...
box2d.b2SeparationFunction.prototype.FindMinSeparation = function(o, t, e) {
    var r = box2d.b2TimeOfImpact.s_xfA, i = box2d.b2TimeOfImpact.s_xfB;
    switch (this.m_sweepA.GetTransform(r, e), this.m_sweepB.GetTransform(i, e), this.m_type) {
      case box2d.b2SeparationFunctionType.e_points:
        var b = box2d.b2MulT_R_V2(r.q, this.m_axis, box2d.b2TimeOfImpact.s_axisA), n = box2d.b2MulT_R_V2(i.q, box2d.b2Vec2.s_t0.Copy(this.m_axis).SelfNeg(), box2d.b2TimeOfImpact.s_axisB);
...
box2d.b2TimeOfImpact = function(o, t) {
    ...
    var r = t.proxyA, i = t.proxyB, b = box2d.b2TimeOfImpact.s_sweepA.Copy(t.sweepA), n = box2d.b2TimeOfImpact.s_sweepB.Copy(t.sweepB);
    b.Normalize(), n.Normalize();
    var p = t.tMax, s = box2d.b2Max(box2d.b2_linearSlop, r.m_radius + i.m_radius - 3 * box2d.b2_linearSlop), a = .25 * box2d.b2_linearSlop;
    box2d.ENABLE_ASSERTS && box2d.b2Assert(s > a);
    var d = 0, l = 0, x = box2d.b2TimeOfImpact.s_cache;
    x.count = 0;
    var y = box2d.b2TimeOfImpact.s_distanceInput;
    for (y.proxyA = t.proxyA, y.proxyB = t.proxyB, y.useRadii = !1; ;) {
        var c = box2d.b2TimeOfImpact.s_xfA, _ = box2d.b2TimeOfImpact.s_xfB;
        ...
        _ = !1;
        for (var m = p, u = 0; ;) {
            var h = box2d.b2TimeOfImpact.s_indexA, g = box2d.b2TimeOfImpact.s_indexB, f = c.FindMinSeparation(h, g, m);
            if (f > s + a) {
...
box2d.b2Fixture.prototype.Synchronize = function(o, t, e) {
    if (0 !== this.m_proxyCount) for (var r = 0; r < this.m_proxyCount; ++r) {
        var i = this.m_proxies[r], b = box2d.b2Fixture.prototype.Synchronize.s_aabb1, n = box2d.b2Fixture.prototype.Synchronize.s_aabb2;
...
box2d.b2Fixture.prototype.Refilter = function() {
    if (null !== this.m_body) {
        for (var o = this.m_body.GetContactList(); o; ) {
            var t = o.contact, e = t.GetFixtureA(), r = t.GetFixtureB();
            e !== this && r !== this || t.FlagForFiltering(), o = o.next;
        }
        if (null !== (o = this.m_body.GetWorld())) for (o = o.m_contactManager.m_broadPhase, 
...
box2d.b2Body.prototype.SetTransform = function(o, t, e) {
    if (o instanceof box2d.b2Vec2 && "number" == typeof t) this.SetTransform_X_Y_A(o.x, o.y, t); else if (o instanceof box2d.b2Transform) this.SetTransform_X_Y_A(o.p.x, o.p.y, o.GetAngle()); else {
...
box2d.b2Body.prototype.SetTransform_X_Y_A = function(o, t, e) {
    if (box2d.ENABLE_ASSERTS && box2d.b2Assert(!this.m_world.IsLocked()), !this.m_world.IsLocked() && (this.m_xf.p.x !== o || this.m_xf.p.y !== t || this.m_xf.q.GetAngle() !== e)) for (this.m_xf.q.SetAngle(e), 
...
box2d.b2Body.prototype.SetMassData.s_oldCenter = new box2d.b2Vec2(), box2d.b2Body.prototype.ResetMassData = function() {
    ...
    this.m_sweep.c.Copy(this.m_xf.p), this.m_sweep.a0 = this.m_sweep.a; else {
        ...
        for (var o = box2d.b2Body.prototype.ResetMassData.s_localCenter.SetZero(), t = this.m_fixtureList; t; t = t.m_next) if (0 !== t.m_density) {
...
box2d.b2Body.prototype.SetType = function(o) {
    if (box2d.ENABLE_ASSERTS && box2d.b2Assert(!this.m_world.IsLocked()), !this.m_world.IsLocked() && this.m_type !== o) {
        ...
        t = this.m_fixtureList; t; t = t.m_next) for (var e = t.m_proxyCount, r = 0; r < e; ++r) o.TouchProxy(t.m_proxies[r].proxy);
    }
...
box2d.b2Body.prototype.SetActive = function(o) {
    if (box2d.ENABLE_ASSERTS && box2d.b2Assert(!this.m_world.IsLocked()), o !== this.IsActive()) if (o) {
...
box2d.b2Body.prototype.ShouldCollideConnected = function(o) {
    for (var t = this.m_jointList; t; t = t.next) if (t.other === o && !t.joint.m_collideConnected) return !1;
    return !0;
...
box2d.b2Contact.prototype.GetWorldManifold = function(o) {
    var t = this.m_fixtureA.GetBody(), e = this.m_fixtureB.GetBody(), r = this.m_fixtureA.GetShape(), i = this.m_fixtureB.GetShape();
...
box2d.b2Contact.prototype.Update = function(o) {
    ...
    var e = !1, r = (t = this.m_flag_touchingFlag, this.m_fixtureA.IsSensor()), i = this.m_fixtureB.IsSensor(), b = (r = r || i, 
    i = this.m_fixtureA.GetBody(), this.m_fixtureB.GetBody()), n = (e = i.GetTransform(), 
    b.GetTransform());
    ...
    this.m_manifold.pointCount = 0; else {
    ...
    this.m_flag_touchingFlag = e, !t && e && o && o.BeginContact(this), t && !e && o && o.EndContact(this), 
...
box2d.b2ChainAndCircleContact.prototype.Evaluate = function(o, t, e) {
    var r = this.m_fixtureA.GetShape(), i = this.m_fixtureB.GetShape();
...
box2d.b2ContactFactory.prototype.Destroy = function(o) {
    var t = o.m_fixtureA, e = o.m_fixtureB;
...
box2d.b2ContactManager.prototype.Destroy = function(o) {
    var t = o.GetFixtureA(), e = o.GetFixtureB();
...
box2d.b2ContactManager.prototype.Collide = function() {
    for (var o = this.m_contactList; o; ) {
        var t = o.GetFixtureA(), e = o.GetFixtureB(), r = o.GetChildIndexA(), i = o.GetChildIndexB(), b = t.GetBody(), n = e.GetBody();
...
box2d.b2ContactManager.prototype.AddPair = function(o, t) {
    ...
    var e = o.fixture, r = t.fixture, i = o.childIndex, b = t.childIndex, n = e.GetBody(), p = r.GetBody();
    if (n !== p) {
        for (var s = p.GetContactList(); s; ) {
            if (s.other === n) {
                var a = s.contact.GetFixtureA(), d = s.contact.GetFixtureB(), l = s.contact.GetChildIndexA(), x = s.contact.GetChildIndexB();
...
box2d.b2ContactSolver.prototype.Initialize = function(o) {
    ...
    if (this.m_velocityConstraints.length < this.m_count) for (t = box2d.b2Max(2 * this.m_velocityConstraints.length, this.m_count), 
    ...
    o = 0, t = this.m_count; o < t; ++o) for (b = (i = this.m_contacts[o]).m_fixtureA, 
...
box2d.b2ContactSolver.prototype.WarmStart.s_P = new box2d.b2Vec2(), box2d.b2ContactSolver.prototype.SolveVelocityConstraints = function() {
    ...
    for (o = 0, t = this.m_count; o < t; ++o) {
        ...
        if (1 !== i.pointCount && box2d.g_blockSolve) for (l = i.points[0], g = i.points[1], 
        ...
        V.y = r - g.velocityBias, V.SelfSub(box2d.b2Mul_M22_V2(i.K, v, box2d.b2Vec2.s_t0)); ;) {
            if (box2d.b2Mul_M22_V2(i.normalMass, V, J).SelfNeg(), 0 <= J.x && 0 <= J.y) {
                box2d.b2Sub_V2_V2(J, v, M), box2d.b2Mul_S_V2(M.x, m, D), box2d.b2Mul_S_V2(M.y, m, w), 
                box2d.b2Add_V2_V2(D, w, G), x.SelfMulSub(p, G), y -= s * (box2d.b2Cross_V2_V2(l.rA, D) + box2d.b2Cross_V2_V2(g.rA, w)), 
                c.SelfMulAdd(a, G), _ += d * (box2d.b2Cross_V2_V2(l.rB, D) + box2d.b2Cross_V2_V2(g.rB, w)), 
            ...
            break;
        } else for (e = 0; e < l; ++e) g = i.points[e], box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(c, _, g.rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(x, y, g.rA, box2d.b2Vec2.s_t1), P), 
...
box2d.b2ContactSolver.prototype.StoreImpulses = function() {
    var o, t, e, r, i, b;
    for (o = 0, t = this.m_count; o < t; ++o) for (i = this.m_velocityConstraints[o], 
...
box2d.b2PositionSolverManifold.prototype.Initialize = function(o, t, e, r) {
    var i = box2d.b2PositionSolverManifold.prototype.Initialize.s_pointA, b = box2d.b2PositionSolverManifold.prototype.Initialize.s_pointB, n = box2d.b2PositionSolverManifold.prototype.Initialize.s_planePoint, p = box2d.b2PositionSolverManifold.prototype.Initialize.s_clipPoint;
...
box2d.b2Island.prototype.Initialize = function(o, t, e, r, i) {
    ...
    if (this.m_positions.length < o) for (t = box2d.b2Max(2 * this.m_positions.length, o), 
    ...
    if (this.m_velocities.length < o) for (t = box2d.b2Max(2 * this.m_velocities.length, o), 
...
box2d.b2Island.prototype.Solve = function(o, t, e, r) {
    for (var i = box2d.b2Island.s_timer.Reset(), b = t.dt, n = 0; n < this.m_bodyCount; ++n) {
        var p = this.m_bodies[n], s = this.m_positions[n].c.Copy(p.m_sweep.c), a = p.m_sweep.a, d = this.m_velocities[n].v.Copy(p.m_linearVelocity), l = p.m_angularVelocity;
    ...
    r) {
        ...
        if (o >= box2d.b2_timeToSleep && s) for (n = 0; n < this.m_bodyCount; ++n) (p = this.m_bodies[n]).SetAwake(!1);
    }
...
box2d.b2Island.prototype.SolveTOI = function(o, t, e) {
    ...
    for (o = o.dt, r = 0; r < this.m_bodyCount; ++r) {
        ...
        var b = this.m_velocities[r].v, n = this.m_velocities[r].w, p = box2d.b2Mul_S_V2(o, b, box2d.b2Island.s_translation);
...
box2d.b2Island.prototype.Report = function(o) {
    if (null !== this.m_listener) for (var t = 0; t < this.m_contactCount; ++t) {
        ...
        if (e) {
            var r = o[t], i = box2d.b2Island.s_impulse;
...
box2d.b2AreaJoint = function(o) {
    ...
    for (var e = this.m_targetArea = 0, r = this.m_bodies.length; e < r; ++e) {
        var i = this.m_bodies[e], b = this.m_bodies[(e + 1) % r], n = i.GetWorldCenter(), p = b.GetWorldCenter();
...
box2d.b2AreaJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    if (o.step.warmStarting) for (this.m_impulse *= o.step.dtRatio, t = 0, e = this.m_bodies.length; t < e; ++t) {
        var i = this.m_bodies[t], b = o.velocities[i.m_islandIndex].v;
        r = this.m_deltas[t];
...
box2d.b2AreaJoint.prototype.SolveVelocityConstraints = function(o) {
    for (var t = 0, e = 0, r = 0, i = this.m_bodies.length; r < i; ++r) {
        var b = this.m_bodies[r], n = o.velocities[b.m_islandIndex].v, p = this.m_deltas[r];
...
box2d.b2AreaJoint.prototype.SolvePositionConstraints = function(o) {
    for (var t = 0, e = 0, r = 0, i = this.m_bodies.length; r < i; ++r) {
        var b = this.m_bodies[r], n = (b = o.positions[b.m_islandIndex].c, o.positions[this.m_bodies[(r + 1) % i].m_islandIndex].c), p = box2d.b2Sub_V2_V2(n, b, this.m_delta), s = p.Length();
...
box2d.b2DistanceJoint.prototype.Dump = function() {
    if (box2d.DEBUG) {
        var o = this.m_bodyA.m_islandIndex, t = this.m_bodyB.m_islandIndex;
...
box2d.b2DistanceJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    var t = o.positions[this.m_indexA].c, e = o.velocities[this.m_indexA].v, r = o.velocities[this.m_indexA].w, i = o.positions[this.m_indexB].c, b = o.positions[this.m_indexB].a, n = o.velocities[this.m_indexB].v, p = o.velocities[this.m_indexB].w, s = this.m_qA.SetAngle(o.positions[this.m_indexA].a);
...
box2d.b2DistanceJoint.prototype.SolvePositionConstraints = function(o) {
    ...
    var t = o.positions[this.m_indexA].c, e = o.positions[this.m_indexA].a, r = o.positions[this.m_indexB].c, i = o.positions[this.m_indexB].a;
    this.m_qA.SetAngle(e), this.m_qB.SetAngle(i);
    var b = box2d.b2Mul_R_V2(this.m_qA, this.m_lalcA, this.m_rA), n = box2d.b2Mul_R_V2(this.m_qB, this.m_lalcB, this.m_rB);
    (s = this.m_u).x = r.x + n.x - t.x - b.x, s.y = r.y + n.y - t.y - b.y;
    var p = this.m_u.Normalize() - this.m_length, s = (p = box2d.b2Clamp(p, -box2d.b2_maxLinearCorrection, box2d.b2_maxLinearCorrection), 
...
box2d.b2FrictionJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    this.m_invMassA = this.m_bodyA.m_invMass, this.m_invMassB = this.m_bodyB.m_invMass, 
    this.m_invIA = this.m_bodyA.m_invI, this.m_invIB = this.m_bodyB.m_invI;
    var t = o.velocities[this.m_indexA].v, e = o.velocities[this.m_indexA].w, r = o.positions[this.m_indexB].a, i = o.velocities[this.m_indexB].v, b = o.velocities[this.m_indexB].w, n = this.m_qA.SetAngle(o.positions[this.m_indexA].a);
    ...
    var p = box2d.b2Mul_R_V2(r, this.m_lalcB, this.m_rB), s = (r = this.m_invMassA, 
    this.m_invMassB), a = this.m_invIA, d = this.m_invIB, l = this.m_K;
...
box2d.b2World.prototype.SetAllowSleeping = function(o) {
    if (o !== this.m_allowSleep && (this.m_allowSleep = o, !this.m_allowSleep)) for (o = this.m_bodyList; o; o = o.m_next) o.SetAwake(!0);
...
box2d.b2World.prototype.SetGravity = function(o, t) {
    ...
    t)) for (var e = this.m_bodyList; e; e = e.m_next) e.SetAwake(!0);
...
box2d.b2World.prototype.DestroyBody = function(o) {
    if (box2d.ENABLE_ASSERTS && box2d.b2Assert(0 < this.m_bodyCount), box2d.ENABLE_ASSERTS && box2d.b2Assert(!this.IsLocked()), 
    !this.IsLocked()) {
...
box2d.b2World.prototype.CreateJoint = function(o) {
    ...
    var e = o.bodyA, r = o.bodyB;
    if (!o.collideConnected) for (o = r.GetContactList(); o; ) o.other === e && o.contact.FlagForFiltering(), 
    o = o.next;
    return t;
...
box2d.b2World.prototype.DestroyJoint = function(o) {
    if (box2d.ENABLE_ASSERTS && box2d.b2Assert(!this.IsLocked()), !this.IsLocked()) {
        ...
        box2d.ENABLE_ASSERTS && box2d.b2Assert(0 < this.m_jointCount), --this.m_jointCount, 
        !t) for (o = r.GetContactList(); o; ) o.other === e && o.contact.FlagForFiltering(), 
        o = o.next;
    }
...
box2d.b2World.prototype.Solve = function(o) {
    ...
    r = this.m_bodyCount;
    for (var i = this.s_stack, b = this.m_bodyList; b; b = b.m_next) if (!b.m_flag_islandFlag && b.IsAwake() && b.IsActive() && b.GetType() !== box2d.b2BodyType.b2_staticBody) {
        e.Clear();
        var n = 0;
        for (i[n++] = b, b.m_flag_islandFlag = !0; 0 < n; ) if (t = i[--n], box2d.ENABLE_ASSERTS && box2d.b2Assert(t.IsActive()), 
...
box2d.b2World.prototype.SolveTOI = function(o) {
    ...
    for (;;) {
        var i = null;
        for (e = 1, r = this.m_contactManager.m_contactList; r; r = r.m_next) if (r.IsEnabled() && !(r.m_toiCount > box2d.b2_maxSubSteps)) {
            var b = 1;
            if (r.m_flag_toiFlag) b = r.m_toi; else {
                var n = r.GetFixtureA(), p = r.GetFixtureB();
                if (n.IsSensor() || p.IsSensor()) continue;
                b = n.GetBody();
                var s = p.GetBody(), a = b.m_type, d = s.m_type;
                box2d.ENABLE_ASSERTS && box2d.b2Assert(a !== box2d.b2BodyType.b2_staticBody || d !== box2d.b2BodyType.b2_staticBody);
                var l = b.IsAwake() && a !== box2d.b2BodyType.b2_staticBody, x = s.IsAwake() && d !== box2d.b2BodyType.b2_staticBody;
                if (!l && !x) continue;
                if (a = b.IsBullet() || a !== box2d.b2BodyType.b2_dynamicBody, d = s.IsBullet() || d !== box2d.b2BodyType.b2_dynamicBody, 
                !a && !d) continue;
        ...
        ++i.m_toiCount, i.IsEnabled() && i.IsTouching()) {
            ...
            b.m_flag_islandFlag = !0, s.m_flag_islandFlag = !0, i.m_flag_islandFlag = !0, i = 0; 2 > i; ++i) if ((r = 0 === i ? b : s).m_type === box2d.b2BodyType.b2_dynamicBody) for (n = r.m_contactList; n && t.m_bodyCount !== t.m_bodyCapacity && t.m_contactCount !== t.m_contactCapacity; n = n.next) !(p = n.contact).m_flag_islandFlag && ((d = n.other).m_type !== box2d.b2BodyType.b2_dynamicBody || r.IsBullet() || d.IsBullet()) && (a = p.m_fixtureB.m_isSensor, 
            ...
            i = 0; i < t.m_bodyCount; ++i) if ((r = t.m_bodies[i]).m_flag_islandFlag = !1, r.m_type === box2d.b2BodyType.b2_dynamicBody) for (r.SynchronizeFixtures(), 
...
box2d.b2World.prototype.QueryAABB = function(o, t) {
    ...
    }, t), o instanceof box2d.b2QueryCallback) for (var r = this.m_particleSystemList; r; r = r.m_next) o.ShouldQueryParticleSystem(r) && r.QueryAABB(o, t);
...
box2d.b2World.prototype.QueryShape = function(o, t, e, r) {
    var i = this.m_contactManager.m_broadPhase, b = box2d.b2World.prototype.QueryShape.s_aabb;
    ...
    }, b), o instanceof box2d.b2QueryCallback) for (r = this.m_particleSystemList; r; r = r.m_next) o.ShouldQueryParticleSystem(r) && r.QueryAABB(o, b);
...
box2d.b2World.prototype.QueryShape.s_aabb = new box2d.b2AABB(), box2d.b2World.prototype.QueryPoint = function(o, t, e) {
    ...
    if (i.lowerBound.Set(t.x - e, t.y - e), i.upperBound.Set(t.x + e, t.y + e), r.Query(function(e) {
        return e = r.GetUserData(e), box2d.ENABLE_ASSERTS && box2d.b2Assert(e instanceof box2d.b2FixtureProxy), 
        !(e = e.fixture).TestPoint(t) || (o instanceof box2d.b2QueryCallback ? o.ReportFixture(e) : o(e));
    }, i), o instanceof box2d.b2QueryCallback) for (e = this.m_particleSystemList; e; e = e.m_next) o.ShouldQueryParticleSystem(e) && e.QueryAABB(o, i);
...
box2d.b2World.prototype.QueryPoint.s_aabb = new box2d.b2AABB(), box2d.b2World.prototype.RayCast = function(o, t, e) {
    var r = this.m_contactManager.m_broadPhase, i = box2d.b2World.prototype.RayCast.s_input;
    if (i.maxFraction = 1, i.p1.Copy(t), i.p2.Copy(e), r.RayCast(function(i, b) {
        ...
        var p = n.fixture, s = box2d.b2World.prototype.RayCast.s_output;
    ...
    }, i), o instanceof box2d.b2RayCastCallback) for (i = this.m_particleSystemList; i; i = i.m_next) o.ShouldQueryParticleSystem(i) && i.RayCast(o, t, e);
...
box2d.b2World.prototype.DrawShape = function(o, t) {
    switch ((e = o.GetShape()).m_type) {
      ...
      case box2d.b2ShapeType.e_edgeShape:
        var e = (i = e instanceof box2d.b2EdgeShape ? e : null).m_vertex1, r = i.m_vertex2;
        this.m_debugDraw.DrawSegment(e, r, t);
        break;

      case box2d.b2ShapeType.e_chainShape:
        var i = (e = e instanceof box2d.b2ChainShape ? e : null).m_count, b = e.m_vertices;
        e = b[0];
...
box2d.b2World.prototype.DrawJoint = function(o) {
    var t = o.GetBodyA(), e = o.GetBodyB(), r = t.m_xf.p, i = e.m_xf.p, b = (e = o.GetAnchorA(box2d.b2World.prototype.DrawJoint.s_p1), 
...
box2d.b2World.prototype.DrawJoint.s_s2 = new box2d.b2Vec2(), box2d.b2World.prototype.DrawParticleSystem = function(o) {
    ...
    if (t) {
        var e = o.GetRadius(), r = o.GetPositionBuffer();
...
box2d.b2World.prototype.DrawDebugData = function() {
    if (null !== this.m_debugDraw) {
        var o = this.m_debugDraw.GetFlags(), t = box2d.b2World.prototype.DrawDebugData.s_color.SetRGB(0, 0, 0);
        if (o & box2d.b2DrawFlags.e_shapeBit) for (var e = this.m_bodyList; e; e = e.m_next) {
            var r = e.m_xf;
        ...
        if (o & box2d.b2DrawFlags.e_particleBit) for (e = this.m_particleSystemList; e; e = e.m_next) this.DrawParticleSystem(e);
        if (o & box2d.b2DrawFlags.e_jointBit) for (e = this.m_jointList; e; e = e.m_next) this.DrawJoint(e);
        if (o & box2d.b2DrawFlags.e_aabbBit) {
            t.SetRGB(.9, .3, .9);
            r = this.m_contactManager.m_broadPhase;
            var b = box2d.b2World.prototype.DrawDebugData.s_vs;
            for (e = this.m_bodyList; e; e = e.m_next) if (e.IsActive()) for (i = e.GetFixtureList(); i; i = i.m_next) for (var n = 0; n < i.m_proxyCount; ++n) {
        ...
        if (o & box2d.b2DrawFlags.e_centerOfMassBit) for (e = this.m_bodyList; e; e = e.m_next) (r = box2d.b2World.prototype.DrawDebugData.s_xf).q.Copy(e.m_xf.q), 
        r.p.Copy(e.GetWorldCenter()), this.m_debugDraw.DrawTransform(r);
        if (o & box2d.b2DrawFlags.e_controllerBit) for (o = this.m_controllerList; o; o = o.m_next) o.Draw(this.m_debugDraw);
    }
...
box2d.b2World.prototype.DrawDebugData.s_xf = new box2d.b2Transform(), box2d.b2World.prototype.SetBroadPhase = function(o) {
    ...
    for (var e = this.m_bodyList; e; e = e.m_next) for (var r = e.m_fixtureList; r; r = r.m_next) r.m_proxy = o.CreateProxy(t.GetFatAABB(r.m_proxy), r);
...
box2d.b2MotorJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    this.m_invMassA = this.m_bodyA.m_invMass, this.m_invMassB = this.m_bodyB.m_invMass, 
    this.m_invIA = this.m_bodyA.m_invI, this.m_invIB = this.m_bodyB.m_invI;
    var t = o.positions[this.m_indexA].c, e = o.positions[this.m_indexA].a, r = o.velocities[this.m_indexA].v, i = o.velocities[this.m_indexA].w, b = o.positions[this.m_indexB].c, n = o.positions[this.m_indexB].a, p = o.velocities[this.m_indexB].v, s = o.velocities[this.m_indexB].w, a = this.m_qA.SetAngle(e), d = this.m_qB.SetAngle(n), l = box2d.b2Mul_R_V2(a, box2d.b2Vec2.s_t0.Copy(this.m_localCenterA).SelfNeg(), this.m_rA), x = (d = box2d.b2Mul_R_V2(d, box2d.b2Vec2.s_t0.Copy(this.m_localCenterB).SelfNeg(), this.m_rB), 
    this.m_invMassA), y = this.m_invMassB, c = this.m_invIA, _ = this.m_invIB, m = this.m_K;
...
box2d.b2MotorJoint.prototype.SolveVelocityConstraints = function(o) {
    var t = o.velocities[this.m_indexA].v, e = o.velocities[this.m_indexA].w, r = o.velocities[this.m_indexB].v, i = o.velocities[this.m_indexB].w, b = this.m_invMassA, n = this.m_invMassB, p = this.m_invIA, s = this.m_invIB, a = o.step.dt, d = o.step.inv_dt, l = i - e + d * this.m_correctionFactor * this.m_angularError, x = (l = -this.m_angularMass * l, 
    this.m_angularImpulse), y = a * this.m_maxTorque;
    this.m_angularImpulse = box2d.b2Clamp(this.m_angularImpulse + l, -y, y);
    e -= p * (l = this.m_angularImpulse - x), i += s * l;
    var c = this.m_rA, _ = this.m_rB;
...
box2d.b2MouseJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    var t = o.positions[this.m_indexB].c, e = o.velocities[this.m_indexB].v, r = o.velocities[this.m_indexB].w, i = this.m_qB.SetAngle(o.positions[this.m_indexB].a), b = this.m_bodyB.GetMass(), n = 2 * box2d.b2_pi * this.m_frequencyHz, p = 2 * b * this.m_dampingRatio * n;
    b = b * n * n, n = o.step.dt;
...
box2d.b2MouseJoint.prototype.SolveVelocityConstraints = function(o) {
    var t = o.velocities[this.m_indexB].v, e = o.velocities[this.m_indexB].w, r = box2d.b2AddCross_V2_S_V2(t, e, this.m_rB, box2d.b2MouseJoint.prototype.SolveVelocityConstraints.s_Cdot), i = (r = box2d.b2Mul_M22_V2(this.m_mass, box2d.b2Add_V2_V2(r, box2d.b2Add_V2_V2(this.m_C, box2d.b2Mul_S_V2(this.m_gamma, this.m_impulse, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0).SelfNeg(), box2d.b2MouseJoint.prototype.SolveVelocityConstraints.s_impulse), 
...
box2d.b2PrismaticJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    box2d.b2Sub_V2_V2(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
    var d = box2d.b2Mul_R_V2(b, this.m_lalcB, this.m_rB), l = box2d.b2Add_V2_V2(box2d.b2Sub_V2_V2(i, t, box2d.b2Vec2.s_t0), box2d.b2Sub_V2_V2(d, a, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.InitVelocityConstraints.s_d), x = (t = this.m_invMassA, 
...
box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints = function(o) {
    var t = o.velocities[this.m_indexA].v, e = o.velocities[this.m_indexA].w, r = o.velocities[this.m_indexB].v, i = o.velocities[this.m_indexB].w, b = this.m_invMassA, n = this.m_invMassB, p = this.m_invIA, s = this.m_invIB;
    if (this.m_enableMotor && this.m_limitState !== box2d.b2LimitState.e_equalLimits) {
        var a = box2d.b2Dot_V2_V2(this.m_axis, box2d.b2Sub_V2_V2(r, t, box2d.b2Vec2.s_t0)) + this.m_a2 * i - this.m_a1 * e, d = (a = this.m_motorMass * (this.m_motorSpeed - a), 
        this.m_motorImpulse), l = o.step.dt * this.m_maxMotorForce;
...
box2d.b2PrismaticJoint.prototype.SolvePositionConstraints = function(o) {
    ...
    l = box2d.b2Max(l, y - this.m_upperTranslation), S = !0)), S) {
        ...
        var C = a * m * _ + d * u * n;
        0 === (S = a + d) && (S = 1);
        var A = a * _ + d * n, B = p + s + a * _ * _ + d * n * n, v = this.m_K3;
...
box2d.b2PrismaticJoint.prototype.GetJointTranslation = function() {
    var o = this.m_bodyA.GetWorldPoint(this.m_localAnchorA, box2d.b2PrismaticJoint.prototype.GetJointTranslation.s_pA), t = this.m_bodyB.GetWorldPoint(this.m_localAnchorB, box2d.b2PrismaticJoint.prototype.GetJointTranslation.s_pB);
...
box2d.b2PrismaticJoint.prototype.GetJointSpeed = function() {
    var o = this.m_bodyA, t = this.m_bodyB;
    ...
    var r = box2d.b2Mul_R_V2(t.m_xf.q, this.m_lalcB, this.m_rB), i = box2d.b2Add_V2_V2(o.m_sweep.c, e, box2d.b2Vec2.s_t0), b = box2d.b2Add_V2_V2(t.m_sweep.c, r, box2d.b2Vec2.s_t1), n = (i = box2d.b2Sub_V2_V2(b, i, box2d.b2Vec2.s_t2), 
    b = o.GetWorldVector(this.m_localXAxisA, this.m_axis), o.m_linearVelocity), p = t.m_linearVelocity;
...
box2d.b2PulleyJoint.prototype.SolvePositionConstraints = function(o) {
    var t = o.positions[this.m_indexA].c, e = o.positions[this.m_indexA].a, r = o.positions[this.m_indexB].c, i = o.positions[this.m_indexB].a, b = this.m_qA.SetAngle(e), n = this.m_qB.SetAngle(i);
    ...
    var p = this.m_uA.Copy(t).SelfAdd(b).SelfSub(this.m_groundAnchorA), s = this.m_uB.Copy(r).SelfAdd(n).SelfSub(this.m_groundAnchorB), a = p.Length(), d = s.Length();
    a > 10 * box2d.b2_linearSlop ? p.SelfMul(1 / a) : p.SetZero(), d > 10 * box2d.b2_linearSlop ? s.SelfMul(1 / d) : s.SetZero();
    var l = box2d.b2Cross_V2_V2(b, p), x = box2d.b2Cross_V2_V2(n, s);
...
box2d.b2RevoluteJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    this.m_invMassA = this.m_bodyA.m_invMass, this.m_invMassB = this.m_bodyB.m_invMass, 
    this.m_invIA = this.m_bodyA.m_invI, this.m_invIB = this.m_bodyB.m_invI;
    var t = o.positions[this.m_indexA].a, e = o.velocities[this.m_indexA].v, r = o.velocities[this.m_indexA].w, i = o.positions[this.m_indexB].a, b = o.velocities[this.m_indexB].v, n = o.velocities[this.m_indexB].w, p = this.m_qA.SetAngle(t), s = this.m_qB.SetAngle(i);
    ...
    var a = this.m_invIA, d = this.m_invIB, l = 0 === a + d;
...
box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints = function(o) {
    var t = o.velocities[this.m_indexA].v, e = o.velocities[this.m_indexA].w, r = o.velocities[this.m_indexB].v, i = o.velocities[this.m_indexB].w, b = this.m_invMassA, n = this.m_invMassB, p = this.m_invIA, s = this.m_invIB, a = 0 === p + s;
    if (this.m_enableMotor && this.m_limitState !== box2d.b2LimitState.e_equalLimits && !a) {
        var d = i - e - this.m_motorSpeed, l = (d = -this.m_motorMass * d, this.m_motorImpulse), x = o.step.dt * this.m_maxMotorTorque;
...
box2d.b2RevoluteJoint.prototype.SolvePositionConstraints = function(o) {
    var t = o.positions[this.m_indexA].c, e = o.positions[this.m_indexA].a, r = o.positions[this.m_indexB].c, i = o.positions[this.m_indexB].a, b = this.m_qA.SetAngle(e), n = this.m_qB.SetAngle(i), p = 0, s = 0;
    ...
    var d = this.m_invMassA, l = this.m_invMassB, x = this.m_invIA, y = this.m_invIB, c = this.m_K;
...
box2d.b2GearJoint.prototype.SolveVelocityConstraints = function(o) {
    ...
    u += this.m_iA + this.m_iC, y = i - s - this.m_referenceAngleA; else {
    ...
    u += this.m_ratio * this.m_ratio * (this.m_iB + this.m_iD), c = n - d - this.m_referenceAngleB; else {
...
box2d.b2GearJoint.prototype.Dump = function() {
    if (box2d.DEBUG) {
        var o = this.m_bodyA.m_islandIndex, t = this.m_bodyB.m_islandIndex, e = this.m_joint1.m_index, r = this.m_joint2.m_index;
...
box2d.b2RopeJoint.prototype.InitVelocityConstraints.s_P = new box2d.b2Vec2(), box2d.b2RopeJoint.prototype.SolveVelocityConstraints = function(o) {
    var t = o.velocities[this.m_indexA].v, e = o.velocities[this.m_indexA].w, r = o.velocities[this.m_indexB].v, i = o.velocities[this.m_indexB].w, b = box2d.b2AddCross_V2_S_V2(t, e, this.m_rA, box2d.b2RopeJoint.prototype.SolveVelocityConstraints.s_vpA), n = box2d.b2AddCross_V2_S_V2(r, i, this.m_rB, box2d.b2RopeJoint.prototype.SolveVelocityConstraints.s_vpB), p = this.m_length - this.m_maxLength;
...
box2d.b2RopeJoint.prototype.SolveVelocityConstraints.s_P = new box2d.b2Vec2(), box2d.b2RopeJoint.prototype.SolvePositionConstraints = function(o) {
    ...
    box2d.b2Sub_V2_V2(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
    n = box2d.b2Mul_R_V2(n, this.m_lalcB, this.m_rB);
    var p = (a = this.m_u.Copy(r).SelfAdd(n).SelfSub(t).SelfSub(b)).Normalize(), s = p - this.m_maxLength, a = (s = box2d.b2Clamp(s, 0, box2d.b2_maxLinearCorrection), 
...
box2d.b2WeldJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    box2d.b2Sub_V2_V2(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB), box2d.b2Mul_R_V2(s, this.m_lalcB, this.m_rB);
    p = this.m_invMassA, s = this.m_invMassB;
    var a = this.m_invIA, d = this.m_invIB;
...
box2d.b2WeldJoint.prototype.SolveVelocityConstraints.s_P = new box2d.b2Vec2(), box2d.b2WeldJoint.prototype.SolvePositionConstraints = function(o) {
    var t = o.positions[this.m_indexA].c, e = o.positions[this.m_indexA].a, r = o.positions[this.m_indexB].c, i = o.positions[this.m_indexB].a, b = this.m_qA.SetAngle(e), n = this.m_qB.SetAngle(i), p = this.m_invMassA, s = this.m_invMassB, a = this.m_invIA, d = this.m_invIB;
    box2d.b2Sub_V2_V2(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
    ...
    c.ez.y = l.x * a + x.x * d, c.ex.z = c.ez.x, c.ey.z = c.ez.y, c.ez.z = a + d, 0 < this.m_frequencyHz) {
        var y = box2d.b2Sub_V2_V2(box2d.b2Add_V2_V2(r, x, box2d.b2Vec2.s_t0), box2d.b2Add_V2_V2(t, l, box2d.b2Vec2.s_t1), box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_C1), c = (n = y.Length(), 
...
box2d.b2WheelJoint.prototype.SolveVelocityConstraints = function(o) {
    var t = this.m_invMassA, e = this.m_invMassB, r = this.m_invIA, i = this.m_invIB, b = o.velocities[this.m_indexA].v, n = o.velocities[this.m_indexA].w, p = o.velocities[this.m_indexB].v, s = o.velocities[this.m_indexB].w, a = box2d.b2Dot_V2_V2(this.m_ax, box2d.b2Sub_V2_V2(p, b, box2d.b2Vec2.s_t0)) + this.m_sBx * s - this.m_sAx * n;
    a = -this.m_springMass * (a + this.m_bias + this.m_gamma * this.m_springImpulse);
    this.m_springImpulse += a;
    var d = box2d.b2Mul_S_V2(a, this.m_ax, box2d.b2WheelJoint.prototype.SolveVelocityConstraints.s_P), l = a * this.m_sAx;
    a *= this.m_sBx;
...
box2d.b2WheelJoint.prototype.SolvePositionConstraints = function(o) {
    ...
    box2d.b2Sub_V2_V2(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
    n = box2d.b2Mul_R_V2(n, this.m_lalcB, this.m_rB);
    var s = box2d.b2Add_V2_V2(box2d.b2Sub_V2_V2(r, t, box2d.b2Vec2.s_t0), box2d.b2Sub_V2_V2(n, p, box2d.b2Vec2.s_t1), box2d.b2WheelJoint.prototype.SolvePositionConstraints.s_d), a = (b = box2d.b2Mul_R_V2(b, this.m_localYAxisA, this.m_ay), 
...
box2d.b2WheelJoint.prototype.GetPrismaticJointTranslation = function() {
    var o = this.m_bodyA, t = this.m_bodyB, e = o.GetWorldPoint(this.m_localAnchorA, new box2d.b2Vec2());
...
box2d.b2WheelJoint.prototype.GetPrismaticJointSpeed = function() {
    ...
    box2d.b2Sub_V2_V2(this.m_localAnchorB, t.m_sweep.localCenter, this.m_lalcB);
    var r = box2d.b2Mul_R_V2(t.m_xf.q, this.m_lalcB, this.m_rB), i = box2d.b2Add_V2_V2(o.m_sweep.c, e, box2d.b2Vec2.s_t0), b = box2d.b2Add_V2_V2(t.m_sweep.c, r, box2d.b2Vec2.s_t1), n = (i = box2d.b2Sub_V2_V2(b, i, box2d.b2Vec2.s_t2), 
    b = o.GetWorldVector(this.m_localXAxisA, new box2d.b2Vec2()), o.m_linearVelocity), p = t.m_linearVelocity;
    o = o.m_angularVelocity, t = t.m_angularVelocity;
    return box2d.b2Dot_V2_V2(i, box2d.b2Cross_S_V2(o, b, box2d.b2Vec2.s_t0)) + box2d.b2Dot_V2_V2(b, box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(p, t, r, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(n, o, e, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0));
...
box2d.b2ParticleColor = function(o, t, e, r) {
    if (0 !== arguments.length) if (o instanceof box2d.b2Color) this.r = 0 | 255 * o.r, 
    this.g = 0 | 255 * o.g, this.b = 0 | 255 * o.b, this.a = 0 | 255 * o.a; else {
...
box2d.b2ParticleColor.prototype.Set = function(o, t, e, r) {
    if (o instanceof box2d.b2Color) this.SetColor(o); else {
        if (!(3 <= arguments.length)) throw Error();
...
box2d.b2ParticleColor.MixColors = function(o, t, e) {
    var r = e * (t.r - o.r) >> box2d.b2ParticleColor.k_bitsPerComponent, i = e * (t.g - o.g) >> box2d.b2ParticleColor.k_bitsPerComponent, b = e * (t.b - o.b) >> box2d.b2ParticleColor.k_bitsPerComponent;
...
box2d.b2ParticleGroup.prototype.DestroyParticles = function(o) {
    if (box2d.b2Assert(!1 === this.m_system.m_world.IsLocked()), !this.m_system.m_world.IsLocked()) for (var t = this.m_firstIndex; t < this.m_lastIndex; t++) this.m_system.DestroyParticle(t, o);
...
box2d.b2ParticleGroup.prototype.UpdateStatistics = function() {
    var o = new box2d.b2Vec2(), t = new box2d.b2Vec2();
...
box2d.b2ParticleSystem.ConnectionFilter.prototype.IsNecessary = function(o) {
    ...
    this.m_staticPressureBuffer && (this.m_staticPressureBuffer[t] = 0), this.m_depthBuffer && (this.m_depthBuffer[t] = 0), 
    ...
    var e = this.m_proxyBuffer.data[this.m_proxyBuffer.Append()], r = 0 < o.lifetime;
...
box2d.b2ParticleSystem.prototype.CreateParticleGroup = function(o) {
    ...
    var i = this.m_count, b = new box2d.b2ParticleGroup();
...
box2d.b2ParticleSystem.prototype.ComputeCollisionEnergy = function() {
    for (var o = box2d.b2ParticleSystem.prototype.ComputeCollisionEnergy.s_v, t = this.m_velocityBuffer.data, e = 0, r = 0; r < this.m_contactBuffer.count; r++) {
        var i = (b = this.m_contactBuffer.data[r]).normal, b = box2d.b2Sub_V2_V2(t[b.indexB], t[b.indexA], o);
...
box2d.b2ParticleSystem.prototype.ApplyLinearImpulse = function(o, t, e) {
    var r = this.m_velocityBuffer.data, i = (t - o) * this.GetParticleMass();
...
box2d.b2ParticleSystem.prototype.ApplyForce = function(o, t, e) {
    ...
    box2d.b2ParticleSystem.IsSignificantForce(e)) for (this.PrepareForceBuffer(), i = o; i < t; i++) this.m_forceBuffer[i].SelfAdd(e);
...
box2d.b2ParticleSystem.prototype.QueryAABB = function(o, t) {
    if (0 !== this.m_proxyBuffer.count) for (var e = this.m_proxyBuffer.count, r = box2d.std_lower_bound(this.m_proxyBuffer.data, 0, e, box2d.b2ParticleSystem.computeTag(this.m_inverseDiameter * t.lowerBound.x, this.m_inverseDiameter * t.lowerBound.y), box2d.b2ParticleSystem.Proxy.CompareProxyTag), i = (e = box2d.std_upper_bound(this.m_proxyBuffer.data, r, e, box2d.b2ParticleSystem.computeTag(this.m_inverseDiameter * t.upperBound.x, this.m_inverseDiameter * t.upperBound.y), box2d.b2ParticleSystem.Proxy.CompareTagProxy), 
    this.m_positionBuffer.data); r < e; ++r) {
        var b = this.m_proxyBuffer.data[r].index, n = i[b];
...
box2d.b2ParticleSystem.prototype.QueryPointAABB.s_aabb = new box2d.b2AABB(), box2d.b2ParticleSystem.prototype.RayCast = function(o, t, e) {
    var r = box2d.b2ParticleSystem.prototype.RayCast.s_aabb, i = box2d.b2ParticleSystem.prototype.RayCast.s_p, b = box2d.b2ParticleSystem.prototype.RayCast.s_v, n = box2d.b2ParticleSystem.prototype.RayCast.s_n, p = box2d.b2ParticleSystem.prototype.RayCast.s_point;
    if (0 !== this.m_proxyBuffer.count) {
        ...
        for (b = box2d.b2Dot_V2_V2(e, e), r = this.GetInsideBoundsEnumerator(r); 0 <= (d = r.GetNext()); ) {
            var l = box2d.b2Sub_V2_V2(t, s[d], i), x = box2d.b2Dot_V2_V2(l, e);
...
box2d.b2ParticleSystem.Proxy.prototype.tag = 0, box2d.b2ParticleSystem.Proxy.CompareProxyProxy = function(o, t) {
    ...
    for (;this.m_first < this.m_last; ) {
        var o = (this.m_system.m_proxyBuffer.data[this.m_first].tag & box2d.b2ParticleSystem.xMask) >>> 0, t = (this.m_system.m_proxyBuffer.data[this.m_first].tag & box2d.b2ParticleSystem.yMask) >>> 0;
...
box2d.b2ParticleSystem.prototype.CreateParticlesStrokeShapeForGroup = function(o, t, e) {
    var r = box2d.b2ParticleSystem.prototype.CreateParticlesStrokeShapeForGroup.s_edge, i = box2d.b2ParticleSystem.prototype.CreateParticlesStrokeShapeForGroup.s_d, b = box2d.b2ParticleSystem.prototype.CreateParticlesStrokeShapeForGroup.s_p, n = t.stride;
...
box2d.b2ParticleSystem.prototype.CreateParticlesFillShapeForGroup = function(o, t, e) {
    var r = box2d.b2ParticleSystem.prototype.CreateParticlesFillShapeForGroup.s_aabb, i = box2d.b2ParticleSystem.prototype.CreateParticlesFillShapeForGroup.s_p, b = t.stride;
    0 === b && (b = this.GetParticleStride());
    var n = box2d.b2Transform.IDENTITY;
    box2d.b2Assert(1 === o.GetChildCount()), o.ComputeAABB(r, n, 0);
    for (var p = Math.floor(r.lowerBound.y / b) * b; p < r.upperBound.y; p += b) for (var s = Math.floor(r.lowerBound.x / b) * b; s < r.upperBound.x; s += b) {
        var a = i.Set(s, p);
...
box2d.b2ParticleSystem.CompositeShape.prototype.m_shapeCount = 0, box2d.b2ParticleSystem.CompositeShape.prototype.Clone = function() {
    ...
    for (var e = 0; e < this.m_shapeCount; e++) if (this.m_shapes[e].TestPoint(o, t)) return !0;
    return !1;
...
box2d.b2ParticleSystem.CompositeShape.prototype.ComputeAABB = function(o, t, e) {
    ...
    o.upperBound.y = -box2d.b2_maxFloat, box2d.b2Assert(0 === e), e = 0; e < this.m_shapeCount; e++) for (var i = this.m_shapes[e].GetChildCount(), b = 0; b < i; b++) {
        var n = r;
...
box2d.b2ParticleSystem.ParticleCanBeConnected = function(o, t) {
    ...
    var r = box2d.b2ParticleSystem.prototype.UpdatePairsAndTriads.s_dab, i = box2d.b2ParticleSystem.prototype.UpdatePairsAndTriads.s_dbc, b = box2d.b2ParticleSystem.prototype.UpdatePairsAndTriads.s_dca, n = this.m_positionBuffer.data;
    box2d.b2Assert(o <= t);
    for (var p = 0, s = o; s < t; s++) p |= this.m_flagsBuffer.data[s];
    if (p & box2d.b2ParticleSystem.k_pairFlags) for (s = 0; s < this.m_contactBuffer.count; s++) {
        var a = this.m_contactBuffer.data[s], d = a.indexA, l = a.indexB, x = this.m_flagsBuffer.data[d], y = this.m_flagsBuffer.data[l], c = this.m_groupBuffer[d], _ = this.m_groupBuffer[l];
    ...
    if (p & box2d.b2ParticleSystem.k_triadFlags) {
        ...
        if (0 === a) for (s = o; s < t; s++) e.IsNecessary(s);
        o = this.GetParticleStride(), p.Generate(o / 2, 2 * o);
        var m = this;
        p.GetNodes(function(o, t, p) {
            var s = m.m_flagsBuffer.data[o], a = m.m_flagsBuffer.data[t], d = m.m_flagsBuffer.data[p];
            if ((s | a | d) & box2d.b2ParticleSystem.k_triadFlags && e.ShouldCreateTriad(o, t, p)) {
                var l = n[o], x = n[t], y = n[p], c = box2d.b2Sub_V2_V2(l, x, r), _ = box2d.b2Sub_V2_V2(x, y, i), u = box2d.b2Sub_V2_V2(y, l, b), h = box2d.b2_maxTriadDistanceSquared * m.m_squaredDiameter;
                if (!(box2d.b2Dot_V2_V2(c, c) > h || box2d.b2Dot_V2_V2(_, _) > h || box2d.b2Dot_V2_V2(u, u) > h)) {
                    var g = m.m_groupBuffer[o], f = m.m_groupBuffer[t], S = m.m_groupBuffer[p];
...
box2d.b2ParticleSystem.ReactiveFilter.prototype.m_flagsBuffer = null, box2d.b2ParticleSystem.ReactiveFilter.prototype.IsNecessary = function(o) {
    ...
    for (var e = o.GetBufferIndex(), r = 0; r < this.m_contactBuffer.count; r++) {
        var i = (b = this.m_contactBuffer.data[r]).indexA, b = b.indexB;
    ...
    var r = o.GetParticleCount(), i = new box2d.b2ParticleGroupDef();
    ...
    for (var e = o.GetBufferIndex(), r = 0; r < this.m_pairBuffer.count; r++) {
        var i = (n = this.m_pairBuffer.data[r]).indexA, b = n.indexB;
    ...
    for (var o = [], t = 0, e = 0; e < this.m_contactBuffer.count; e++) {
        var r = (l = this.m_contactBuffer.data[e]).indexA, i = l.indexB, b = this.m_groupBuffer[r], n = this.m_groupBuffer[i];
        b && b === n && b.m_groupFlags & box2d.b2ParticleGroupFlag.b2_particleGroupNeedsUpdateDepth && (o[t++] = l);
    }
    for (b = [], n = 0, e = this.m_groupList; e; e = e.GetNext()) if (e.m_groupFlags & box2d.b2ParticleGroupFlag.b2_particleGroupNeedsUpdateDepth) for (b[n++] = e, 
    ...
    for (box2d.b2Assert(null !== this.m_depthBuffer), i = 0; i < n; i++) for (i = (e = b[i]).m_firstIndex; i < e.m_lastIndex; i++) p = this.m_accumulationBuffer[i], 
    ...
    for (var s = 0; s < p; s++) {
        ...
        for (e = 0; e < t; e++) {
            r = (l = o[e]).indexA, i = l.indexB;
            var d = 1 - l.weight, l = this.m_depthBuffer[r], x = this.m_depthBuffer[i], y = x + d;
            d = l + d;
    ...
    for (i = 0; i < n; i++) for (i = (e = b[i]).m_firstIndex; i < e.m_lastIndex; i++) this.m_depthBuffer[i] = this.m_depthBuffer[i] < box2d.b2_maxFloat ? this.m_depthBuffer[i] * this.m_particleDiameter : 0;
    ...
    var e = this.m_proxyBuffer.count, r = box2d.std_lower_bound(this.m_proxyBuffer.data, 0, e, t, box2d.b2ParticleSystem.Proxy.CompareProxyTag), i = box2d.std_upper_bound(this.m_proxyBuffer.data, 0, e, o, box2d.b2ParticleSystem.Proxy.CompareTagProxy);
    ...
    var r = box2d.b2ParticleSystem.prototype.AddContact.s_d, i = this.m_positionBuffer.data;
    ...
    for (var t = this.m_inverseDiameter, e = 0; e < this.m_proxyBuffer.count; ++e) {
        var r = this.m_proxyBuffer.data[e], i = o[r.index];
...
box2d.b2ParticleSystem.UpdateBodyContactsCallback.prototype.ReportFixtureAndParticle = function(o, t, e) {
    var r = box2d.b2ParticleSystem.UpdateBodyContactsCallback.prototype.ReportFixtureAndParticle.s_rp, i = this.m_system.m_positionBuffer.data[e], b = box2d.b2ParticleSystem.UpdateBodyContactsCallback.prototype.ReportFixtureAndParticle.s_n;
    if ((t = o.ComputeDistance(i, b, t)) < this.m_system.m_particleDiameter && this.ShouldCollideFixtureParticle(o, this.m_system, e)) {
        var n = o.GetBody(), p = n.GetWorldCenter(), s = n.GetMass(), a = n.GetInertia() - s * n.GetLocalCenter().LengthSquared(), d = (s = 0 < s ? 1 / s : 0, 
...
box2d.b2ParticleSystem.prototype.UpdateBodyContacts = function() {
    var o = box2d.b2ParticleSystem.prototype.UpdateBodyContacts.s_aabb, t = new box2d.b2ParticleSystem.FixtureParticleSet();
    if (this.NotifyBodyContactListenerPreContact(t), 0 < this.m_stuckThreshold) for (var e = this.GetParticleCount(), r = 0; r < e; r++) this.m_bodyContactCountBuffer.data[r] = 0, 
...
box2d.b2ParticleSystem.prototype.Solve = function(o) {
    ...
    !this.m_paused)) for (this.m_iterationIndex = 0; this.m_iterationIndex < o.particleIterations; this.m_iterationIndex++) {
        ++this.m_timestamp;
        var e = t.Copy(o);
...
box2d.b2ParticleSystem.prototype.SolveCollision = function(o) {
    var t = this.m_positionBuffer.data, e = this.m_velocityBuffer.data, r = box2d.b2ParticleSystem.prototype.SolveCollision.s_aabb;
    ...
    for (var i = 0; i < this.m_count; i++) {
        var b = e[i], n = t[i], p = n.x + o.dt * b.x;
        b = n.y + o.dt * b.y;
...
box2d.b2ParticleSystem.prototype.LimitVelocity = function(o) {
    ...
    for (var e = 0; e < this.m_count; e++) {
        var r = t[e], i = box2d.b2Dot_V2_V2(r, r);
        i > o && r.SelfMul(box2d.b2Sqrt(o / i));
    }
}, box2d.b2ParticleSystem.prototype.SolveGravity = function(o) {
    var t = box2d.b2ParticleSystem.prototype.SolveGravity.s_gravity, e = this.m_velocityBuffer.data;
...
box2d.b2ParticleSystem.prototype.SolveBarrier = function(o) {
    ...
    for (var m = this.GetParticleMass(), u = 0; u < this.m_pairBuffer.count; u++) {
        if ((f = this.m_pairBuffer.data[u]).flags & box2d.b2ParticleFlag.b2_barrierParticle) {
            var h = f.indexA, g = f.indexB, f = y[h], S = y[g], P = t;
            ...
            S = box2d.b2Sub_V2_V2(S, f, i), g = box2d.b2Sub_V2_V2(g, h, b), P = this.GetInsideBoundsEnumerator(P); 0 <= (C = P.GetNext()); ) {
                var v = y[C], V = this.m_groupBuffer[C];
                if (A !== V && B !== V) {
                    var J = this.GetLinearVelocity(V, C, v, n), M = box2d.b2Sub_V2_V2(v, f, p), D = box2d.b2Sub_V2_V2(J, h, s), w = box2d.b2Cross_V2_V2(g, D), G = box2d.b2Cross_V2_V2(S, D) - box2d.b2Cross_V2_V2(M, g), T = box2d.b2Cross_V2_V2(S, M), I = a, R = d;
                    if (0 === w) {
                        if (0 === G) continue;
                        ...
                        if ((T = (-G - F) / (2 * w)) > (w = (-G + F) / (2 * w)) && (G = T, T = w, w = G), 
                        box2d.b2AddMul_V2_S_V2(S, T, g, I), box2d.b2AddMul_V2_S_V2(M, T, D, R), G = box2d.b2Dot_V2_V2(I, R) / box2d.b2Dot_V2_V2(I, I), 
                        !(0 <= T && T < _ && 0 <= G && 1 >= G)) {
...
box2d.b2ParticleSystem.prototype.SolveStaticPressure = function(o) {
    ...
    for (var e = this.m_def.staticPressureRelaxation, r = 0; r < this.m_def.staticPressureIterations; r++) {
        ...
        for (i = 0; i < this.m_contactBuffer.count; i++) {
            if ((p = this.m_contactBuffer.data[i]).flags & box2d.b2ParticleFlag.b2_staticPressureParticle) {
                var b = p.indexA, n = p.indexB, p = p.weight;
    ...
    for (o = 0; o < this.m_bodyContactBuffer.count; o++) {
        var t = (e = this.m_bodyContactBuffer.data[o]).index, e = e.weight;
    ...
    if (this.m_allParticleFlags & box2d.b2ParticleSystem.k_noPressureFlags) for (p = 0; p < this.m_count; p++) this.m_flagsBuffer.data[p] & box2d.b2ParticleSystem.k_noPressureFlags && (this.m_accumulationBuffer[p] = 0);
    if (this.m_allParticleFlags & box2d.b2ParticleFlag.b2_staticPressureParticle) for (box2d.b2Assert(null !== this.m_staticPressureBuffer), 
    ...
    p = 0; p < this.m_bodyContactBuffer.count; p++) {
        var a = (s = this.m_bodyContactBuffer.data[p]).index, d = s.body, l = (i = s.weight, 
        s.mass), x = s.normal, y = e[a];
    ...
    var t = box2d.b2ParticleSystem.prototype.SolveDamping.s_v, e = box2d.b2ParticleSystem.prototype.SolveDamping.s_f, r = this.m_positionBuffer.data, i = this.m_velocityBuffer.data, b = this.m_def.dampingStrength;
    o = 1 / this.GetCriticalVelocity(o);
    for (var n = this.GetParticleInvMass(), p = 0; p < this.m_bodyContactBuffer.count; p++) {
        var s = (y = this.m_bodyContactBuffer.data[p]).index, a = y.body, d = y.weight, l = y.mass, x = y.normal, y = r[s], c = box2d.b2Sub_V2_V2(a.GetLinearVelocityFromWorldPoint(y, box2d.b2Vec2.s_t0), i[s], t);
...
box2d.b2ParticleSystem.prototype.SolveRigidDamping = function() {
    for (var o = box2d.b2ParticleSystem.prototype.SolveRigidDamping.s_t0, t = box2d.b2ParticleSystem.prototype.SolveRigidDamping.s_t1, e = box2d.b2ParticleSystem.prototype.SolveRigidDamping.s_p, r = box2d.b2ParticleSystem.prototype.SolveRigidDamping.s_v, i = [ 0 ], b = [ 0 ], n = [ 0 ], p = [ 0 ], s = [ 0 ], a = [ 0 ], d = this.m_positionBuffer.data, l = this.m_def.dampingStrength, x = 0; x < this.m_bodyContactBuffer.count; x++) {
        var y = (h = this.m_bodyContactBuffer.data[x]).index, c = this.m_groupBuffer[y];
        if (this.IsRigidGroup(c)) {
            var _ = h.body, m = h.normal, u = h.weight, h = d[y], g = box2d.b2Sub_V2_V2(_.GetLinearVelocityFromWorldPoint(h, o), c.GetLinearVelocityFromWorldPoint(h, t), r);
    ...
    for (x = 0; x < this.m_contactBuffer.count; x++) {
        ...
        var f = this.m_groupBuffer[_], S = this.IsRigidGroup(c), P = this.IsRigidGroup(f);
...
box2d.b2ParticleSystem.prototype.SolveRigidDamping.s_v = new box2d.b2Vec2(), box2d.b2ParticleSystem.prototype.SolveExtraDamping = function() {
    for (var o = box2d.b2ParticleSystem.prototype.SolveExtraDamping.s_v, t = box2d.b2ParticleSystem.prototype.SolveExtraDamping.s_f, e = this.m_velocityBuffer.data, r = this.m_positionBuffer.data, i = this.GetParticleInvMass(), b = 0; b < this.m_bodyContactBuffer.count; b++) {
        ...
        if (this.m_flagsBuffer.data[n] & box2d.b2ParticleSystem.k_extraDampingFlags) {
            var p = d.body, s = d.mass, a = d.normal, d = r[n], l = box2d.b2Sub_V2_V2(p.GetLinearVelocityFromWorldPoint(d, box2d.b2Vec2.s_t0), e[n], o);
...
box2d.b2ParticleSystem.prototype.SolveExtraDamping.s_f = new box2d.b2Vec2(), box2d.b2ParticleSystem.prototype.SolveWall = function() {
    ...
    for (var t = box2d.b2ParticleSystem.prototype.SolveRigid.s_position, e = box2d.b2ParticleSystem.prototype.SolveRigid.s_rotation, r = box2d.b2ParticleSystem.prototype.SolveRigid.s_transform, i = box2d.b2ParticleSystem.prototype.SolveRigid.s_velocityTransform, b = this.m_positionBuffer.data, n = this.m_velocityBuffer.data, p = this.m_groupList; p; p = p.GetNext()) if (p.m_groupFlags & box2d.b2ParticleGroupFlag.b2_rigidParticleGroup) {
        p.UpdateStatistics();
        var s = e;
        s.SetAngle(o.dt * p.m_angularVelocity);
        var a = box2d.b2Add_V2_V2(p.m_center, box2d.b2Sub_V2_V2(box2d.b2Mul_S_V2(o.dt, p.m_linearVelocity, box2d.b2Vec2.s_t0), box2d.b2Mul_R_V2(s, p.m_center, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0), t), d = r;
...
box2d.b2ParticleSystem.prototype.SolveElastic = function(o) {
    for (var t = box2d.b2ParticleSystem.prototype.SolveElastic.s_pa, e = box2d.b2ParticleSystem.prototype.SolveElastic.s_pb, r = box2d.b2ParticleSystem.prototype.SolveElastic.s_pc, i = box2d.b2ParticleSystem.prototype.SolveElastic.s_r, b = box2d.b2ParticleSystem.prototype.SolveElastic.s_t0, n = this.m_positionBuffer.data, p = this.m_velocityBuffer.data, s = o.inv_dt * this.m_def.elasticStrength, a = 0; a < this.m_triadBuffer.count; a++) {
        ...
        if (d.flags & box2d.b2ParticleFlag.b2_elasticParticle) {
            var l = d.indexA, x = d.indexB, y = d.indexC, c = d.pa, _ = d.pb, m = d.pc, u = t.Copy(n[l]), h = e.Copy(n[x]), g = r.Copy(n[y]);
            l = p[l], x = p[x], y = p[y];
            u.SelfMulAdd(o.dt, l), h.SelfMulAdd(o.dt, x), g.SelfMulAdd(o.dt, y);
            var f = (u.x + h.x + g.x) / 3, S = (u.y + h.y + g.y) / 3;
...
box2d.b2ParticleSystem.prototype.SolveElastic.s_t0 = new box2d.b2Vec2(), box2d.b2ParticleSystem.prototype.SolveSpring = function(o) {
    for (var t = box2d.b2ParticleSystem.prototype.SolveSpring.s_pa, e = box2d.b2ParticleSystem.prototype.SolveSpring.s_pb, r = box2d.b2ParticleSystem.prototype.SolveSpring.s_d, i = box2d.b2ParticleSystem.prototype.SolveSpring.s_f, b = this.m_positionBuffer.data, n = this.m_velocityBuffer.data, p = o.inv_dt * this.m_def.springStrength, s = 0; s < this.m_pairBuffer.count; s++) {
        if ((c = this.m_pairBuffer.data[s]).flags & box2d.b2ParticleFlag.b2_springParticle) {
            var a = c.indexA, d = c.indexB, l = t.Copy(b[a]), x = e.Copy(b[d]);
            a = n[a], d = n[d];
            l.SelfMulAdd(o.dt, a), x.SelfMulAdd(o.dt, d);
            l = box2d.b2Sub_V2_V2(x, l, r), x = c.distance;
            var y = l.Length(), c = box2d.b2Mul_S_V2(p * c.strength * (x - y) / y, l, i);
...
box2d.b2ParticleSystem.prototype.SolveTensile = function(o) {
    var t = box2d.b2ParticleSystem.prototype.SolveTensile.s_weightedNormal, e = box2d.b2ParticleSystem.prototype.SolveTensile.s_s, r = box2d.b2ParticleSystem.prototype.SolveTensile.s_f, i = this.m_velocityBuffer.data;
    ...
    for (b = 0; b < this.m_contactBuffer.count; b++) {
        if ((a = this.m_contactBuffer.data[b]).flags & box2d.b2ParticleFlag.b2_tensileParticle) {
            var n = a.indexA, p = a.indexB, s = a.weight, a = a.normal;
    ...
    for (b = 0; b < this.m_contactBuffer.count; b++) if ((a = this.m_contactBuffer.data[b]).flags & box2d.b2ParticleFlag.b2_tensileParticle) {
        n = a.indexA, p = a.indexB, s = a.weight, a = a.normal;
        var l = this.m_weightBuffer[n] + this.m_weightBuffer[p], x = box2d.b2Sub_V2_V2(this.m_accumulation2Buffer[p], this.m_accumulation2Buffer[n], e);
...
box2d.b2ParticleSystem.prototype.SolveViscous = function() {
    for (var o = box2d.b2ParticleSystem.prototype.SolveViscous.s_v, t = box2d.b2ParticleSystem.prototype.SolveViscous.s_f, e = this.m_positionBuffer.data, r = this.m_velocityBuffer.data, i = this.m_def.viscousStrength, b = this.GetParticleInvMass(), n = 0; n < this.m_bodyContactBuffer.count; n++) {
        ...
        if (this.m_flagsBuffer.data[p] & box2d.b2ParticleFlag.b2_viscousParticle) {
            var s = l.body, a = l.weight, d = l.mass, l = e[p], x = box2d.b2Sub_V2_V2(s.GetLinearVelocityFromWorldPoint(l, box2d.b2Vec2.s_t0), r[p], o);
...
box2d.b2ParticleSystem.prototype.SolveRepulsive = function(o) {
    var t = box2d.b2ParticleSystem.prototype.SolveRepulsive.s_f, e = this.m_velocityBuffer.data;
    ...
    var t = box2d.b2ParticleSystem.prototype.SolvePowder.s_f, e = this.m_positionBuffer.data, r = this.m_velocityBuffer.data;
    ...
    for (var i = 1 - box2d.b2_particleStride, b = this.GetParticleInvMass(), n = 0; n < this.m_bodyContactBuffer.count; n++) {
        ...
        if (this.m_flagsBuffer.data[p] & box2d.b2ParticleFlag.b2_powderParticle) {
            var s = x.weight;
            if (s > i) {
                var a = x.body, d = e[p], l = x.normal, x = box2d.b2Mul_S_V2(o * x.mass * (s - i), l, t);
    ...
    var t = box2d.b2ParticleSystem.prototype.SolveSolid.s_f, e = this.m_velocityBuffer.data;
    this.m_depthBuffer = this.RequestBuffer(this.m_depthBuffer), o = o.inv_dt * this.m_def.ejectionStrength;
    for (var r = 0; r < this.m_contactBuffer.count; r++) {
        var i = this.m_contactBuffer.data[r], b = i.indexA, n = i.indexB;
    ...
    if (o) for (var t = 0; t < this.m_contactBuffer.count; t++) {
        var e = (r = this.m_contactBuffer.data[t]).indexA, r = r.indexB;
    ...
    }), this.m_indexByExpirationTimeBuffer.data) for (i = e = 0; i < this.m_count; i++) (b = t[this.m_indexByExpirationTimeBuffer.data[i]]) !== box2d.b2_invalidParticleIndex && (this.m_indexByExpirationTimeBuffer.data[e++] = b);
    ...
    var t = this.m_expirationTimeBuffer.data, e = this.m_indexByExpirationTimeBuffer.data, r = this.GetParticleCount();
    for (this.m_expirationTimeBufferRequiresSorting && (box2d.std_sort(e, 0, r, function(o, e) {
        var r = t[o], i = t[e], b = 0 >= r;
        return b === 0 >= i ? r > i : b;
    ...
    if (o !== t && t !== e) {
        ...
        if (this.m_expirationTimeBuffer.data) {
            ...
            var i = this.GetParticleCount(), b = this.m_indexByExpirationTimeBuffer.data;
    ...
    var o = box2d.b2ParticleSystem.prototype.RemoveSpuriousBodyContacts.s_n, t = box2d.b2ParticleSystem.prototype.RemoveSpuriousBodyContacts.s_pos, e = box2d.b2ParticleSystem.prototype.RemoveSpuriousBodyContacts.s_normal, r = this, i = -1, b = 0;
    this.m_bodyContactBuffer.count = box2d.std_remove_if(this.m_bodyContactBuffer.data, function(n) {
        ...
        if (p.SelfMul(r.m_particleDiameter * (1 - n.weight)), p = box2d.b2Add_V2_V2(r.m_positionBuffer.data[n.index], p, t), 
        !n.fixture.TestPoint(p)) {
            for (var s = n.fixture.GetShape().GetChildCount(), a = 0; a < s; a++) if (n.fixture.ComputeDistance(p, e, a) < box2d.b2_linearSlop) return !1;
            return 0, !0;
        }
        return !1;
...
box2d.b2VoronoiDiagram.prototype.Generate = function(o, t) {
    ...
    if (0 === b) this.m_countY = this.m_countX = 0; else {
        ...
        for (p = 0; p < this.m_countY; p++) for (b = 0; b < this.m_countX - 1; b++) e = b + p * this.m_countX, 
        ...
        for (p = 0; p < this.m_countY - 1; p++) for (b = 0; b < this.m_countX; b++) e = b + p * this.m_countX, 
        ...
        for (;!i.Empty(); ) if (b = (n = i.Front()).m_x, p = n.m_y, e = n.m_i, n = n.m_generator, 
        i.Pop(), (r = this.m_diagram[e]) !== n) {
            var s = r.center.x - b, a = (r = r.center.y - p, n.center.x - b), d = n.center.y - p;
...
box2d.b2VoronoiDiagram.prototype.GetNodes = function(o) {
    for (var t = 0; t < this.m_countY - 1; t++) for (var e = 0; e < this.m_countX - 1; e++) {
        var r = e + t * this.m_countX, i = this.m_diagram[r], b = this.m_diagram[r + 1], n = this.m_diagram[r + this.m_countX];
...
box2d.b2Rope.prototype.Initialize = function(o) {
    ...
    t = 0; t < r; ++t) {
        var i = this.m_ps[t], b = this.m_ps[t + 1];
...
box2d.b2Rope.prototype.SolveC2 = function() {
    for (var o = this.m_count - 1, t = 0; t < o; ++t) {
        var e = this.m_ps[t], r = this.m_ps[t + 1], i = box2d.b2Sub_V2_V2(r, e, box2d.b2Rope.s_d), b = i.Normalize(), n = this.m_ims[t], p = this.m_ims[t + 1];
        if (0 !== n + p) {
            var s = p / (n + p);
...
box2d.b2Rope.prototype.SolveC3 = function() {
    for (var o = this.m_count - 2, t = 0; t < o; ++t) {
        var e = this.m_ps[t], r = this.m_ps[t + 1], i = this.m_ps[t + 2], b = this.m_ims[t], n = this.m_ims[t + 1], p = this.m_ims[t + 2], s = box2d.b2Sub_V2_V2(r, e, box2d.b2Rope.s_d1), a = box2d.b2Sub_V2_V2(i, r, box2d.b2Rope.s_d2);
        if (0 != (x = s.LengthSquared()) * (y = a.LengthSquared())) {
            var d = box2d.b2Cross_V2_V2(s, a), l = box2d.b2Dot_V2_V2(s, a), x = (d = box2d.b2Atan2(d, l), 
            s = box2d.b2Mul_S_V2(-1 / x, s.SelfSkew(), box2d.b2Rope.s_Jd1), box2d.b2Mul_S_V2(1 / y, a.SelfSkew(), box2d.b2Rope.s_Jd2)), y = (a = box2d.b2Rope.s_J1.Copy(s).SelfNeg(), 
...
box2d.b2BuoyancyController.prototype.Step = function(o) {
    if (this.m_bodyList) for (this.useWorldGravity && this.gravity.Copy(this.GetWorld().GetGravity()), 
    o = this.m_bodyList; o; o = o.nextBody) {
        var t = o.body;
        if (t.IsAwake()) {
            for (var e = new box2d.b2Vec2(), r = new box2d.b2Vec2(), i = 0, b = 0, n = t.GetFixtureList(); n; n = n.m_next) {
                var p = new box2d.b2Vec2(), s = n.GetShape().ComputeSubmergedArea(this.normal, this.offset, t.GetTransform(), p);
                i = i + s;
                e.x += s * p.x, e.y += s * p.y;
                var a = 0;
...
box2d.b2BuoyancyController.prototype.Draw = function(o) {
    var t = new box2d.b2Vec2(), e = new box2d.b2Vec2();
...
box2d.b2GravityController.prototype.Step = function(o) {
    if (this.invSqr) for (o = this.m_bodyList; o; o = o.nextBody) for (var t = o.body, e = t.GetWorldCenter(), r = t.GetMass(), i = this.m_bodyList; i !== o; i = i.nextBody) {
        var b = i.body, n = b.GetWorldCenter(), p = b.GetMass(), s = n.x - e.x, a = n.y - e.y, d = s * s + a * a;
    ...
    } else for (o = this.m_bodyList; o; o = o.nextBody) for (e = (t = o.body).GetWorldCenter(), 
...
box2d.b2TensorDampingController.prototype.SetAxisAligned = function(o, t) {
    ...
    return e.x = o.x - t.x, e.y = o.y - t.y, e;
}, window.box2d = box2d, function(o, t) {
    ...
    var r = function(o) {
        function ColliderBase() {
            var o;
            return _classCallCheck(this, ColliderBase), (o = _possibleConstructorReturn(this, _getPrototypeOf(ColliderBase).apply(this, arguments)))._isSensor = !1, 
            o._density = 10, o._friction = .2, o._restitution = 0, o;
        }
    ...
    var i = function(o) {
        function RigidBody() {
            var o;
            return _classCallCheck(this, RigidBody), (o = _possibleConstructorReturn(this, _getPrototypeOf(RigidBody).apply(this, arguments)))._type = "dynamic", 
            o._allowSleep = !0, o._angularVelocity = 0, o._angularDamping = 0, o._linearVelocity = {
                x: 0,
                y: 0
            }, o._linearDamping = 0, o._bullet = !1, o._allowRotation = !0, o._gravityScale = 1, 
            o.group = 0, o.category = 1, o.mask = -1, o.label = "RigidBody", o;
        }
        return _inherits(RigidBody, t.Component), _createClass(RigidBody, [ {
            key: "_createBody",
            value: function() {
                if (!this._body && this.owner) {
                    var o = this.owner, r = window.box2d, i = new r.b2BodyDef(), b = o.localToGlobal(t.Point.TEMP.setTo(0, 0), !1, e.Physics.I.worldRoot);
            ...
            value: function() {
                if ("static" != this.type && this._body.IsAwake()) {
                    var o = this._body.GetPosition(), r = this._body.GetAngle(), i = this.owner;
    ...
    var b = function() {
        ...
        function Physics() {
            var o;
            return _classCallCheck(this, Physics), (o = _possibleConstructorReturn(this, _getPrototypeOf(Physics).call(this))).box2d = window.box2d, 
            o.velocityIterations = 8, o.positionIterations = 3, o._eventList = [], o;
        }
        return _inherits(Physics, t.EventDispatcher), _createClass(Physics, [ {
            ...
            value: function() {
                ...
                if (!this._enabled) {
                    ...
                    this.world = new e.b2World(r), this.world.SetDestructionListener(new b()), this.world.SetContactListener(new p()), 
                    this.allowSleeping = null == o.allowSleeping || o.allowSleeping, o.customUpdate || t.Laya.physicsTimer.frameLoop(1, this, this._update), 
            ...
            key: "_sendEvent",
            value: function(o, e) {
                var r = e.GetFixtureA().collider, i = e.GetFixtureB().collider, b = r.owner, n = i.owner;
                if (e.getHitInfo = function() {
                    ...
                    var p = [ i, r, e ];
                    0 === o ? (b.event(t.Event.TRIGGER_ENTER, p), b._triggered ? b.event(t.Event.TRIGGER_STAY, p) : b._triggered = !0) : (b._triggered = !1, 
                    b.event(t.Event.TRIGGER_EXIT, p));
                }
                n && (p = [ r, i, e ], 0 === o ? (n.event(t.Event.TRIGGER_ENTER, p), n._triggered ? n.event(t.Event.TRIGGER_STAY, p) : n._triggered = !0) : (n._triggered = !1, 
                n.event(t.Event.TRIGGER_EXIT, p)));
            }
        }, {
            key: "_createBody",
            value: function(o) {
    ...
    var p = function() {
        ...
        function BoxCollider() {
            var o;
            return _classCallCheck(this, BoxCollider), (o = _possibleConstructorReturn(this, _getPrototypeOf(BoxCollider).apply(this, arguments)))._x = 0, 
            o._y = 0, o._width = 100, o._height = 100, o;
        }
        return _inherits(BoxCollider, r), _createClass(BoxCollider, [ {
            ...
            value: function() {
                ...
                this.label = this.label || "BoxCollider", _get(_getPrototypeOf(BoxCollider.prototype), "getDef", this).call(this);
            }
        }, {
            key: "_setShape",
            value: function() {
                var o = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0], t = this.owner.scaleX || 1, e = this.owner.scaleY || 1;
    ...
    var a = function(o) {
        function ChainCollider() {
            var o;
            return _classCallCheck(this, ChainCollider), (o = _possibleConstructorReturn(this, _getPrototypeOf(ChainCollider).apply(this, arguments)))._x = 0, 
            o._y = 0, o._points = "0,0,100,0", o._loop = !1, o;
        }
        return _inherits(ChainCollider, r), _createClass(ChainCollider, [ {
            ...
            value: function() {
                ...
                this.label = this.label || "ChainCollider", _get(_getPrototypeOf(ChainCollider.prototype), "getDef", this).call(this);
            }
        }, {
            key: "_setShape",
            value: function() {
                var o = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0], t = this._points.split(","), e = t.length;
    ...
    var d = function(o) {
        function CircleCollider() {
            var o;
            return _classCallCheck(this, CircleCollider), (o = _possibleConstructorReturn(this, _getPrototypeOf(CircleCollider).apply(this, arguments)))._x = 0, 
            o._y = 0, o._radius = 50, o;
        }
        return _inherits(CircleCollider, r), _createClass(CircleCollider, [ {
            ...
            value: function() {
                ...
                this.label = this.label || "CircleCollider", _get(_getPrototypeOf(CircleCollider.prototype), "getDef", this).call(this);
            }
        }, {
            key: "_setShape",
            value: function() {
                var o = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0], t = this.owner.scaleX || 1;
                this._shape.m_radius = this._radius / n.PIXEL_RATIO * t, this._shape.m_p.Set((this._radius + this._x) / n.PIXEL_RATIO * t, (this._radius + this._y) / n.PIXEL_RATIO * t), 
                o && this.refresh();
            }
        }, {
            key: "resetShape",
    ...
    var l = function(o) {
        function PhysicsDebugDraw() {
            var o;
            return _classCallCheck(this, PhysicsDebugDraw), (o = _possibleConstructorReturn(this, _getPrototypeOf(PhysicsDebugDraw).call(this))).m_drawFlags = 99, 
            PhysicsDebugDraw._inited || (PhysicsDebugDraw._inited = !0, PhysicsDebugDraw.init()), 
            o._camera = {}, o._camera.m_center = new PhysicsDebugDraw.box2d.b2Vec2(0, 0), o._camera.m_extent = 25, 
            o._camera.m_zoom = 1, o._camera.m_width = 1280, o._camera.m_height = 800, o._mG = new t.Graphics(), 
            o.graphics = o._mG, o._textSp = new t.Sprite(), o._textG = o._textSp.graphics, o.addChild(o._textSp), 
            o;
        }
        return _inherits(PhysicsDebugDraw, t.Sprite), _createClass(PhysicsDebugDraw, [ {
            ...
            value: function() {
                this.world && (this._textG.clear(), this._mG.clear(), this._mG.save(), this._mG.scale(n.PIXEL_RATIO, n.PIXEL_RATIO), 
                this.lineWidth = 1 / n.PIXEL_RATIO, this.world.DrawDebugData(), this._mG.restore());
            }
        }, {
            key: "SetFlags",
            value: function(o) {
            ...
            key: "DrawParticles",
            value: function(o, t, e, r) {
                if (null !== e) for (var i = 0; i < r; ++i) {
                    var b = o[i], n = e[i];
                    this._mG.drawCircle(b.x, b.y, t, n.MakeStyleString(), null, this.lineWidth);
                } else for (i = 0; i < r; ++i) b = o[i], this._mG.drawCircle(b.x, b.y, t, "#ffff00", null, this.lineWidth);
            }
        }, {
            key: "DrawSegment",
            value: function(o, t, e) {
            ...
            key: "DrawTransform",
            value: function(o) {
                this.PushTransform(o), this._mG.drawLine(0, 0, 1, 0, PhysicsDebugDraw.box2d.b2Color.RED.MakeStyleString(1), this.lineWidth), 
            ...
            key: "DrawAABB",
            value: function(o, t) {
                var e = o.lowerBound.x, r = o.lowerBound.y, i = o.upperBound.x - o.lowerBound.x, b = o.upperBound.y - o.lowerBound.y;
                this._mG.drawRect(e, r, i, b, null, t.MakeStyleString(), this.lineWidth);
            }
        } ], [ {
            key: "init",
            value: function() {
                PhysicsDebugDraw.box2d = t.Browser.window.box2d, PhysicsDebugDraw.DrawString_s_color = new PhysicsDebugDraw.box2d.b2Color(.9, .6, .6), 
                PhysicsDebugDraw.DrawStringWorld_s_p = new PhysicsDebugDraw.box2d.b2Vec2(), PhysicsDebugDraw.DrawStringWorld_s_cc = new PhysicsDebugDraw.box2d.b2Vec2(), 
                PhysicsDebugDraw.DrawStringWorld_s_color = new PhysicsDebugDraw.box2d.b2Color(.5, .9, .5);
            }
        }, {
            key: "enable",
            value: function() {
                ...
                if (!PhysicsDebugDraw.I) {
                    ...
                    e.world = n.I.world, e.world.SetDebugDraw(e), e.zOrder = 1e3, e.m_drawFlags = o, 
                    t.Laya.stage.addChild(e), PhysicsDebugDraw.I = e;
                }
                return e;
            }
        } ]), PhysicsDebugDraw;
    ...
    var x = function(o) {
        function PolygonCollider() {
            var o;
            return _classCallCheck(this, PolygonCollider), (o = _possibleConstructorReturn(this, _getPrototypeOf(PolygonCollider).apply(this, arguments)))._x = 0, 
            o._y = 0, o._points = "50,0,100,100,0,100", o;
        }
        return _inherits(PolygonCollider, r), _createClass(PolygonCollider, [ {
            key: "getDef",
            value: function() {
                return this._shape || (this._shape = new window.box2d.b2PolygonShape(), this._setShape(!1)), 
                this.label = this.label || "PolygonCollider", _get(_getPrototypeOf(PolygonCollider.prototype), "getDef", this).call(this);
            }
        }, {
            key: "_setShape",
            value: function() {
    ...
    var c = function(o) {
        function DistanceJoint() {
            var o;
            return _classCallCheck(this, DistanceJoint), (o = _possibleConstructorReturn(this, _getPrototypeOf(DistanceJoint).apply(this, arguments))).selfAnchor = [ 0, 0 ], 
            o.otherAnchor = [ 0, 0 ], o.collideConnected = !1, o._length = 0, o._frequency = 0, 
            o._damping = 0, o;
        }
        return _inherits(DistanceJoint, y), _createClass(DistanceJoint, [ {
            ...
            value: function() {
                if (!this._joint) {
                    ...
                    var o = window.box2d, t = DistanceJoint._temp || (DistanceJoint._temp = new o.b2DistanceJointDef());
                    t.bodyA = this.otherBody ? this.otherBody.getBody() : n.I._emptyBody, t.bodyB = this.selfBody.getBody(), 
                    ...
                    var e = t.bodyA.GetWorldPoint(t.localAnchorA, new o.b2Vec2()), r = t.bodyB.GetWorldPoint(t.localAnchorB, new o.b2Vec2());
    ...
    var _ = function(o) {
        function GearJoint() {
            var o;
            return _classCallCheck(this, GearJoint), (o = _possibleConstructorReturn(this, _getPrototypeOf(GearJoint).apply(this, arguments))).collideConnected = !1, 
            o._ratio = 1, o;
        }
        return _inherits(GearJoint, y), _createClass(GearJoint, [ {
            ...
            value: function() {
                if (!this._joint) {
                    ...
                    var o = window.box2d, t = GearJoint._temp || (GearJoint._temp = new o.b2GearJointDef());
    ...
    var m = function(o) {
        function MotorJoint() {
            var o;
            return _classCallCheck(this, MotorJoint), (o = _possibleConstructorReturn(this, _getPrototypeOf(MotorJoint).apply(this, arguments))).collideConnected = !1, 
            o._linearOffset = [ 0, 0 ], o._angularOffset = 0, o._maxForce = 1e3, o._maxTorque = 1e3, 
            o._correctionFactor = .3, o;
        }
        return _inherits(MotorJoint, y), _createClass(MotorJoint, [ {
            ...
            value: function() {
                if (!this._joint) {
                    ...
                    if (this.selfBody = this.selfBody || this.owner.getComponent(i), !this.selfBody) throw "selfBody can not be empty";
                    var o = window.box2d, t = MotorJoint._temp || (MotorJoint._temp = new o.b2MotorJointDef());
                    t.Initialize(this.otherBody.getBody(), this.selfBody.getBody()), t.linearOffset = new o.b2Vec2(this._linearOffset[0] / n.PIXEL_RATIO, this._linearOffset[1] / n.PIXEL_RATIO), 
    ...
    var u = function(o) {
        function MouseJoint() {
            var o;
            return _classCallCheck(this, MouseJoint), (o = _possibleConstructorReturn(this, _getPrototypeOf(MouseJoint).apply(this, arguments)))._maxForce = 1e4, 
            o._frequency = 5, o._damping = .7, o;
        }
        return _inherits(MouseJoint, y), _createClass(MouseJoint, [ {
            ...
            value: function() {
                if (!this._joint) {
                    if (this.selfBody = this.selfBody || this.owner.getComponent(i), !this.selfBody) throw "selfBody can not be empty";
                    var o = window.box2d, e = MouseJoint._temp || (MouseJoint._temp = new o.b2MouseJointDef());
                    if (this.anchor) var r = this.selfBody.owner.localToGlobal(t.Point.TEMP.setTo(this.anchor[0], this.anchor[1]), !1, n.I.worldRoot); else r = n.I.worldRoot.globalToLocal(t.Point.TEMP.setTo(t.Laya.stage.mouseX, t.Laya.stage.mouseY));
                    var b = new o.b2Vec2(r.x / n.PIXEL_RATIO, r.y / n.PIXEL_RATIO);
                    e.bodyA = n.I._emptyBody, e.bodyB = this.selfBody.getBody(), e.target = b, e.frequencyHz = this._frequency, 
                    e.damping = this._damping, e.maxForce = this._maxForce, this._joint = n.I._createJoint(e);
                }
            }
        }, {
            key: "onStageMouseUp",
    ...
    var h = function(o) {
        function PrismaticJoint() {
            var o;
            return _classCallCheck(this, PrismaticJoint), (o = _possibleConstructorReturn(this, _getPrototypeOf(PrismaticJoint).apply(this, arguments))).anchor = [ 0, 0 ], 
            o.axis = [ 1, 0 ], o.collideConnected = !1, o._enableMotor = !1, o._motorSpeed = 0, 
            o._maxMotorForce = 1e4, o._enableLimit = !1, o._lowerTranslation = 0, o._upperTranslation = 0, 
            o;
        }
        return _inherits(PrismaticJoint, y), _createClass(PrismaticJoint, [ {
            ...
            value: function() {
                if (!this._joint) {
                    if (this.selfBody = this.selfBody || this.owner.getComponent(i), !this.selfBody) throw "selfBody can not be empty";
                    var o = window.box2d, e = PrismaticJoint._temp || (PrismaticJoint._temp = new o.b2PrismaticJointDef()), r = this.selfBody.owner.localToGlobal(t.Point.TEMP.setTo(this.anchor[0], this.anchor[1]), !1, n.I.worldRoot), b = new o.b2Vec2(r.x / n.PIXEL_RATIO, r.y / n.PIXEL_RATIO);
                    ...
                    e.enableLimit = this._enableLimit, e.lowerTranslation = this._lowerTranslation / n.PIXEL_RATIO, 
                    e.upperTranslation = this._upperTranslation / n.PIXEL_RATIO, e.collideConnected = this.collideConnected, 
    ...
    var g = function(o) {
        function PulleyJoint() {
            var o;
            return _classCallCheck(this, PulleyJoint), (o = _possibleConstructorReturn(this, _getPrototypeOf(PulleyJoint).apply(this, arguments))).selfAnchor = [ 0, 0 ], 
            o.otherAnchor = [ 0, 0 ], o.selfGroundPoint = [ 0, 0 ], o.otherGroundPoint = [ 0, 0 ], 
            o.ratio = 1.5, o.collideConnected = !1, o;
        }
    ...
    var f = function(o) {
        function RevoluteJoint() {
            var o;
            return _classCallCheck(this, RevoluteJoint), (o = _possibleConstructorReturn(this, _getPrototypeOf(RevoluteJoint).apply(this, arguments))).anchor = [ 0, 0 ], 
            o.collideConnected = !1, o._enableMotor = !1, o._motorSpeed = 0, o._maxMotorTorque = 1e4, 
            o._enableLimit = !1, o._lowerAngle = 0, o._upperAngle = 0, o;
        }
        return _inherits(RevoluteJoint, y), _createClass(RevoluteJoint, [ {
            ...
            value: function() {
                if (!this._joint) {
                    if (this.selfBody = this.selfBody || this.owner.getComponent(i), !this.selfBody) throw "selfBody can not be empty";
                    var o = window.box2d, e = RevoluteJoint._temp || (RevoluteJoint._temp = new o.b2RevoluteJointDef()), r = this.selfBody.owner.localToGlobal(t.Point.TEMP.setTo(this.anchor[0], this.anchor[1]), !1, n.I.worldRoot), b = new o.b2Vec2(r.x / n.PIXEL_RATIO, r.y / n.PIXEL_RATIO);
    ...
    var S = function(o) {
        function RopeJoint() {
            var o;
            return _classCallCheck(this, RopeJoint), (o = _possibleConstructorReturn(this, _getPrototypeOf(RopeJoint).apply(this, arguments))).selfAnchor = [ 0, 0 ], 
            o.otherAnchor = [ 0, 0 ], o.collideConnected = !1, o._maxLength = 1, o;
        }
        return _inherits(RopeJoint, y), _createClass(RopeJoint, [ {
            ...
            value: function() {
                if (!this._joint) {
                    if (this.selfBody = this.selfBody || this.owner.getComponent(i), !this.selfBody) throw "selfBody can not be empty";
                    var o = window.box2d, t = RopeJoint._temp || (RopeJoint._temp = new o.b2RopeJointDef());
                    t.bodyA = this.otherBody ? this.otherBody.getBody() : n.I._emptyBody, t.bodyB = this.selfBody.getBody(), 
                    t.localAnchorA.Set(this.otherAnchor[0] / n.PIXEL_RATIO, this.otherAnchor[1] / n.PIXEL_RATIO), 
                    t.localAnchorB.Set(this.selfAnchor[0] / n.PIXEL_RATIO, this.selfAnchor[1] / n.PIXEL_RATIO), 
                    t.maxLength = this._maxLength / n.PIXEL_RATIO, t.collideConnected = this.collideConnected, 
                    this._joint = n.I._createJoint(t);
                }
            }
        }, {
    ...
    var P = function(o) {
        function WeldJoint() {
            var o;
            return _classCallCheck(this, WeldJoint), (o = _possibleConstructorReturn(this, _getPrototypeOf(WeldJoint).apply(this, arguments))).anchor = [ 0, 0 ], 
            o.collideConnected = !1, o._frequency = 5, o._damping = .7, o;
        }
        return _inherits(WeldJoint, y), _createClass(WeldJoint, [ {
            ...
            value: function() {
                if (!this._joint) {
                    if (!this.otherBody) throw "otherBody can not be empty";
                    if (this.selfBody = this.selfBody || this.owner.getComponent(i), !this.selfBody) throw "selfBody can not be empty";
                    var o = window.box2d, e = WeldJoint._temp || (WeldJoint._temp = new o.b2WeldJointDef()), r = this.selfBody.owner.localToGlobal(t.Point.TEMP.setTo(this.anchor[0], this.anchor[1]), !1, n.I.worldRoot), b = new o.b2Vec2(r.x / n.PIXEL_RATIO, r.y / n.PIXEL_RATIO);
                    e.Initialize(this.otherBody.getBody(), this.selfBody.getBody(), b), e.frequencyHz = this._frequency, 
                    e.dampingRatio = this._damping, e.collideConnected = this.collideConnected, this._joint = n.I._createJoint(e);
                }
            }
        }, {
            key: "frequency",
    ...
    var C = function(o) {
        function WheelJoint() {
            var o;
            return _classCallCheck(this, WheelJoint), (o = _possibleConstructorReturn(this, _getPrototypeOf(WheelJoint).apply(this, arguments))).anchor = [ 0, 0 ], 
            o.collideConnected = !1, o.axis = [ 1, 0 ], o._frequency = 5, o._damping = .7, o._enableMotor = !1, 
            o._motorSpeed = 0, o._maxMotorTorque = 1e4, o;
        }
        return _inherits(WheelJoint, y), _createClass(WheelJoint, [ {
            ...
            value: function() {
                if (!this._joint) {
                    if (!this.otherBody) throw "otherBody can not be empty";
                    if (this.selfBody = this.selfBody || this.owner.getComponent(i), !this.selfBody) throw "selfBody can not be empty";
                    var o = window.box2d, e = WheelJoint._temp || (WheelJoint._temp = new o.b2WheelJointDef()), r = this.selfBody.owner.localToGlobal(t.Point.TEMP.setTo(this.anchor[0], this.anchor[1]), !1, n.I.worldRoot), b = new o.b2Vec2(r.x / n.PIXEL_RATIO, r.y / n.PIXEL_RATIO);
    ...
    t.ClassUtils.regClass("laya.physics.joint.WheelJoint", C), t.ClassUtils.regClass("Laya.WheelJoint", C), 
    o.BoxCollider = s, o.ChainCollider = a, o.CircleCollider = d, o.ColliderBase = r, 
    o.DestructionListener = b, o.DistanceJoint = c, o.GearJoint = _, o.IPhysics = e, 
    o.JointBase = y, o.MotorJoint = m, o.MouseJoint = u, o.Physics = n, o.PhysicsDebugDraw = l, 
    o.PolygonCollider = x, o.PrismaticJoint = h, o.PulleyJoint = g, o.RevoluteJoint = f, 
    o.RigidBody = i, o.RopeJoint = S, o.WeldJoint = P, o.WheelJoint = C;
