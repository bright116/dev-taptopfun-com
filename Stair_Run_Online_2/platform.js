...
! function () {
    ...
    class platform {
        ...
        prompt0(msg, duration = 3000) {
			...
			if (!this.labelInfo) {
				this.labelBg = new Laya.Box();
				this.labelBg.bgColor = "#000000";
				this.labelBg.alpha = 0.5;
				this.labelBg.centerX = 0;
				this.labelBg.centerY = -50;
			...
			this.labelBg.visible = this.labelInfo.visible = true;
			Laya.stage.addChild(this.labelBg);
			Laya.stage.addChild(this.labelInfo);
			Laya.timer.clear(this, this.clearLabel)
			this.labelBg.width = this.labelInfo.width + 20;
			this.labelBg.height = this.labelInfo.height;
			Laya.timer.once(duration, this, this.clearLabel)
		}
		clearLabel() {
			this.labelBg.visible = this.labelInfo.visible = false;
		}
