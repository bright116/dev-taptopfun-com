! function(t, e) {
    ...
    function ieee754_write(t, e, r, i, n, f) {
        ...
        for (e = Math.abs(e), isNaN(e) || e === 1 / 0 ? (s = isNaN(e) ? 1 : 0, o = l) : (o = Math.floor(Math.log(e) / Math.LN2),
            ...
            w += v, s /= 256, n -= 8);
        for (o = o << n | s, a += n; a > 0; t[r + w] = 255 & o, w += v, o /= 256, a -= 8);
        t[r + w - v] |= 128 * b;
    }
    e.accessor = function() {
        return Uint8Array;
        ...
        if (t instanceof Uint8Array) o = new e(0, n, f), t.length > 0 && (o.buffer = t.buffer,
            o.offset = t.byteOffset, o.limit = t.byteOffset + t.byteLength, o.view = new Uint8Array(t.buffer));
        else if (t instanceof ArrayBuffer) o = new e(0, n, f),
            t.byteLength > 0 && (o.buffer = t, o.offset = 0, o.limit = t.byteLength, o.view = t.byteLength > 0 ? new Uint8Array(t) : null);
        else {
    ...
    var f = function() {
        ...
        return t.encode = function(t, r) {
            ...
            for (; null !== (i = t());)
                if (void 0 === (n = r[i]) && fail(i), null !== (i = t()) && (void 0 === (f = r[i]) && fail(i),
    ...
    r.toBase64 = function(t, e) {
        ...
        for (var n, f, o = t.length, s = new e((o + 1) / 3 | 0, r, i), h = 0, a = 0, l = !1, u = !1, g = !1, w = !1, v = !1; h < o;) {
            switch (n = t.charAt(h++)) {
                case "!":
                    if (!i) {
                        if (u || g || w) {
            ...
            if (v) throw TypeError("Illegal str: Invalid symbol at " + h);
        }
        if (!i) {
        ...
        var t = {
            ...
            decodeUTF8: function(t, e) {
                for (var r, i, n, f, o = function(t) {
                    ...
                    if (0 == (128 & r)) e(r);
                    else if (192 == (224 & r)) null === (i = t()) && o([r, i]),
                    e((31 & r) << 6 | 63 & i);
                else if (224 == (240 & r))(null === (i = t()) || null === (n = t())) && o([r, i, n]),
