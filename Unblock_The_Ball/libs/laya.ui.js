...
!function(t, e) {
    ...
    var n = function(t) {
        ...
        return _inherits(AutoBitmap, e.Graphics), _createClass(AutoBitmap, [ {
            ...
            key: "getTexture",
            value: function value(t, i, s, n, a) {
                var h;
            ...
            value: function value() {
                ...
                if (t) {
                    ...
                    if (e.Utils.isOkTextureList(a) || (a = null), a) this._sources = a; else {
                        if (this._sources = [], 1 === this._stateNum) this._sources.push(t); else for (var h = 0; h < this._stateNum; h++) {
                            this._sources.push(e.Texture.createFromTexture(t, 0, s * h, i, s));
                        }
                    ...
                    if (e.Utils.isOkTextureList(h) || (h = null), h) this._sources = h; else {
                        ...
                        for (var r = 0; r < this._clipY; r++) {
                            for (var o = 0; o < this._clipX; o++) {
                                this._sources.push(e.Texture.createFromTexture(i, s * o, n * r, s, n));
                            }
                        }
    ...
    var m = function(t) {
        ...
        return _inherits(List, u), _createClass(List, [ {
            ...
            value: function value(t, e, i) {
                ...
                for (var _ = t; _ < i; _++) {
                    for (var g = 0; g < e; g++) {
                        (n = o && o.length ? o.pop() : this.createItem()).x = (this._isVertical ? g : _) * a - s._x, 
            ...
            key: "renderItems",
            value: function value() {
                for (var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0, e = (arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0) || this._cells.length; t < e; t++) {
                    this.renderItem(this._cells[t], this._startIndex + t);
                }
        ...
        return _inherits(HBox, z), _createClass(HBox, [ {
            ...
            value: function value() {
                ...
                for (i = 0, s = t.length; i < s; i++) {
                    (n = t[i]).x = a, a += n.width * n.scaleX + this._space, this._align == HBox.TOP ? n.y = 0 : this._align == HBox.MIDDLE ? n.y = .5 * (e - n.height * n.scaleY) : this._align == HBox.BOTTOM && (n.y = e - n.height * n.scaleY);
                }
                this._sizeChanged();
            }
        }, {
    ...
    var H = function(t) {
        ...
        return _inherits(VBox, z), _createClass(VBox, [ {
            ...
            value: function value() {
                ...
                var a = 0;
                for (i = 0, s = t.length; i < s; i++) {
                    (n = t[i]).y = a, a += n.height * n.scaleY + this._space, this._align == VBox.LEFT ? n.x = 0 : this._align == VBox.CENTER ? n.x = .5 * (e - n.width * n.scaleX) : this._align == VBox.RIGHT && (n.x = e - n.width * n.scaleX);
                }
                this._sizeChanged();
            }
        }, {
