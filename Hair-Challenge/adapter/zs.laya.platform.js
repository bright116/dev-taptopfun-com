window.zs = window.zs || {}, window.zs.laya = window.zs.laya || {}, function(t, e) {
    ...
    class i extends e.Script {
        ...
        static enterGamePopup() {
            a.zs_jump_switch && a.isPublicVersion() && a.zs_auto_full_screen_jump_switch && a.zs_Fakerjump && setTimeout(function() {
                null != zs.laya.platform.PlatformMgr.is_new && 0 == zs.laya.platform.PlatformMgr.is_new ? i.showScreenAd() : null == zs.laya.platform.PlatformMgr.is_new && i.showScreenAd();
            }, 5e3);
        }
    ...
    class a {
        ...
        static initAdSetting(t, i) {
            ...
            this.zs_game_star_jump_switch = !0, this.adUnitId1 = i.zs_native_adunit, this.adUnitId2 = i.zs_native_adunit2, 
            this.adUnitId3 = i.zs_native_adunit3, this.adUnitId4 = i.zs_native_adunit4, this.adUnitId5 = i.zs_native_adunit5, 
        ...
        static initOpenAwardNum() {
            ...
            e.LocalStorage.setItem("Hair-Challenge_open_recorder_num", 0));
        }
        ...
        static isShareRecorder(t) {
            ...
            if (s.IsNumber(a.zs_show_share_num)) {
                ...
                var i = e.LocalStorage.getItem("Hair-Challenge_open_recorder_num") || 0;
    ...
    a.zs_Fakerjump = !1, e.ILaya.regClass(a), e.ClassUtils.regClass("zs.laya.platform.ADConfig", a), 
    ...
    class v extends e.Script {
        ...
        onMouseAd(t, i) {
            "click" == t.type && zs.laya.sdk.ZSReportSdk.navigate2Mini(this.adData[i], zs.laya.platform.PlatformMgr.user_id, () => {
    ...
    class A extends e.Script {
        ...
        onBgClick() {
            zs.laya.sdk.ZSReportSdk.navigate2Mini(this.adData, zs.laya.platform.PlatformMgr.user_id, function() {
                e.stage.event(zs.laya.game.EventId.APP_JUMP_SUCCESS);
            }, function() {
    ...
    class y extends zs.laya.base.ZhiSeView {
        ...
        onSucClick() {
            this.owner.close(), zs.laya.sdk.ZSReportSdk.navigate2Mini(this.adData, zs.laya.platform.PlatformMgr.user_id, function() {
                e.stage.event(zs.laya.game.EventId.APP_JUMP_SUCCESS);
            }, function() {
                e.stage.event(zs.laya.game.EventId.APP_JUMP_CANCEL);
            }, function() {});
    ...
    class I extends zs.laya.base.ZhiSeView {
        ...
        onAwake() {
            ...
            this.fakeExitBtn && this.fakeExitBtn.on(e.Event.CLICK, this, this.onOpenListAd), 
            this.continueBtn && this.continueBtn.on(e.Event.CLICK, this, this.closeView), this.headAdList.renderHandler = e.Handler.create(this, this.onItemRender, [ this.headAdList ], !1), 
        ...
        onStart() {
            ...
            let s = this;
            this.initData(), this.continueBtn.visible = !1, a.zs_switch && a.zs_auto_jump_switch && a.zs_banner_vertical_enable ? e.timer.once(500, this, function() {
                if (this.mainAdList && this.mainAdList.array && this.mainAdList.array.length) {
                    ...
                    }, t), e.stage.once(zs.laya.platform.PlatformMgr.APP_JUMP_CANCEL, s, s.showBtn), 
                    s.showTimer = setTimeout(s.showBtn.bind(this), 3e3);
                } else this.showBtn();
            }) : this.showBtn(), this.showFingerEff();
        }
        showBtn() {
        ...
        onContinue() {
            if (!a.zs_switch || this.firstClick) this.closeView(); else {
                this.firstClick = !0;
                ...
                var s = zs.laya.platform.ADConfig.zs_full_screen_banner_time ? 1e3 * zs.laya.platform.ADConfig.zs_full_screen_banner_time : 0;
                setTimeout(function() {
                    i.hideAll(), t.continueBtn.on(e.Event.CLICK, t, t.closeView);
                }, a + Math.max(2e3, s) + 500);
            }
        }
        closeView() {
            e.SoundManager.playSound(i.soundClick), i.currentView = "", this.owner.close();
    ...
    e.ILaya.regClass(k), e.ClassUtils.regClass("zs.laya.platform.ListAdView", k), e.ClassUtils.regClass("Zhise.ListAdView", k);
    ...
    class L extends e.Script {
        ...
        onEnable() {
            ...
            var t = i.platformCfg.nativeCfg[this.viewName];
            if (t) {
    ...
    t.PlatformMgr = i, t.MathUtils = s, t.ADConfig = a, t.ExportGameCtrl = l, t.NativeAdsCtrl = B, 
