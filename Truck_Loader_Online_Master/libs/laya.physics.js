...
box2d.b2DynamicTree.prototype.GetAreaRatio = function() {
    ...
    var o = this.m_root.aabb.GetPerimeter(), t = function(o) {
...
box2d.b2ContactSolver.prototype.WarmStart.s_P = new box2d.b2Vec2(), box2d.b2ContactSolver.prototype.SolveVelocityConstraints = function() {
    var o, t, e, r, i, b, n, p, s, a, d, l, x, y, c, _, m, u, h, g, f, S, P = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_dv, C = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_dv1, A = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_dv2, B = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P, v = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_a, V = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_b, J = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_x, M = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_d, w = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P1, D = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P2, G = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P1P2;
    for (o = 0, t = this.m_count; o < t; ++o) {
        for (b = (i = this.m_velocityConstraints[o]).indexA, n = i.indexB, p = i.invMassA, 
...
box2d.b2RevoluteJoint.prototype.GetReactionForce = function(o, t) {
    return new box2d.b2Vec2().Set(o * this.m_impulse.x, o * this.m_impulse.y);
...
box2d.b2WheelJoint.prototype.GetReactionForce = function(o, t) {
    return (t = new box2d.b2Vec2()).x = o * (this.m_impulse * this.m_ay.x + this.m_springImpulse * this.m_ax.x), 
    ...
    for (var m = this.GetParticleMass(), u = 0; u < this.m_pairBuffer.count; u++) {
        if ((f = this.m_pairBuffer.data[u]).flags & box2d.b2ParticleFlag.b2_barrierParticle) {
            ...
            S = box2d.b2Sub_V2_V2(S, f, i), g = box2d.b2Sub_V2_V2(g, h, b), P = this.GetInsideBoundsEnumerator(P); 0 <= (C = P.GetNext()); ) {
                ...
                if (A !== V && B !== V) {
                    var J = this.GetLinearVelocity(V, C, v, n), M = box2d.b2Sub_V2_V2(v, f, p), w = box2d.b2Sub_V2_V2(J, h, s), D = box2d.b2Cross_V2_V2(g, w), G = box2d.b2Cross_V2_V2(S, w) - box2d.b2Cross_V2_V2(M, g), T = box2d.b2Cross_V2_V2(S, M), I = a, R = d;
                    if (0 === D) {
                        if (0 === G) continue;
                        ...
                        box2d.b2AddMul_V2_S_V2(S, T, g, I), box2d.b2AddMul_V2_S_V2(M, T, w, R), G = box2d.b2Dot_V2_V2(I, R) / box2d.b2Dot_V2_V2(I, I), 
                        !(0 <= T && T < _ && 0 <= G && 1 >= G)) {
...
box2d.b2TensorDampingController.prototype.SetAxisAligned = function(o, t) {
    ...
    class n extends t.EventDispatcher {
        ...
        static enable(o = null) {
            n.I.start(o), e.RigidBody = i, e.Physics = this;
        }
        start(o = null) {
            if (!this._enabled) {
                this._enabled = !0, o || (o = {});
                var e = window.box2d;
                if (null == e) return void console.error("Can not find box2d libs, you should reuqest box2d.js first.");
        ...
        _sendEvent(o, e) {
            var r = e.GetFixtureA().collider, i = e.GetFixtureB().collider, b = r.owner, p = i.owner;
            if (e.getHitInfo = function() {
                var o = new box2d.b2WorldManifold();
                this.GetWorldManifold(o);
                var t = o.points[0];
                return t.x *= n.PIXEL_RATIO, t.y *= n.PIXEL_RATIO, o;
            }, b) {
                var s = [ i, r, e ];
                0 === o ? (b.event(t.Event.TRIGGER_ENTER, s), b._triggered ? b.event(t.Event.TRIGGER_STAY, s) : b._triggered = !0) : (b._triggered = !1, 
        ...
        play() {
            t.Laya.physicsTimer.loop(1, this, this._update);
        }
        get allowSleeping() {
    ...
    class s extends r {
        ...
        _setShape(o = !0) {
            var t = this.owner.scaleX || 1, e = this.owner.scaleY || 1;
    ...
    class a extends r {
        ...
        _setShape(o = !0) {
            var t = this._points.split(","), e = t.length;
    ...
    class l extends t.Sprite {
        constructor() {
            super(), this.m_drawFlags = 99, l._inited || (l._inited = !0, l.init()), this._camera = {}, 
            this._camera.m_center = new l.box2d.b2Vec2(0, 0), this._camera.m_extent = 25, this._camera.m_zoom = 1, 
        ...
        static init() {
            l.box2d = t.Browser.window.box2d, l.DrawString_s_color = new l.box2d.b2Color(.9, .6, .6), 
            l.DrawStringWorld_s_p = new l.box2d.b2Vec2(), l.DrawStringWorld_s_cc = new l.box2d.b2Vec2(), 
        ...
        DrawTransform(o) {
            this.PushTransform(o), this._mG.drawLine(0, 0, 1, 0, l.box2d.b2Color.RED.MakeStyleString(1), this.lineWidth), 
    ...
    class c extends y {
        constructor(o, t) {
            ...
            this._length = 0, this._frequency = 0, this._damping = 0, this.selfBody = o, this.otherBody = t;
        }
        _createJoint() {
            if (!this._joint) {
                var o = window.box2d, t = c._temp = new o.b2DistanceJointDef();
                t.bodyA = this.otherBody.getBody(), t.bodyB = this.selfBody.getBody(), t.localAnchorA.Set(this.otherAnchor[0] / n.PIXEL_RATIO, this.otherAnchor[1] / n.PIXEL_RATIO), 
    ...
    class _ extends y {
        ...
        _createJoint() {
            if (!this._joint) {
                ...
                var o = window.box2d, t = _._temp || (_._temp = new o.b2GearJointDef());
    ...
    class m extends y {
        ...
        _createJoint() {
            if (!this._joint) {
                ...
                var o = window.box2d, t = m._temp || (m._temp = new o.b2MotorJointDef());
    ...
    class u extends y {
        ...
        _onEnable() {
            this._createJoint(), 
            window.PhySicsFunMove = function(o, t, e, r) {
                this._createJoint(e, r); 
                if(this._joint){
                    this._joint.SetTarget(new window.box2d.b2Vec2(o / n.PIXEL_RATIO, t / n.PIXEL_RATIO));
                }
            }.bind(this), 
            
            window.PhySicsFunUP = function() {
                this.onStageMouseUp();
            }.bind(this);
        }
        _onAwake() {}
        ...
        _createJoint(o = 0, e = 0) {
            if (!this._joint) {
                if (this.selfBody = this.selfBody || this.owner.getComponent(i), !this.selfBody) throw "selfBody can not be empty";
                var r = window.box2d, b = u._temp || (u._temp = new r.b2MouseJointDef());
                if (this.anchor) var p = this.selfBody.owner.localToGlobal(t.Point.TEMP.setTo(this.anchor[0], this.anchor[1]), !1, n.I.worldRoot); else p = n.I.worldRoot.globalToLocal(t.Point.TEMP.setTo(o, e));
                var s = new r.b2Vec2(p.x / n.PIXEL_RATIO, p.y / n.PIXEL_RATIO);
                b.bodyA = n.I._emptyBody, b.bodyB = this.selfBody.getBody(), b.target = s, b.frequencyHz = this._frequency, 
                b.damping = this._damping, b.maxForce = this._maxForce, this._joint = n.I._createJoint(b);
            }
        }
        onStageMouseUp() {
            super._onDisable();
    ...
    class h extends y {
        ...
        _createJoint() {
            if (!this._joint) {
                if (this.selfBody = this.selfBody || this.owner.getComponent(i), !this.selfBody) throw "selfBody can not be empty";
                var o = window.box2d, e = h._temp || (h._temp = new o.b2PrismaticJointDef()), r = this.selfBody.owner.localToGlobal(t.Point.TEMP.setTo(this.anchor[0], this.anchor[1]), !1, n.I.worldRoot), b = new o.b2Vec2(r.x / n.PIXEL_RATIO, r.y / n.PIXEL_RATIO);
    ...
    class f extends y {
        ...
        _createJoint() {
            if (!this._joint) {
                if (this.selfBody = this.selfBody || this.owner.getComponent(i), !this.selfBody) throw "selfBody can not be empty";
                var o = window.box2d, e = f._temp || (f._temp = new o.b2RevoluteJointDef()), r = this.selfBody.owner.localToGlobal(t.Point.TEMP.setTo(this.anchor[0], this.anchor[1]), !1, n.I.worldRoot), b = new o.b2Vec2(r.x / n.PIXEL_RATIO, r.y / n.PIXEL_RATIO);
    ...
    class S extends y {
        ...
        _createJoint() {
            if (!this._joint) {
                if (this.selfBody = this.selfBody || this.owner.getComponent(i), !this.selfBody) throw "selfBody can not be empty";
                var o = window.box2d, t = S._temp || (S._temp = new o.b2RopeJointDef());
    ...
    class P extends y {
        constructor(o) {
            super(...arguments), this.anchor = [ 0, 0 ], this.collideConnected = !1, this._frequency = 0, 
            this._damping = 0, this.otherBody2 = o;
        }
        _createJoint() {
            if (!this._joint) {
                if (this.selfBody = this.selfBody || this.owner.getComponent(i), !this.selfBody) throw "selfBody can not be empty";
                var o = window.box2d, e = P._temp || (P._temp = new o.b2WeldJointDef());
                this.anchor = [ 0, 0 ];
                var r = this.selfBody.owner.localToGlobal(t.Point.TEMP.setTo(this.anchor[0], this.anchor[1]), !1, n.I.worldRoot), b = new o.b2Vec2(r.x / n.PIXEL_RATIO, r.y / n.PIXEL_RATIO);
                e.Initialize(this.otherBody2.getBody(), this.selfBody.getBody(), b), e.frequencyHz = this._frequency, 
    ...
    class C extends y {
        ...
        _createJoint() {
            if (!this._joint) {
                if (!this.otherBody) throw "otherBody can not be empty";
                if (this.selfBody = this.selfBody || this.owner.getComponent(i), !this.selfBody) throw "selfBody can not be empty";
                var o = window.box2d, e = C._temp || (C._temp = new o.b2WheelJointDef()), r = this.selfBody.owner.localToGlobal(t.Point.TEMP.setTo(this.anchor[0], this.anchor[1]), !1, n.I.worldRoot), b = new o.b2Vec2(r.x / n.PIXEL_RATIO, r.y / n.PIXEL_RATIO);
