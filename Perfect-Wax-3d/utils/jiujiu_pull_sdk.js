!function() {
    ...
    for (var n = {
        ...
        JJGetGameConfigAdShare: function() {
            ...
            return n && (o = n()),
             o.app_key = window.JJSdkConf.app_key, o.version = window.JJSdkConf.version, 
            void 0 === o.version ? 
            void console.error("配置三合一接口必须小游戏传递版本号") : e("GET", window.JJSdkConf.req_domain + "/batch/configs", o);
        }
