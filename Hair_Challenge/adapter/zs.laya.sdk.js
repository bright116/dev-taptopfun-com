window.zs = window.zs || {}, window.zs.laya = window.zs.laya || {}, function (t, i) {
    ...
    class s {
        ...
        static playVideo(t, e, a) {
            i.stage.event(s.EVENT_AD_VIDEO_PLAY), platform.getInstance().showReward(() => {
        ...
        static checkCustomAd(t, i, s, e, n, a, c, o, r, d) {
            this._instance && this._instance.checkCustomAd(t, i, s, e, n, a, c, o, r, d);
        }
        static hideCustomAd() {
