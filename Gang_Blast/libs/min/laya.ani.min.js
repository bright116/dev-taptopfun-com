...
!function(t, e) {
    ...
    var n = /* */ function() {
        ...
        _createClass2(n, null, [ {
            ...
            value: function parse(t, _n) {
                var h, l, o, u, _, p, d, c = _n.__getBuffer(), m = _n.readUTFString();
                t._aniClassName = m;
                var x, y = _n.readUTFString().split("\n"), g = _n.getUint8(), f = _n.getUint32(), M = _n.getUint32();
                f > 0 && (x = c.slice(f, M));
                var D = new e.Byte(x);
                for (M > 0 && (t._publicExtData = c.slice(M, c.byteLength)), t._useParent = !!_n.getUint8(), 
                t._anis.length = g, h = 0; h < g; h++) {
                    ...
                    for (v.totalKeyframeDatasLength = 0, l = 0; l < A; l++) {
                        ...
                        S.childs = [];
                        var T = _n.getInt16();
                        T >= 0 && (S.name = y[T], v.bone3DMap[S.name] = l), S.keyFrame = [], S.parentIndex = _n.getInt16(), 
                        -1 == S.parentIndex ? S.parent = null : S.parent = v.nodes[S.parentIndex], S.lerpType = _n.getUint8();
                        var b = _n.getUint32();
                        D.pos = b;
                        ...
                        var F = _n.getUint16();
                        F > 0 && (S.extenData = c.slice(_n.pos, _n.pos + F), _n.pos += F);
                        var w = _n.getUint16();
                        S.keyFrame.length = w;
                        var k, P = 0;
                        for (o = 0, u = w; o < u; o++) {
                            if ((k = S.keyFrame[o] = new s()).duration = _n.getFloat32(), k.startTime = P, 2 === S.lerpType) {
                                k.interpolationData = [];
                                var L, U = _n.getUint8();
                                switch (L = _n.getFloat32()) {
                                  ...
                                  default:
                                    for (k.interpolationData.push(L), p = 1; p < U; p++) {
                                        k.interpolationData.push(_n.getFloat32());
                                    }
                                }
                            }
                            for (k.data = new Float32Array(C), k.dData = new Float32Array(C), k.nextData = new Float32Array(C), 
                            _ = 0; _ < C; _++) {
                                k.data[_] = _n.getFloat32(), k.data[_] > -1e-8 && k.data[_] < 1e-8 && (k.data[_] = 0);
                            }
                            P += k.duration;
                        }
    ...
    var o = /* */ function(_e$EventDispatcher) {
        ...
        function o() {
            ...
            _this = _super.call(this), _this.isCache = !0, _this.playbackRate = 1, _this._destroyed = !1, 
            _this._currentAnimationClipIndex = -1, _this._currentKeyframeIndex = -1, _this._currentTime = 0, 
            _this._overallDuration = Number.MAX_VALUE, _this._stopWhenCircleFinish = !1, _this._elapsedPlaybackTime = 0, 
            _this._startUpdateLoopCount = -1, _this._cachePlayRate = 1, _this.cacheFrameRate = 60, 
            _this.returnToZeroStopped = !1;
            return _this;
        }
        _createClass2(o, [ {
            key: "templet",
    ...
    var _ = /* */ function(_e$Resource) {
        ...
        function _() {
            ...
            _this2 = _super2.call(this), _this2._anis = [], _this2._aniMap = {}, _this2.unfixedLastAniIndex = -1, 
            _this2._fullFrames = null, _this2._boneCurKeyFrm = [];
            return _this2;
        }
        _createClass2(_, [ {
            key: "parse",
            ...
            value: function _BezierInterpolation_6(t, e, i, a, r, s, n, h, l) {
                ...
                return i[a] = r[e] + (l[e] - r[e]) * u.getBezierRate(s / h, o[_3], o[_3 + 1], o[_3 + 2], o[_3 + 3]), 
                5;
            }
        }, {
            ...
            value: function _BezierInterpolation_7(t, e, i, a, r, s, n, h, l) {
                ...
                return i[a] = o[_4 + 4] + o[_4 + 5] * u.getBezierRate((.001 * s + o[_4 + 6]) / o[_4 + 7], o[_4], o[_4 + 1], o[_4 + 2], o[_4 + 3]), 
                9;
            }
        } ]);
        return _;
        ...
        _createClass2(A, [ {
            ...
            value: function _applyIk3(t, i, a, r, s, n) {
                ...
                if (p + M <= v || v + p <= M || v + M <= p) {
                    ...
                    var _t2 = (f - _ + D) / (2 * D), _e = Math.sqrt(f - _t2 * _t2 * D) / v, _i = d + y * _t2, _a = c + g * _t2, _r = -g * _e, _n2 = y * _e;
        ...
        _createClass2(T, [ {
            ...
            value: function apply(t, e) {
                if (this.target) {
                    ...
                    var I, A = D[0], S = D[1], _T = this.data.offsetRotation, b = "chain" == h && 0 == _T;
                    for (m = 0, I = 3; m < _; m++, I += 3) {
                        ...
                        if (A = f, S = M, r) {
                            ...
                            k = l ? D[I - 1] : 0 == d[m + 1] ? D[I + 2] : Math.atan2(F, C), k -= Math.atan2(E, U) - _T / 180 * Math.PI, 
            ...
            value: function computeWorldPositions(t, e, i, a, r, s, n) {
                ...
                var I = this._curves;
                l = 0;
                var A, S, _T2, b, C, F, w, k, P, L = h[0], U = h[1], B = 0, E = 0, R = 0, N = 0, O = 0, V = 0;
                for (x = 0, P = 2; x < D; x++, P += 6) {
                    C = 2 * (A = .1875 * (L - 2 * (B = h[P]) + (R = h[P + 2]))) + (_T2 = .09375 * (3 * (B - R) - L + (O = h[P + 4]))), 
                    F = 2 * (S = .1875 * (U - 2 * (E = h[P + 1]) + (N = h[P + 3]))) + (b = .09375 * (3 * (E - N) - U + (V = h[P + 5]))), 
                    w = .75 * (B - L) + A + .16666667 * _T2, k = .75 * (E - U) + S + .16666667 * b, 
                    l += Math.sqrt(w * w + k * k), w += C, k += F, C += _T2, F += b, l += Math.sqrt(w * w + k * k), 
                    w += C, k += F, l += Math.sqrt(w * w + k * k), w += C + _T2, k += F + b, l += Math.sqrt(w * w + k * k), 
                    I[x] = l, L = O, U = V;
                }
                ...
                for (x = 0, o = 0, u = 0, Y = 0; x < a; x++, o += 3) {
                    if ((_ = g += p = f[x]) < 0) this.addBeforePosition(_, h, 0, M, o); else if (_ > l) this.addAfterPosition(_ - l, h, y - 4, M, o); else {
                        ...
                        if (u != v) {
                            v = u;
                            var W = 6 * u;
                            for (C = 2 * (A = .03 * ((L = h[W]) - 2 * (B = h[W + 2]) + (R = h[W + 4]))) + (_T2 = .006 * (3 * (B - R) - L + (O = h[W + 6]))), 
                            F = 2 * (S = .03 * ((U = h[W + 1]) - 2 * (E = h[W + 3]) + (N = h[W + 5]))) + (b = .006 * (3 * (E - N) - U + (V = h[W + 7]))), 
                            w = .3 * (B - L) + A + .16666667 * _T2, k = .3 * (E - U) + S + .16666667 * b, X = Math.sqrt(w * w + k * k), 
                            K[0] = X, W = 1; W < 8; W++) {
                                w += C, k += F, C += _T2, F += b, X += Math.sqrt(w * w + k * k), K[W] = X;
                            }
                            w += C, k += F, X += Math.sqrt(w * w + k * k), K[8] = X, w += C + _T2, k += F + b, 
    ...
    var F = /* */ function(_e$Sprite) {
        ...
        function F() {
            ...
            var e = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
            _classCallCheck2(this, F);
            _this3 = _super5.call(this), _this3._boneMatrixArray = [], _this3._lastTime = 0, 
            _this3._currAniIndex = -1, _this3._pause = !0, _this3._aniClipIndex = -1, _this3._clipIndex = -1, 
            _this3._skinIndex = 0, _this3._skinName = "default", _this3._aniMode = 0, _this3._index = -1, 
            _this3._total = -1, _this3._indexControl = !1, _this3._eventIndex = 0, _this3._drawOrderIndex = 0, 
            _this3._drawOrder = null, _this3._lastAniClipIndex = -1, _this3._lastUpdateAniClipIndex = -1, 
            _this3._playAudio = !0, _this3._soundChannelArr = [], t && _this3.init(t, e);
            return _this3;
        }
        _createClass2(F, [ {
            key: "init",
            ...
            value: function _createGraphics() {
                ...
                if (this._pathDic) for (var _F in this._pathDic) {
                    (S = this._pathDic[_F]).apply(this._boneList, s);
                }
            ...
            value: function destroy() {
                var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !0;
                _get2(_getPrototypeOf2(F.prototype), "destroy", this).call(this, t), this._templet._removeReference(1), 
    ...
    var U = /* */ function(_ref) {
        ...
        function U() {
            var _this4;
            _classCallCheck2(this, U);
            _this4 = _super6.apply(this, arguments), _this4._graphicsCache = [], _this4.srcBoneMatrixArr = [], 
            _this4.ikArr = [], _this4.tfArr = [], _this4.pathArr = [], _this4.boneSlotDic = {}, 
            _this4.bindBoneBoneSlotDic = {}, _this4.boneSlotArray = [], _this4.skinDataArray = [], 
            _this4.skinDic = {}, _this4.subTextureDic = {}, _this4.isParseFail = !1, _this4.drawOrderAniArr = [], 
            _this4.eventAniArr = [], _this4.attachmentNames = null, _this4.deformAniArr = [], 
            _this4.skinSlotDisplayDataArr = [], _this4._isParseAudio = !1, _this4._isDestroyed = !1, 
            _this4._rate = 30, _this4.isParserComplete = !1, _this4.aniSectionDic = {}, _this4._textureDic = {}, 
            _this4.mBoneArr = [];
            return _this4;
        }
        _createClass2(U, [ {
            ...
            key: "parse",
            value: function parse(t) {
                _get2(_getPrototypeOf2(U.prototype), "parse", this).call(this, t), this.event(e.Event.LOADED, this), 
            ...
            value: function _parsePublicExtData() {
                ...
                var h, l, o = new e.Byte(this.getPublicExtData()), u = 0, _ = 0, p = 0, m = 0, x = 0, y = 0, A = 0, T = 0, C = 0, F = o.getInt32(), _U = o.readUTFString(), B = _U.split("\n");
                for (i = 0; i < F; i++) {
                    if (h = this._mainTexture, l = this._path + B[2 * i], _U = B[2 * i + 1], null == this._mainTexture && (h = this._textureDic[l]), 
                    ...
                    this.subTextureDic[_U] = e.Texture.create(h, u, _, p, m, -x, -y, A, T);
                }
                this._mainTexture = h;
            ...
            value: function destroy() {
                ...
                _get2(_getPrototypeOf2(U.prototype), "destroy", this).call(this), e.ILaya.loader.clearRes(this._skBufferUrl);
            }
        }, {
            key: "getAniNameByIndex",
            value: function getAniNameByIndex(t) {
    ...
    var B = /* */ function(_e$Sprite2) {
        ...
        function B() {
            ...
            var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
            _classCallCheck2(this, B);
            _this5 = _super7.call(this), _this5._start = 0, _this5._Pos = 0, _this5._ended = !0, 
            _this5._loadedImage = {}, _this5._endFrame = -1, _this5.interval = 30, _this5._ids = {}, 
            _this5._idOfSprite = [], _this5._reset(), _this5._playing = !1, _this5._parentMovieClip = t, 
            t ? (_this5._isRoot = !1, _this5._movieClipList = t._movieClipList, _this5._movieClipList.push(_assertThisInitialized2(_this5))) : (_this5._movieClipList = [ _assertThisInitialized2(_this5) ], 
