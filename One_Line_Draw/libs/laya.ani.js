!function(t, e, i) {
    i.un, i.uns;
    var a = i.static, s = i.class, r = i.getset, n = i.__newvec, h = laya.maths.Bezier, l = laya.utils.Browser, o = laya.utils.Byte, u = (laya.events.Event, 
    ...
    laya.resource.Resource), v = laya.utils.RunDriver, M = laya.display.Sprite, D = laya.utils.Stat, I = laya.resource.Texture, N = (laya.net.URL, 
    laya.utils.Utils), b = function() {
        function t() {
        ...
        return s(t, "laya.ani.AnimationParser01"), t.parse = function(t, e) {
            ...
            t._anis.length = p, a = 0; a < p; a++) {
                ...
                for (x.totalKeyframeDatasLength = 0, s = 0; s < v; s++) {
                    ...
                    M.childs = [];
                    var D = e.getInt16();
                    D >= 0 && (M.name = _[D], x.bone3DMap[M.name] = s), M.keyFrame = new Array(), M.parentIndex = e.getInt16(), 
                    -1 == M.parentIndex ? M.parent = null : M.parent = x.nodes[M.parentIndex], M.lerpType = e.getUint8();
                    var I = e.getUint32();
                    y.pos = I;
                    var N = M.keyframeWidth = y.getUint16();
                    if (x.totalKeyframeDatasLength += N, 0 === M.lerpType || 1 === M.lerpType) for (M.interpolationMethod = [], 
                    M.interpolationMethod.length = N, r = 0; r < N; r++) M.interpolationMethod[r] = et.interpolation[y.getUint8()];
                    null != M.parent && M.parent.childs.push(M);
                    var A = e.getUint16();
                    A > 0 && (M.extenData = i.slice(e.pos, e.pos + A), e.pos += A);
                    var C = e.getUint16();
                    M.keyFrame.length = C;
                    var w, S = 0;
                    for (r = 0, n = C; r < n; r++) {
                        if (w = M.keyFrame[r] = new Z(), w.duration = e.getFloat32(), w.startTime = S, 2 === M.lerpType) {
                            w.interpolationData = [];
                        ...
                        for (w.data = new Float32Array(N), h = 0; h < N; h++) w.data[h] = e.getFloat32(), 
        ...
        return s(t, "laya.ani.AnimationParser02"), t.READ_DATA = function() {
            ...
            for (var e = t._BLOCK.count = t._reader.getUint16(), i = t._BLOCK.blockStarts = [], a = t._BLOCK.blockLengths = [], s = 0; s < e; s++) i.push(t._reader.getUint32()), 
            ...
            for (l.length = h, a = 0; a < h; a++) l[a] = et.interpolation[e.getByte()];
            var o = e.getUint8();
        ...
        function t() {
            ...
            this.d = -1, this._tempMatrix = null, this._sprite = null, this.resultTransform = new H(), 
        ...
        return e.setTempMatrix = function(t) {
            ...
            this._sprite.y = a + this.resultMatrix.ty) : (this._sprite = new M(), this._sprite.graphics.drawCircle(0, 0, 5, "#ff0000"), 
            ...
            var e, i, a = 0, s = 0;
            for (a = 0, s = this._children.length; a < s; a++) if (e = this._children[a], i = e.findBone(t)) return i;
            return null;
        ...
        return e.showSlotData = function(t, e) {
                ...
                switch (this.currDisplayData.type) {
                  ...
                  case 1:
                    ...
                    if (null == this.currDisplayData.bones) {
                        ...
                        _ = this._curDiyUV) : _ = this.currDisplayData.uvs, this._mVerticleArr = d, this.currDisplayData.triangles.length, 
            ...
            return x.isWebGL || x.isConchApp ? v.skinAniSprite() : x.isWebGL ? null : at.useSimpleMeshInCanvas ? new it() : new tt();
        ...
        return e.renderToContext = function(t) {
            ...
            g = r[a + 1] * _;
            var M = n[e], D = n[i], I = n[a], N = n[e + 1], b = n[i + 1], T = n[a + 1];
            if (t.canvasPadding > 0) {
                var A = t.canvasPadding, C = t.canvasPadding, w = (M + D + I) / 3, S = (N + b + T) / 3, F = M - w, k = N - S, P = Math.sqrt(F * F + k * k);
                M = w + F / P * (P + A), N = S + k / P * (P + C), k = b - S, D = w + (F = D - w) / (P = Math.sqrt(F * F + k * k)) * (P + A), 
                b = S + k / P * (P + C), k = T - S, I = w + (F = I - w) / (P = Math.sqrt(F * F + k * k)) * (P + A), 
                T = S + k / P * (P + C);
            }
            ...
            var U = 1 / (p * x + y * m + f * g - x * m - y * f - p * g), L = M * x + y * I + D * g - x * I - y * D - M * g, R = p * D + M * m + f * I - D * m - M * f - p * I, O = p * x * I + y * D * m + M * f * g - M * x * m - y * f * I - p * D * g, E = N * x + y * T + b * g - x * T - y * b - N * g, K = p * b + N * m + f * T - b * m - N * f - p * T, Y = p * x * T + y * b * m + N * f * g - N * x * m - y * f * T - p * b * g;
            s.transform(L * U, E * U, R * U, K * U, O * U, Y * U), s.drawImage(o, h.uv[0] * d, h.uv[1] * _, u, c, h.uv[0] * d, h.uv[1] * _, u, c), 
            s.restore();
        }, t;
    }(), k = function() {
        function t() {
        ...
        return s(t, "laya.ani.bone.canvasmesh.MeshData"), t.prototype.getBounds = function() {
        ...
        return e.binarySearch1 = function(t, e) {
            ...
            if (void 0 === i && (i = 1), t += .05, !(this.timeList.length <= 0)) {
                ...
                if (!(t < this.timeList[0])) {
                    var s = this.vectices[0].length, r = [], n = this.binarySearch1(this.timeList, t);
                    if (this.frameIndex = n, t >= this.timeList[this.timeList.length - 1]) {
                        var h = this.vectices[this.vectices.length - 1];
                        if (i < 1) for (a = 0; a < s; a++) r[a] += (h[a] - r[a]) * i; else for (a = 0; a < s; a++) r[a] = h[a];
                        this.deformData = r;
                    } else {
                        this.tweenKeyList[this.frameIndex];
                        var l = this.vectices[this.frameIndex - 1], o = this.vectices[this.frameIndex], u = this.timeList[this.frameIndex - 1], c = this.timeList[this.frameIndex];
        ...
        return e.apply = function() {
            ...
            if (0 != h) {
                ...
                u < 0 ? (u = -u, _ = 180, f = -1) : (_ = 0, f = 1), c < 0 && (c = -c, f = -f), d < 0 ? (d = -d, 
                p = 180) : p = 0;
                var m = a.resultTransform.x, y = NaN, x = NaN, g = NaN, v = e.resultMatrix.a, D = e.resultMatrix.c, I = e.resultMatrix.b, N = e.resultMatrix.d, b = Math.abs(u - c) <= 1e-4;
                b ? (x = v * m + D * (y = a.resultTransform.y) + e.resultMatrix.tx, g = I * m + N * y + e.resultMatrix.ty) : (y = 0, 
                ...
                var A = 1 / (v * (N = T.resultMatrix.d) - D * I), C = s - T.resultMatrix.tx, w = r - T.resultMatrix.ty, S = (C * N - w * D) * A - l, F = (w * v - C * I) * A - o, k = ((C = x - T.resultMatrix.tx) * N - (w = g - T.resultMatrix.ty) * D) * A - l, P = (w * v - C * I) * A - o, B = Math.sqrt(k * k + P * P), U = a.length * d, L = NaN, R = NaN;
                if (b) {
                    var O = (S * S + F * F - B * B - (U *= u) * U) / (2 * B * U);
                    O < -1 ? O = -1 : O > 1 && (O = 1), R = Math.acos(O) * n, v = B + U * O, D = U * Math.sin(R), 
                    L = Math.atan2(F * v - S * D, S * v + F * D);
                } else {
                    var E = (v = u * U) * v, K = (D = c * U) * D, Y = S * S + F * F, V = Math.atan2(F, S), W = -2 * K * B, X = K - E;
                    if ((N = W * W - 4 * X * (I = K * B * B + E * Y - E * K)) > 0) {
                        var z = Math.sqrt(N);
                        W < 0 && (z = -z);
                        var q = (z = -(W + z) / 2) / X, G = I / z, H = Math.abs(q) < Math.abs(G) ? q : G;
                        H * H <= Y && (w = Math.sqrt(Y - H * H) * n, L = V - Math.atan2(w, H), R = Math.atan2(w / c, (H - B) / u));
                    }
                    var Q = 0, Z = Number.MAX_VALUE, j = 0, $ = 0, J = 0, tt = 0, et = 0, it = 0;
                    (N = (C = B + v) * C) > tt && (J = 0, tt = N, et = C), (N = (C = B - v) * C) < Z && (Q = Math.PI, 
                    Z = N, j = C);
                    var at = Math.acos(-v * B / (E - K));
                    (N = (C = v * Math.cos(at) + B) * C + (w = D * Math.sin(at)) * w) < Z && (Q = at, 
                    Z = N, j = C, $ = w), N > tt && (J = at, tt = N, et = C, it = w), Y <= (Z + tt) / 2 ? (L = V - Math.atan2($ * n, j), 
                    R = Q * n) : (L = V - Math.atan2(it * n, et), R = J * n);
                }
                var st = Math.atan2(y, m) * f, rt = e.resultTransform.skX;
                (L = (L - st) * t.radDeg + _ - rt) > 180 ? L -= 360 : L < -180 && (L += 360), e.resultTransform.x = l, 
                e.resultTransform.y = o, e.resultTransform.skX = e.resultTransform.skY = rt + L * h, 
                rt = a.resultTransform.skX, (R = ((R + st) * t.radDeg - 0) * f + p - (rt %= 360)) > 180 ? R -= 360 : R < -180 && (R += 360), 
                a.resultTransform.x = m, a.resultTransform.y = y, a.resultTransform.skX = a.resultTransform.skY = a.resultTransform.skY + R * h, 
                e.update();
            }
        }, e._applyIk3 = function(e, a, s, r, n, h) {
            if (0 != h) {
                var l = NaN, o = NaN, u = a.resultMatrix.a * a.length, c = a.resultMatrix.b * a.length, d = u * u + c * c, _ = Math.sqrt(d), p = e.resultMatrix.tx, f = e.resultMatrix.ty, m = a.resultMatrix.tx, y = a.resultMatrix.ty, x = m - p, g = y - f, v = x * x + g * g, D = Math.sqrt(v), I = (x = s - e.resultMatrix.tx) * x + (g = r - e.resultMatrix.ty) * g, N = Math.sqrt(I);
                ...
                l = m, o = y, this.isDebug && (this._sp || (this._sp = new M(), i.stage.addChild(this._sp)), 
                ...
                var U;
                (U = t._tempMatrix).identity(), U.rotate(B), U.scale(a.resultMatrix.getScaleX(), a.resultMatrix.getScaleY()), 
        ...
        return s(t, "laya.ani.bone.MeshTools"), t.findEdge = function(t, e, i) {
            ...
            s = e.vertices;
            var r, n, h = 0, l = 0, o = 0;
            return h = (n = t.findBestTriangle(a))[0], l = n[1], o = n[2], t._absArr.length = 0, 
            t.isNormalUV(e.texture.uv) && t.adptTexture(e), r = t.solvePoints(e.texture.uv, a[h], a[h + 1], a[l] - a[h], a[l + 1] - a[h + 1], a[o] - a[h], a[o + 1] - a[h + 1], t._absArr), 
            t.transPoints(r, s[h], s[h + 1], s[l] - s[h], s[l + 1] - s[h + 1], s[o] - s[h], s[o + 1] - s[h + 1], i);
            ...
            var a, s, r = (a = e.texture).width, n = a.height;
            ...
            l = l || [];
            var o = 0, u = 0;
            for (u = e.length, o = 0; o < u; o += 2) t.transPoint(e[o], e[o + 1], i, a, s, r, n, h, l);
            return l;
        ...
        return e.apply = function(t, e) {
            if (this.target) {
                ...
                for (f = 0, A = 3; f < c; f++, A += 3) {
                    ...
                    if (I = g, N = v, s) {
                        ...
                        U = l ? M[A - 1] : 0 == _[f + 1] ? M[A + 2] : Math.atan2(w, C), U -= Math.atan2(P, F) - b / 180 * Math.PI, 
                        T && (L = Math.cos(U), R = Math.sin(U), I += ((x = y.length) * (L * F - R * P) - C) * a, 
            ...
            var h, l, o = e.currDisplayData.bones, u = e.currDisplayData.weights, c = e.currDisplayData.triangles, d = 0, _ = 0, p = 0, f = 0, m = 0, y = 0, x = 0, g = 0, v = 0, M = 0, D = 0;
            if (null != o) {
                ...
                var b;
                if (b = e.parent, i) for (D = i.length, d = 0; d < D; d++) if (i[d].name == b) {
                    l = i[d];
                    break;
                }
                var T;
                ...
                for (l && (k *= l.d), _ = a, m = n; m < s; _ += 2, m += 2) v = c[_], M = c[_ + 1], 
                r[m] = v * w + M * S + A, r[m + 1] = -(v * F + M * k + C);
            }
            ...
            var h = [], l = 0, o = t.currDisplayData.verLen, u = this.position, c = this._spaces, d = [], _ = [], p = o / 6, f = -1, m = NaN, y = 0, x = 0, g = NaN, v = NaN, M = NaN, D = NaN;
            if (p--, o -= 4, this.computeWorldVertices2(t, e, 2, o, h, 0), this._debugKey) for (l = 0; l < h.length; ) i.drawCircle(h[l++], h[l++], 10, "#ff0000");
            d = h, this._curves.length = p;
            var I = this._curves;
            m = 0;
            var N = d[0], b = d[1], T = 0, A = 0, C = 0, w = 0, S = 0, F = 0, k = NaN, P = NaN, B = NaN, U = NaN, L = NaN, R = NaN, O = NaN, E = NaN, K = 0;
            for (l = 0, K = 2; l < p; l++, K += 6) T = d[K], A = d[K + 1], C = d[K + 2], w = d[K + 3], 
            L = 2 * (k = .1875 * (N - 2 * T + C)) + (B = .09375 * (3 * (T - C) - N + (S = d[K + 4]))), 
            R = 2 * (P = .1875 * (b - 2 * A + w)) + (U = .09375 * (3 * (A - w) - b + (F = d[K + 5]))), 
            O = .75 * (T - N) + k + .16666667 * B, E = .75 * (A - b) + P + .16666667 * U, m += Math.sqrt(O * O + E * E), 
            O += L, E += R, L += B, R += U, m += Math.sqrt(O * O + E * E), O += L, E += R, m += Math.sqrt(O * O + E * E), 
            O += L + B, E += R + U, m += Math.sqrt(O * O + E * E), I[l] = m, N = S, b = F;
            if (r && (u *= m), n) for (l = 0; l < a; l++) c[l] *= m;
            var Y = this._segments, V = 0, W = 0;
            for (l = 0, y = 0, x = 0, W = 0; l < a; l++, y += 3) if (v = c[l], u += v, (g = u) < 0) this.addBeforePosition(g, d, 0, _, y); else if (g > m) this.addAfterPosition(g - m, d, o - 4, _, y); else {
                for (;;x++) if (D = I[x], !(g > D)) {
                ...
                if (x != f) {
                    f = x;
                    var X = 6 * x;
                    for (N = d[X], b = d[X + 1], T = d[X + 2], A = d[X + 3], C = d[X + 4], w = d[X + 5], 
                    L = 2 * (k = .03 * (N - 2 * T + C)) + (B = .006 * (3 * (T - C) - N + (S = d[X + 6]))), 
                    R = 2 * (P = .03 * (b - 2 * A + w)) + (U = .006 * (3 * (A - w) - b + (F = d[X + 7]))), 
                    O = .3 * (T - N) + k + .16666667 * B, E = .3 * (A - b) + P + .16666667 * U, V = Math.sqrt(O * O + E * E), 
                    Y[0] = V, X = 1; X < 8; X++) O += L, E += R, L += B, R += U, V += Math.sqrt(O * O + E * E), 
                    Y[X] = V;
                    O += L, E += R, V += Math.sqrt(O * O + E * E), Y[8] = V, O += L + B, E += R + U, 
                    V += Math.sqrt(O * O + E * E), Y[9] = V, W = 0;
                }
                for (g *= V; ;W++) if (D = Y[W], !(g > D)) {
            ...
            0 == t && (t = 1e-4);
            var d = t * t, _ = d * t, p = 1 - t, f = p * p, m = f * p, y = p * t, x = 3 * y, g = p * x, v = x * t, M = e * m + a * g + r * v + h * _, D = i * m + s * g + n * v + l * _;
        ...
        return e.createTexture = function(t) {
            ...
            x.isWebGL || this.uvs[1] > this.uvs[5] && (this.texture.offsetY = this.texture.sourceHeight - this.texture.height - this.texture.offsetY), 
            this.texture);
        }, e.destory = function() {
        ...
        return s(t, "laya.ani.bone.SlotData"), t.prototype.getDisplayByName = function(t) {
        ...
        return s(t, "laya.ani.bone.TfConstraint"), t.prototype.apply = function() {
        ...
        return e.initData = function(t) {
            ...
            var t;
            return (t = this.mMatrix ? this.mMatrix : this.mMatrix = new m()).identity(), t.scale(this.scX, this.scY), 
        ...
        return s(t, "laya.ani.bone.UVTools"), t.getRelativeUV = function(t, e, i) {
            ...
            if (0 == t[0] && 0 == t[1] && 1 == t[4] && 1 == t[5]) return i ? (N.copyArray(i, e), 
            i) : e;
            var a = t[0], s = t[2] - t[0], r = t[1], n = t[5] - t[1];
            i || (i = []), i.length = e.length;
            var h = 0, l = 0;
        ...
        return s(t, "laya.ani.math.BezierLerp"), t.getBezierRate = function(e, i, a, s, r) {
            ...
            for (u = l.length, o = 0; o < u; o += 2) if (e <= l[o]) return t._bezierResultCache[h] = l[o + 1], 
            l[o + 1];
        ...
        return i.imps(a, {
            ...
            if (-1 !== this._currentAnimationClipIndex && !this._paused && this._templet && this._templet.loaded) {
                ...
                if (i += this._currentTime, a > 0) if (i >= a) do {
                ...
                } while (i >= a); else this._setPlayParams(i, e); else {
            ...
            this._startUpdateLoopCount = D.loopCount, this.event("played"), this._templet.loaded ? this._calculatePlayDuration() : this._templet.once("loaded", this, this._onAnimationTempletLoaded), 
            this._update(0);
        ...
        return s(e, "laya.ani.GraphicsAni", c), e.prototype.drawSkin = function(t) {
            var e = [ t ];
        ...
        return a.parse = function(t) {
            ...
            for (var n = this._anis[t].nodes, h = 0, l = 0, o = n.length, u = 0; l < o; l++) {
                ...
                var _ = r - c.startTime, p = d.lerpType;
                if (p) switch (p) {
                  case 0:
                  case 1:
                  ...
                  case 2:
                    var f = c.interpolationData, m = f.length, y = 0;
                    for (h = 0; h < m; ) {
                        var x = f[h];
                        switch (x) {
                          case 6:
                ...
                } else for (h = 0; h < d.keyframeWidth; ) h += d.interpolationMethod[h](d, h, i, u + h, c.data, _, null, c.duration, c.nextData);
                u += d.keyframeWidth;
            }
            ...
            for (var r = 0, h = 0, l = s.length, o = 0; h < l; h++) {
                var u = s[h];
                for (a < this.unfixedCurrentTimes[h] && (this.unfixedCurrentFrameIndexes[h] = 0), 
                this.unfixedCurrentTimes[h] = a; this.unfixedCurrentFrameIndexes[h] < u.keyFrame.length && !(u.keyFrame[this.unfixedCurrentFrameIndexes[h]].startTime > this.unfixedCurrentTimes[h]); ) this.unfixedKeyframes[h] = u.keyFrame[this.unfixedCurrentFrameIndexes[h]], 
                ...
                if (u.lerpType) switch (u.lerpType) {
                  ...
                  case 2:
                    var _ = c.interpolationData, p = _.length, f = 0;
                    for (r = 0; r < p; ) {
                        var m = _[r];
                        switch (m) {
                          case 6:
                ...
                } else for (r = 0; r < u.keyframeWidth; ) r += u.interpolationMethod[r](u, r, i, o + r, c.data, d, null, c.duration, c.nextData);
                o += u.keyframeWidth;
            }
        ...
        i.getCanvasPic = function() {
            ...
            this.transform.translate(-e, -i)) : (this.transform = tt._tempMatrix, this.transform.identity(), 
        ...
        function e() {
            ...
            e.__super.call(this), this.tempMesh = new k();
        }
        ...
        return i.init2 = function(e, i, a, s, r) {
            ...
            if (this.context = t.ctx || t, this.mesh) {
                ...
                this.tempMesh.vertices = K.solveMesh(this.mesh, this.tempMesh.vertices), this.cacheOK = !0), 
            ...
            g = r[a + 1] * _;
            var M = n[e], D = n[i], I = n[a], N = n[e + 1], b = n[i + 1], T = n[a + 1], A = 1 / (p * x + y * m + f * g - x * m - y * f - p * g), C = M * x + y * I + D * g - x * I - y * D - M * g, w = p * D + M * m + f * I - D * m - M * f - p * I, S = p * x * I + y * D * m + M * f * g - M * x * m - y * f * I - p * D * g, F = N * x + y * T + b * g - x * T - y * b - N * g, k = p * b + N * m + f * T - b * m - N * f - p * T, P = p * x * T + y * b * m + N * f * g - N * x * m - y * f * T - p * b * g;
            if (this.transformCmds[0] = C * A, this.transformCmds[1] = F * A, this.transformCmds[2] = w * A, 
            this.transformCmds[3] = k * A, this.transformCmds[4] = S * A, this.transformCmds[5] = P * A, 
        ...
        return a.init = function(t, e) {
            void 0 === e && (e = 0);
            var i = 0, a = 0;
            if (1 == e) for (this._graphicsCache = [], i = 0, a = t.getAnimationCount(); i < a; i++) this._graphicsCache.push([]);
            if (this._yReverseMatrix = t.yReverseMatrix, this._aniMode = e, this._templet = t, 
            this._player = new $(), this._player.cacheFrameRate = t.rate, this._player.templet = t, 
            ...
            i = 0, a = t.ikArr.length; i < a; i++) this._ikArr.push(new O(t.ikArr[i], this._boneList));
            if (t.pathArr.length > 0) {
                var s, r;
                null == this._pathDic && (this._pathDic = {});
                var n;
                for (i = 0, a = t.pathArr.length; i < a; i++) s = t.pathArr[i], r = new Y(s, this._boneList), 
                (n = this._boneSlotDic[s.name]) && ((r = new Y(s, this._boneList)).target = n), 
                this._pathDic[s.name] = r;
            }
            if (t.tfArr.length > 0) for (this._tfArr = [], i = 0, a = t.tfArr.length; i < a; i++) this._tfArr.push(new q(t.tfArr[i], this._boneList));
            ...
            if (null != t) {
                ...
                var e;
                (e = st.TEMPLET_DICTIONARY[this._aniPath]) ? e.isParseFail ? this._parseFail() : e.isParserComplete ? this._parseComplete() : (e.on("complete", this, this._parseComplete), 
                e.on("error", this, this._parseFail)) : ((e = new st())._setUrl(this._aniPath), 
                st.TEMPLET_DICTIONARY[this._aniPath] = e, e.on("complete", this, this._parseComplete), 
            ...
            !(++this._drawOrderIndex >= a.length)); ) e = a[this._drawOrderIndex];
            var s;
            0 == this._aniMode || 1 == this._aniMode ? this.graphics = J.create() : this.graphics instanceof laya.ani.GraphicsAni ? this.graphics.clear() : this.graphics = J.create(), 
            s = this.graphics;
            ...
            var n, h, l, u, c = this._aniSectionDic[this._aniClipIndex], d = 0, _ = 0, p = 0, f = 0, y = 0, x = this._templet.srcBoneMatrixArr.length;
            for (_ = 0, y = c[0]; _ < x; _++) u = this._boneList[_], l = this._templet.srcBoneMatrixArr[_], 
            u.resultTransform.scX = l.scX * this._curOriginalData[d++], u.resultTransform.skX = l.skX + this._curOriginalData[d++], 
            u.resultTransform.skY = l.skY + this._curOriginalData[d++], u.resultTransform.scY = l.scY * this._curOriginalData[d++], 
            u.resultTransform.x = l.x + this._curOriginalData[d++], u.resultTransform.y = l.y + this._curOriginalData[d++], 
            8 === this._templet.tMatrixDataLen && (u.resultTransform.skewX = l.skewX + this._curOriginalData[d++], 
            u.resultTransform.skewY = l.skewY + this._curOriginalData[d++]);
            var g, v = {}, M = {};
            for (y += c[1]; _ < y; _++) v[(g = r[_]).name] = this._curOriginalData[d++], M[g.name] = this._curOriginalData[d++], 
            this._curOriginalData[d++], this._curOriginalData[d++], this._curOriginalData[d++], 
            this._curOriginalData[d++];
            var D = {}, I = {};
            for (y += c[2]; _ < y; _++) D[(g = r[_]).name] = this._curOriginalData[d++], I[g.name] = this._curOriginalData[d++], 
            this._curOriginalData[d++], this._curOriginalData[d++], this._curOriginalData[d++], 
            this._curOriginalData[d++];
            if (this._pathDic) {
                var N;
                for (y += c[3]; _ < y; _++) if (g = r[_], N = this._pathDic[g.name]) switch (new o(g.extenData).getByte()) {
                  case 1:
            ...
            this._ikArr) {
                var b;
                for (_ = 0, y = this._ikArr.length; _ < y; _++) b = this._ikArr[_], D.hasOwnProperty(b.name) && (b.bendDirection = D[b.name]), 
                I.hasOwnProperty(b.name) && (b.mix = I[b.name]), b.apply();
            }
            if (this._pathDic) for (var T in this._pathDic) (N = this._pathDic[T]).apply(this._boneList, s);
            if (this._tfArr) for (_ = 0, f = this._tfArr.length; _ < f; _++) this._tfArr[_].apply();
            for (_ = 0, f = this._boneList.length; _ < f; _++) if (u = this._boneList[_], h = this._bindBoneBoneSlotDic[u.name], 
            u.resultMatrix.copyTo(this._boneMatrixArray[_]), h) for (p = 0, y = h.length; p < y; p++) (n = h[p]) && n.setParentMatrix(u.resultMatrix);
            var A, C = {}, w = this._templet.deformAniArr;
            if (w && w.length > 0) {
                if (this._lastAniClipIndex != this._aniClipIndex) for (this._lastAniClipIndex = this._aniClipIndex, 
                _ = 0, y = this._boneSlotArray.length; _ < y; _++) (n = this._boneSlotArray[_]).deformData = null;
            ...
            var k, P, B;
            if (this._drawOrder) for (_ = 0, y = this._drawOrder.length; _ < y; _++) k = v[(n = this._boneSlotArray[this._drawOrder[_]]).name], 
            P = M[n.name], isNaN(P) || (s.save(), s.alpha(P)), isNaN(k) || -2 == k || (this._templet.attachmentNames ? n.showDisplayByName(this._templet.attachmentNames[k]) : n.showDisplayByIndex(k)), 
            C[this._drawOrder[_]] ? (B = C[this._drawOrder[_]], n.currDisplayData && B[n.currDisplayData.attachmentName] ? n.deformData = B[n.currDisplayData.attachmentName] : n.deformData = null) : n.deformData = null, 
            isNaN(P) ? n.draw(s, this._boneMatrixArray, 2 == this._aniMode) : n.draw(s, this._boneMatrixArray, 2 == this._aniMode, P), 
            isNaN(P) || s.restore(); else for (_ = 0, y = this._boneSlotArray.length; _ < y; _++) k = v[(n = this._boneSlotArray[_]).name], 
            P = M[n.name], isNaN(P) || (s.save(), s.alpha(P)), isNaN(k) || -2 == k || (this._templet.attachmentNames ? n.showDisplayByName(this._templet.attachmentNames[k]) : n.showDisplayByIndex(k)), 
            C[_] ? (B = C[_], n.currDisplayData && B[n.currDisplayData.attachmentName] ? n.deformData = B[n.currDisplayData.attachmentName] : n.deformData = null) : n.deformData = null, 
            isNaN(P) ? n.draw(s, this._boneMatrixArray, 2 == this._aniMode) : n.draw(s, this._boneMatrixArray, 2 == this._aniMode, P), 
            isNaN(P) || s.restore();
            ...
            if (t) {
                ...
                if (t) for (h = 0, l = t.deformSlotDataList.length; h < l; h++) for (s = t.deformSlotDataList[h], 
            ...
            var n = -1, h = NaN;
            if (h = e ? 2147483647 : 0, "string" == typeof t) for (var o = 0, u = this._templet.getAnimationCount(); o < u; o++) {
        ...
        a.destroy = function(e) {
            ...
            var i, a, s, r = 0, n = 0, h = 0, l = !1, o = this._idOfSprite, u = this._data;
            ...
            this._curIndex > t && t < this._preIndex && (this._reset(!0), u.pos = this._Pos); this._curIndex <= t && !this._ended; ) switch (u.getUint16()) {
              case 12:
                if (r = u.getUint16(), n = this._ids[u.getUint16()], this._Pos = u.pos, u.pos = n, 
                0 == (h = u.getUint8())) {
                    var c = u.getUint16();
                    if (!(a = o[r])) {
                        a = o[r] = new M();
                        var d = new M();
                        d.loadImage(this.basePath + c + ".png"), this._loadedImage[this.basePath + c + ".png"] = !0, 
                        a.addChild(d), d.size(u.getFloat32(), u.getFloat32());
                        var _ = u._getMatrix();
                        d.transform = _;
                    }
                    a.alpha = 1;
                } else 1 == h && ((i = o[r]) || (o[r] = i = new e(this), i.interval = this.interval, 
            ...
            var t;
            (t = p.getRes(this._url)) ? !this._atlasPath || p.getAtlas(this._atlasPath) ? (this.basePath = this._atlasPath ? p.getAtlas(this._atlasPath).dir : this._url.split(".swf")[0] + "/image/", 
        ...
        return a.loadAni = function(t) {
            ...
            if (this._isDestroyed) this.destroy(); else {
                var t = 0;
                this._loadList = [];
                var e, a = new o(this.getPublicExtData()), s = 0, r = a.getInt32(), n = a.readUTFString(), h = n.split("\n");
                for (t = 0; t < r; t++) e = this._path + h[2 * t], n = h[2 * t + 1], a.getFloat32(), 
                a.getFloat32(), a.getFloat32(), a.getFloat32(), s = a.getFloat32(), isNaN(s), s = a.getFloat32(), 
                isNaN(s), s = a.getFloat32(), isNaN(s), s = a.getFloat32(), isNaN(s), -1 == this._loadList.indexOf(e) && this._loadList.push(e);
            ...
            var n, h, l = new o(this.getPublicExtData()), u = 0, c = 0, d = 0, _ = 0, p = 0, f = 0, y = 0, x = 0, g = 0, v = l.getInt32(), M = l.readUTFString(), D = M.split("\n");
            for (t = 0; t < v; t++) {
            ...
            this._mainTexture = n;
            var N, b = l.getUint16();
            for (t = 0; t < b; t++) (N = []).push(l.getUint16()), N.push(l.getUint16()), N.push(l.getUint16()), 
            N.push(l.getUint16()), this.aniSectionDic[t] = N;
            var T, A, C, F, k, O = l.getInt16(), K = {};
            for (t = 0; t < O; t++) T = new w(), 0 == t ? k = T : T.root = k, T.d = r ? -1 : 1, 
            C = l.readUTFString(), F = l.readUTFString(), T.length = l.getFloat32(), 1 == l.getByte() && (T.inheritRotation = !1), 
            1 == l.getByte() && (T.inheritScale = !1), T.name = C, F && ((A = K[F]) ? A.addChild(T) : this.mRootBone = T), 
            K[C] = T, this.mBoneArr.push(T);
            this.tMatrixDataLen = l.getUint16();
            var Y, q = l.getUint16(), Q = Math.floor(q / this.tMatrixDataLen), Z = this.srcBoneMatrixArr;
            for (t = 0; t < Q; t++) (Y = new H()).scX = l.getFloat32(), Y.skX = l.getFloat32(), 
            ...
            Z.push(Y), (T = this.mBoneArr[t]).transform = Y;
            var j, $ = l.getUint16(), J = 0;
            for (t = 0; t < $; t++) {
                for (j = new E(), J = l.getUint16(), e = 0; e < J; e++) j.boneNames.push(l.readUTFString()), 
                j.boneIndexs.push(l.getInt16());
                j.name = l.readUTFString(), j.targetBoneName = l.readUTFString(), j.targetBoneIndex = l.getInt16(), 
                j.bendDirection = l.getFloat32(), j.mix = l.getFloat32(), j.isSpine = r, this.ikArr.push(j);
            }
            var tt, et = l.getUint16(), it = 0;
            for (t = 0; t < et; t++) {
                for (tt = new G(), it = l.getUint16(), e = 0; e < it; e++) tt.boneIndexs.push(l.getInt16());
            ...
            for (t = 0; t < st; t++) {
                for ((at = new V()).name = l.readUTFString(), rt = l.getUint16(), e = 0; e < rt; e++) at.bones.push(l.getInt16());
            ...
            var nt, ht, lt, ot, ut = 0, ct = 0, dt = 0, _t = NaN, pt = 0, ft = l.getInt16();
            for (t = 0; t < ft; t++) {
                var mt = l.getUint8(), yt = {};
                this.deformAniArr.push(yt);
                for (var xt = 0; xt < mt; xt++) for ((nt = new P()).skinName = l.getUTFString(), 
                yt[nt.skinName] = nt, ut = l.getInt16(), e = 0; e < ut; e++) for (ht = new B(), 
                nt.deformSlotDataList.push(ht), ct = l.getInt16(), i = 0; i < ct; i++) for (lt = new U(), 
                ht.deformSlotDisplayList.push(lt), lt.slotIndex = l.getInt16(), lt.attachment = l.getUTFString(), 
                dt = l.getInt16(), a = 0; a < dt; a++) for (1 == l.getByte() ? lt.tweenKeyList.push(!0) : lt.tweenKeyList.push(!1), 
                _t = l.getFloat32(), lt.timeList.push(_t), ot = [], lt.vectices.push(ot), pt = l.getInt16(), 
                s = 0; s < pt; s++) ot.push(l.getFloat32());
            }
            var gt, vt, Mt = l.getInt16(), Dt = 0, It = 0;
            for (t = 0; t < Mt; t++) {
                for (Dt = l.getInt16(), gt = [], e = 0; e < Dt; e++) {
                    for ((vt = new L()).time = l.getFloat32(), It = l.getInt16(), i = 0; i < It; i++) vt.drawOrder.push(l.getInt16());
                    gt.push(vt);
                }
                this.drawOrderAniArr.push(gt);
            }
            var Nt, bt, Tt = l.getInt16(), At = 0;
            for (t = 0; t < Tt; t++) {
                for (At = l.getInt16(), Nt = [], e = 0; e < At; e++) (bt = new R()).name = l.getUTFString(), 
                bt.intValue = l.getInt32(), bt.floatValue = l.getFloat32(), bt.stringValue = l.getUTFString(), 
                bt.time = l.getFloat32(), Nt.push(bt);
                this.eventAniArr.push(Nt);
            }
            var Ct = l.getInt16();
            if (Ct > 0) for (this.attachmentNames = [], t = 0; t < Ct; t++) this.attachmentNames.push(l.getUTFString());
            var wt, St, Ft = l.getInt16();
            for (t = 0; t < Ft; t++) (wt = new S()).name = l.readUTFString(), wt.parent = l.readUTFString(), 
            wt.attachmentName = l.readUTFString(), wt.srcDisplayIndex = wt.displayIndex = l.getInt16(), 
            wt.templet = this, this.boneSlotDic[wt.name] = wt, null == (St = this.bindBoneBoneSlotDic[wt.parent]) && (this.bindBoneBoneSlotDic[wt.parent] = St = []), 
            St.push(wt), this.boneSlotArray.push(wt);
            var kt, Pt, Bt, Ut = l.readUTFString().split("\n"), Lt = 0, Rt = l.getUint8(), Ot = 0, Et = 0, Kt = 0, Yt = 0, Vt = 0, Wt = 0, Xt = 0;
            for (t = 0; t < Rt; t++) {
                for ((kt = new W()).name = Ut[Lt++], Ot = l.getUint8(), e = 0; e < Ot; e++) {
                    for ((Pt = new z()).name = Ut[Lt++], wt = this.boneSlotDic[Pt.name], Et = l.getUint8(), 
                    i = 0; i < Et; i++) {
                        if (Bt = new X(), this.skinSlotDisplayDataArr.push(Bt), Bt.name = Ut[Lt++], Bt.attachmentName = Ut[Lt++], 
                        Bt.transform = new H(), Bt.transform.scX = l.getFloat32(), Bt.transform.skX = l.getFloat32(), 
                        Bt.transform.skY = l.getFloat32(), Bt.transform.scY = l.getFloat32(), Bt.transform.x = l.getFloat32(), 
                        Bt.transform.y = l.getFloat32(), Pt.displayArr.push(Bt), Bt.width = l.getFloat32(), 
                        Bt.height = l.getFloat32(), Bt.type = l.getUint8(), Bt.verLen = l.getUint16(), (O = l.getUint16()) > 0) for (Bt.bones = [], 
                        a = 0; a < O; a++) {
                            var zt = l.getUint16();
                            Bt.bones.push(zt);
                        }
                        if ((Kt = l.getUint16()) > 0) for (Bt.uvs = [], a = 0; a < Kt; a++) Bt.uvs.push(l.getFloat32());
                        if ((Yt = l.getUint16()) > 0) for (Bt.weights = [], a = 0; a < Yt; a++) Bt.weights.push(l.getFloat32());
                        if ((Vt = l.getUint16()) > 0) for (Bt.triangles = [], a = 0; a < Vt; a++) Bt.triangles.push(l.getUint16());
                        if ((Wt = l.getUint16()) > 0) for (Bt.vertices = [], a = 0; a < Wt; a++) Bt.vertices.push(l.getFloat32());
                        if ((Xt = l.getUint16()) > 0) for (Bt.lengths = [], a = 0; a < Xt; a++) Bt.lengths.push(l.getFloat32());
                    }
                    kt.slotArr.push(Pt);
                }
                this.skinDic[kt.name] = kt, this.skinDataArray.push(kt);
            }
            1 == l.getUint8() ? (this.yReverseMatrix = new m(1, 0, 0, -1, 0, 0), k && k.setTempMatrix(this.yReverseMatrix)) : k && k.setTempMatrix(new m()), 
