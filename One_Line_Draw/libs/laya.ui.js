!(function (t, i, e) {
  ...
  var s = e.static,
    ...
    c = laya.utils.Ease,
    u = laya.events.Event,
    _ = (laya.events.EventDispatcher, laya.display.css.Font),
  ...
  var I = (function () {
    ...
    M = (function () {
      ...
      return (
        ...
        s(t, [
          "grayFilter",
          function () {
            return (this.grayFilter = new a([0.3086, 0.6094, 0.082, 0, 0, 0.3086, 0.6094, 0.082, 0, 0, 0.3086, 0.6094, 0.082, 0, 0, 0, 0, 0, 1, 0]));
          },
          "escapeSequence",
          function () {
    ...
    T = (function (t) {
      ...
      return (
        ...
        (s.changeSource = function () {
          ...
          if (t && t.bitmap) {
            var e = this.width,
              ...
              o = t.sourceHeight;
            if (!h || (n === e && o === s))
              this.clear(), this.drawTexture(t, this._offset ? this._offset[0] : 0, this._offset ? this._offset[1] : 0, e, s);
            else {
              t.$_GID || (t.$_GID = B.getGID());
              var r = t.$_GID + "." + e + "." + s + "." + h.join(".");
              if (B.isOKCmdList(k.I.get(r))) return void (this.cmds = k.I.get(r));
              this.clear();
              var l = h[0],
                a = h[1],
                c = h[2],
              ...
              u && l && this.drawTexture(i.getTexture(t, 0, 0, u, l), 0, 0, u, l),
                a && l && this.drawTexture(i.getTexture(t, n - a, 0, a, l), e - a, 0, a, l),
                u && c && this.drawTexture(i.getTexture(t, 0, o - c, u, c), 0, s - c, u, c),
                a && c && this.drawTexture(i.getTexture(t, n - a, o - c, a, c), e - a, s - c, a, c),
                l && this.drawBitmap(_, i.getTexture(t, u, 0, n - u - a, l), u, 0, e - u - a, l),
                c && this.drawBitmap(_, i.getTexture(t, u, o - c, n - u - a, c), u, s - c, e - u - a, c),
                u && this.drawBitmap(_, i.getTexture(t, 0, l, u, o - l - c), 0, l, u, s - l - c),
                a && this.drawBitmap(_, i.getTexture(t, n - a, l, a, o - l - c), e - a, l, a, s - l - c),
                this.drawBitmap(_, i.getTexture(t, u, l, n - u - a, o - l - c), u, l, e - u - a, s - l - c),
                d && this.restore(),
        ...
        (s.drawBitmap = function (t, i, e, s, h, n) {
          void 0 === h && (h = 0),
            void 0 === n && (n = 0),
            h < 0.1 || n < 0.1 || (!t || (i.width == h && i.height == n) ? this.drawTexture(i, e, s, h, n) : this.fillTexture(i, e, s, h, n));
        }),
        (s.clear = function (i) {
        ...
        (i.getTexture = function (t, i, e, s, h) {
          s <= 0 && (s = 1), h <= 0 && (h = 1), t.$_GID || (t.$_GID = B.getGID());
          var n = t.$_GID + "." + i + "." + e + "." + s + "." + h,
            o = k.I.get(n);
          return (o && o.source) || ((o = x.createFromTexture(t, i, e, s, h)), k.I.set(n, o)), o;
        }),
        i
      );
    })(f),
      ...
      (function (t) {
        ...
        return (
          ...
          (s.resetLayoutX = function () {
            ...
            if ((isNaN(t.anchorX) || (this.pivotX = t.anchorX * this.width), this.layoutEnabled)) {
              ...
              i &&
                (isNaN(t.centerX)
                  ? isNaN(t.left)
                    ? isNaN(t.right) || (this.x = Math.round(i.width - this.displayWidth - t.right + this.pivotX * this.scaleX))
                    : ((this.x = Math.round(t.left + this.pivotX * this.scaleX)),
                      isNaN(t.right) || (this.width = (i._width - t.left - t.right) / (this.scaleX || 0.01)))
                  : (this.x = Math.round(0.5 * (i.width - this.displayWidth) + t.centerX + this.pivotX * this.scaleX)));
            }
          }),
          (s.resetLayoutY = function () {
            ...
            if ((isNaN(t.anchorY) || (this.pivotY = t.anchorY * this.height), this.layoutEnabled)) {
              ...
              i &&
                (isNaN(t.centerY)
                  ? isNaN(t.top)
                    ? isNaN(t.bottom) || (this.y = Math.round(i.height - this.displayHeight - t.bottom + this.pivotY * this.scaleY))
                    : ((this.y = Math.round(t.top + this.pivotY * this.scaleY)),
                      isNaN(t.bottom) || (this.height = (i._height - t.top - t.bottom) / (this.scaleY || 0.01)))
                  : (this.y = Math.round(0.5 * (i.height - this.displayHeight) + t.centerY + this.pivotY * this.scaleY)));
            }
          }),
          ...
          (s._childChanged = function (i) {
            this.callLater(this.changeSize), t.prototype._childChanged.call(this, i);
          }),
          ...
          n(
            ...
            function (t) {
              this._width != t &&
                ...
                !this._layout.enable ||
                  (isNaN(this._layout.centerX) && isNaN(this._layout.right) && isNaN(this._layout.anchorX)) ||
                  this.resetLayoutX());
            }
          ),
          ...
          n(
            ...
            function (t) {
              this._height != t &&
                ...
                this.callLater(this.changeSize),
                !this._layout.enable ||
                  (isNaN(this._layout.centerY) && isNaN(this._layout.bottom) && isNaN(this._layout.anchorY)) ||
                  this.resetLayoutY());
            }
          ),
          n(
          ...
          n(0, s, "scaleY", t.prototype._$get_scaleY, function (t) {
            e.superGet(b, this, "scaleY") != t &&
              (e.superSet(b, this, "scaleY", t), this.callLater(this.changeSize), this._layout.enable && this.resetLayoutY());
          }),
          ...
          n(0, s, "scaleX", t.prototype._$get_scaleX, function (t) {
            e.superGet(b, this, "scaleX") != t &&
              (e.superSet(b, this, "scaleX", t), this.callLater(this.changeSize), this._layout.enable && this.resetLayoutX());
          }),
          n(
            0,
            s,
          ...
          n(
            ...
            function (t) {
              this._toolTip != t &&
                ((this._toolTip = t),
                null != t
                  ? (this.on("mouseover", this, this.onMouseOver), this.on("mouseout", this, this.onMouseOut))
                  : (this.off("mouseover", this, this.onMouseOver), this.off("mouseout", this, this.onMouseOut)));
            }
          ),
          n(
            0,
    ...
    A = (function (t) {
        ...
        (this.lockLayer = null),
          ...
          (this.closeEffect = function (t, i) {
            w.to(
              ...
              300,
              c.strongOut,
              p.create(this, this.doClose, [t, i])
            );
          }),
          i.__super.call(this),
      ...
      return (
        ...
        (s.setLockView = function (t) {
          this.lockLayer || ((this.lockLayer = new N()), (this.lockLayer.mouseEnabled = !0), this.lockLayer.size(e.stage.width, e.stage.height)),
        ...
        (s.open = function (t, i, e) {
          void 0 === i && (i = !1),
            ...
            e && null != t.popupEffect ? t.popupEffect.runWith(t) : this.doOpen(t),
            this.event("open");
        }),
        (s.doOpen = function (t) {
          t.onOpened();
    ...
    H = (function (t) {
      ...
      return (
            ...
            if (this._skin != t)
              if (((this._skin = t), t)) {
                ...
                i
                  ...
                  : e.loader.load(this._skin, p.create(this, this.setSource, [this._skin]), null, "image", 1, !0, this._group);
        ...
        n(
          ...
          function (t) {
            this._bitmap.sizeGrid = M.fillArray(L.defaultSizeGrid, t, Number);
          }
        ),
        n(0, s, "measureWidth", function () {
      ...
      return (
        ...
        (o.onMouse = function (t) {
          if (!1 !== this.toggle || !this._selected)
            return "click" === t.type
              ? (this.toggle && (this.selected = !this._selected), void (this._clickHandler && this._clickHandler.run()))
        ...
        (o.changeClips = function () {
          ...
          if (t) {
            ...
            var s = t.$_GID + "-" + this._stateNum,
              h = k.I.get(s);
            if ((B.isOkTextureList(h) || (h = null), h)) this._sources = h;
            else {
              if (((this._sources = []), 1 === this._stateNum)) this._sources.push(t);
              else for (var n = 0; n < this._stateNum; n++) this._sources.push(x.createFromTexture(t, 0, e * n, i, e));
              k.I.set(s, this._sources);
            }
            this._autoSize
              ? ((this._bitmap.width = this._width || i),
                (this._bitmap.height = this._height || e),
                this._text && ((this._text.width = this._bitmap.width), (this._text.height = this._bitmap.height)))
        ...
        n(
          ...
          function (t) {
            (this._strokeColors = M.fillArray(L.buttonLabelColors, t, String)), this._setStateChanged();
          }
        ),
        n(
          0,
          ...
          function (t) {
            (this._labelColors = M.fillArray(L.buttonLabelColors, t, String)), this._setStateChanged();
          }
        ),
        ...
        n(
          ...
          function (t) {
            (this._text || t) &&
              (this.createText(),
              this._text.text != t &&
                (t && !this._text.parent && this.addChild(this._text), (this._text.text = (t + "").replace(/\\n/g, "\n")), this._setStateChanged()));
          }
        ),
        n(
          0,
        ...
        n(
          ...
          function (t) {
            this.createText(), (this._text.padding = M.fillArray(L.labelPadding, t, Number));
          }
        ),
        n(
          0,
      ...
      return (
        ...
        (s.changeClip = function () {
          if (((this._clipChanged = !1), this._skin)) {
            var t = m.getRes(this._skin);
            t ? this.loadComplete(this._skin, t) : e.loader.load(this._skin, p.create(this, this.loadComplete, [this._skin]));
          }
        }),
        (s.loadComplete = function (t, i) {
          if (t === this._skin && i) {
            var e = this._clipWidth || Math.ceil(i.sourceWidth / this._clipX),
              ...
              h = this._skin + e + s,
              n = k.I.get(h);
            if ((B.isOkTextureList(n) || (n = null), n)) this._sources = n;
            else {
              this._sources = [];
              for (var o = 0; o < this._clipY; o++)
                for (var r = 0; r < this._clipX; r++) this._sources.push(x.createFromTexture(i, e * r, s * o, e, s));
    ...
    X = (function (t) {
      ...
      return (
            ...
            for (var s = 0; s < 20; s++) {
              ...
              h =
                0 === s
                  ...
                  : 1 === s
                  ? 0
                  : ((51 * (((3 * e + s / 6) % 3 << 0) + 3 * ((e / 6) << 0))) << 16) | (((s % 6) * 51) << 8) | (((e << 0) % 6) * 51);
              var n = M.toColor(h);
              this._colors.push(n);
        ...
        (s.onColorFieldKeyDown = function (t) {
          13 == t.keyCode &&
            (this._colorInput.text ? (this.selectedColor = this._colorInput.text) : (this.selectedColor = null), this.close(), t.stopPropagation());
        }),
      ...
      return (
        ...
        (s.onlistItemMouse = function (t, i) {
          ...
          if ("mouseover" === e || "mouseout" === e) {
            ...
            h &&
              ("mouseover" === e
                ? ((h.bgColor = this._itemColors[0]), (h.color = this._itemColors[1]))
        ...
        n(0, s, "dataSource", t.prototype._$get_dataSource, function (t) {
          (this._dataSource = t),
            ("number" == typeof t && Math.floor(t) == t) || "string" == typeof t
              ...
              : t instanceof Array
              ? (this.labels = t.join(","))
              : e.superSet(P, this, "dataSource", t);
        }),
        n(
          0,
          s,
        ...
        n(
          ...
          function (t) {
            this._button.text.padding = M.fillArray(L.labelPadding, t, Number);
          }
        ),
        n(
          0,
    ...
    D = (function (t) {
      ...
      return (
        ...
        (s.createChildren = function () {
          this.addChild((this.slider = new V())), this.addChild((this.upButton = new O())), this.addChild((this.downButton = new O()));
        }),
        (s.initialize = function () {
        ...
        (s.onButtonMouseDown = function (t) {
          ...
          this.slide(i), e.timer.once(L.scrollBarDelayTime, this, this.startLoop, [i]), e.stage.once("mouseup", this, this.onStageMouseUp);
        }),
        ...
        (s.changeScrollBar = function () {
          (this.upButton.visible = this._showButtons),
            ...
            this._showButtons &&
              ((this.upButton.skin = this._skin.replace(".png", "$up.png")), (this.downButton.skin = this._skin.replace(".png", "$down.png"))),
            ...
            0 !== this._lastOffset &&
              (this._checkElastic ||
                (this.elasticDistance > 0
                  ? this._checkElastic ||
                    0 == this._lastOffset ||
                    ((this._lastOffset > 0 && this._value <= this.min) || (this._lastOffset < 0 && this._value >= this.max)
              ...
              this._isElastic
                ? this._value <= this.min
                  ...
                  : this._value >= this.max && (this.value -= this._lastOffset * Math.max(0, 1 - (this._value - this.max) / this.elasticDistance))
            ...
            if (((this._target.mouseEnabled = !0), this._isElastic))
              this._value < this.min
                ? w.to(
                    ...
                    c.sineOut,
                    p.create(this, this.elasticOver)
                  )
              ...
              this._offsets.length < 1 &&
                (this._offsets[0] = this.isVertical ? e.stage.mouseY - this._lastPoint.y : e.stage.mouseX - this._lastPoint.x);
          ...
          if (
            (t > 0 &&
              (this._lastOffset > 0 && this.value <= this.min
                ? ((this._isElastic = !0), (i = 0.5 * -(this.min - t - this.value)), this._lastOffset > i && (this._lastOffset = i))
                : this._lastOffset < 0 &&
                  this.value >= this.max &&
                  ((this._isElastic = !0), (i = 0.5 * -(this.max + t - this.value)), this._lastOffset < i && (this._lastOffset = i))),
            (this.value -= this._lastOffset),
        ...
        n(
          ...
          function (t) {
            t !== this._value &&
              ((this._value = t),
              this._isElastic ||
                (this.slider._value != t && ((this.slider._value = t), this.slider.changeValue()), (this._value = this.slider._value)),
              this.event("change"),
        ...
        n(
          ...
          function (t) {
            this.runCallLater(this.changeScrollBar),
              ...
              this.scaleBar &&
                (this.slider.isVertical
                  ? (this.slider.bar.height = Math.max(this.slider.height * t, L.scrollBarMinNum))
                  : (this.slider.bar.width = Math.max(this.slider.width * t, L.scrollBarMinNum)));
          }
        ),
        n(
          0,
          ...
          function (t) {
            this._target &&
              (this._target.off("mousewheel", this, this.onTargetMouseWheel), this._target.off("mousedown", this, this.onTargetMouseDown)),
              (this._target = t),
              t &&
    ...
    V = (function (t) {
      ...
      return (
        ...
        (o.createChildren = function () {
          this.addChild((this._bg = new H())), this.addChild((this._bar = new O()));
        }),
        (o.initialize = function () {
        ...
        (o.showValueText = function () {
          if (this.showLabel) {
            ...
            this.addChild(t),
              ...
              this.isVertical
                ? ((t.x = this._bar.x + 20), (t.y = 0.5 * (this._bar.height - t.height) + this._bar.y))
                : ((t.y = this._bar.y - 20), (t.x = 0.5 * (this._bar.width - t.width) + this._bar.x));
          }
        }),
        ...
        (o.mouseMove = function (t) {
          var i = this._value;
          this.isVertical
            ? ((this._bar.y += (e.stage.mouseY - this._ty) / this._globalSacle.y),
              ...
              this._progress && (this._progress.height = this._bar.y + 0.5 * this._bar.height))
            : ((this._bar.x += (e.stage.mouseX - this._tx) / this._globalSacle.x),
              ...
              this._progress && (this._progress.width = this._bar.x + 0.5 * this._bar.width)),
            (this._tx = e.stage.mouseX),
            (this._ty = e.stage.mouseY);
        ...
        (o.setBarPoint = function () {
          this.isVertical
            ...
            : (this._bar.y = Math.round(0.5 * (this._bg.height - this._bar.height)));
        }),
        ...
        (o.changeValue = function () {
          ...
          0 === i && (i = 1),
            this.isVertical
              ? ((this._bar.y = ((this._value - this._min) / i) * (this.height - this._bar.height)),
                this._progress && (this._progress.height = this._bar.y + 0.5 * this._bar.height))
              : ((this._bar.x = ((this._value - this._min) / i) * (this.width - this._bar.width)),
                this._progress && (this._progress.width = this._bar.x + 0.5 * this._bar.width));
        }),
        (o.onBgMouseDown = function (t) {
          var i = this._bg.getMousePoint();
          this.isVertical
            ? (this.value = (i.y / (this.height - this._bar.height)) * (this._max - this._min) + this._min)
            : (this.value = (i.x / (this.width - this._bar.width)) * (this._max - this._min) + this._min);
        }),
        n(0, o, "measureHeight", function () {
        ...
        n(
          ...
          function (t) {
            if (this._skin != t) {
              ...
              m.getRes(i) &&
                (this._progress ||
                  (this.addChild((this._progress = new H())), (this._progress.sizeGrid = this._bar.sizeGrid), this.setChildIndex(this._progress, 1)),
    ...
    G = (function (t) {
      function i(t) {
        (this._tf = null), i.__super.call(this), void 0 === t && (t = ""), (_.defaultColor = L.labelColor), (this.text = t);
      }
      h(i, "laya.ui.Label", t);
      var s = i.prototype;
      return (
        ...
        n(
          ...
          function (t) {
            this._tf.padding = M.fillArray(L.labelPadding, t, Number);
          }
        ),
        n(
          0,
        ...
        n(
          ...
          function (t) {
            this._tf.text != t &&
              (t && (t = M.adptString(t + "")), (this._tf.text = t), this.event("change"), (this._width && this._height) || this.onCompResize());
          }
        ),
        n(
          0,
    ...
    R = (function (t) {
      ...
      return (
        ...
        (s.createChildren = function () {
          this.addChild((this._bg = new H())), this.addChild((this._bar = new H())), (this._bar._bitmap.autoCacheCmd = !1);
        }),
    ...
    W =
      ((function (t) {
        function i() {
          (this._tipBox = null),
            ...
            i.__super.call(this),
            (this._tipBox = new P()),
            this._tipBox.addChild((this._tipText = new S())),
        ...
        (s._onStageHideTip = function (t) {
          ...
          (s._showDefaultTip = function (t) {
            ...
            s.clear(),
              s.drawRect(0, 0, this._tipText.width + 10, this._tipText.height + 10, i.tipBackColor),
      ...
      (function (t) {
        ...
        var s = i.prototype;
        (s.init = function () {
          r.onMiniGame && this.isSupportJump
            ? (e.timer.loop(this._resquestTime, this, this.onGetAdvsListData), this.onGetAdvsListData(), this.initEvent())
            : (this.visible = !1);
        }),
      ...
      (function (t) {
        ...
        return (
          (r.createView = function (t) {
            if ((t.animations && !this._idMap && (this._idMap = {}), i.createComp(t, this, this), t.animations)) {
              var e,
                ...
                r = n.length;
              for (o = 0; o < r; o++) {
                switch (((e = new d()), (s = n[o]), e._setUp(this._idMap, s), (this[s.name] = e), e._setControlNode(this), s.action)) {
                  case 1:
                    e.play(0, !1);
                    break;
          ...
          (i._regs = function () {
            for (var t in i.uiClassMap) l.regClass(t, i.uiClassMap[t]);
          }),
          (i.createComp = function (t, s, h, n) {
            if (!(s = s || i.getCompInstance(t))) return console.warn("can not create:" + t.type), null;
            var o = t.child;
            if (o)
              for (var r = s instanceof laya.ui.List, a = 0, c = o.length; a < c; a++) {
                var u = o[a];
                if (!s.hasOwnProperty("itemRender") || ("render" != u.props.name && "render" !== u.props.renderType))
                  if ("Graphic" == u.type) l.addGraphicsToSprite(u, s);
                  else if (l.isDrawType(u.type)) l.addGraphicToSprite(u, s, !0);
                  else {
                    if (r) {
                      var _ = [],
          ...
          (i.setCompValue = function (t, s, h, o, r) {
            if ("string" == typeof h && h.indexOf("${") > -1) {
              if ((i._sheet || (i._sheet = l.getClass("laya.data.Table")), !i._sheet)) return void console.warn("Can not find class Sheet");
              if (r) r.push(t, s, h);
              else if (o) {
          ...
          (i.getCompInstance = function (t) {
            ...
            return (
              (s = h ? i.viewClassMap[h] || i.uiClassMap[h] || e.__classmap[h] : i.uiClassMap[t.type]),
        ...
        n(0, s, "dataSource", t.prototype._$get_dataSource, function (t) {
          (this._dataSource = t),
            "boolean" == typeof t
              ...
              : e.superSet(O, this, "dataSource", t);
        }),
        i
      );
    })(O),
    F = (function (t) {
      ...
      return (
        ...
        (e.removeChildAt = function (t) {
          return (
            this.getChildAt(t).off("resize", this, this.onResize), this._setItemChanged(), laya.display.Node.prototype.removeChildAt.call(this, t)
          );
        }),
        (e.refresh = function () {
          this._setItemChanged();
        ...
        (s.changeValue = function () {
          if (this._sources && this._valueArr) {
            ...
            if ((t = this._sources[0])) {
              ...
              i
                ? ((this._wordsW = this._valueArr.length * (t.sourceWidth + this.spaceX)), (this._wordsH = t.sourceHeight))
                : ((this._wordsW = t.sourceWidth), (this._wordsH = (t.sourceHeight + this.spaceY) * this._valueArr.length));
              var e = 0;
              if (this._width)
                switch (this._align) {
                  case "center":
              ...
              for (var s = 0, h = this._valueArr.length; s < h; s++) {
                ...
                this.sources[n] &&
                  ((t = this.sources[n]),
                  i
                    ? this.graphics.drawTexture(t, e + s * (t.sourceWidth + this.spaceX), 0, t.sourceWidth, t.sourceHeight)
                    : this.graphics.drawTexture(t, 0 + e, s * (t.sourceHeight + this.spaceY), t.sourceWidth, t.sourceHeight));
              }
    ...
    j = (function (t) {
      ...
      return (
        ...
        (s.onScrollStart = function () {
          this._$P.cacheAs || (this._$P.cacheAs = e.superGet(N, this, "cacheAs")),
            e.superSet(N, this, "cacheAs", "none"),
          ...
          if (((this._cellChanged = !1), this._itemRender)) {
            ...
            (this._cellSize = this._isVertical ? e : i),
              (this._cellOffset = this._isVertical
                ...
                : i * Math.max(this._repeatX2, this._repeatX) - s - this._spaceX),
              this._isVertical && this._scrollBar
                ? (this._scrollBar.height = h)
                : !this._isVertical && this._scrollBar && (this._scrollBar.width = s),
        ...
        (s._createItems = function (t, i, e) {
          ...
          if (this.cacheContent) {
            var r = new N();
            (r.cacheAsBitmap = !0),
              r.pos((this._isVertical ? 0 : t) * n, (this._isVertical ? t : 0) * o),
          ...
          for (var u = t; u < e; u++)
            for (var _ = 0; _ < i; _++)
              ((h = l && l.length ? l.pop() : this.createItem()).x = (this._isVertical ? _ : u) * n - s.x),
        ...
        (s.setContentSize = function (t, i) {
          (this._content.width = t),
            ...
            (this._scrollBar || 0 != this._offset.x || 0 != this._offset.y) &&
              (this._content.scrollRect || (this._content.scrollRect = new v()),
              this._content.scrollRect.setTo(-this._offset.x, -this._offset.y, t, i),
        ...
        (s.onCellMouse = function (t) {
          ...
          e < 0 ||
            ("click" === t.type || "rightclick" === t.type
              ...
              : ("mouseover" !== t.type && "mouseout" !== t.type) || this._selectedIndex === e || this.changeCellState(i, "mouseover" === t.type, 0),
        ...
        (s.onScrollBarChange = function (t) {
          ...
          this._isVertical ? ((d.y = i - this._offset.y), (d.x = -this._offset.x)) : ((d.y = -this._offset.y), (d.x = i - this._offset.x)),
        ...
        (s.renderItem = function (t, i) {
          this._array && i >= 0 && i < this._array.length
            ? ((t.visible = !0),
              t._$bindData ? ((t._dataSource = this._array[i]), this._bindData(t, this._array[i])) : (t.dataSource = this._array[i]),
        ...
        (s.changeItem = function (t, i) {
          t > -1 &&
            ...
            ((this._array[t] = i), t >= this._startIndex && t < this._startIndex + this._cells.length && this.renderItem(this.getCell(t), t));
        }),
            ...
            if (
              ...
              (this._cellOffset > 0 ? this.totalPage + 1 : this.totalPage) > 1
                ? ((this._scrollBar.scrollSize = this._cellSize),
                  ...
                  this._scrollBar.setScroll(0, (h - s) * this._cellSize + this._cellOffset, this._scrollBar.value),
                  (this._scrollBar.target = this._content))
                : (this._scrollBar.setScroll(0, 0, 0), (this._scrollBar.target = this._content));
            }
          }
        ),
        n(0, s, "dataSource", t.prototype._$get_dataSource, function (t) {
    ...
    K = (function (t) {
      ...
      return (
        ...
        (s.setContentSize = function (t, i) {
          var e = this._content;
          (e.width = t), (e.height = i), e.scrollRect || (e.scrollRect = new v()), e.scrollRect.setTo(0, 0, t, i), (e.scrollRect = e.scrollRect);
        }),
        (s.onScrollBarChange = function (t) {
        ...
        n(
          ...
          function (t) {
            null == this._hScrollBar &&
              (laya.display.Node.prototype.addChild.call(this, (this._hScrollBar = new q())),
        ...
        n(
          ...
          function (t) {
            null == this._vScrollBar &&
              (laya.display.Node.prototype.addChild.call(this, (this._vScrollBar = new et())),
      ...
      return (
        ...
        (s.initItems = function () {
          ...
          for (var t = 0; t < 1e4; t++) {
            ...
            if (null == i) break;
            this._items.push(i), (i.selected = t === this._selectedIndex), (i.clickHandler = p.create(this, this.itemClick, [t], !1));
          }
        }),
    ...
    tt = (function (t) {
      ...
      return (
        ...
        (s.getFilterSource = function (t, i, e) {
          ...
          var s;
          for (var h in t)
            !(s = t[h]).isDirectory && String(s.label).toLowerCase().indexOf(e) > -1 && ((s.x = 0), i.push(s)),
    ...
    et = (function (t) {
      ...
      return h(i, "laya.ui.VScrollBar", D), i;
    })(),
    st = (function (t) {
      function i(t) {
      ...
      return (
        ...
        n(
          ...
          function (t) {
            this._skin != t &&
              ((this._skin = t),
              this._bg || (this.graphics = this._bg = new T()),
        ...
        n(
          ...
          function (t) {
            this._bg || (this.graphics = this._bg = new T()), (this._bg.sizeGrid = M.fillArray(L.defaultSizeGrid, t, Number));
          }
        ),
        n(
          0,
    ...
    nt = (function (t) {
      ...
      return (
        ...
        n(
          ...
          function (t) {
            if (t) {
              ...
              (this._dragArea = new v(i[0], i[1], i[2], i[3])), this.on("mousedown", this, this._onMouseDown);
        ...
        n(0, s, "zOrder", t.prototype._$get_zOrder, function (t) {
          e.superSet(W, this, "zOrder", t), i.manager._checkMask();
        }),
        n(
          1,
          i,
      ...
      return (
        ...
        (s.changeScroll = function () {
          var t = this._vScrollBar && this._tf.maxScrollY > 0,
            ...
            h = this._tf.padding || L.labelPadding;
          (this._tf.width = e),
            (this._tf.height = s),
            this._vScrollBar &&
              ((this._vScrollBar.x = this._width - this._vScrollBar.width - h[2]),
              (this._vScrollBar.y = h[1]),
              (this._vScrollBar.height = this._height - (i ? this._hScrollBar.height : 0) - h[1] - h[3]),
            ...
            this._hScrollBar &&
              ...
              (this._hScrollBar.y = this._height - this._hScrollBar.height - h[3]),
        ...
        n(
          ...
          function (t) {
            null == this._hScrollBar &&
              (this.addChild((this._hScrollBar = new q())),
