        ...
        if (e.hasOwnProperty(s)) {
          ...
          o || a
            ? o && a
              ...
              : (o && Object.defineProperty(t, s, o), a && Object.defineProperty(t, s, a))
            : (t[s] = e[s]);
        }
...
!(function (t, e, i) {
    ...
    var o = (function () {
            ...
            if (null != t && null != e) {
              ...
              for (r = 0; r < s.length; r++) {
                var o = s[r],
                  ...
                  c = new P();
                (c.x = parseInt(o.getAttributeNode("x").nodeValue)),
                  (c.y = parseInt(o.getAttributeNode("y").nodeValue)),
                  (c.width = parseInt(o.getAttributeNode("width").nodeValue)),
                  (c.height = parseInt(o.getAttributeNode("height").nodeValue));
            ...
            if (null != t && null != e) {
              ...
              for (r = 0; r < s.length; r++) {
                var o = s[r].attributes,
                  ...
                  c = new P();
                (c.x = parseInt(o.x.nodeValue)),
                  (c.y = parseInt(o.y.nodeValue)),
                  (c.width = parseInt(o.width.nodeValue)),
      ...
      f = (function () {
        function e() {
          (this._one = null),
            ...
            R.isConchNode && ((this._nativeObj = new t._conchGraphics()), (this.id = this._nativeObj.conchID));
        }
        ...
        return (
            ...
            if (t) {
              ...
              if (this._cmds) {
                for (n = this._cmds.length, i = 0; i < n; i++)
                  !(s = this._cmds[i]) ||
                    (s.callee !== R._context._drawTexture && s.callee !== R._context._drawTextureWithTransform) ||
                    ((s[0] = null), e._cache.push(s));
                this._cmds.length = 0;
              } else
                s &&
                  (!s ||
          ...
          (n.drawTexture = function (t, i, n, s, r, o, a) {
            ...
            var h = !R.isWebGL && (N.onFirefox || N.onEdge || N.onIE || N.onSafari) ? 0.5 : 0,
              l = s / t.sourceWidth,
              u = r / t.sourceHeight;
            ...
            return (
              ...
              (r += 2 * h),
              e._cache.length
                ? (((c = e._cache.pop())[0] = t), (c[1] = i), (c[2] = n), (c[3] = s), (c[4] = r), (c[5] = o), (c[6] = a))
                : (c = [t, i, n, s, r, o, a]),
              (c.callee = o || 1 != a ? R._context._drawTextureWithTransform : R._context._drawTexture),
              null != this._one || o || 1 != a ? this._saveToCmd(c.callee, c) : ((this._one = c), (this._render = this._renderOneImg)),
          ...
          (n.drawLine = function (t, e, i, n, s, r) {
            ...
            var o = 0;
            R.isWebGL &&
              ((o = q.getInstance().getId()), null == this._vectorgraphArray && (this._vectorgraphArray = []), this._vectorgraphArray.push(o));
            var a = r % 2 == 0 ? 0 : 0.5,
          ...
          (n.drawLines = function (t, e, i, n, s) {
            ...
            if (i && !(i.length < 4)) {
              R.isWebGL &&
                ((r = q.getInstance().getId()), null == this._vectorgraphArray && (this._vectorgraphArray = []), this._vectorgraphArray.push(r));
              var o = s % 2 == 0 ? 0 : 0.5,
                a = [t + o, e + o, i, n, s, r];
          ...
          (n.drawCircle = function (t, e, i, n, s, r) {
            ...
            var o = s ? r / 2 : 0,
              a = 0;
            R.isWebGL &&
              ((a = q.getInstance().getId()), null == this._vectorgraphArray && (this._vectorgraphArray = []), this._vectorgraphArray.push(a));
          ...
          (n.drawPie = function (t, e, i, n, s, r, o, a) {
            ...
            var h = o ? a / 2 : 0,
              ...
              u = 0;
            R.isWebGL &&
              ((u = q.getInstance().getId()), null == this._vectorgraphArray && (this._vectorgraphArray = []), this._vectorgraphArray.push(u));
            ...
            if (R.isConchNode) {
              for (
                var t = laya.display.Graphics.prototype,
                  e = N.window.ConchGraphics.prototype,
                  i = [
                    "clear",
                    "destroy",
                    "alpha",
              ...
              (t._saveToCmd = null),
                ...
                (t.drawTexture = function (t, e, i, n, s, r, o) {
                  if (
                    (void 0 === e && (e = 0), void 0 === i && (i = 0), void 0 === n && (n = 0), void 0 === s && (s = 0), void 0 === o && (o = 1), t)
                  )
                    if (t.loaded) {
                      if (
                        t.loaded &&
                        ...
                        var a = t.uv,
                          ...
                          l = t.bitmap.height;
                        a[4] < a[0] && a[5] < a[1]
                          ? this.drawImageM(t.bitmap.source, a[4] * h, a[5] * l, (a[0] - a[4]) * h, (a[1] - a[5]) * l, e, i, n, s, r, o)
                ...
                (t.fillTexture = function (t, e, i, n, s, r, o) {
                  if ((void 0 === n && (n = 0), void 0 === s && (s = 0), void 0 === r && (r = "repeat"), t && t.loaded)) {
                    ...
                    a =
                      t.uv != lt.DEF_UV
                        ? h.createPattern(t.bitmap.source, r, c[0] * l, c[1] * u, (c[2] - c[0]) * l, (c[5] - c[3]) * u)
        ...
        return (
          ...
          (e.getBounds = function (t) {
            return (
              ...
              (!this._bounds || !this._temp || this._temp.length < 1 || t != this._cacheBoundsType) &&
                (this._bounds = P._getWrapRec(this.getBoundPoints(t), this._bounds)),
          ...
          (e._getCmdPoints = function (e) {
            ...
            if (
              ...
              (i.length = 0),
              s || null == this._graphics._one || ((t._tempCmds.length = 0), t._tempCmds.push(this._graphics._one), (s = t._tempCmds)),
              !s)
            )
              return i;
            var r;
                ...
                switch (a.callee) {
                  ...
                  case n._drawTexture:
                    (h = a[0]),
                      e
                        ? a[3] && a[4]
                          ? t._addPointArrToRst(i, P._getBoundPointS(a[1], a[2], a[3], a[4]), o)
                          : ((h = a[0]), t._addPointArrToRst(i, P._getBoundPointS(a[1], a[2], h.width, h.height), o))
                  ...
                  case n._drawTextureWithTransform:
                    var v;
                    a[5] ? (o.copyTo(l), l.concat(a[5]), (v = l)) : (v = o),
                      e
                        ? a[3] && a[4]
                          ? t._addPointArrToRst(i, P._getBoundPointS(a[1], a[2], a[3], a[4]), v)
                          : ((h = a[0]), t._addPointArrToRst(i, P._getBoundPointS(a[1], a[2], h.width, h.height), v))
                        : ((h = a[0]),
                          (u = (a[3] || h.sourceWidth) / h.width),
                          (c = (a[4] || h.sourceHeight) / h.height),
                          (_ = u * h.sourceWidth),
                  ...
                  case 20:
                    ...
                    (y = 0.5 * a[5]),
                      a[0] == a[2]
                        ? t._tempPoints.push(a[0] + y, a[1], a[2] + y, a[3], a[0] - y, a[1], a[2] - y, a[3])
                        : a[1] == a[3]
                        ? t._tempPoints.push(a[0], a[1] + y, a[2], a[3] + y, a[0], a[1] - y, a[2], a[3] - y)
                        : t._tempPoints.push(a[0], a[1], a[2], a[3]),
      ...
      m =
        ...
        (function () {
          function t() {}
          return (
            s(t, "laya.events.KeyBoardManager"),
            (t.__init__ = function () {
            ...
            (e.__init__ = function (e, i) {
              ...
              (i.oncontextmenu = function (e) {
                ...
                i.addEventListener(
                  ...
                  function (e) {
                    t.enabled
                      ? (t._isFirstTouch || xt.isInputting || e.preventDefault(), (t._isFirstTouch = !1), r.push(e), (s.mouseDownTime = -N.now()))
                      : (n._curTouchID = NaN);
                  },
                  !0
                ),
            ...
            (e.check = function (t, e, i, n) {
              ...
              return (
                a
                  ...
                  : n === this.onMouseUp && t === this._stage && ((this._target = this._stage), n.call(this, this._target)),
                a
              );
            }),
              ...
              if (e) {
                for (var i, n = 0, s = 0, r = 0; n < e; ) {
                  ...
                  switch (("mousemove" !== o.type && (this._prePoint.x = this._prePoint.y = -1e6), o.type)) {
                    ...
                    case "mousemove":
                      Math.abs(this._prePoint.x - o.clientX) + Math.abs(this._prePoint.y - o.clientY) >= this.mouseMoveAccuracy &&
                        ((this._prePoint.x = o.clientX),
                        (this._prePoint.y = o.clientY),
                        this.initEvent(o),
                    ...
                    case "touchmove":
                      ...
                      for (s = 0, r = l.length; s < r; s++)
                        (i = l[s]),
                          (t.multiTouchEnabled || i.identifier == this._curTouchID) &&
                            (this.initEvent(i, o), this.check(this._stage, this.mouseX, this.mouseY, this.onMouseMove));
                      break;
          ...
          (e.onMouseDown = function (e, i, n) {
            if ((void 0 === n && (n = !1), this.enable)) {
              ...
              (s = this.getTouchFromArr(i, this.preOvers)),
                ...
                N.onMobile && this.sendEvents(o, "mouseover");
              var a;
              (a = n ? this.preDowns : this.preRightDowns),
                (s = this.getTouchFromArr(i, a)) ? (s.tar = e) : ((r = this.createTouchO(e, i)), a.push(r)),
                this.sendEvents(o, n ? "mousedown" : "rightmousedown"),
                this._clearTempArrs();
            }
          }),
          ...
          (e.onMouseMove = function (e, i) {
            if (this.enable) {
              ...
              (n = this.getTouchFromArr(i, this.preOvers))
                ? (this.checkMouseOutAndOverOfMove(e, n.tar), (n.tar = e), (s = this.getEles(e, null, t._tEleArr)))
                : ((s = this.getEles(e, null, t._tEleArr)), this.sendEvents(s, "mouseover"), this.preOvers.push(this.createTouchO(e, i))),
                this.sendEvents(s, "mousemove"),
                this._clearTempArrs();
            }
          }),
          ...
          (e.onMouseUp = function (e, i, n) {
            if ((void 0 === n && (n = !1), this.enable)) {
              ...
              if (((_ = n ? this.preDowns : this.preRightDowns), (s = this.getTouchFromArr(i, _)))) {
                ...
                h.length > 0 && this.sendEvents(h, n ? "click" : "rightclick"),
                  n && d && this.sendEvents(h, "doubleclick"),
              ...
              (s = this.getTouchFromArr(i, this.preOvers)) &&
                c &&
                ((h = this.getEles(s.tar, null, h)) && h.length > 0 && this.sendEvents(h, "mouseout"),
        ...
        return (
          ...
          (t.slerpQuaternionArray = function (t, e, i, n, s, r, o) {
            var a,
              ...
              y = i[n + 3];
            return (
              (h = _ * g + d * m + f * v + p * y) < 0 && ((h = -h), (g = -g), (m = -m), (v = -v), (y = -y)),
              1 - h > 1e-6
                ? ((a = Math.acos(h)), (l = Math.sin(a)), (u = Math.sin((1 - s) * a) / l), (c = Math.sin(s * a) / l))
                : ((u = 1 - s), (c = s)),
              (r[o + 0] = u * _ + c * g),
              (r[o + 1] = u * d + c * m),
              (r[o + 2] = u * f + c * v),
          ...
          (t.sortByKey = function (e, i, n) {
            ...
            var s;
            return (
              (s = i ? (n ? t.sortNumBigFirst : t.sortBigFirst) : n ? t.sortNumSmallFirst : t.sortSmallFirst),
              function (t, i) {
                return s(t[e], i[e]);
              }
            );
        ...
        return (
          ...
          (e.scaleEx = function (t, e) {
            var i = this.a,
              ...
              r = this.d;
            0 !== n || 0 !== s
              ? ((this.a = t * i), (this.b = t * n), (this.c = e * s), (this.d = e * r))
              : ((this.a = t * i), (this.b = 0 * r), (this.c = 0 * i), (this.d = e * r)),
              (this.bTransform = !0);
          }),
          (e.rotateEx = function (t) {
            var e = Math.cos(t),
              ...
              o = this.d;
            0 !== s || 0 !== r
              ? ((this.a = e * n + i * r), (this.b = e * s + i * o), (this.c = -i * n + e * r), (this.d = -i * s + e * o))
              : ((this.a = e * n), (this.b = i * o), (this.c = -i * n), (this.d = e * o)),
              (this.bTransform = !0);
          }),
          (e.clone = function () {
            var e = t.create();
            return (
              (e.a = this.a), (e.b = this.b), (e.c = this.c), (e.d = this.d), (e.tx = this.tx), (e.ty = this.ty), (e.bTransform = this.bTransform), e
            );
          }),
          (e.copyTo = function (t) {
            return (
              (t.a = this.a), (t.b = this.b), (t.c = this.c), (t.d = this.d), (t.tx = this.tx), (t.ty = this.ty), (t.bTransform = this.bTransform), t
            );
          }),
          (e.toString = function () {
            ...
            return (
              0 !== u || 0 !== c
                ? ((i.a = n * l + s * c),
                  ...
                  (i.tx = l * a + c * h + d),
                  (i.ty = u * a + _ * h + f))
                : ((i.a = n * l), (i.b = s * _), (i.c = r * l), (i.d = o * _), (i.tx = l * a + d), (i.ty = _ * h + f)),
              i
            );
          }),
            ...
            return (
              0 !== u || 0 !== c
                ? ((i[0] = n * l + s * c),
                  ...
                  (i[12] = l * a + c * h + d),
                  (i[13] = u * a + _ * h + f))
                : ((i[0] = n * l), (i[1] = s * _), (i[4] = r * l), (i[5] = o * _), (i[12] = l * a + d), (i[13] = _ * h + f)),
              i
            );
          }),
            ...
            return (
              0 !== i || 0 !== n
                ? ((a.a = h * e + l * n),
                  ...
                  (a.tx = e * _ + n * d + r),
                  (a.ty = i * _ + s * d + o))
                : ((a.a = h * e), (a.b = l * s), (a.c = u * e), (a.d = c * s), (a.tx = e * _ + r), (a.ty = s * d + o)),
              a
            );
          }),
          ...
          (t.preMul = function (t, e, i) {
            ...
            return (
              ...
              (i.ty = _ * o + t.ty),
              (0 === h && 0 === l && 0 === s && 0 === r) ||
                ((i.a += h * r), (i.d += l * s), (i.b += a * s + h * o), (i.c += l * n + u * r), (i.tx += _ * r), (i.ty += c * s)),
              i
            );
          }),
          ...
          (e._getBoundPoints = function () {
            ...
            return (
              ...
              0 == this.width || 0 == this.height
                ? e
                : (e.push(this.x, this.y, this.x + this.width, this.y, this.x, this.y + this.height, this.x + this.width, this.y + this.height), e)
            );
          }),
          (e.isEmpty = function () {
        ...
        return (
          ...
          r(
            ...
            function (e) {
              e != t._musicMuted &&
                (e
                  ? (t._tMusic && t._musicChannel && !t._musicChannel.isStopped ? t._musicChannel.pause() : (t._musicChannel = null),
                    (t._musicMuted = e))
                  : ((t._musicMuted = e), t._tMusic && t._musicChannel && t._musicChannel.resume()));
            }
          ),
          r(
            1,
          ...
          (t.playSound = function (e, n, s, r, o) {
            ...
            var h;
            N.onMiniGame || (h = i.loader.getRes(e)), r || (r = t._soundClass), h || ((h = new r()).load(e), N.onMiniGame || ot.cacheRes(e, h));
            var l;
      ...
      R = (function () {
        function e(t, n) {
          ...
          (e._mainCanvas.source.width = t),
            ...
            (e._context = new D(t, n, o ? null : e._mainCanvas)).ctx.setIsMainContext(),
        ...
        return (
          (n._onVisibilitychange = function () {
            i.stage.isVisibility
              ? 0 != this._timeId && N.window.clearInterval(this._timeId)
              : (this._timeId = N.window.setInterval(this._enterFrame, 1e3));
          }),
      ...
      D = (function () {
          ...
          (this.x = 0),
            ...
            (this._drawPie = function (t, e, i) {
              ...
              R.isWebGL && n.setPathId(i[8]),
                n.beginPath(),
                R.isWebGL ? (n.movePath(i[0] + t, i[1] + e), n.moveTo(0, 0)) : n.moveTo(t + i[0], e + i[1]),
            ...
            (this._drawLine = function (t, e, i) {
              ...
              R.isWebGL && n.setPathId(i[6]),
                ...
                (n.lineWidth = i[5]),
                R.isWebGL
                  ? (n.movePath(t, e), n.moveTo(i[0], i[1]), n.lineTo(i[2], i[3]))
                  : (n.moveTo(t + i[0], e + i[1]), n.lineTo(t + i[2], e + i[3])),
                n.stroke();
            }),
            (this._drawLines = function (t, e, i) {
              ...
              var s = i[2],
                r = 2,
                o = s.length;
              if (R.isWebGL) for (n.moveTo(s[0], s[1]); r < o; ) n.lineTo(s[r++], s[r++]);
              else for (n.moveTo(t + s[0], e + s[1]); r < o; ) n.lineTo(t + s[r++], e + s[r++]);
              n.stroke();
            }),
            ...
            (this._drawPoly = function (t, e, i) {
              ...
              if (R.isWebGL)
                for (n.setPathId(i[6]), n.beginPath(), t += i[0], e += i[1], n.movePath(t, e), n.moveTo(s[0], s[1]); r < o; )
                  n.lineTo(s[r++], s[r++]);
              else for (n.beginPath(), t += i[0], e += i[1], n.moveTo(t + s[0], e + s[1]); r < o; ) n.lineTo(t + s[r++], e + s[r++]);
            ...
            n ? (this.ctx = n.getContext("2d")) : ((n = yt.create("3D")), (this.ctx = o.createWebGLContext2D(n)), n._setContext(this.ctx)),
            n.size(e, i),
            (this.canvas = n);
        }
        ...
        return (
          ...
          (e._fillAndStroke = function (t, e, i, n) {
            void 0 === n && (n = !1);
            var s = this.ctx;
            null != t && ((s.fillStyle = t), R.isWebGL ? s.fill(n) : s.fill()),
        ...
        return (
          ...
          (e._transform = function (e, i, n, s) {
            var r = e.transform,
              o = this._next;
            r && o != t.NORENDER
              ? (i.save(), i.transform(r.a, r.b, r.c, r.d, r.tx + n, r.ty + s), o._fun.call(o, e, i, 0, 0), i.restore())
              : o._fun.call(o, e, i, n, s);
          }),
          (e._childs = function (t, e, i, n) {
            ...
            if (((i = i - r.translateX + s.paddingLeft), (n = n - r.translateY + s.paddingTop), s._calculation)) {
              ...
              if (o) {
                ...
                a &&
                  (a.stroke
                    ? e.fillBorderWords(o, i, n, a.font, a.color, a.strokeColor, a.stroke)
                    : e.fillWords(o, i, n, a.font, a.color, "none" != a.textDecoration && a.underLine ? 1 : 0));
              }
            }
            var h,
              l = t._childs,
            ...
            if (r) {
              ...
              if (("bitmap" === d ? $.canvasBitmap++ : $.canvasNormal++, _)) {
                ...
                R.isWebGL && "bitmap" !== d
                  ...
                  : (((u = t.getSelfBounds()).x = u.x - t.pivotX),
                    (u.y = u.y - t.pivotY),
                    (u.x = u.x - 16),
                    (u.y = u.y - 16),
                    (u.width = u.width + 32),
                ...
                if (((f = u.width * g), (p = u.height * m), (h = u.x), (l = u.y), R.isWebGL && "bitmap" === d && (f > 2048 || p > 2048)))
                  return (
                    ...
                    r.ctx && (X.recover("RenderContext", r.ctx), r.ctx.canvas.size(0, 0), (r.ctx = null)),
        ...
        return (
          ...
          (e.strokeText = function (t, e, i, n, s, r, o) {
            $.drawCall++,
              arguments.length > 3 &&
                null != n &&
                ((this.font = n), (this.strokeStyle = s), (this.lineWidth = r), (this.textAlign = o), (this.textBaseline = "top")),
              this.__strokeText(t, e, i);
          }),
          (e.transformByMatrix = function (t) {
          ...
          (e.drawTextureWithTransform = function (t, e, i, n, s, r, o, a, h) {
            ...
            this.save(),
              ...
              r
                ? (this.transform(r.a, r.b, r.c, r.d, r.tx + o, r.ty + a),
                  this.drawImage(t.source, l[0] * u, l[1] * c, (l[2] - l[0]) * u, (l[5] - l[3]) * c, e, i, n, s))
                : this.drawImage(t.source, l[0] * u, l[1] * c, (l[2] - l[0]) * u, (l[5] - l[3]) * c, e + o, i + a, n, s),
              this.restore();
          }),
            ...
            if (h.loaded && h.bitmap && h.source) {
              ...
              s
                ? (this.save(),
                  ...
                  this.restore())
                : this.drawImage(h.source, c[0] * _, c[1] * d, (c[2] - c[0]) * _, (c[5] - c[3]) * d, a[1] - i + t, a[2] - n + e, a[3], a[4]),
          ...
          (e.drawTriangle = function (t, e, i, n, s, r, o, a) {
            ...
            if (a) {
              ...
              (w = S + (E / A) * (A + 1)),
                (b = P + (I / A) * (A + 1)),
                (I = C - P),
                (x = S + ((E = x - S) / (A = Math.sqrt(E * E + I * I))) * (A + 1)),
                (C = P + (I / A) * (A + 1)),
                (I = M - P),
                (T = S + ((E = T - S) / (A = Math.sqrt(E * E + I * I))) * (A + 1)),
                (M = P + (I / A) * (A + 1));
            }
            this.save(),
            ...
            this.transform(R * L, k * L, D * L, O * L, F * L, N * L),
          ...
          (e.fillWords = function (t, e, i, n, s, r) {
            ...
            for (var o = 0, a = t.length; o < a; o++) {
              ...
              if ((this.__fillText(h.char, h.x + e, h.y + i), 1 === r)) {
                var l = h.height,
                  u = 0.5 * h.style.letterSpacing;
                u || (u = 0),
                  this.beginPath(),
                  (this.strokeStyle = s),
                  (this.lineWidth = 1),
                  this.moveTo(e + h.x - u + 0.5, i + h.y + l + 0.5),
                  this.lineTo(e + h.x + h.width + u + 0.5, i + h.y + l + 0.5),
                  this.stroke();
              }
            }
          }),
          ...
          (t.__init__ = function (t) {
            ...
            (t = t || CanvasRenderingContext2D.prototype).inited ||
              ((t.inited = !0),
          ...
          (e.addSize = function (t) {
            t &&
              (this.autoRelease &&
                ...
                this.garbageCollection((1 - this._garbageCollectionRate) * this.autoReleaseMaxSize),
              (this._memorySize += t));
          }),
      ...
      N =
        ...
        (function () {
          function n() {}
          return (
            s(n, "laya.utils.Browser"),
            r(1, n, "pixelRatio", function () {
              return (
                n.__init__(),
                n.userAgent.indexOf("Mozilla/6.0(Linux; Android 6.0; HUAWEI NXT-AL10 Build/HUAWEINXT-AL10)") > -1 ? 2 : o.getPixelRatio()
              );
            }),
            ...
            r(
              ...
              function () {
                return (
                  n.__init__(),
                  n._container || (((n._container = n.createElement("div")).id = "layaContainer"), n.document.body.appendChild(n._container)),
                  n._container
                );
              },
              function (t) {
      ...
      B = (function () {
        function t(t) {
          (this._xd_ = !0),
            ...
            (this._length = 0),
            t
              ? ((this._u8d_ = new Uint8Array(t)), (this._d_ = new DataView(this._u8d_.buffer)), (this._length = this._d_.byteLength))
        ...
        return (
              ...
              (n = r[this._pos_++]) < 128
                ...
                : (e += s(
                    n < 224
                      ...
                      : n < 240
                      ? ((31 & n) << 12) | ((127 & r[this._pos_++]) << 6) | (127 & r[this._pos_++])
                      : ((15 & n) << 18) | ((127 & r[this._pos_++]) << 12) | ((r[this._pos_++] << 6) & 127) | (127 & r[this._pos_++])
                  ));
            return e;
          }),
          (e.getCustomString = function (t) {
            for (var e = "", i = 0, n = 0, s = String.fromCharCode, r = this._u8d_; t > 0; )
              ...
              else for (i = n - 128, this._pos_++, t -= i; i > 0; ) (n = r[this._pos_++]), (e += s((r[this._pos_++] << 8) | n)), i--;
            return e;
          }),
          (e.clear = function () {
          ...
          (e.writeUTFBytes = function (t) {
            for (var e = 0, i = (t += "").length; e < i; e++) {
              ...
              n <= 127
                ? this.writeByte(n)
                : n <= 2047
                ? (this.ensureWrite(this._pos_ + 2), this._u8d_.set([192 | (n >> 6), 128 | (63 & n)], this._pos_), (this._pos_ += 2))
                : n <= 65535
          ...
          r(
            ...
            function (t) {
              this._allocated_ < t
                ? this.___resizeBuffer((this._allocated_ = Math.floor(Math.max(t, 2 * this._allocated_))))
                : this._allocated_ > t && this.___resizeBuffer((this._allocated_ = t)),
                (this._length = t);
            }
          ),
          r(
        ...
        return (
              ...
              for (var h = 0, l = a.length; h < l; h++) {
                ...
                if (("render" !== u.props.name && "render" !== u.props.renderType) || !i._$set_itemRender)
                  if ("Graphic" == u.type) t.addGraphicsToSprite(u, i);
                    ...
                    "Script" == u.type
                      ? c.hasOwnProperty("owner")
                        ? (c.owner = i)
                        : c.hasOwnProperty("target") && (c.target = i)
                      : "mask" == u.props.renderType
                      ? (i.mask = c)
                      : i.addChild(c);
                  }
                else i.itemRender = u;
          ...
          (t._getGraphicsFromSprite = function (t, e) {
            ...
            switch ((n = t.props.renderType)) {
              ...
              case "unHit":
                var s;
                e.hitArea || (e.hitArea = new Y()), (s = e.hitArea)[n] || (s[n] = new f()), (i = s[n]);
            }
          ...
          (t._getTransformData = function (e) {
            ...
            (e.hasOwnProperty("pivotX") || e.hasOwnProperty("pivotY")) &&
              (i = i || new M()).translate(-t._getObjVar(e, "pivotX", 0), -t._getObjVar(e, "pivotY", 0));
            ...
            return (
              ...
              (1 == n && 1 == s && 0 == r) || ((i = i || new M()).scale(n, s), i.rotate(0.0174532922222222 * r)),
              i
            );
          }),
          ...
          (t._getParams = function (e, i, n, s) {
            ...
            var h;
            return (
              (h = t._getTransformData(e)) ? (n || (n = 0), h.translate(r[n], r[n + 1]), (r[n] = r[n + 1] = 0), (t._tM = h)) : (t._tM = null),
              s && t[s] && (r = t[s](r)),
              r
            );
          }),
      ...
      z =
        ...
        (function () {
          ...
          var e = t.prototype;
          return (
            (e.start = function (t, e, n, s, r, o, a, h) {
              void 0 === h && (h = 0.92),
                this.clearTimer(),
                (this.target = t),
                (this.area = e),
            ...
            (e.stop = function () {
              this._dragging &&
                ((v.instance.disableMouseEvent = !1),
            ...
            (e.checkElastic = function () {
              ...
              if (
                (this.target.x < this.area.x
                  ? (t = this.area.x)
                  : this.target.x > this.area.x + this.area.width && (t = this.area.x + this.area.width),
                this.target.y < this.area.y
                  ? (e = this.area.y)
                  : this.target.y > this.area.y + this.area.height && (e = this.area.y + this.area.height),
                isNaN(t) && isNaN(e))
              )
                this.clear();
              else {
                ...
                isNaN(t) || (i.x = t),
                  isNaN(e) || (i.y = e),
                  (this._tween = j.to(this.target, i, this.elasticBackTime, H.sineOut, l.create(this, this.clear), 0, !1, !1));
              }
            }),
            (e.tweenMove = function () {
              (this._offsetX *= this.ratio * this._elasticRateX),
                ...
                this.area && this.checkArea(),
                this.target.event("dragmove", this.data),
                ((Math.abs(this._offsetX) < 1 && Math.abs(this._offsetY) < 1) || this._elasticRateX < 0.5 || this._elasticRateY < 0.5) &&
                  (i.timer.clear(this, this.tweenMove), this.elasticDistance > 0 ? this.checkElastic() : this.clear());
            }),
            (e.clear = function () {
              if (this.target) {
                this.clearTimer();
      ...
      H = (function () {
        ...
        return (
          ...
          (t.bounceInOut = function (e, i, n, s) {
            return e < 0.5 * s ? 0.5 * t.bounceIn(2 * e, 0, n, s) + i : 0.5 * t.bounceOut(2 * e - s, 0, n, s) + 0.5 * n + i;
          }),
          ...
          (t.elasticIn = function (e, i, n, s, r, o) {
            ...
            return 0 == e
              ...
              ? i + n
              : (o || (o = 0.3 * s),
                !r || (n > 0 && r < n) || (n < 0 && r < -n) ? ((r = n), (a = o / 4)) : (a = (o / t.PI2) * Math.asin(n / r)),
          ...
          (t.elasticInOut = function (e, i, n, s, r, o) {
            ...
            return 0 == e
              ...
              : (o || (o = s * (0.3 * 1.5)),
                !r || (n > 0 && r < n) || (n < 0 && r < -n) ? ((r = n), (a = o / 4)) : (a = (o / t.PI2) * Math.asin(n / r)),
                e < 1
                  ? r * Math.pow(2, 10 * (e -= 1)) * Math.sin(((e * s - a) * t.PI2) / o) * -0.5 + i
                  : r * Math.pow(2, -10 * (e -= 1)) * Math.sin(((e * s - a) * t.PI2) / o) * 0.5 + n + i);
          }),
          ...
          (t.strongInOut = function (t, e, i, n) {
            return (t /= 0.5 * n) < 1 ? 0.5 * i * t * t * t * t * t + e : 0.5 * i * ((t -= 2) * t * t * t * t + 2) + e;
          }),
          ...
          (t.quartInOut = function (t, e, i, n) {
            return (t /= 0.5 * n) < 1 ? 0.5 * i * t * t * t * t + e : 0.5 * -i * ((t -= 2) * t * t * t - 2) + e;
          }),
          ...
          (t.cubicInOut = function (t, e, i, n) {
            return (t /= 0.5 * n) < 1 ? 0.5 * i * t * t * t + e : 0.5 * i * ((t -= 2) * t * t + 2) + e;
          }),
          ...
          (t.quadInOut = function (t, e, i, n) {
            return (t /= 0.5 * n) < 1 ? 0.5 * i * t * t + e : 0.5 * -i * (--t * (t - 2) - 1) + e;
          }),
          ...
          (t.circInOut = function (t, e, i, n) {
            return (t /= 0.5 * n) < 1 ? 0.5 * -i * (Math.sqrt(1 - t * t) - 1) + e : 0.5 * i * (Math.sqrt(1 - (t -= 2) * t) + 1) + e;
          }),
          ...
          (t.ptInPolygon = function (e, i, n) {
            ...
            for (var c = 0; c < u; c += 2)
              (o = n[c]),
                (a = n[c + 1]),
                (h = n[(c + 2) % u]),
                a == (l = n[(c + 3) % u]) || s.y < Math.min(a, l) || s.y >= Math.max(a, l) || (((s.y - a) * (h - o)) / (l - a) + o > s.x && r++);
            return r % 2 == 1;
          }),
          (t._cmds = []),
          n(t, [
      ...
      X =
        ...
        (function () {
          ...
          s(t, "laya.utils.Log"),
            (t.enable = function () {
              t._logdiv ||
                ((t._logdiv = N.window.document.createElement("div")),
            ...
            (t.print = function (e) {
              t._logdiv &&
                (t._count >= t.maxCount && t.clear(), t._count++, (t._logdiv.innerText += e + "\n"), (t._logdiv.scrollTop = t._logdiv.scrollHeight));
            }),
            (t.clear = function () {
        ...
        (function () {
          ...
          return (
              ...
              void 0 === e && (e = 0),
                ...
                !R.isConchApp || R.isConchWebGL
                  ? (R.isConchWebGL || N.onMiniGame || N.onLimixiu || (t._useCanvas = !0),
                    ...
                    t.enable())
                  : N.window.conch.showFPS && N.window.conch.showFPS(e, i);
            }),
            (t.createUIPre = function (e, i) {
              ...
              t._canvas ||
                ((t._canvas = new yt("2D")).size(t._width, t._height),
              ...
              if (this.scale <= 0) this._lastTimer = this._now();
                ...
                for (this._count = 0, o = 0, a = n.length; o < a; o++)
                  if (null !== (h = n[o]).method) {
                    ...
                    if (s >= h.exeTime)
                      if (h.repeat)
                        if (h.jumpFrame) for (; s >= h.exeTime; ) (h.exeTime += h.delay), h.run(!1);
      ...
      j = (function () {
        ...
        return (
          ...
          (e._create = function (e, n, s, r, o, a, h, l, u, c) {
            ...
            return (
              t.tweenMap[_] ? (h && t.clearTween(e), t.tweenMap[_].push(this)) : (t.tweenMap[_] = [this]),
              c
                ? a <= 0
                  ? this.firstStart(e, n, l)
                  : ((this._delayParam = [e, n, l]), i.scaleTimer.once(a, this, this.firstStart, this._delayParam))
                : this._initProps(e, n, l),
              this
            );
          }),
          ...
          (e._clear = function () {
            this.pause(),
              ...
              (this._props = null),
              (this._delayParam = null),
              this._usedPool && ((this.update = null), X.recover("tween", this));
          }),
          (e.recover = function () {
          ...
          (e.resume = function () {
            this._usedTimer >= this._duration ||
              ((this._startTimer = N.now() - this._usedTimer - this._delay),
              this._delayParam
                ? this._usedTimer < 0
                  ? i.scaleTimer.once(-this._usedTimer, this, this.firstStart, this._delayParam)
        ...
        return (
          ...
          (t.getTransformRelativeToWindow = function (t, e, n) {
            ...
            var l = i.stage.canvasDegree % 180 != 0,
              ...
              c = NaN;
            l
              ? ((u = n + r.y), (c = e + r.x), (u *= o.d), (c *= o.a), 90 == i.stage.canvasDegree ? ((u = a - u), (c += h)) : ((u += a), (c = h - c)))
              : ((u = e + r.x), (c = n + r.y), (u *= o.a), (c *= o.d), (u += a), (c += h));
            var _ = NaN,
              d = NaN;
            return (
              l ? ((_ = o.d * r.height), (d = o.a * r.width)) : ((_ = o.a * r.width), (d = o.d * r.height)),
              {
                x: u,
                y: c,
                scaleX: _,
          ...
          (n.replaceChild = function (t, e) {
            ...
            return i > -1
              ? (this._childs.splice(i, 1, t),
                this.conchModel && (this.conchModel.removeChild(e.conchModel), this.conchModel.addChildAt(t.conchModel, i)),
                (e.parent = null),
                (t.parent = this),
                t)
              : null;
            ...
            function (t) {
              this._parent !== t &&
                (t
                  ? ((this._parent = t),
                    this.event("added"),
                    this._getBit(1) && (this._setUpNoticeChain(), t.displayedInStage && this._displayChild(this, !0)),
                    t._childChanged(this))
                  : (this.event("removed"), this._parent._childChanged(), this._getBit(1) && this._displayChild(this, !1), (this._parent = t)));
            }
          ),
      ...
      tt = (function (t) {
        ...
        return (
          ...
          (i._calculation = function (t, e) {
            ...
            var a = e.split(" ");
            return (
              (a[0] = parseFloat(a[0]) / 100),
              1 == a.length ? (a[1] = a[2] = 0) : ((a[1] = parseFloat(a[1]) / 100), (a[2] = parseFloat(a[2]))),
              (o[t] = a),
              (o.input[t] = e),
              n(),
              !0
            ...
            for (var n, s = [], r = t.split(i), o = 0, a = r.length; o < a; o++) {
              ...
              if (0 != u.length) {
                ...
                switch (u) {
                  ...
                  case "padding":
                    (n = c.split(" ")).length > 1 || (n[1] = n[2] = n[3] = n[0]),
      ...
      et = (function (t) {
        ...
        return (
          ...
          (i.load = function (t) {
            ...
            if (
              (t == E._tMusic
                ? (e._initMusicAudio(), (r = e._musicAudio).src != t && ((e._audioCache[r.src] = null), (r = null)))
                : (r = e._audioCache[t]),
              r && r.readyState >= 2)
            )
              this.event("complete");
              ...
              r ||
                (t == E._tMusic ? (e._initMusicAudio(), (r = e._musicAudio)) : (r = N.createElement("audio")), (e._audioCache[t] = r), (r.src = t)),
          ...
          (i.play = function (t, i) {
            ...
            (s = X.getItem("audio:" + this.url)),
              R.isConchApp
                ? s || ((s = N.createElement("audio")).src = this.url)
                : this.url == E._tMusic
          ...
          (e._initMusicAudio = function () {
            e._musicAudio ||
              (e._musicAudio || (e._musicAudio = N.createElement("audio")), R.isConchApp || N.document.addEventListener("mousedown", e._makeMusicOK));
          }),
      ...
      st = (function (t) {
        ...
        return (
          ...
          (e.decode = function () {
            e.buffs.length <= 0 ||
              e.isDecoding ||
              ((e.isDecoding = !0), (e.tInfo = e.buffs.shift()), e.ctx.decodeAudioData(e.tInfo.buffer, e._done, e._fail));
          }),
          (e._done = function (t) {
          ...
          (e._unlock = function () {
            e._unlocked ||
              (e._playEmptySound(),
              "running" == e.ctx.state &&
                (N.document.removeEventListener("mousedown", e._unlock, !0),
                N.document.removeEventListener("touchend", e._unlock, !0),
                N.document.removeEventListener("touchstart", e._unlock, !0),
                (e._unlocked = !0)));
          }),
          (e.initWebAudio = function () {
            "running" != e.ctx.state &&
              ...
              N.document.addEventListener("touchstart", e._unlock, !0));
          }),
          (e._dataCache = {}),
          (e.buffs = []),
          (e.isDecoding = !1),
          ...
          n(e, [
            ...
            function () {
              return (this.ctx = e.webAudioEnabled
                ? new (e.window.AudioContext || e.window.webkitAudioContext || e.window.mozAudioContext)()
                : void 0);
            },
            "_miniBuffer",
            function () {
      ...
      rt = (function (t) {
        ...
        return (
          (i.send = function (t, e, i, n, s) {
            ...
            var r = this,
              o = this._http;
            if ((o.open(i, t, !0), s)) for (var a = 0; a < s.length; a++) o.setRequestHeader(s[a++], s[a]);
            else
              R.isConchApp ||
                (e && "string" != typeof e
          ...
          (i.complete = function () {
            ...
            try {
              "json" === this._responseType
                ...
                ? (this._data = K.parseXMLFromString(this._http.responseText))
      ...
      ot = (function (t) {
        ...
        var n = e.prototype;
        return (
          (n.load = function (t, i, n, s, r) {
            if (
              (void 0 === n && (n = !0),
              void 0 === r && (r = !1),
              (this._url = t),
              0 === t.indexOf("data:image") ? (this._type = i = "image") : ((this._type = i || (i = this.getTypeFromUrl(t))), (t = L.formatURL(t))),
              (this._cache = n),
              (this._data = null),
              !r && e.loadedMap[t])
            )
          ...
          (n._loadImage = function (t) {
            ...
            "nativeimage" === this._type
              ? (((n = new N.window.Image()).crossOrigin = ""), (n.onload = r), (n.onerror = o), (n.src = t), (e.imgCache[t] = n))
              : new Tt.create(t, {
                  onload: r,
                  onerror: o,
                  onCreate: function (i) {
          ...
          (n.onProgress = function (t) {
            "atlas" === this._type ? this.event("progress", 0.3 * t) : this.event("progress", t);
          }),
          (n.onError = function (t) {
            this.event("error", t);
          }),
          (n.onLoaded = function (t) {
            ...
            if ("plf" == i) this.parsePLFData(t), this.complete(t);
              ...
              if (!t.src && !t._setContext) {
                ...
                return this.event("progress", 0.3 + (1 / s.length) * 0.6), this._loadImage(s.pop());
              }
              if ((this._data.pics.push(t), this._data.toLoads.length > 0))
                return this.event("progress", 0.3 + (1 / this._data.toLoads.length) * 0.6), this._loadImage(this._data.toLoads.pop());
              ...
              if (this._data.meta && this._data.meta.scale && 1 != this._data.meta.scale) {
                ...
                for (v in c)
                  (w = f[(y = c[v]).frame.idx ? y.frame.idx : 0]),
                    (x = L.formatURL(d + v)),
                    e.cacheRes(
                      x,
                      lt.create(
              ...
              if (!t.src) return (this._data = t), this.event("progress", 0.5), this._loadImage(this._url.replace(".fnt", ".png"));
              var b = new u();
              b.parseFont(this._data, t);
              var C = this._url.split(".fnt")[0].split("/"),
                M = C[C.length - 1];
              gt.registerBitmapFont(M, b), (this._data = b), this.complete(this._data);
            } else if ("pkm" == i) {
              var S = Tt.create(t, this._url),
                P = new lt(S);
          ...
          (e.checkNext = function () {
            ...
            for (var t = N.now(); e._startIndex < e._loaders.length; )
              if ((N.now(), e._loaders[e._startIndex].endLoad(), e._startIndex++, N.now() - t > e.maxTimeOut))
                return (
                  console.warn("loader callback cost a long time:" + (N.now() - t) + " url=" + e._loaders[e._startIndex - 1].url),
          ...
          (e.clearTextureRes = function (t) {
            ...
            i &&
              i.bitmap &&
              (R.isConchApp && !R.isConchWebGL
                ? i.bitmap.source.releaseTexture && i.bitmap.source.releaseTexture()
        ...
        return (
          ...
          (o._create = function (t, n, s, r, o, a, h, u) {
            ...
            if (_)
              !_.hasOwnProperty("loaded") || _.loaded
                ? (s && s.runWith(1), n && n.run())
                : n && i.loader._createListener(t, n.caller, n.method, n.args, !0, !1);
            else {
          ...
          (o.load = function (t, n, s, o, a, h, l, u) {
            ...
            if (null != _)
              ...
              var d = e._resMap[t];
              d
                ? (n && d._createListener("complete", n.caller, n.method, n.args, !1, !1),
                  s && d._createListener("progress", s.caller, s.method, s.args, !1, !1))
                : (((d = this._infoPool.length ? this._infoPool.pop() : new r()).url = t),
                  (d.type = o),
                  (d.cache = h),
                  (d.group = l),
                  (d.ignoreCache = u),
          ...
          (o._createLoad = function (t, n, s, o, a, h, l, u, c) {
            ...
            if (null != d)
              ...
              var f = e._resMap[n];
              f
                ? (s && f._createListener("complete", s.caller, s.method, s.args, !1, !1),
                  o && f._createListener("progress", o.caller, o.method, o.args, !1, !1))
                : (((f = this._infoPool.length ? this._infoPool.pop() : new r()).url = n),
                  (f.clas = t),
                  (f.type = a),
                  (f.cache = l),
                  (f.group = u),
      ...
      ht =
        ((function (t) {
          function e(t) {
            e.__super.call(this),
              t || (t = [0.3, 0.59, 0.11, 0, 0, 0.3, 0.59, 0.11, 0, 0, 0.3, 0.59, 0.11, 0, 0, 0, 0, 0, 1, 0]),
            ...
            (i.connectByUrl = function (t) {
              ...
              null != this._socket && this.close(),
                ...
                this.protocols && 0 != this.protocols.length
                  ? (this._socket = new N.window.WebSocket(t, this.protocols))
                  : (this._socket = new N.window.WebSocket(t)),
          ...
          (i.workerMessage = function (t) {
            ...
            (i.imageLoaded = function (t) {
              ...
              switch (t.dataType) {
                ...
                case "imagedata":
                  (n = (i = new yt("2D")).source.getContext("2d")),
                    (s = t.imagedata),
                    i.size(s.width, s.height),
                    n.putImageData(s, 0, 0),
                    (s = t.imagedata),
                ...
                case "imageBitmap":
                  (s = t.imageBitmap),
                    R.isWebGL
                      ? (i = s)
                      : ((n = (i = new yt("2D")).source.getContext("2d")), i.size(s.width, s.height), n.drawImage(s, 0, 0), (i.src = t.url));
              }
            ...
            (e.__init__ = function () {
              return (
                null == e._preLoadFun &&
                !!N.window.Worker &&
                ((e._preLoadFun = ot.prototype._loadImage), (ot.prototype._loadImage = e.prototype._loadImage), e.I || (e.I = new e()), !0)
              );
            }),
          ...
          return (
            ...
            (n._setGroup = function (t) {
              if (this._group !== t) {
                var i;
                this._group &&
                  ((i = e._groupResourcesMap[this._group]).splice(i.indexOf(this), 1), 0 === i.length && delete e._groupResourcesMap[this._group]),
            ...
            (n.releaseResource = function (t) {
              return (
                ...
                !(
                  (!t && this.lock) ||
                  (this._released && !t) ||
                  (this.disposeResource(), (this._released = !0), (this._lastUseFrameCount = -1), this.event("released", this), 0)
                )
              );
            }),
            ...
            (n.destroy = function () {
              if (!this._destroyed) {
                ...
                var t;
                this._url &&
                  ((t = e._urlResourcesMap[this._url]) && (t.splice(t.indexOf(this), 1), 0 === t.length && delete e._urlResourcesMap[this.url]),
                  ot.clearRes(this._url),
                  this.__loaded || o.cancelLoadByUrl(this._url)),
                  this._group &&
                    ((t = e._groupResourcesMap[this._group]).splice(t.indexOf(this), 1), 0 === t.length && delete e._groupResourcesMap[this.url]);
              }
            }),
        ...
        return (
          ...
          (a.setTo = function (e, i) {
            ...
            if (((this.uv = i || n.DEF_UV), e)) {
              ...
              if (this._loaded) o.addToAtlas && o.addToAtlas(r);
                ...
                var a = e;
                a instanceof laya.resource.HTMLImage &&
                  a.image &&
                  a.image.addEventListener(
                    "load",
                    function (t) {
          ...
          (a.destroy = function (t) {
            if ((void 0 === t && (t = !1), this.bitmap && this.bitmap.referenceCount > 0)) {
              var e = this.bitmap;
              t
                ? (R.isConchApp && e.source && e.source.conchDestroy && this.bitmap.source.conchDestroy(),
                  (this.bitmap = null),
                  e.dispose(),
                  e._clearReference())
                : (e._removeReference(),
                  0 == e.referenceCount &&
                    (R.isConchApp && e.source && e.source.conchDestroy && this.bitmap.source.conchDestroy(), (this.bitmap = null), e.dispose())),
          ...
          (a.getPixels = function (t, e, i, n) {
            ...
            return R.isWebGL
              ? o.getTexturePixels(this, t, e, i, n)
              : (N.canvas.size(i, n),
                N.canvas.clear(),
            ...
            function (t) {
              !t &&
                ...
                (t ||
                  ...
                  ((this.bitmap.minFifter = 9728), (this.bitmap.magFifter = 9728), (this.bitmap.enableMerageInAtlas = !1)));
            }
          ),
          ...
          (o.gotoTime = function (t) {
            if (null != this._tweenDataList && 0 != this._tweenDataList.length) {
              ...
              for (var n in this._firstTweenDic)
                if ((i = this._firstTweenDic[n])) for (var s in i) i.diyTarget.hasOwnProperty(s) && (i.diyTarget[s] = i[s]);
              ...
              for (a = 0, h = this._tweenDataList.length; a < h; a++)
                0 == (o = this._tweenDataList[a]).type &&
                  t >= o.startTime &&
                  t < o.endTime &&
                  ((this._index = Math.max(this._index, a + 1)),
                  this._gidIndex++,
                  (e = X.getItemByClass("tween", j))._create(
                    o.target,
                    o.data,
                    o.duration,
                    o.ease,
                    l.create(this, this._animComplete, [this._gidIndex]),
                    0,
                    !1,
                    o.isTo,
                    !0,
                  ...
                  e.setStartTime(this._currTime - (t - o.startTime)),
          ...
          (o._update = function () {
            ...
            if (0 != this._tweenDataList.length && this._index < this._tweenDataList.length) {
              ...
              n >= r.startTime &&
                ...
                0 == r.type
                  ? (this._gidIndex++,
                    (s = X.getItemByClass("tween", j))._create(
                      r.target,
                      r.data,
                      r.duration,
                      r.ease,
        ...
        return (
          ...
          (h.getSelfBounds = function () {
            return this._$P.uBounds
              ? this._$P.uBounds
              : (this._$P.mBounds || this._set$P("mBounds", new P()), P._getWrapRec(this._getBoundPointsM(!1), this._$P.mBounds));
          }),
          ...
          (h._getBoundPointsM = function (t) {
            ...
            for (
              var n, s, r, o = this._graphics ? this._graphics.getBoundPoints() : K.clearArray(this._$P.temBM), a = 0, h = (r = this._childs).length;
              a < h;
              a++
            )
              ...
              if (i) {
                ...
                n && 0 === n._repaint && ((n._repaint = 1), n.parentRepaint()),
                  this._$P.maskParent &&
                    ...
                    ((this._$P.maskParent._repaint = 1), this._$P.maskParent.parentRepaint());
          ...
          (h.on = function (t, i, n, s) {
            return 1 !== this._mouseEnableState && this.isMouseEvent(t)
              ? ((this.mouseEnabled = !0), this._setBit(2, !0), this._parent && this._$2__onDisplay(), this._createListener(t, i, n, s, !1))
              : e.prototype.on.call(this, t, i, n, s);
          }),
          (h.once = function (t, i, n, s) {
            return 1 !== this._mouseEnableState && this.isMouseEvent(t)
              ? ((this.mouseEnabled = !0), this._setBit(2, !0), this._parent && this._$2__onDisplay(), this._createListener(t, i, n, s, !0))
              : e.prototype.once.call(this, t, i, n, s);
          }),
          ...
          (h.hitTestPoint = function (t, e) {
            ...
            return (
              ...
              (this._$P.hitArea
                ...
                ? P.TEMP.setTo(0, 0, this._width, this._height)
                : this.getSelfBounds()
              ).contains(t, e)
            );
          }),
          ...
          r(
            ...
            function (t) {
              (this.getStyle().scrollRect = t),
                this.repaint(),
                t
                  ? ((this._renderType |= 128), this.conchModel && this.conchModel.scrollRect(t.x, t.y, t.width, t.height))
          ...
          r(
            ...
            function (t) {
              this._style &&
                ...
                ((this.getStyle().visible = t), this.conchModel && this.conchModel.visible(t), this.parentRepaint());
            }
          ),
          r(
            0,
            ...
            function (t) {
              this._graphics && (this._graphics._sp = null),
                (this._graphics = t),
                t
                  ? ((this._renderType &= -2), (this._renderType |= 512), (t._sp = this), this.conchModel && this.conchModel.graphics(this._graphics))
            ...
            function (t) {
              t && 0 === t.length && (t = null),
                this._$P.filters != t &&
                  ...
                  R.isConchApp &&
                    (this.conchModel && (a.RUNTIMEVERION < "0.9.1" ? this.conchModel.removeType(16) : this.conchModel.removeType(32)),
                  ...
                  t && t.length > 0
                    ? (this._getBit(1) || this._setUpNoticeType(1),
                      (R.isWebGL && 1 == t.length && t[0] instanceof laya.filters.ColorFilter) ||
                        ("bitmap" != this.cacheAs && (R.isConchNode || (this.cacheAs = "bitmap"), this._set$P("cacheForFilters", !0)),
                        this._set$P("hasFilter", !0)))
                    : (this._set$P("hasFilter", !1), this._$P.cacheForFilters && "bitmap" == this.cacheAs && (this.cacheAs = "none")),
                  this.repaint());
            }
          ),
          ...
          r(
            ...
            function (t) {
              (t && this.mask && this.mask._$P.maskParent) ||
                (t
                  ? ((this.cacheAs = "bitmap"), this._set$P("_mask", t), t._set$P("maskParent", this))
                  : (this.mask && this.mask._set$P("maskParent", null), this._set$P("_mask", t), (this.cacheAs = "none")),
          ...
          n(a, [
            ...
            function () {
              return (this.RUNTIMEVERION = t.conch
                ? conchConfig.getRuntimeVersion().substr(conchConfig.getRuntimeVersion().lastIndexOf("-") + 1)
                : "");
            },
          ]),
          a
        ...
        return (
          ...
          (n.stop = function () {
            (this.isStopped = !0),
              ...
              this._audio &&
                ("pause" in this._audio && R.isConchApp && this._audio.stop(),
                this._audio.pause(),
        ...
        return (
          (n.play = function () {
            if ((E.addChannel(this), (this.isStopped = !1), this._clearBufferSource(), this.audioBuffer)) {
              ...
              (this.bufferSource = i),
                ...
                i.playbackRate.setTargetAtTime
                  ? i.playbackRate.setTargetAtTime(E.playbackRate, this.context.currentTime, 0.001)
          ...
          r(
            ...
            function (t) {
              this.isStopped ||
                ((this._volume = t),
                this.gain.gain.setTargetAtTime ? this.gain.gain.setTargetAtTime(t, this.context.currentTime, 0.001) : (this.gain.gain.value = t));
            }
          ),
          (e._tryCleanFailed = !1),
          (e.SetTargetDelay = 0.001),
          e
        );
      })(),
      ft = (function (t) {
      ...
      pt = (function (t) {
        ...
        return (
          ...
          (i._setControlNode = function (t) {
            this._controlNode &&
              (this._controlNode.off("display", this, this._checkResumePlaying), this._controlNode.off("undisplay", this, this._checkResumePlaying)),
              (this._controlNode = t),
          ...
          (i._checkResumePlaying = function () {
            this._isPlaying &&
              (this._controlNode.displayedInStage ? this.play(this._index, this.loop, this._actionName) : this.clearTimer(this, this._frameLoop));
          }),
          (i.stop = function () {
        ...
        return (
          ...
          (o.renderText = function (t, e) {
            ...
            var n =
              ...
              this.fontSize +
              "px " +
              (N.onIPhone ? laya.display.Text._fontFamilyMap[this.font] || this.font : this.font);
            N.context.font = n;
            var s = this.padding,
              r = s[3],
              o = "left",
            ...
            if (
              (!l &&
                ...
                ("right" == this.align
                  ? ((o = "right"), (r = this._width - s[1]))
                  : "center" == this.align && ((o = "center"), (r = 0.5 * this._width + s[3] - s[1]))),
              this._height > 0)
            ) {
              var c = this._textHeight > this._height ? "top" : this.valign;
              "middle" === c ? (u = 0.5 * (this._height - e * h) + s[0] - s[2]) : "bottom" === c && (u = this._height - e * h - s[2]);
            }
            var _ = this._style;
            ...
            for (var m = 0, v = 0, y = Math.min(this._lines.length, e + t) || 1, w = t; w < y; w++) {
              ...
              if (
                ...
                R.isWebGL ? (this._words || (this._words = []), (x = this._words.length > w - t ? this._words[w - t] : new J()).setText(T)) : (x = T),
          ...
          (o.evalTextSize = function () {
            ...
            (t = Math.max.apply(this, this._lineWidths)),
              (e = this._currBitmapFont
                ? this._lines.length * (this._currBitmapFont.getMaxHeight() + this.leading) + this.padding[0] + this.padding[2]
                : this._lines.length * (this._charSize.height + this.leading) + this.padding[0] + this.padding[2]),
          ...
          (o.parseLines = function (t) {
            ...
            if (this._currBitmapFont)
              ...
              R.isConchApp && 0 === s.width && 0 === s.height && (s = N.context.measureText("W")),
            ...
            for (var l = r, u = t.length; l < u; l++)
              if (((o = this.getTextWidth(t.charAt(l))), (a += o) > i))
                if (this.wordWrap) {
                  ...
                  if (
                    (c.charCodeAt(c.length - 1) < 255
                      ? (n = /(?:\w|-)+$/.exec(c)) && ((l = n.index + h), 0 == n.index ? (l += c.length) : (c = t.substring(h, l)))
                      : e.RightToLeft &&
                        (n = /([\u0600-\u06FF])+$/.exec(c)) &&
                        ((l = n.index + h), 0 == n.index ? (l += c.length) : (c = t.substring(h, l))),
                    s.push(c),
            ...
            return (
              (e =
                this._currBitmapFont && this._currBitmapFont.autoScaleSize
                  ? this._width * (this._currBitmapFont.fontSize / this.fontSize)
                  : this._width) <= 0 && (e = this.wordWrap ? 100 : N.width),
              e <= 0 && (e = 100),
              e - t[3] - t[1]
            );
          }),
          (o.getCharPoint = function (t, e) {
            ...
            return (e || new S()).setTo(
              this._startX + u - (this._clipPoint ? this._clipPoint.x : 0),
              this._startY + h * (this._charSize.height + this.leading) - (this._clipPoint ? this._clipPoint.y : 0)
            );
          }),
          r(
            0,
          ...
          (e.setTextRightToLeft = function () {
            var t;
            ((t = N.canvas.source.style).display = "none"),
              (t.position = "absolute"),
              (t.direction = "rtl"),
      ...
      mt = (function (t) {
        function e() {
          ...
          void 0 !== o.hidden
            ...
            : void 0 !== o.webkitHidden && ((r = "webkitvisibilitychange"), (s = "webkitVisibilityState")),
        ...
        return (
          ...
          (a.setScreenSize = function (t, e) {
            ...
            this.conchModel && this.conchModel.size(this._width, this._height),
              ...
              1 === l && 1 === u
                ...
                : ((this.transform.a = this._formatData(l / (d / c))),
              ...
              i &&
                ("horizontal" === this._screenMode
                  ? (a.rotate(Math.PI / 2), a.translate(e / p, 0), (this.canvasDegree = 90))
                  : (a.rotate(-Math.PI / 2), a.translate(0, t / p), (this.canvasDegree = -90))),
          ...
          (a.render = function (e, n, s) {
            ...
            if ((this._renderCount++, R.isFlash && this.repaint(), this._style.visible)) {
              ...
              var a =
                  "slow" !== ("mouse" === this._frameRate ? (this._frameStartTime - this._mouseMoveTime < 2e3 ? "fast" : "slow") : this._frameRate),
              ...
              if ((($.renderSlow = !a), a || h || R.isConchApp)) {
                ...
                var l,
                  u = 0,
                  c = 0;
                if (R.isConchNode) for (u = 0, c = this._scenes.length; u < c; u++) (l = this._scenes[u]) && l._updateSceneConch();
                else for (u = 0, c = this._scenes.length; u < c; u++) (l = this._scenes[u]) && l._updateScene();
                if (R.isConchNode) {
                  var _ = ct.CustomList;
                ...
                (this.renderingEnabled &&
                  ...
                  (R.isWebGL
                    ? (e.clear(),
                      ...
                      e.flush(),
                      o.endFinish(),
                      q.instance && q.getInstance().endDispose())
                    : (o.clear(this._bgColor), t.prototype.render.call(this, e, n, s), $._show && $._sp && $._sp.render(e, n, s))));
          ...
          r(0, a, "visible", t.prototype._$get_visible, function (t) {
            this.visible !== t && (i.superSet(ct, this, "visible", t), (R._mainCanvas.source.style.visibility = t ? "visible" : "hidden"));
          }),
        ...
        ((function (t) {
          ...
          (i._onParentChange = function () {
            ...
            r(0, i, "target", null, function (t) {
              this._tar &&
                (this._setPlayActions(this._tar, this._playEvents, "play", !1), this._setPlayActions(this._tar, this._stopEvents, "stop", !1)),
                (this._tar = t),
                this._tar &&
                  (this._setPlayActions(this._tar, this._playEvents, "play", !0), this._setPlayActions(this._tar, this._stopEvents, "stop", !0));
            }),
      ...
      yt = (function (t) {
        ...
        return (
          ...
          (i.size = function (t, e) {
            (this._w != t || this._h != e || (this._source && (this._source.width != t || this._source.height != e))) &&
              ((this._w = t),
              (this._h = e),
      ...
      wt =
        ((function (t) {
          ...
          s(e, "laya.resource.HTMLSubImage", ft),
        ...
        (function (t) {
          ...
          (n.destroy = function (t) {
              ...
              if ((void 0 === i && (i = !1), this._url && (t = this._url + "#" + t), t && e.framesMap[t])) {
                ...
                return (
                  (n = e.framesMap[t]) instanceof Array
                    ? ((this._frames = e.framesMap[t]), (this._count = this._frames.length))
                    : (n.nodeRoot && ((e.framesMap[t] = this._parseGraphicAnimationByData(n)), (n = e.framesMap[t])),
            ...
            (n._frameLoop = function () {
              this._style.visible && this._style.alpha > 0.01 && t.prototype._frameLoop.call(this);
            }),
            ...
            (n.loadAnimation = function (t, e, n) {
              return (
                ...
                this._setFramesFromCache(this._actionName)
                  ...
                  : i.loader.load(n, l.create(this, this._loadAnimationData, [t, e, n]), null, "atlas"),
                this
              );
            }),
          ...
          return (
            (i._setUp = function (t, e) {
              (this._labels = null),
                ...
                e.parsed
                  ? ((this._count = e.count), (this._labels = e.labels), (this._animationNewFrames = e.animationNewFrames))
            ...
            (i._calculateFrameValues = function (t, e, i) {
              ...
              if ((o > this._count && (this._count = o), t.tween))
                for (null == (n = H[t.tweenMethod]) && (n = H.linearNone), s = r; s < o; s++)
                  (i[s] = n(s - r, a, h, l)), this._animationNewFrames && (this._animationNewFrames[s] = !0);
              else for (s = r; s < o; s++) i[s] = a;
      ...
      xt = (function (t) {
        ...
        return (
          ...
          (o._syncInputTransform = function () {
            ...
            R.isConchApp
              ? (t.setScale(n.scaleX, n.scaleY), t.setSize(s, r), t.setPos(n.x, n.y))
              : ((e.inputContainer.style.transform = e.inputContainer.style.webkitTransform =
                  "scale(" + n.scaleX + "," + n.scaleY + ") rotate(" + i.stage.canvasDegree + "deg)"),
                (t.style.width = s + "px"),
                (t.style.height = r + "px"),
          ...
          (o._focusIn = function () {
            ...
            (e.whiteSpace = this.wordWrap ? "pre-wrap" : "nowrap"),
              ...
              R.isConchApp && (t.setType(this._type), t.setForbidEdit(!this._editable)),
              ...
              this.event("focus"),
              N.onPC && t.focus(),
              N.onMiniGame || (this._text, (this._text = null)),
              this.typeset(),
          ...
          (o._setPromptColor = function () {
            (e.promptStyleDOM = N.getElementById("promptStyle")) ||
              ((e.promptStyleDOM = N.createElement("style")).setAttribute("id", "promptStyle"), N.document.head.appendChild(e.promptStyleDOM)),
          ...
          (o._focusOut = function () {
            (laya.display.Input.isInputting = !1),
              ...
              this._content
                ? (i.superSet(gt, this, "text", this._content), i.superSet(gt, this, "color", this._originColor))
                : (i.superSet(gt, this, "text", this._prompt), i.superSet(gt, this, "color", this._promptColor)),
              i.stage.off("keydown", this, this._onKeyDown),
              (i.stage.focus = null),
              this.event("blur"),
                ...
                this._focus
                  ...
                  : (this._multiline || (t = t.replace(/\r?\n/g, "")),
                    ...
                    t
                      ...
                      : (i.superSet(gt, this, "text", this._prompt), i.superSet(gt, this, "color", this.promptColor)));
            }
          ),
          ...
          r(
            ...
            function (t) {
              ...
              this._focus !== t &&
                (t
                  ? (i.target ? i.target._focusOut() : this._setInputMethod(), (i.target = this), this._focusIn())
                  : ((i.target = null),
                    this._focusOut(),
          ...
          r(
            ...
            function (t) {
              t
                ? ((t = "[^" + t + "]").indexOf("^^") > -1 && (t = t.replace("^^", "")), (this._restrictPattern = new RegExp(t, "g")))
                : (this._restrictPattern = null);
            }
          ),
          r(
          ...
          (e._createInputElement = function () {
            e._initInput((e.area = N.createElement("textarea"))),
              ...
              ((e.inputContainer = N.createElement("div")).style.position = "absolute"),
          ...
          (e._processInputting = function (t) {
            ...
            if (e) {
              ...
              e._restrictPattern &&
                ((i = i.replace(/\u2006|\x27/g, "")),
                e._restrictPattern.test(i) && ((i = i.replace(e._restrictPattern, "")), (laya.display.Input.inputElement.value = i))),
                (e._text = i),
                e.event("input");
            }
          }),
                  ...
                  (r = h[(s = l[u])]),
                    -1 == (g = a[s])
                      ...
                      ? (f = (d = t.keyframes[s])[0]).tween
                        ? (null == (_ = H[f.tweenMethod]) && (_ = H.linearNone),
                          (p = d[1]),
                          (o = _(e, this._initData[s], p.value - this._initData[s], p.index)))
                        : (o = this._initData[s])
        ...
        (function (t) {
          ...
          return (
            ...
            (r._updateNodeGraphic = function (t, e, i, n, s) {
              void 0 === s && (s = 1);
              var r,
                o = (r = this._nodeGDic[t.compId] = this._getNodeGraphicData(t.compId, e, this._nodeGDic[t.compId])).alpha * s;
              if (!(o < 0.01)) {
                ...
                r.skin &&
                  ...
                  (a._checkTransform()
                    ? (n.drawTexture(h, 0, 0, r.width, r.height, a, o), (r.resultTransform = null))
                    : n.drawTexture(h, a.tx, a.ty, r.width, r.height, null, o));
                var l;
                if ((l = t.child)) {
                  var u = 0,
                    c = 0;
            ...
            (r._updateNodeGraphic2 = function (t, e, i) {
              ...
              if (((n = this._nodeGDic[t.compId] = this._getNodeGraphicData(t.compId, e, this._nodeGDic[t.compId])), t.child)) {
                ...
                var a = !1;
                (a = s.bTransform || 1 != n.alpha) && i.save(),
              ...
              (s.skin = h),
                ...
                h &&
                  ((w = this._getTextureByUrl(h))
                    ? (l || (l = w.sourceWidth), u || (u = w.sourceHeight))
  ...
  "function" == typeof define &&
    define.amd &&
    define("laya.core", ["require", "exports"], function (e, i) {
