!function(t, e, i) {
    i.un, i.uns;
    var r = i.static, s = i.class, a = i.getset, n = i.__newvec, h = laya.maths.Arith, l = laya.maths.Bezier, o = laya.resource.Bitmap, u = laya.utils.Browser, _ = laya.utils.Byte, c = laya.utils.Color, f = (laya.filters.ColorFilter, 
    i.Config), d = laya.resource.Context, m = (laya.events.Event, laya.filters.Filter), p = laya.display.Graphics, g = laya.resource.HTMLCanvas, v = (laya.utils.HTMLChar, 
    laya.resource.HTMLImage), x = laya.resource.HTMLSubImage, b = (laya.utils.Handler, 
    laya.net.Loader, laya.maths.Matrix), y = laya.maths.Point, T = laya.maths.Rectangle, A = laya.renders.Render, E = (laya.renders.RenderContext, 
    laya.renders.RenderSprite), S = laya.resource.Resource, w = laya.resource.ResourceManager, R = laya.utils.RunDriver, I = laya.display.Sprite, M = laya.display.Stage, C = laya.utils.Stat, L = laya.utils.StringKey, P = (laya.display.css.Style, 
    laya.system.System), D = laya.display.Text, F = laya.resource.Texture, B = (laya.display.css.TransformInfo, 
    laya.net.URL, laya.utils.Utils), N = laya.utils.VectorGraphManager;
    laya.utils.WordText, i.interface("laya.webgl.shapes.IShape"), i.interface("laya.webgl.submit.ISubmit"), 
    ...
    var O = function() {
        ...
        return r.getAltasID = function() {
            ...
            for (var r = -1, s = -1, a = this._width, n = this._height, h = this._cells, l = 0; l < n; l++) if (!(this._rowInfo[l].spaceCount < t)) for (var o = 0; o < a; ) {
                var u = 3 * (l * a + o);
                if (0 != h[u] || h[u + 1] < t || h[u + 2] < e) o += h[u + 1]; else {
                    r = o, s = l;
                    for (var _ = 0; _ < t; _++) if (h[3 * _ + u + 2] < e) {
                        r = -1;
                        break;
                    }
        ...
        return e.setAtlasParam = function(e, i, r, s) {
            ...
            this._gridSize = r, this._maxAtlaserCount = s, this._gridNumX = e / r, this._gridNumY = i / r, 
            this._curAtlasIndex = 0, this.freeAll(), !0;
            throw console.log("设置大图合集参数错误，只能在开始页面设置各种参数"), -1;
        }, e.pushData = function(e) {
            var i = e.bitmap, r = -1, s = null, a = 0, n = 0, h = 0;
            for (a = 0, n = this._atlaserArray.length; a < n && (h = (this._curAtlasIndex + a) % n, 
            s = this._atlaserArray[h], -1 == (r = s.findBitmapIsExist(i))); a++) ;
            if (-1 != r) {
            ...
            for (var o = Math.ceil((e.bitmap.width + 2) / this._gridSize), u = Math.ceil((e.bitmap.height + 2) / this._gridSize), _ = !1, c = 0; c < 2; c++) {
                ...
                for (a = 0; a < f; a++) {
                    ...
                    var d = this._atlaserArray[h], m = 0, p = 0, g = d.addTex(1, o, u);
                    if (g.ret) {
                        m = g.x * this._gridSize + 1, p = g.y * this._gridSize + 1, i.lock = !0, d.addToAtlasTexture(i, m, p), 
                        d.addToAtlas(e, m, p), _ = !0, this._curAtlasIndex = h;
                        break;
                    }
                }
                if (_) break;
                this._atlaserArray.push(new Rt(this._gridNumX, this._gridNumY, this._width, this._height, t._sid_++)), 
        ...
        return e.setValue = function(t) {
            ...
            if (e) {
                var i;
                if ("string" == typeof e ? i = c.create(e) : e instanceof laya.utils.Color && (i = e), 
        ...
        function t() {
            ...
            this.tempArray = [], this.closePath = !1, this.geomatrys = [], bt.mainContext, this.ib = $t.create(35048), 
            this.vb = Jt.create(5);
        }
        ...
        return e.addPoint = function(t, e) {
            ...
            var n;
            return this.geomatrys.push(this._curGeomatry = n = new Lt(t, e, i, r, s, a)), r || (n.fill = !1), 
            void 0 == a && (n.borderWidth = 0), n;
        }, e.setGeomtry = function(t) {
            this.geomatrys.push(this._curGeomatry = t);
        }, e.drawLine = function(t, e, i, r, s) {
            var a;
            return this.closePath ? this.geomatrys.push(this._curGeomatry = a = new Ct(t, e, i, r, s)) : this.geomatrys.push(this._curGeomatry = a = new Mt(t, e, i, r, s)), 
            a.fill = !1, a;
        }, e.update = function() {
        ...
        return i.imps(e, {
            ...
            if ((e._saveMark._saveuse & i) !== i) {
                ...
                var a = t._cache, n = a._length > 0 ? a[--a._length] : new t();
        ...
        return i.imps(e, {
            ...
            if (131072 != (131072 & e._saveMark._saveuse)) {
                ...
                var r = t._cache, s = r._length > 0 ? r[--r._length] : new t();
        ...
        function t() {
            this._contextX = 0, this._contextY = 0, this._clipRect = new T(), this._rect = new T(), 
            this._matrix = new b();
        }
        ...
        return i.imps(e, {
            ...
            if (262144 != (262144 & e._saveMark._saveuse)) {
                ...
                var _ = t._cache, c = _._length > 0 ? _[--_._length] : new t();
                c._clipSaveRect = e._clipRect, c._clipRect.setTo(h, l, o, u), e._clipRect = c._clipRect, 
                c._rect.x = r, c._rect.y = s, c._rect.width = a, c._rect.height = n, c._contextX = e._x, 
                c._contextY = e._y, c._saveMatrix = e._curMat, e._curMat.copyTo(c._matrix), e._curMat = c._matrix, 
                c._submitStencil = i;
                var f = e._save;
                f[f._length++] = c;
            }
        ...
        return i.imps(e, {
            ...
            if (2048 != (2048 & i._saveuse)) {
                i._saveuse |= 2048;
                var r = t._no, s = r._length > 0 ? r[--r._length] : new t();
        ...
        return e.setSP = function(t) {
            ...
            this.target ? this.target.size(t, e) : this.target = Nt.create(t, e), this.target.hasListener("recovered") || this.target.on("recovered", this, function(t) {
                i.timer.callLater(r._sp, r._sp.repaint);
            })) : this.target.size(t, e);
        }, e._flushToTarget = function(t, e) {
            if (!e._destroy) {
                var i = vt.worldScissorTest, r = vt.worldClipRect;
                vt.worldClipRect = this._clipRect, this._clipRect.x = this._clipRect.y = 0, this._clipRect.width = this._width, 
                this._clipRect.height = this._height, vt.worldScissorTest = !1, bt.mainContext.disable(3089);
                var s = vt.worldAlpha, a = vt.worldMatrix4, n = vt.worldMatrix, h = vt.worldFilters, l = vt.worldShaderDefines;
                if (vt.worldMatrix = b.EMPTY, vt.restoreTempArray(), vt.worldMatrix4 = vt.TEMPMAT4_ARRAY, 
                vt.worldAlpha = 1, vt.worldFilters = null, vt.worldShaderDefines = null, Bt.activeShader = null, 
                e.start(), f.showCanvasMark ? e.clear(0, 1, 0, .3) : e.clear(0, 0, 0, 0), t.flush(), 
                e.end(), Bt.activeShader = null, vt.worldAlpha = s, vt.worldMatrix4 = a, vt.worldMatrix = n, 
                vt.worldFilters = h, vt.worldShaderDefines = l, vt.worldScissorTest = i, i) {
        ...
        return s(t, "laya.webgl.shader.d2.Shader2D"), t.prototype.destroy = function() {
        ...
        return e.add = function(t) {
            ...
            var r = i[t];
            if (r) return r;
            for (var s = {}, a = 1, n = 0; n < 32 && !((a = 1 << n) > t); n++) if (t & a) {
                var h = e[a];
                h && (s[h] = "");
            }
            return i[t] = s, s;
        ...
        return e.init = function(e, i, r) {
            ...
            r ? this._ps = r : (t._defaultPS || (t._defaultPS = []).push(0, 1, 3, 3, 1, 2), 
            ...
            this._verticles = r, this._uvs = s, this.mEleNum = this._ps.length, this.mTexture = t, 
            (A.isConchNode || A.isConchApp) && (this._initMyData(), this.mVBData = new Float32Array(this._vs));
        }, e._initMyData = function() {
            var e = 0, i = 0, r = 4 * this._verticles.length;
            this._vs = t._tempVS;
            var s = !1;
            if (A.isConchNode || A.isConchApp ? (this._vs.length = r, s = !0) : this._vs.length < r && (this._vs.length = r, 
            s = !0), t._tVSLen = r, s) for (;e < r; ) this._vs[e] = this._verticles[i], this._vs[e + 1] = this._verticles[i + 1], 
            this._vs[e + 2] = this._uvs[i], this._vs[e + 3] = this._uvs[i + 1], this._vs[e + 4] = 1, 
            this._vs[e + 5] = 1, this._vs[e + 6] = 1, this._vs[e + 7] = 1, e += 8, i += 2; else for (;e < r; ) this._vs[e] = this._verticles[i], 
            ...
            if (A.isWebGL && this.mTexture) {
                ...
                this.transform || (this.transform = b.EMPTY), this.transform.translate(e, i), b.mul(this.transform, t._curMat, this._tempMatrix), 
                this.transform.translate(-e, -i);
                var s = r.shaderValue, a = s.u_mmat2 || vt.getMatrArray();
                vt.mat2MatArray(this._tempMatrix, a), s.textureHost = this.mTexture, s.offsetX = 0, 
                s.offsetY = 0, s.u_mmat2 = a, s.ALPHA = t._shader2D.ALPHA, t._submits[t._submits._length++] = r;
            } else A.isConchApp && this.mTexture && (this.transform || (this.transform = b.EMPTY), 
        ...
        function t(t, e, i, r, s, a, n, h, l) {
            ...
            this.y = e, this.width = i, this.height = r, this.edges = s, this.color = a, this.borderWidth = n, 
            this.borderColor = h;
        }
        ...
        e.needUpdate = function(t) {
            ...
            var r = this.x, s = this.y, a = this.edges, n = (this.r1 - this.r0) / a, h = this.width, l = this.height, o = this.color, u = (o >> 16 & 255) / 255, _ = (o >> 8 & 255) / 255, c = (255 & o) / 255;
            t.push(r, s, u, _, c);
            for (var f = 0; f < a + 1; f++) t.push(r + Math.sin(n * f + this.r0) * h, s + Math.cos(n * f + this.r0) * l), 
            t.push(u, _, c);
            for (f = 0; f < a; f++) e.push(i, i + f + 1, i + f + 2);
        }, e.createLine2 = function(t, e, i, r, s, a) {
            var n, h, l, o, u, _, c, f, d, m, p, g, v, x, b, y, T, A, E, S, w = t.concat(), R = s, I = this.borderColor, M = (I >> 16 & 255) / 255, C = (I >> 8 & 255) / 255, L = (255 & I) / 255, P = w.length / 2, D = r, F = i / 2;
            l = w[0], o = w[1], m = l - (u = w[2]), d = (d = -(o - (_ = w[3]))) / (S = Math.sqrt(d * d + m * m)) * F, 
            m = m / S * F, R.push(l - d + this.x, o - m + this.y, M, C, L, l + d + this.x, o + m + this.y, M, C, L);
            for (var B = 1; B < P - 1; B++) l = w[2 * (B - 1)], o = w[2 * (B - 1) + 1], u = w[2 * B], 
            _ = w[2 * B + 1], c = w[2 * (B + 1)], f = w[2 * (B + 1) + 1], m = l - u, g = u - c, 
            b = (-(d = (d = -(o - _)) / (S = Math.sqrt(d * d + m * m)) * F) + l) * (-(m = m / S * F) + _) - (-d + u) * (-m + o), 
            A = (-(p = (p = -(_ - f)) / (S = Math.sqrt(p * p + g * g)) * F) + c) * (-(g = g / S * F) + _) - (-p + u) * (-g + f), 
            E = (v = -m + o - (-m + _)) * (T = -p + u - (-p + c)) - (y = -g + f - (-g + _)) * (x = -d + u - (-d + l)), 
            Math.abs(E) < .1 ? (E += 10.1, R.push(u - d + this.x, _ - m + this.y, M, C, L, u + d + this.x, _ + m + this.y, M, C, L)) : (n = (x * A - T * b) / E, 
            h = (y * b - v * A) / E, R.push(n + this.x, h + this.y, M, C, L, u - (n - u) + this.x, _ - (h - _) + this.y, M, C, L));
            l = w[w.length - 4], o = w[w.length - 3], m = l - (u = w[w.length - 2]), d = (d = -(o - (_ = w[w.length - 1]))) / (S = Math.sqrt(d * d + m * m)) * F, 
            m = m / S * F, R.push(u - d + this.x, _ - m + this.y, M, C, L, u + d + this.x, _ + m + this.y, M, C, L);
            var N = a;
            for (B = 1; B < N; B++) e.push(D + 2 * (B - 1), D + 2 * (B - 1) + 1, D + 2 * B + 1, D + 2 * B + 1, D + 2 * B, D + 2 * (B - 1));
            return R;
        }, e.createLine = function(t, e, i, r) {
            var s = t.concat(), a = t, n = this.borderColor, h = (n >> 16 & 255) / 255, l = (n >> 8 & 255) / 255, o = (255 & n) / 255;
            s.splice(0, 5);
            var u, _, c, f, d, m, p, g, v, x, b, y, T, A, E, S, w, R, I, M, C = s.length / 5, L = r, P = i / 2;
            c = s[0], f = s[1], x = c - (d = s[5]), v = (v = -(f - (m = s[6]))) / (M = Math.sqrt(v * v + x * x)) * P, 
            x = x / M * P, a.push(c - v, f - x, h, l, o, c + v, f + x, h, l, o);
            for (var D = 1; D < C - 1; D++) c = s[5 * (D - 1)], f = s[5 * (D - 1) + 1], d = s[5 * D], 
            m = s[5 * D + 1], p = s[5 * (D + 1)], g = s[5 * (D + 1) + 1], x = c - d, y = d - p, 
            E = (-(v = (v = -(f - m)) / (M = Math.sqrt(v * v + x * x)) * P) + c) * (-(x = x / M * P) + m) - (-v + d) * (-x + f), 
            R = (-(b = (b = -(m - g)) / (M = Math.sqrt(b * b + y * y)) * P) + p) * (-(y = y / M * P) + m) - (-b + d) * (-y + g), 
            I = (T = -x + f - (-x + m)) * (w = -b + d - (-b + p)) - (S = -y + g - (-y + m)) * (A = -v + d - (-v + c)), 
            Math.abs(I) < .1 ? (I += 10.1, a.push(d - v, m - x, h, l, o, d + v, m + x, h, l, o)) : (u = (A * R - w * E) / I, 
            _ = (S * E - T * R) / I, a.push(u, _, h, l, o, d - (u - d), m - (_ - m), h, l, o));
            c = s[s.length - 10], f = s[s.length - 9], x = c - (d = s[s.length - 5]), v = (v = -(f - (m = s[s.length - 4]))) / (M = Math.sqrt(v * v + x * x)) * P, 
            x = x / M * P, a.push(d - v, m - x, h, l, o, d + v, m + x, h, l, o);
            var F = this.edges + 1;
            for (D = 1; D < F; D++) e.push(L + 2 * (D - 1), L + 2 * (D - 1) + 1, L + 2 * D + 1, L + 2 * D + 1, L + 2 * D, L + 2 * (D - 1));
            return a;
        }, e.createLoopLine = function(t, e, i, r, s, a) {
            var n = t.concat(), h = s || t, l = this.borderColor, o = (l >> 16 & 255) / 255, u = (l >> 8 & 255) / 255, _ = (255 & l) / 255;
            n.splice(0, 5);
            var c = [ n[0], n[1] ], f = [ n[n.length - 5], n[n.length - 4] ], d = f[0] + .5 * (c[0] - f[0]), m = f[1] + .5 * (c[1] - f[1]);
            n.unshift(d, m, 0, 0, 0), n.push(d, m, 0, 0, 0);
            var p, g, v, x, b, y, T, A, E, S, w, R, I, M, C, L, P, D, F, B, N = n.length / 5, O = r, V = i / 2;
            v = n[0], x = n[1], S = v - (b = n[5]), E = (E = -(x - (y = n[6]))) / (B = Math.sqrt(E * E + S * S)) * V, 
            S = S / B * V, h.push(v - E, x - S, o, u, _, v + E, x + S, o, u, _);
            for (var U = 1; U < N - 1; U++) v = n[5 * (U - 1)], x = n[5 * (U - 1) + 1], b = n[5 * U], 
            y = n[5 * U + 1], T = n[5 * (U + 1)], A = n[5 * (U + 1) + 1], S = v - b, R = b - T, 
            C = (-(E = (E = -(x - y)) / (B = Math.sqrt(E * E + S * S)) * V) + v) * (-(S = S / B * V) + y) - (-E + b) * (-S + x), 
            D = (-(w = (w = -(y - A)) / (B = Math.sqrt(w * w + R * R)) * V) + T) * (-(R = R / B * V) + y) - (-w + b) * (-R + A), 
            F = (I = -S + x - (-S + y)) * (P = -w + b - (-w + T)) - (L = -R + A - (-R + y)) * (M = -E + b - (-E + v)), 
            Math.abs(F) < .1 ? (F += 10.1, h.push(b - E, y - S, o, u, _, b + E, y + S, o, u, _)) : (p = (M * D - P * C) / F, 
            g = (L * C - I * D) / F, h.push(p, g, o, u, _, b - (p - b), y - (g - y), o, u, _));
            a && (e = a);
            var k = this.edges + 1;
        ...
        return s(t, "laya.webgl.shapes.Earcut"), t.earcut = function(e, i, r) {
            r = r || 2;
            var s = i && i.length, a = s ? i[0] * r : e.length, n = t.linkedList(e, 0, a, r, !0), h = [];
            if (!n) return h;
            var l, o, u, _, c, f, d;
            if (s && (n = t.eliminateHoles(e, i, n, r)), e.length > 80 * r) {
                l = u = e[0], o = _ = e[1];
                for (var m = r; m < a; m += r) c = e[m], f = e[m + 1], c < l && (l = c), f < o && (o = f), 
                c > u && (u = c), f > _ && (_ = f);
            ...
            var n, h;
            if (a === t.signedArea(e, i, r, s) > 0) for (n = i; n < r; n += s) h = t.insertNode(n, e[n], e[n + 1], h); else for (n = r - s; n >= i; n -= s) h = t.insertNode(n, e[n], e[n + 1], h);
            ...
            if (e) {
                ...
                for (var l, o, u = e; e.prev !== e.next; ) if (l = e.prev, o = e.next, n ? t.isEarHashed(e, s, a, n) : t.isEar(e)) i.push(l.i / r), 
                i.push(e.i / r), i.push(o.i / r), t.removeNode(e), e = o.next, u = o.next; else if ((e = o) === u) {
            ...
            var s = e;
            do {
                var a = s.prev, n = s.next.next;
                !t.equals(a, n) && t.intersects(a, s, s.next, n) && t.locallyInside(a, n) && t.locallyInside(n, a) && (i.push(a.i / r), 
                i.push(s.i / r), i.push(n.i / r), t.removeNode(s), t.removeNode(s.next), s = e = n), 
                s = s.next;
            } while (s !== e);
            return s;
            ...
            do {
                for (var l = h.next.next; l !== h.prev; ) {
                    if (h.i !== l.i && t.isValidDiagonal(h, l)) {
                        ...
                        return h = t.filterPoints(h, h.next), o = t.filterPoints(o, o.next), t.earcutLinked(h, i, r, s, a, n), 
            ...
            var a, n, h, l, o, u = [];
            for (a = 0, n = i.length; a < n; a++) h = i[a] * s, l = a < n - 1 ? i[a + 1] * s : e.length, 
            (o = t.linkedList(e, h, l, s, !1)) === o.next && (o.steiner = !0), u.push(t.getLeftmost(o));
            ...
            var o, u = r, _ = r.x, c = r.y, f = 1 / 0;
            for (s = r.next; s !== u; ) a >= s.x && s.x >= _ && a !== s.x && t.pointInTriangle(n < c ? a : h, n, _, c, n < c ? h : a, n, s.x, s.y) && ((o = Math.abs(n - s.y) / (a - s.x)) < f || o === f && s.x > r.x) && t.locallyInside(s, e) && (r = s, 
            f = o), s = s.next;
            return r;
        }, t.indexCurve = function(e, i, r, s) {
            var a = e;
            do {
                null === a.z && (a.z = t.zOrder(a.x, a.y, i, r, s)), a.prevZ = a.prev, a.nextZ = a.next, 
                a = a.next;
            } while (a !== e);
            ...
            do {
                for (i = t, t = null, a = null, n = 0; i; ) {
                    ...
                    for (l = o; h > 0 || l > 0 && r; ) 0 !== h && (0 === l || !r || i.z <= r.z) ? (s = i, 
                    i = i.nextZ, h--) : (s = r, r = r.nextZ, l--), a ? a.nextZ = s : t = s, s.prevZ = a, 
                    a = s;
                    i = r;
                }
                a.nextZ = null, o *= 2;
            ...
            return t = 32767 * (t - i) * s, e = 32767 * (e - r) * s, t = 16711935 & (t | t << 8), 
            ...
            var i = t, r = !1, s = (t.x + e.x) / 2, a = (t.y + e.y) / 2;
            do {
                i.y > a != i.next.y > a && i.next.y !== i.y && s < (i.next.x - i.x) * (a - i.y) / (i.next.y - i.y) + i.x && (r = !r), 
                i = i.next;
            } while (i !== t);
            return r;
        }, t.splitPolygon = function(t, e) {
            var i = new st(t.i, t.x, t.y), r = new st(e.i, e.x, e.y), s = t.next, a = e.prev;
            return t.next = e, e.prev = t, i.next = s, s.prev = i, r.next = i, i.prev = r, a.next = r, 
            r.prev = a, r;
        }, t.insertNode = function(t, e, i, r) {
            var s = new st(t, e, i);
            return r ? (s.next = r.next, s.prev = r, r.next.prev = s, r.next = s) : (s.prev = s, 
            s.next = s), s;
            ...
            for (var s = 0, a = e, n = i - r; a < i; a += r) s += (t[n] - t[a]) * (t[a + 1] + t[n + 1]), 
            n = a;
            return s;
        }, t;
    }(), st = function() {
        ...
        function t(t, e, i, r, s, a, n) {
            ...
            this.fillAlpha = s, this.shape = n, this.fill = a;
        }
        ...
        return i.imps(e, {
            ...
            return this.shaderValue.upload(), G.activeBlendFunction !== this._blendFn && (i.enable(3042), 
            this._blendFn(i), G.activeBlendFunction = this._blendFn), C.drawCall++, C.trianglesFaces += this._numEle / 3, 
            ...
            null == r && ((r = n._selfVb || (n._selfVb = Jt.create(-1))).clear(), s = 0), n._ib = i, 
            n._vb = r, n._startIdx = s * mt.BYTES_PIDX, n._numEle = 0;
            var h = e._nBlendType;
        ...
        return i.imps(e, {
            ...
            this._vb.bind_upload(this._ib);
            var r = vt.worldMatrix4, s = b.TEMP;
            ...
            return G.activeBlendFunction !== this._blendFn && (n.enable(3042), this._blendFn(n), 
            G.activeBlendFunction = this._blendFn), C.drawCall++, C.trianglesFaces += this._numEle / 3, 
            n.drawElements(4, this._numEle, 5123, this.startIndex), vt.worldMatrix4 = r, Bt.activeShader = null, 
            1;
        ...
        function t() {
            this.submitIndex = 0, this.submitLength = 0, this.context = null, this.clipRect = new T(), 
        ...
        return i.imps(e, {
            ...
            var s = vt.worldMatrix4, a = s[0], n = s[5];
            if (t = t * a + s[12], e = e * n + s[13], i *= a, r *= n, i < 1 || r < 1) return !1;
            var h = t + i, l = e + r;
            t < 0 && (t = 0, i = h - t), e < 0 && (e = 0, r = l - e);
            var o = vt.worldClipRect;
            if (t = Math.max(t, o.x), e = Math.max(e, o.y), i = Math.min(h, o.right) - t, r = Math.min(l, o.bottom) - e, 
            i < 1 || r < 1) return !1;
            var u = vt.worldScissorTest;
            return this.screenRect.copyFrom(o), o.x = t, o.y = e, o.width = i, o.height = r, 
            vt.worldScissorTest = !0, e = vt.height - e - r, bt.mainContext.scissor(t, e, i, r), 
            bt.mainContext.enable(3089), this.context.submitElement(this.submitIndex, this.submitIndex + this.submitLength), 
            u ? (e = vt.height - this.screenRect.y - this.screenRect.height, bt.mainContext.scissor(this.screenRect.x, e, this.screenRect.width, this.screenRect.height), 
            bt.mainContext.enable(3089)) : (bt.mainContext.disable(3089), vt.worldScissorTest = !1), 
            o.copyFrom(this.screenRect), !0;
        }, e._scissorWithTagart = function(t, e, i, r) {
            if (i < 1 || r < 1) return !1;
            var s = t + i, a = e + r;
            t < 0 && (t = 0, i = s - t), e < 0 && (e = 0, r = a - e);
            var n = vt.worldClipRect;
            if (t = Math.max(t, n.x), e = Math.max(e, n.y), i = Math.min(s, n.right) - t, r = Math.min(a, n.bottom) - e, 
            i < 1 || r < 1) return !1;
            var h = vt.worldScissorTest;
            return this.screenRect.copyFrom(n), vt.worldScissorTest = !0, n.x = t, n.y = e, 
            n.width = i, n.height = r, e = vt.height - e - r, bt.mainContext.scissor(t, e, i, r), 
            bt.mainContext.enable(3089), this.context.submitElement(this.submitIndex, this.submitIndex + this.submitLength), 
            h ? (e = vt.height - this.screenRect.y - this.screenRect.height, bt.mainContext.scissor(this.screenRect.x, e, this.screenRect.width, this.screenRect.height), 
            bt.mainContext.enable(3089)) : (bt.mainContext.disable(3089), vt.worldScissorTest = !1), 
        ...
        return i.imps(e, {
            ...
            var n;
            if (e._renderKey = 0, t._mask > 0 && t._mask--, 0 == t._mask) n = laya.webgl.submit.SubmitStencil.create(3), 
            e.addRenderObject(n), e._curSubmit = at.RENDERBASE; else {
                n = laya.webgl.submit.SubmitStencil.create(7), e.addRenderObject(n);
                var h = e._vb;
                if (h._byteLength, pt.fillRectImgVb(h, null, i.x, i.y, i.width, i.height, F.DEF_UV, r, s, a, 0, 0)) {
                    e._shader2D.glTexture = null;
                    var l = e._curSubmit = at.createSubmit(e, e._ib, h, (h._byteLength - 64) / 32 * 3, Et.create(2, 0));
                    l.shaderValue.ALPHA = 1, e._submits[e._submits._length++] = l, e._curSubmit._numEle += 6, 
                    e._curSubmit = at.RENDERBASE;
            ...
            var r;
            e._renderKey = 0, t._mask > 0 && t._mask--, 0 == t._mask ? (r = laya.webgl.submit.SubmitStencil.create(3), 
            e.addRenderObject(r), e._curSubmit = at.RENDERBASE) : (r = laya.webgl.submit.SubmitStencil.create(7), 
            e.addRenderObject(r), e._submits[e._submits._length++] = i, r = laya.webgl.submit.SubmitStencil.create(8), 
            e.addRenderObject(r));
        }, t.create = function(e) {
            var i = t._cache._length ? t._cache[--t._cache._length] : new t();
        ...
        return i.imps(e, {
            ...
            this.shaderValue.upload(), this.blend(), C.drawCall++, C.trianglesFaces += this._numEle / 3, 
            bt.mainContext.drawElements(4, this._numEle, 5123, this._startIdx)), 1;
        }, e.blend = function() {
            ...
            var h = t._cache._length ? t._cache[--t._cache._length] : new t();
            return h._ib = i, h._vb = r, h.proName = n, h._startIdx = s * mt.BYTES_PIDX, h._numEle = 0, 
            h.blendType = e._nBlendType, h.shaderValue = a, h.shaderValue.setValue(e._shader2D), 
            h;
        }, t._cache = (t._cache = [], t._cache._length = 0, t._cache), t;
    }(), ct = function() {
        function t() {
        ...
        return s(t, "laya.webgl.text.DrawText"), t.__init__ = function() {
            ...
            var p, g, v = t._drawValue.value(n, l, o, u, f, d, m), x = 0, b = 0, y = t._charsTemp, T = 0, A = NaN;
            if (s) for (y.length = s.length, x = 0, b = s.length; x < b; x++) A = (g = s[x]).charNum + v.txtID, 
            y[x] = p = t._charsCache[A] || t.getChar(g.char, A, v), p.active(); else {
                var E = r instanceof laya.utils.WordText ? r.toString() : r;
                if (D.CharacterCache) {
                    t._charSeg.textToSpit(E);
                    var S = t._charSeg.length();
                    for (y.length = S, x = 0, b = S; x < b; x++) A = t._charSeg.getCharCode(x) + v.txtID, 
                    y[x] = p = t._charsCache[A] || t.getChar(t._charSeg.getChar(x), A, v), p.active(), 
                    T += p.cw;
            ...
            var R, I, M = NaN, C = 0;
            if (s) for (x = 0, b = y.length; x < b; x++) (p = y[x]).isSpace || (g = s[x], M = p.borderSize, 
            R = p.texture, i._drawText(R, _ + w + g.x * f - M, c + g.y * d - M, R.width, R.height, a, 0, 0, 0, 0)); else {
                for (x = 0, b = y.length; x < b; x++) (p = y[x]).isSpace || (M = p.borderSize, R = p.texture, 
                i._drawText(R, _ + w - M, c - M, R.width, R.height, a, 0, 0, 0, 0), e && ((I = e[C++]) || (I = e[C - 1] = []), 
                I[0] = R, I[1] = w - M, I[2] = -M)), w += p.cw;
                e && (e.length = C);
            }
            ...
            if (void 0 === d && (d = 0), !(r && 0 === r.length || s && 0 === s.length)) {
                ...
                if (g) {
                    var x = (a = a.copyTo(At._tmpMatrix)).tx, b = a.ty;
                    a.scale(1 / m, 1 / p), a._checkTransform(), _ *= m, c *= p, _ += x - a.tx, c += b - a.ty;
                } else m = p = 1;
                if (s) t._drawSlow(null, e, r, s, a, n, h, l, o, u, _, c, m, p, d); else {
                    ...
                    var A = r + n.toString() + l + o + u + m + p + h, E = t._textsCache[A];
                    D.CharacterCache ? E ? t._drawFast(E, e, a, _, c) : (t._textsCache.__length || (t._textsCache.__length = 0), 
                    t._textsCache.__length > f.WebGLTextCacheCount && ((t._textsCache = {}).__length = 0, 
                    t._curPoolIndex = 0), t._textCachesPool[t._curPoolIndex] ? (E = t._textsCache[A] = t._textCachesPool[t._curPoolIndex], 
                    E.length = 0) : t._textCachesPool[t._curPoolIndex] = E = t._textsCache[A] = [], 
                    t._textsCache.__length++, t._curPoolIndex++, t._drawSlow(E, e, r, s, a, n, h, l, o, u, _, c, m, p, d)) : t._drawSlow(E, e, r, s, a, n, h, l, o, u, _, c, m, p, d);
                }
            }
        ...
        t._textsCache = {}, t._drawValue = null, t.d = [], t._charSeg = null, t.__init$ = function() {
            e = function() {
                function t() {}
                return s(t, ""), t.prototype.value = function(e, i, r, s, a, n, h) {
                    this.font = e, this.fillColor = i, this.borderColor = r, this.lineWidth = s, this.scaleX = a, 
                    this.scaleY = n, this.underLine = h;
                    var l = e.toString() + a + n + s + i + r + h;
                    return this.txtID = t._keymap[l], this.txtID || (this.txtID = 1e-7 * ++t._keymapCount, 
                    t._keymap[l] = this.txtID), this;
                }, t.clear = function() {
        ...
        return e.setFont = function(e) {
            ...
            if (i) this._words = i[0], this._size = i[1]; else {
                this._words = e.split(" ");
                for (var r = 0, s = this._words.length; r < s; r++) if (this._words[r].indexOf("px") > 0) {
                    this._index = r;
                    break;
                }
        ...
        return s(t, "laya.webgl.utils.GlUtils"), t.make2DProjection = function(t, e, i) {
            ...
            for (var i = t.getUint16Array(), r = 0, s = 0; s < e; s++) i[r++] = 4 * s, i[r++] = 4 * s + 2, 
            i[r++] = 4 * s + 1, i[r++] = 4 * s, i[r++] = 4 * s + 3, i[r++] = 4 * s + 2;
            ...
            o[2 + (l -= 16)] = s[0], o[l + 3] = s[1], o[l + 6] = s[2], o[l + 7] = s[3], o[l + 10] = s[4], 
            o[l + 11] = s[5], o[l + 14] = s[6], o[l + 15] = s[7];
            var u = a.a, _ = a.b, c = a.c, f = a.d;
            if (1 !== u || 0 !== _ || 0 !== c || 1 !== f) {
                a.bTransform = !0;
                var d = a.tx + n, m = a.ty + h;
            ...
            } else a.bTransform = !1, e += a.tx + n, i += a.ty + h, o[l] = e + r[0], o[l + 1] = i + r[1], 
            ...
            h -= r.length;
            for (var o = r.length, u = s.a, _ = s.b, c = s.c, f = s.d, d = 0; d < o; d += 4) if (l[h + d + 2] = r[d + 2], 
            l[h + d + 3] = r[d + 3], 1 !== u || 0 !== _ || 0 !== c || 1 !== f) {
                s.bTransform = !0;
                var m = s.tx + a, p = s.ty + n;
            ...
            t.byteLength = r + 16 << 2;
            for (var s = t.getFloat32Array(), a = 0, n = r - 16; a < 4; a++) s[r] = s[n] + e, 
            ++n, s[++r] = s[n] + i, ++n, s[++r] = s[n], ++n, s[++r] = s[n], ++r, ++n;
            t._upload = !0;
        }, t.fillRectImgVb = function(t, e, i, r, s, a, n, h, l, o, u, _, c) {
            void 0 === c && (c = !1);
            var f, d, m, p, g, v, x, b, y, T, A, E, S, w, R, I, M = 1, C = h.a, L = h.b, P = h.c, D = h.d, F = e && e.width < 99999999;
            if (1 !== C || 0 !== L || 0 !== P || 1 !== D ? (h.bTransform = !0, 0 === L && 0 === P && (M = 23, 
            y = s + i, T = a + r, f = C * i + (A = h.tx + l), m = C * y + A, d = D * r + (E = h.ty + o), 
            p = D * T + E)) : (M = 23, h.bTransform = !1, m = (f = i + h.tx + l) + s, p = (d = r + h.ty + o) + a), 
            F && (g = e.x, v = e.y, x = e.width + g, b = e.height + v), 1 !== M) {
            ...
            N[B + 11] = n[5], N[B + 14] = n[6], N[B + 15] = n[7], M) {
              case 1:
                A = h.tx + l, E = h.ty + o;
                var O = C * i, V = P * r, U = D * r, k = L * i, H = C * (y = s + i), G = P * (T = a + r), z = D * T, W = L * y;
                c ? (S = O + V + A, R = Math.round(S) - S, w = U + k + E, I = Math.round(w) - w, 
                N[B] = S + R, N[B + 1] = w + I, N[B + 4] = H + V + A + R, N[B + 5] = U + W + E + I, 
                N[B + 8] = H + G + A + R, N[B + 9] = z + W + E + I, N[B + 12] = O + G + A + R, N[B + 13] = z + k + E + I) : (N[B] = O + V + A, 
                N[B + 1] = U + k + E, N[B + 4] = H + V + A, N[B + 5] = U + W + E, N[B + 8] = H + G + A, 
                N[B + 9] = z + W + E, N[B + 12] = O + G + A, N[B + 13] = z + k + E);
                break;
            ...
            var o = .5 * h, u = t._fillLineArray, _ = -(s - n), c = r - a, f = Math.sqrt(_ * _ + c * c);
            _ /= f, c /= f, _ *= o, c *= o, u[0] = r - _, u[1] = s - c, u[4] = r + _, u[5] = s + c, 
            u[8] = a + _, u[9] = n + c, u[12] = a - _, u[13] = n - c, l && l.transformPointArray(u, u);
        ...
        s(t, "laya.webgl.utils.MatirxArray"), t.ArrayMul = function(e, i, r) {
            if (e) if (i) for (var s = NaN, a = NaN, n = NaN, h = NaN, l = 0; l < 4; l++) s = e[l], 
            a = e[l + 4], n = e[l + 8], h = e[l + 12], r[l] = s * i[0] + a * i[1] + n * i[2] + h * i[3], 
            r[l + 4] = s * i[4] + a * i[5] + n * i[6] + h * i[7], r[l + 8] = s * i[8] + a * i[9] + n * i[10] + h * i[11], 
            r[l + 12] = s * i[12] + a * i[13] + n * i[14] + h * i[15]; else t.copyArray(e, r); else t.copyArray(i, r);
        ...
        function t(t, e, i) {
            ...
            this._ib = new $t(), i && this._ib._resizeBuffer(i, !1);
        }
        ...
        return e.cloneWithNewVB = function() {
            ...
            for (var e = this._ib.getUint16Array(), i = 0, r = 0, s = 0; s < t; s++) e[i++] = r, 
        ...
        return s(t, "laya.webgl.utils.RenderState2D"), t.getMatrArray = function() {
            ...
            var r = e, s = i;
            return s[0] = r.a, s[1] = r.b, s[2] = t.EMPTYMAT4_ARRAY[2], s[3] = t.EMPTYMAT4_ARRAY[3], 
            s[4] = r.c, s[5] = r.d, s[6] = t.EMPTYMAT4_ARRAY[6], s[7] = t.EMPTYMAT4_ARRAY[7], 
            s[8] = t.EMPTYMAT4_ARRAY[8], s[9] = t.EMPTYMAT4_ARRAY[9], s[10] = t.EMPTYMAT4_ARRAY[10], 
            s[11] = t.EMPTYMAT4_ARRAY[11], s[12] = r.tx, s[13] = r.ty, s[14] = t.EMPTYMAT4_ARRAY[14], 
        ...
        t.curRenderTarget = null, t.width = 0, t.height = 0, r(t, [ "worldMatrix", function() {
        ...
        return a._compileToTree = function(i, r, s, a, n) {
            var h, l, o, u, _, c, f, d = 0, m = 0, p = 0, g = 0;
            for (m = s; m < r.length; m++) if (!((o = r[m]).length < 1) && 0 !== (d = o.indexOf("//"))) {
                if (d >= 0 && (o = o.substr(0, d)), h = f || new e(a), f = null, h.text = o, h.noCompile = !0, 
                (d = o.indexOf("#")) >= 0) {
                    ...
                    switch (h.name = u, u) {
                      case "#ifdef":
                      case "#ifndef":
                        if (h.src = o, h.noCompile = null != o.match(/[!&|()=<>]/), h.noCompile ? console.log("function():Boolean{return " + o.substr(d + h.name.length) + "}") : (c = o.replace(/^\s*/, "").split(/\s+/), 
                        h.setCondition(c[1], "#ifdef" === u ? 1 : 2), h.text = "//" + h.text), h.setParent(i), 
                        i = h, n) for (c = o.substr(g).split(t._splitToWordExps3), g = 0; g < c.length; g++) (o = c[g]).length && (n[o] = !0);
                        continue;

                      case "#if":
                        if (h.src = o, h.noCompile = !0, h.setParent(i), i = h, n) for (c = o.substr(g).split(t._splitToWordExps3), 
                        g = 0; g < c.length; g++) (o = c[g]).length && "defined" != o && (n[o] = !0);
                        continue;

                      case "#else":
                        h.src = o, l = (i = i.parent).childs[i.childs.length - 1], h.noCompile = l.noCompile, 
                        h.noCompile || (h.condition = l.condition, h.conditionType = 1 == l.conditionType ? 2 : 1, 
                        h.text = "//" + h.text + " " + l.text + " " + h.conditionType), h.setParent(i), 
                        i = h;
                        continue;

                      case "#endif":
                        l = (i = i.parent).childs[i.childs.length - 1], h.noCompile = l.noCompile, h.noCompile || (h.text = "//" + h.text), 
                        h.setParent(i);
                        continue;
            ...
            return n && ("attribute" == a ? e.push(h) : i.push(h)), ":" == r[s + 3] && (h.type = r[s + 4], 
            s += 2), s += 2;
            ...
            for (var o = 0, u = 0, _ = 0; _ < 2; _++) {
                ...
                for (o = 0, u = f.length; o < u; o++) {
                    var d = f[o];
                    if ("attribute" == d || "uniform" == d) o = t._parseOne(a, n, f, o, d, !0); else {
                        if ("#define" == d) {
                            l[d = f[++o]] = 1;
                            continue;
                        }
                        if ("#ifdef" == d) for (h[c = f[++o]] = h[c] || [], o++; o < u; o++) if ("attribute" == (d = f[o]) || "uniform" == d) o = t._parseOne(a, n, f, o, d, l[c]); else if ("#else" == d) for (o++; o < u; o++) if ("attribute" == (d = f[o]) || "uniform" == d) o = t._parseOne(a, n, f, o, d, !l[c]); else if ("#endif" == d) break;
                    }
                }
            }
            return s;
        }, t.splitToWords = function(t, e) {
            for (var i, r, s = [], a = -1, n = 0, h = t.length; n < h; n++) if (i = t.charAt(n), 
            " \t=+-*/&%!<>()'\",;".indexOf(i) >= 0) {
                ...
                "(" == i && e && s.length > 0 && (r = s[s.length - 1] + ";", "vec4;main;".indexOf(r) < 0 && (e.useFuns += r)), 
                a = -1;
            } else a < 0 && (a = n);
            ...
            e = function() {
                ...
                return e.setParent = function(t) {
                    ...
                    if (this.text && e.push(this.text), this.childs.length > 0 && this.childs.forEach(function(r, s, a) {
                        r._toscript(t, e, i);
                    }), this.includefiles.length > 0 && this.useFuns.length > 0) for (var s, a = 0, n = this.includefiles.length; a < n; a++) this.includefiles[a].curUseID != i && (s = this.includefiles[a].file.getFunsScript(this.useFuns)).length > 0 && (this.includefiles[a].curUseID = i, 
                    e[0] = s + e[0]);
                    return e;
                }, t.__id = 1, t;
            }(), i = function() {
                function e(e) {
                    ...
                    this.script = e;
                    for (var i = 0, r = 0, s = 0; !((i = e.indexOf("#begin", i)) < 0); ) {
                        for (s = i + 5; !((s = e.indexOf("#end", s)) < 0) && "i" === e.charAt(s + 4); ) s += 5;
                        if (s < 0) throw "add include err,no #end:" + e;
                        r = e.indexOf("\n", i);
                        var a = t.splitToWords(e.substr(i, r - i), null);
                        "code" == a[1] ? this.codes[a[2]] = e.substr(r + 1, s - r - 1) : "function" == a[1] && (r = e.indexOf("function", i), 
                        r += "function".length, this.funs[a[3]] = e.substr(r + 1, s - r - 1), this.funnames += a[3] + ";"), 
                        i = s + 1;
                    }
                }
                s(e, "");
        ...
        return s(t, "laya.webgl.WebGL"), t._uint8ArraySlice = function() {
            ...
            var e, i = arguments, r = 0, s = 0;
            if (0 === i.length) for (r = this.length, e = new Uint16Array(r), s = 0; s < r; s++) e[s] = this[s]; else if (2 === i.length) {
                var a = i[0], n = i[1];
                if (n > a) for (r = n - a, e = new Uint16Array(r), s = a; s < n; s++) e[s - a] = this[s]; else e = new Uint16Array(0);
            }
            return e;
        }, t.expandContext = function() {
            var t = d.prototype, e = CanvasRenderingContext2D.prototype;
            e.fillTrangles = t.fillTrangles, Zt.__int__(null), e.setIBVB = function(t, e, i, r, s, a, n, h, l, o) {
                void 0 === l && (l = 0), void 0 === o && (o = 0), null === i && (this._ib = this._ib || $t.QuadrangleIB, 
                i = this._ib, pt.expandIBQuadrangle(i, r._byteLength / 64 + 8)), this._setIBVB(t, e, i, r, s, a, n, h, l, o);
            }, e.fillTrangles = function(t, e, i, r, s) {
                this._curMat = this._curMat || b.create(), this._vb = this._vb || Jt.create(), this._ib || (this._ib = $t.create(), 
                pt.fillIBQuadrangle(this._ib, n / 4));
                var a = this._vb, n = r.length >> 4;
            ...
            return R.createFilterAction = e || function(t) {
                ...
                var e = A.context.ctx, i = 0 == e._submits._length || f.preserveDrawingBuffer ? c.create(t)._color : M._wgColor;
                ...
                (i <= 0 || r <= 0) && console.log("[error] canvasWidth and canvasHeight should greater than zero"), 
                i |= 0, r |= 0, s |= 0, a |= 0;
                var n = Nt.create(i, r, 6408, 5121, 0, !1);
                n.start(), n.clear(0, 0, 0, 0), A.context.clear(), E.renders[e]._fun(t, A.context, s, vt.height - r + a), 
                A.context.flush(), n.end();
                ...
                if (n.recycle(), h.byteLength == i * r * 4) {
                    ...
                    return c.data.set(new Uint8ClampedArray(h.buffer)), l._imgData = c, _.putImageData(c, 0, 0), 
                    o.save(), o.translate(0, r), o.scale(1, -1), o.drawImage(u.canvas.source, 0, 0), 
                    o.restore(), l;
                }
                ...
                var n = Nt.create(r, s);
                n.start(), n.clear(0, 0, 0, 0), a.render(A.context, 0, 0), A.context.ctx.flush(), 
                n.end();
                for (var h = n.getData(0, 0, r, s), l = [], o = 0, u = s - 1; u >= 0; u--) for (var _ = 0; _ < r; _++) o = 4 * (u * r + _), 
                ...
                var a = t.getValue("bounds"), n = Nt.create(a.width, a.height);
                if (n.start(), n.clear(0, 0, 0, 0), t.addValue("src", n), t.addValue("ScissorTest", vt.worldScissorTest), 
                vt.worldScissorTest) {
                    var h = new T();
                    h.copyFrom(i.ctx._clipRect), t.addValue("clipRect", h), vt.worldScissorTest = !1, 
                ...
                n.start(), n.clear(0, 0, 0, 0), t.addValue("out", n), e._set$P("_filterCache", n), 
                ...
                var s = this._next;
                if (s) {
                    var a = t.filters, n = a.length;
                    if (1 == n && 32 == a[0].type) return e.ctx.save(), e.ctx.setFilters([ a[0] ]), 
                    s._fun.call(s, t, e, i, r), void e.ctx.restore();
                    var h, l, o = ht.create(), u = y.TEMP, _ = e.ctx._getTransformMatrix(), c = b.create();
                    _.copyTo(c);
                    var f = 0, d = 0, p = !1, g = t._$P._filterCache ? t._$P._filterCache : null;
                    if (!g || t._repaint) {
                        p = t._isHaveGlowFilter(), o.addValue("_isHaveGlowFilter", p), p && (f = 50, d = 25), 
                        (l = new T()).copyFrom(t.getSelfBounds()), l.x += t.x, l.y += t.y, l.x -= t.pivotX + 4, 
                        l.y -= t.pivotY + 4;
                        var v = l.x, x = l.y;
                        ...
                        var E = t.x - v + d, S = t.y - x + d;
                        s._fun.call(s, t, e, E, S), A = nt.create([ o, t, e, 0, 0 ], m._filterEnd), e.addRenderObject(A);
                        for (var w = 0; w < n; w++) 0 != w && (A = nt.create([ o ], m._useSrc), e.addRenderObject(A), 
                        h = Et.create(1, 0), b.TEMP.identity(), e.ctx.drawTarget(o, 0, 0, l.width, l.height, b.TEMP, "out", h, null, G.TOINT.overlay), 
                        A = nt.create([ o ], m._useOut), e.addRenderObject(A)), a[w].action.apply3d(o, t, e, 0, 0);
                        A = nt.create([ o, e ], m._EndTarget), e.addRenderObject(A);
                    } else {
                        if ((p = !!t._$P._isHaveGlowFilter && t._$P._isHaveGlowFilter) && (f = 50, d = 25), 
                        (l = t.getBounds()).width <= 0 || l.height <= 0) return;
                        l.width += f, l.height += f, u.x = l.x * c.a + l.y * c.c, u.y = l.y * c.d + l.x * c.b, 
                        l.x = u.x, l.y = u.y, u.x = l.width * c.a + l.height * c.c, u.y = l.height * c.d + l.width * c.b, 
                        l.width = u.x, l.height = u.y, o.addValue("out", g);
                    }
                    i = i - d - t.x, r = r - d - t.y, u.setTo(i, r), c.transformPoint(u), i = u.x + l.x, 
                    r = u.y + l.y, h = Et.create(1, 0), b.TEMP.identity(), e.ctx.drawTarget(o, i, r, l.width, l.height, b.TEMP, "out", h, null, G.TOINT.overlay), 
                    A = nt.create([ o ], m._recycleScope), e.addRenderObject(A), c.destroy();
                }
            ...
            k.instance.freeAll(), w.releaseContentManagers(!0), t.doNodeRepaint(i.stage), t.mainContext.viewport(0, 0, vt.width, vt.height), 
            ...
            if (null != s.getShaderPrecisionFormat) {
                var a = s.getShaderPrecisionFormat(35633, 36338), n = s.getShaderPrecisionFormat(35632, 36338);
            ...
            P.__init__(), k.__init__(), It.__init__(), at.__init__(), At.__init__(), Et.__init__(), 
            $.__init__(), Zt.__int__(s), G._init_(s), A.isConchApp && conch.setOnInvalidGLRes(t.onInvalidGLRes);
        ...
        return s(t, "laya.webgl.WebGLContext"), t.UseProgram = function(e) {
            return t._useProgram !== e && (bt.mainContext.useProgram(e), t._useProgram = e, 
            !0);
        ...
        function e(t) {
            ...
            this.mOutPoint, this._canvas = t, e._contextcount++, A.isFlash ? (this._ib = $t.create(35044), 
            pt.fillIBQuadrangle(this._ib, 16)) : this._ib = $t.QuadrangleIB, this.clear();
        }
        var n;
        ...
        return h.setIsMainContext = function() {
            ...
            this._targets = null, this._canvas = null, this._ib && this._ib != $t.QuadrangleIB && this._ib.releaseResource();
        }, h.clear = function() {
            this._submits || (this._other = n.DEFAULT, this._curMat = b.create(), this._vb = Jt.create(-1), 
            this._submits = [], this._save = [ Q.Create(this) ], this._save.length = 10, this._shader2D = new $(), 
            this._triangleMesh = Ft.getAMesh()), this._vb.clear(), this._targets && (this._targets.repaint = !0), 
            this._other = n.DEFAULT, this._clear = !0, this._repaint = !1, this._drawCount = 1, 
            ...
            0 === t && 0 === e || (q.save(this), this._curMat.bTransform && (Z.save(this), this._curMat.transformPointN(y.TEMP.setTo(t, e)), 
            t = y.TEMP.x, e = y.TEMP.y), this._x += t, this._y += e);
        }, h.save = function() {
            ...
            void 0 === o && (o = 0);
            var u = this._shader2D, _ = this._curSubmit.shaderValue, f = s ? dt.create(s) : this._other.font;
            if (k.enabled) u.ALPHA !== _.ALPHA && (u.glTexture = null), ft.drawText(this, t, e, this._curMat, f, l || this._other.textAlign, a, n, h, i, r, o); else {
                this._shader2D.defines.getValue();
                var d = a ? c.create(a)._color : u.colorAdd;
                u.ALPHA === _.ALPHA && d === u.colorAdd && _.colorAdd === u.colorAdd || (u.glTexture = null, 
                u.colorAdd = d), ft.drawText(this, t, e, this._curMat, f, l || this._other.textAlign, a, n, h, i, r, o);
            }
            ...
            if (t.loaded && t.bitmap && t.source) {
                ...
                if (u != l.w || _ != l.h) {
                    if (!l.w && !l.h) switch (l.oy = l.ox = 0, n) {
                      ...
                      case "repeat-x":
                        l.width = s, d < 0 ? t.height + d > a ? l.height = a : l.height = t.height + d : (l.oy = d, 
                        t.height + d > a ? l.height = a - d : l.height = t.height);
                        break;

                      case "repeat-y":
                        f < 0 ? t.width + f > s ? l.width = s : l.width = t.width + f : (l.ox = f, t.width + f > s ? l.width = s - f : l.width = t.width), 
                        l.height = a;
                        break;

                      case "no-repeat":
                        f < 0 ? t.width + f > s ? l.width = s : l.width = t.width + f : (l.ox = f, t.width + f > s ? l.width = s - f : l.width = t.width), 
                        d < 0 ? t.height + d > a ? l.height = a : l.height = t.height + d : (l.oy = d, t.height + d > a ? l.height = a - d : l.height = t.height);
                        break;
                ...
                if (e += l.ox, r += l.oy, f -= l.ox, d -= l.oy, pt.fillRectImgVb(o, this._clipRect, e, r, l.width, l.height, l.uv, this._curMat, this._x, this._y, 0, 0)) {
                    ...
                    var p = m.shaderValue;
                    p.textureHost = t;
                    var g = c[0] * u, v = c[1] * _, x = (c[2] - c[0]) * u, b = (c[5] - c[3]) * _, y = -f / u, T = -d / _;
                    p.u_TexRange[0] = g / u, p.u_TexRange[1] = x / u, p.u_TexRange[2] = v / _, p.u_TexRange[3] = b / _, 
                    p.u_offset[0] = y, p.u_offset[1] = T, k.enabled && !this._isMain && m.addTexture(t, (o._byteLength >> 2) - 16), 
            ...
            var r = this._curSubmit._vb || this._vb, s = r._byteLength >> 2;
            r.byteLength = s + 16 << 2;
            for (var a = r.getFloat32Array(), n = 0; n < 16; n += 4) a[s++] = t[n] + e, a[s++] = t[n + 1] + i, 
            a[s++] = t[n + 2], a[s++] = t[n + 3];
            ...
            0;
            var r = t.bitmap, s = r.id + this._shader2D.ALPHA * e + 10016;
            if (s == this._renderKey) return s;
            var a = this._shader2D, n = a.ALPHA, h = this._curSubmit.shaderValue;
            a.ALPHA *= e, this._renderKey = s, this._drawCount++, a.glTexture = r;
            var l = this._vb, o = null, u = l._byteLength / 32 * 3;
            return o = Dt.create(this, this._ib, l, u, Et.create(1, 0)), this._submits[this._submits._length++] = o, 
            o.shaderValue.textureHost = t, o._renderType = 10016, o._preIsSameTextureShader = 10016 === this._curSubmit._renderType && a.ALPHA === h.ALPHA, 
            this._curSubmit = o, a.ALPHA = n, s;
            ...
            if (t.loaded && t.bitmap && t.source) {
                ...
                if (this._clipRect = e.MAXCLIPRECT, this._drawTextureM(t, r[0], r[1], t.width, t.height, s, a, null, 1)) {
                    if (this._clipRect = n, C.drawCall++, !(r.length < 4)) {
                        for (var h = this._curSubmit._vb || this._vb, l = this._curMat.a, o = this._curMat.d, u = 2, _ = r.length; u < _; u += 2) pt.copyPreImgVb(h, (r[u] - r[u - 2]) * l, (r[u + 1] - r[u - 1]) * o), 
            ...
            if (c != this._renderKey) {
                ...
                g = Dt.create(this, this._ib, p, v, Et.create(1, 0)), this._submits[this._submits._length++] = g, 
            ...
            return !!pt.fillRectImgVb(u, this._clipRect, e, r, s || t.width, a || t.height, t.uv, l || this._curMat, this._x, this._y, 0, 0) && (k.enabled && !this._isMain && this._curSubmit.addTexture(t, (u._byteLength >> 2) - 16), 
            this._curSubmit._numEle += 6, this._maxNumEle = Math.max(this._maxNumEle, this._curSubmit._numEle), 
            !0);
            ...
            if (_ != this._renderKey) {
                ...
                (m = k.enabled ? Dt.create(this, this._ib, d, p, Et.create(1, 0)) : Dt.create(this, this._ib, d, p, qt.create()))._preIsSameTextureShader = 10016 === this._curSubmit._renderType && f.ALPHA === c.ALPHA, 
                this._submits[this._submits._length++] = m, m.shaderValue.textureHost = t, m._renderType = 10016, 
                this._curSubmit = m;
            }
            t.active();
            var g = this._curSubmit._vb || this._vb;
            pt.fillRectImgVb(g, this._clipRect, e + n, i + h, r || t.width, s || t.height, t.uv, a || this._curMat, this._x, this._y, l, o, !0) && (k.enabled && !this._isMain && this._curSubmit.addTexture(t, (g._byteLength >> 2) - 16), 
            this._curSubmit._numEle += 6, this._maxNumEle = Math.max(this._maxNumEle, this._curSubmit._numEle));
            ...
            if (n) {
                ...
                n && u.bTransform ? (b.mul(n, u, e._tmpMatrix), (n = e._tmpMatrix)._checkTransform()) : (this._x += u.tx, 
                this._y += u.ty), this._drawTextureM(t, i, r, s, a, 0, 0, n, o), this._x = _, this._y = c;
            } else this._drawTextureM(t, i, r, s, a, h, l, null, o);
        }, h.fillQuadrangle = function(t, e, i, r, s) {
            var a = this._curSubmit, n = this._vb, h = this._shader2D, l = a.shaderValue;
            if (this._renderKey = 0, t.bitmap) {
                var o = t.bitmap;
                h.glTexture == o && h.ALPHA === l.ALPHA || (h.glTexture = o, (a = this._curSubmit = at.createSubmit(this, this._ib, n, n._byteLength / 32 * 3, Et.create(1, 0))).shaderValue.glTexture = o, 
                this._submits[this._submits._length++] = a), pt.fillQuadrangleImgVb(n, e, i, r, t.uv, s || this._curMat, this._x, this._y);
            } else a.shaderValue.fillStyle && a.shaderValue.fillStyle.equal(t) && h.ALPHA === l.ALPHA || (h.glTexture = null, 
            (a = this._curSubmit = at.createSubmit(this, this._ib, n, n._byteLength / 32 * 3, Et.create(2, 0))).shaderValue.defines.add(2), 
            a.shaderValue.fillStyle = z.create(t), this._submits[this._submits._length++] = a), 
            pt.fillQuadrangleImgVb(n, e, i, r, F.DEF_UV, s || this._curMat, this._x, this._y);
            a._numEle += 6;
        }, h.drawTexture2 = function(t, i, r, s, a, n, h, l) {
            if (0 != n) {
                var o = this._curMat;
                if (this._x = t * o.a + i * o.c, this._y = i * o.d + t * o.b, a && (o.bTransform || a.bTransform ? (b.mul(a, o, e._tmpMatrix), 
                a = e._tmpMatrix) : (this._x += a.tx + o.tx, this._y += a.ty + o.ty, a = b.EMPTY)), 
                1 !== n || h) {
                    var u = this._shader2D.ALPHA, _ = this._nBlendType;
                    this._shader2D.ALPHA = n, h && (this._nBlendType = G.TOINT(h)), this._drawTextureM(l[0], l[1] - r, l[2] - s, l[3], l[4], 0, 0, a, 1), 
            ...
            this._curSubmit = at.RENDERBASE, a._targets.drawTo(this, e, i, r, s); else {
                var n = this._submits[this._submits._length++] = Pt.create(a, this._shader2D.ALPHA, this._shader2D.filters), h = r / t.width, l = s / t.height, o = n._matrix;
                this._curMat.copyTo(o), 1 != h && 1 != l && o.scale(h, l);
                var u = o.tx, _ = o.ty;
                o.tx = o.ty = 0, o.transformPoint(y.TEMP.setTo(e, i)), o.translate(y.TEMP.x + u, y.TEMP.y + _), 
                this._curSubmit = at.RENDERBASE;
            }
            f.showCanvasMark && (this.save(), this.lineWidth = 4, this.strokeStyle = a._targets ? "yellow" : "green", 
            this.strokeRect(e - 1, i - 1, r + 2, s + 2, 1), this.strokeRect(e, i, r, s, 1), 
            this.restore());
            ...
            if (pt.fillRectImgVb(u, this._clipRect, e, i, r, s, l || F.DEF_UV, a || this._curMat, this._x, this._y, 0, 0)) {
                this._renderKey = 0, this._shader2D.glTexture = null, this._curSubmit.shaderValue;
                var _ = this._curSubmit = _t.create(this, this._ib, u, (u._byteLength - 64) / 32 * 3, h, n);
                _.blendType = -1 == o ? this._nBlendType : o, _.scope = t, this._submits[this._submits._length++] = _, 
                this._curSubmit._numEle += 6;
            }
            ...
            if (!t.loaded || !t.source) return this.sprite && i.timer.callLater(this, this._repaintSprite), 
            !1;
            this._drawCount++, t.bitmap;
            var c = this._mixRGBandAlpha(4294967295, o), f = (a.length, h.length);
            this._renderKey = -1;
            ...
            return d.shaderValue.textureHost = t, d._renderType = 10016, this._submits[this._submits._length++] = d, 
            l ? (e._tmpMatrix.a = l.a, e._tmpMatrix.b = l.b, e._tmpMatrix.c = l.c, e._tmpMatrix.d = l.d, 
            e._tmpMatrix.tx = l.tx + r, e._tmpMatrix.ty = l.ty + s, b.mul(e._tmpMatrix, this._curMat, e._tmpMatrix)) : (e._tmpMatrix.a = this._curMat.a, 
            e._tmpMatrix.b = this._curMat.b, e._tmpMatrix.c = this._curMat.c, e._tmpMatrix.d = this._curMat.d, 
            e._tmpMatrix.tx = this._curMat.tx + r, e._tmpMatrix.ty = this._curMat.ty + s), this._triangleMesh.addData(a, n, h, e._tmpMatrix, c, this), 
            this._curSubmit._numEle += f, this._maxNumEle = Math.max(this._maxNumEle, this._curSubmit._numEle), 
            !0;
        }, h.transform = function(t, e, i, r, s, a) {
            Z.save(this), b.mul(b.TEMP.setTo(t, e, i, r, s, a), this._curMat, this._curMat), 
            ...
            if (0 != this._curMat.b || 0 != this._curMat.c) {
                ...
                var a = this._vb, n = a._byteLength >> 2;
                ...
                var o = a.getFloat32Array(), u = Math.min(Math.min(Math.min(o[n + 0], o[n + 4]), o[n + 8]), o[n + 12]), _ = Math.max(Math.max(Math.max(o[n + 0], o[n + 4]), o[n + 8]), o[n + 12]), c = Math.min(Math.min(Math.min(o[n + 1], o[n + 5]), o[n + 9]), o[n + 13]), f = Math.max(Math.max(Math.max(o[n + 1], o[n + 5]), o[n + 9]), o[n + 13]);
                K.save(this, l, t, e, i, r, u, c, _ - u, f - c), this._curSubmit = at.RENDERBASE;
            } else {
                i *= this._curMat.a, r *= this._curMat.d;
                var d = y.TEMP;
                this._curMat.transformPoint(d.setTo(t, e)), i < 0 && (d.x = d.x + i, i = -i), r < 0 && (d.y = d.y + r, 
                r = -r), this._renderKey = 0;
                var m = this._curSubmit = ot.create(this);
                this._submits[this._submits._length++] = m, m.submitIndex = this._submits._length, 
                m.submitLength = 9999999, X.save(this, m);
                var p = this._clipRect, g = p.x, v = p.y, x = d.x + i, b = d.y + r;
                g < d.x && (p.x = d.x), v < d.y && (p.y = d.y), p.width = Math.min(x, g + p.width) - p.x, 
                p.height = Math.min(b, v + p.height) - p.y, this._shader2D.glTexture = null, m.clipRect.copyFrom(p), 
                this._curSubmit = at.RENDERBASE;
            }
            ...
            a || (a = b.EMPTY), a.translate(t, e), b.mul(a, this._curMat, c._mat), a.translate(-t, -e), 
            this._submits[this._submits._length++] = c, this._curSubmit = at.RENDERBASE, this._renderKey = 0;
        }, h.addRenderObject = function(t) {
            this._submits[this._submits._length++] = t;
        }, h.fillTrangles = function(t, e, i, r, s) {
            var a = this._curSubmit, n = this._vb, h = this._shader2D, l = a.shaderValue, o = r.length >> 4, u = t.bitmap;
            this._renderKey = 0, h.glTexture == u && h.ALPHA === l.ALPHA || ((a = this._curSubmit = at.createSubmit(this, this._ib, n, n._byteLength / 32 * 3, Et.create(1, 0))).shaderValue.textureHost = t, 
            this._submits[this._submits._length++] = a), pt.fillTranglesVB(n, e, i, r, s || this._curMat, this._x, this._y), 
            a._numEle += 6 * o;
            ...
            this._triangleMesh = Ft.getAMesh(), this.meshlist.push(this._triangleMesh), this._submits._length;
            ...
            if (this.lineWidth > 0) {
                ...
                t.update();
                var i = [ this.mX, this.mY ], r = at.createShape(this, t.ib, t.vb, t.count, t.offset, Et.create(4, 0));
                r.shaderValue.ALPHA = this._shader2D.ALPHA, r.shaderValue.u_pos = i, r.shaderValue.u_mmat2 = vt.TEMPMAT4_ARRAY, 
                this._submits[this._submits._length++] = r, this._renderKey = -1;
            }
            ...
            if (pt.fillLineVb(h, this._clipRect, t, e, i, r, s, a)) {
                ...
                l.strokeStyle === o.strokeStyle && l.ALPHA === o.ALPHA || (l.glTexture = null, (n = this._curSubmit = at.createSubmit(this, this._ib, h, (h._byteLength - 64) / 32 * 3, Et.create(2, 0))).shaderValue.strokeStyle = l.strokeStyle, 
                n.shaderValue.mainID = 2, n.shaderValue.ALPHA = l.ALPHA, this._submits[this._submits._length++] = n), 
                n._numEle += 6;
            }
            ...
            if (-1 == this.mId || !this.mHaveKey) {
                var n = 0, h = 0, l = 0, o = this._getPath();
                this._curMat.copyTo(e._tmpMatrix), e._tmpMatrix.tx = e._tmpMatrix.ty = 0, e._tempPoint.setTo(o.getEndPointX(), o.getEndPointY()), 
                e._tmpMatrix.invertTransformPoint(e._tempPoint);
                var u = e._tempPoint.x - t, _ = e._tempPoint.y - i, c = Math.sqrt(u * u + _ * _);
                if (!(c <= 1e-6)) {
                    var f = u / c, d = _ / c, m = r - t, p = s - i, g = m * m + p * p, v = Math.sqrt(g);
                    if (!(v <= 1e-6)) {
                        var x = m / v, b = p / v, y = f + x, T = d + b, A = Math.sqrt(y * y + T * T);
                        if (!(A <= 1e-6)) {
                            var E = y / A, S = T / A, w = Math.acos(E * f + S * d), R = Math.PI / 2 - w, I = (c = a / Math.tan(R)) * f + t, M = c * d + i, C = Math.sqrt(c * c + a * a), L = t + E * C, P = i + S * C, D = 0, F = 0, B = 0;
                            if (f * b - d * x >= 0) {
                                var N = (D = 2 * R) / e.SEGNUM;
                                F = Math.sin(N), B = Math.cos(N);
                            } else N = (D = 2 * -R) / e.SEGNUM, F = Math.sin(N), B = Math.cos(N);
                            h = this._curMat.a * I + this._curMat.c * M, l = this._curMat.b * I + this._curMat.d * M, 
                            h == this._path.getEndPointX() && l == this._path.getEndPointY() || o.addPoint(h, l);
                            var O = I - L, V = M - P;
                            for (n = 0; n < e.SEGNUM; n++) {
                                var U = O * B + V * F, k = -O * F + V * B;
                                h = U + L, l = k + P, t = this._curMat.a * h + this._curMat.c * l, l = i = this._curMat.b * h + this._curMat.d * l, 
                                (h = t) == this._path.getEndPointX() && l == this._path.getEndPointY() || o.addPoint(h, l), 
                                O = U, V = k;
                            }
                        }
                    }
            ...
            var l = 0, o = 0, u = 0, _ = 0, c = 0, f = 0, d = 0, m = 0;
            if (o = s - r, a) if (Math.abs(o) >= 2 * Math.PI) o = 2 * -Math.PI; else for (;o > 0; ) o -= 2 * Math.PI; else if (Math.abs(o) >= 2 * Math.PI) o = 2 * Math.PI; else for (;o < 0; ) o += 2 * Math.PI;
            u = o / (m = i < 101 ? Math.max(10, o * i / 5) : i < 201 ? Math.max(10, o * i / 20) : Math.max(10, o * i / 40)) / 2, 
            _ = Math.abs(4 / 3 * (1 - Math.cos(u)) / Math.sin(u)), a && (_ = -_);
            var p = this._getPath(), g = NaN, v = NaN;
            for (d = 0; d <= m; d++) l = r + o * (d / m), c = t + Math.cos(l) * i, f = e + Math.sin(l) * i, 
            n && (g = c, v = f, c = this._curMat.a * g + this._curMat.c * v, f = this._curMat.b * g + this._curMat.d * v), 
            c == this._path.getEndPointX() && f == this._path.getEndPointY() || p.addPoint(c, f);
            c = t + Math.cos(s) * i, f = e + Math.sin(s) * i, n && (g = c, v = f, c = this._curMat.a * g + this._curMat.c * v, 
            f = this._curMat.b * g + this._curMat.d * v), c == this._path.getEndPointX() && f == this._path.getEndPointY() || p.addPoint(c, f);
        }, h.quadraticCurveTo = function(t, e, i, r) {
            var s = l.I, a = i, n = r;
            i = this._curMat.a * a + this._curMat.c * n, r = this._curMat.b * a + this._curMat.d * n, 
            a = t, n = e, t = this._curMat.a * a + this._curMat.c * n, e = this._curMat.b * a + this._curMat.d * n;
            ...
            var a = .5 * s;
            this.line(t - a, e, t + i + a, e, s, this._curMat), this.line(t + i, e, t + i, e + r, s, this._curMat), 
            this.line(t, e, t, e + r, s, this._curMat), this.line(t - a, e + r, t + i + a, e + r, s, this._curMat);
        }, h.clip = function() {}, h.drawPoly = function(t, e, i, r, s, a, n) {
            void 0 === n && (n = !1), this._renderKey = 0, this._shader2D.glTexture = null;
            var h = this._getPath();
            if (-1 == this.mId) h.polygon(t, e, i, r, s || 1, a); else if (this.mHaveKey) {
            ...
            if (u = at.createShape(this, h.ib, h.vb, h.count, h.offset, Et.create(4, 0)), u.shaderValue.ALPHA = this._shader2D.ALPHA, 
            u.shaderValue.u_pos = _, u.shaderValue.u_mmat2 = vt.EMPTYMAT4_ARRAY, this._submits[this._submits._length++] = u, 
            s > 0) {
                ...
                h.update(), (u = at.createShape(this, h.ib, h.vb, h.count, h.offset, Et.create(4, 0))).shaderValue.ALPHA = this._shader2D.ALPHA, 
                u.shaderValue.u_mmat2 = vt.EMPTYMAT4_ARRAY, this._submits[this._submits._length++] = u;
            }
            ...
            this._other.font === dt.EMPTY ? this._other.font = new dt(t) : this._other.font.setFont(t));
        }), e.__init__ = function() {
            n.DEFAULT = new n();
        }, e._tempPoint = new y(), e._SUBMITVBSIZE = 32e3, e._MAXSIZE = 99999999, e._RECTVBSIZE = 16, 
        e.MAXCLIPRECT = new T(0, 0, 99999999, 99999999), e._COUNT = 0, e._tmpMatrix = new b(), 
        e.SEGNUM = 32, e._contextcount = 0, r(e, [ "_fontTemp", function() {
        ...
        function e(t, i) {
            ...
            e.__super.call(this), this.defines = new It(), this.position = e._POSITION, this.mainID = t, 
        ...
        return i.setValue = function(t) {}, i.refresh = function() {
            var t = this.size;
            return t[0] = vt.width, t[1] = vt.height, this.alpha = this.ALPHA * vt.worldAlpha, 
            this.mmat = vt.worldMatrix4, this;
            ...
            var t = vt.worldShaderDefines, e = Qt.sharders[this.mainID | this.defines._value | t.getValue()];
            if (!e) {
                var i, r, s = {};
            ...
            var t = vt;
            this.alpha = this.ALPHA * t.worldAlpha, vt.worldMatrix4 !== vt.TEMPMAT4_ARRAY && this.defines.add(128), 
            ...
            this.size[0] = t.width, this.size[1] = t.height, this.mmat = t.worldMatrix4, Bt.activeShader !== i ? (i._shaderValueWidth !== t.width || i._shaderValueHeight !== t.height ? (i._shaderValueWidth = t.width, 
            ...
            e._POSITION = [ 2, 5126, !1, 4 * mt.BYTES_PE, 0 ], e._TEXCOORD = [ 2, 5126, !1, 4 * mt.BYTES_PE, 2 * mt.BYTES_PE ], 
            e._initone(2, Ut), e._initone(4, Gt), e._initone(256, kt), e._initone(512, Vt), 
            e._initone(1, Ht), e._initone(65, qt), e._initone(9, Ht);
        ...
        return i.onCreate = function(t) {
            ...
            var a, n, h = this._next, l = t.mask;
            if (l) {
                i.ctx.save();
                var o = i.ctx.globalCompositeOperation, u = new T();
                ...
                u.x = Math.round(u.x), u.y = Math.round(u.y), u.width > 0 && u.height > 0) {
                    var _ = t._style._tf, c = ht.create();
                    c.addValue("bounds", u), a = nt.create([ c, i ], laya.webgl.utils.RenderSprite3D.tmpTarget), 
                    i.addRenderObject(a), l.render(i, -u.x, -u.y), a = nt.create([ c ], laya.webgl.utils.RenderSprite3D.endTmpTarget), 
                    i.addRenderObject(a), i.ctx.save(), i.clipRect(r - _.translateX + u.x, s - _.translateY + u.y, u.width, u.height), 
                    h._fun.call(h, t, i, r, s), i.ctx.restore(), n = ut.create(6), o = i.ctx.globalCompositeOperation, 
                    n.blendMode = "mask", i.addRenderObject(n), b.TEMP.identity();
                    var f = Et.create(1, 0), d = F.INV_UV, m = u.width, p = u.height;
                    (u.width < 32 || u.height < 32) && ((d = e.tempUV)[0] = 0, d[1] = 0, d[2] = u.width >= 32 ? 1 : u.width / 32, 
                    d[3] = 0, d[4] = u.width >= 32 ? 1 : u.width / 32, d[5] = u.height >= 32 ? 1 : u.height / 32, 
                    d[6] = 0, d[7] = u.height >= 32 ? 1 : u.height / 32, u.width = u.width >= 32 ? u.width : 32, 
                    u.height = u.height >= 32 ? u.height : 32, d[1] *= -1, d[3] *= -1, d[5] *= -1, d[7] *= -1, 
                    d[1] += 1, d[3] += 1, d[5] += 1, d[7] += 1), i.ctx.drawTarget(c, r + u.x - _.translateX, s + u.y - _.translateY, m, p, b.TEMP, "tmpTarget", f, d, 6), 
                    a = nt.create([ c ], laya.webgl.utils.RenderSprite3D.recycleTarget), i.addRenderObject(a), 
                    (n = ut.create(6)).blendMode = o, i.addRenderObject(n);
                }
                i.ctx.restore();
            } else h._fun.call(h, t, i, r, s);
        }, i._blend = function(t, e, i, r) {
            var s = t._style, a = this._next;
            s.blendMode ? (e.ctx.save(), e.ctx.globalCompositeOperation = s.blendMode, a._fun.call(a, t, e, i, r), 
            e.ctx.restore()) : a._fun.call(a, t, e, i, r);
        }, i._transform = function(t, e, i, r) {
            var s = t.transform, a = this._next;
            if (s && a != E.NORENDER) {
                var n = e.ctx;
                t._style, s.tx = i, s.ty = r;
                var h = n._getTransformMatrix(), l = h.clone();
                b.mul(s, h, h), h._checkTransform(), s.tx = s.ty = 0, a._fun.call(a, t, e, 0, 0), 
                l.copyTo(h), l.destroy();
            } else a._fun.call(a, t, e, i, r);
        }, e.tmpTarget = function(t, e) {
            var i = t.getValue("bounds"), r = Nt.create(i.width, i.height);
        ...
        return i.imps(r, {
            ...
            var a = t.getValue("bounds"), n = Et.create(1, 0);
        ...
        function e(t, i, r, s, a) {
            ...
            this._atlasCanvas = new zt(), this._atlasCanvas._atlaser = this, this._atlasCanvas.width = r, 
        ...
        return i.computeUVinAtlasTexture = function(t, e, i, r) {
            var s = k.atlasTextureWidth, a = k.atlasTextureHeight, n = i / s, h = r / a, l = (i + t.bitmap.width) / s, o = (r + t.bitmap.height) / a, u = t.bitmap.width / s, _ = t.bitmap.height / a;
            ...
            if (t instanceof laya.webgl.resource.WebGLImage) {
                var e = t, i = e.url, r = this._InAtlasWebGLImagesKey[i || e.id];
            ...
            var r = t.uv.slice(), s = t.bitmap;
            this._inAtlasTextureKey.push(t), this._inAtlasTextureOriUVValue.push(r), this._inAtlasTextureBitmapValue.push(s), 
        ...
        return i.rebuild = function(t) {
            ...
            for (var i = NaN, r = NaN, s = -1, a = -1, n = t.length / 2, h = 0; h < n; h++) i = t[2 * h], 
            r = t[2 * h + 1], (Math.abs(s - i) > .01 || Math.abs(a - r) > .01) && this._points.push(i, r), 
            s = i, a = r;
        }, i.getData = function(t, e, i) {
            var r = [], s = [];
            this.borderWidth > 0 && this.createLine2(this._points, r, this.borderWidth, i, s, this._points.length / 2), 
            this.mUint16Array.set(r, 0), this.mFloat32Array.set(s, 0), t.append(this.mUint16Array), 
            e.append(this.mFloat32Array);
        }, e;
    }()), Ct = function(t) {
        function e(t, i, r, s, a) {
            this._points = [];
            for (var n = NaN, h = NaN, l = -1, o = -1, u = r.length / 2 - 1, _ = 0; _ < u; _++) n = r[2 * _], 
        ...
        return i.getData = function(t, e, i) {
            if (this.borderWidth > 0) {
                for (var r = this.color, s = (r >> 16 & 255) / 255, a = (r >> 8 & 255) / 255, n = (255 & r) / 255, h = [], l = 0, o = 0, u = [], _ = Math.floor(this._points.length / 2), c = 0; c < _; c++) l = this._points[2 * c], 
                o = this._points[2 * c + 1], h.push(this.x + l, this.y + o, s, a, n);
            ...
            t.length;
            var n = t.concat(), h = s || t, l = this.borderColor, o = (l >> 16 & 255) / 255, u = (l >> 8 & 255) / 255, _ = (255 & l) / 255, c = [ n[0], n[1] ], f = [ n[n.length - 5], n[n.length - 4] ], d = f[0] + .5 * (c[0] - f[0]), m = f[1] + .5 * (c[1] - f[1]);
            n.unshift(d, m, 0, 0, 0), n.push(d, m, 0, 0, 0);
            var p, g, v, x, b, y, T, A, E, S, w, R, I, M, C, L, P, D, F, B, N = n.length / 5, O = r, V = i / 2;
            v = n[0], x = n[1], S = v - (b = n[5]), E = (E = -(x - (y = n[6]))) / (B = Math.sqrt(E * E + S * S)) * V, 
            S = S / B * V, h.push(v - E, x - S, o, u, _, v + E, x + S, o, u, _);
        ...
        function e(t, i, r, s, a, n) {
            ...
            this._mat = b.create(), this._points = r.slice(0, r.length), e.__super.call(this, t, i, 0, 0, this._points.length / 2, s, a, n);
        }
        ...
        return i.rebuild = function(t) {
            ...
            if (this.mUint16Array && this.mFloat32Array && this._repaint) {
                ...
                this._start = i, r = [];
                var h = [], l = [], o = this.color, u = (o >> 16 & 255) / 255, _ = (o >> 8 & 255) / 255, c = (255 & o) / 255;
                for (n = Math.floor(a.length / 2), s = 0; s < n; s++) h.push(this.x + a[2 * s], this.y + a[2 * s + 1], u, _, c), 
                l.push(this.x + a[2 * s], this.y + a[2 * s + 1]);
                for (this.earcutTriangles = rt.earcut(l, null, 2), n = this.earcutTriangles.length, 
                s = 0; s < n; s++) r.push(this.earcutTriangles[s] + i);
        ...
        function e() {
            this._matrix = new b(), this._matrix4 = mt.defaultMatrix4.concat(), e.__super.call(this, 1e4), 
        ...
        return i.renderSubmit = function() {
            ...
            1;
            var t = vt.worldAlpha, e = vt.worldMatrix4, i = vt.worldMatrix, r = vt.worldFilters, s = vt.worldShaderDefines, a = this.shaderValue, n = this._matrix, h = this._matrix4, l = b.TEMP;
            return b.mul(n, i, l), h[0] = l.a, h[1] = l.b, h[4] = l.c, h[5] = l.d, h[12] = l.tx, 
            h[13] = l.ty, vt.worldMatrix = l.clone(), vt.worldMatrix4 = h, vt.worldAlpha = vt.worldAlpha * a.alpha, 
            a.filters && a.filters.length && (vt.worldFilters = a.filters, vt.worldShaderDefines = a.defines), 
            this._ctx_src.flush(), vt.worldAlpha = t, vt.worldMatrix4 = e, vt.worldMatrix.destroy(), 
            vt.worldMatrix = i, vt.worldFilters = r, vt.worldShaderDefines = s, 1;
        ...
        return i.releaseRender = function() {
            ...
            if (this._texs.length < 1) this._isSameTexture = !0; else {
                ...
                if (null !== t) for (var e = this._vb.getFloat32Array(), i = 0, r = this._texs.length; i < r; i++) {
                    var s = this._texs[i];
                    s.active();
                    var a = s.uv;
                    if (this._texsID[i] !== s._uvID) {
                        ...
                        var n = this._vbPos[i];
                        e[n + 2] = a[0], e[n + 3] = a[1], e[n + 6] = a[2], e[n + 7] = a[3], e[n + 10] = a[4], 
                        e[n + 11] = a[5], e[n + 14] = a[6], e[n + 15] = a[7], this._vb.setNeedUpload();
                    }
            ...
            if (G.activeBlendFunction !== this._blendFn && (r.enable(3042), this._blendFn(r), 
            G.activeBlendFunction = this._blendFn), C.drawCall++, C.trianglesFaces += this._numEle / 3, 
            this._preIsSameTextureShader && Bt.activeShader && e._shaderSet ? Bt.activeShader.uploadTexture2D(this.shaderValue.texture) : this.shaderValue.upload(), 
            e._shaderSet = !0, this._texs.length > 1 && !this._isSameTexture) for (var s = t.bitmap, a = 0, n = Bt.activeShader, h = 0, l = this._texs.length; h < l; h++) {
                var o = this._texs[h];
                o.bitmap === s && h + 1 !== l || (n.uploadTexture2D(o.source), r.drawElements(4, 6 * (h - a + 1), 5123, this._startIdx + 6 * a * mt.BYTES_PIDX), 
                s = o.bitmap, a = h);
        ...
        return i.addData = function(t, i, r, s, a, n) {
            for (var h = t.length / 2, l = this._vb.needSize(h * e.const_stride) >> 2, o = this._vb.getFloat32Array(), u = 0, _ = 0; _ < h; _++) {
                var c = t[u], f = t[u + 1], d = c * s.a + f * s.c + s.tx, m = c * s.b + f * s.d + s.ty;
            ...
            if (p > 0) {
                var g = r.length;
                g > e.tmpIdx.length && (e.tmpIdx = new Uint16Array(g));
                for (var v = 0; v < g; v++) e.tmpIdx[v] = r[v] + p;
        ...
        return s(e, "laya.webgl.shader.BaseShader", S), e.activeShader = null, e.bindShader = null, 
        e;
    }(), Nt = function(t) {
        function e(t, i, r, s, a, n, h, l, o) {
            ...
            this._magFifter = 0, this._destroy = !1, void 0 === r && (r = 6408), void 0 === s && (s = 5121), 
            void 0 === a && (a = 34041), void 0 === n && (n = !1), void 0 === h && (h = !1), 
            void 0 === l && (l = -1), void 0 === o && (o = -1), this._type = 1, this._w = t, 
            this._h = i, this._surfaceFormat = r, this._surfaceType = s, this._depthStencilFormat = a, 
            A.isConchWebGL && 34041 === this._depthStencilFormat && (this._depthStencilFormat = 33189), 
            this._mipMap = n, this._repeat = h, this._minFifter = l, this._magFifter = o, this._createWebGLRenderTarget(), 
            this.bitmap.lock = !0, e.__super.call(this, this.bitmap, F.INV_UV);
        }
        ...
        return i.imps(r, {
            ...
            var t = bt.mainContext;
            return this._preRenderTarget = vt.curRenderTarget, vt.curRenderTarget = this, t.bindFramebuffer(36160, this.bitmap.frameBuffer), 
            this._alreadyResolved = !1, 1 == this._type && (t.viewport(0, 0, this._w, this._h), 
            this._svWidth = vt.width, this._svHeight = vt.height, vt.width = this._w, vt.height = this._h, 
            Bt.activeShader = null), this;
            ...
            this._alreadyResolved = !0, vt.curRenderTarget = this._preRenderTarget, 1 == this._type ? (t.viewport(0, 0, this._svWidth, this._svHeight), 
            vt.width = this._svWidth, vt.height = this._svHeight, Bt.activeShader = null) : t.viewport(0, 0, i.stage.width, i.stage.height);
        }, r.getData = function(t, e, i, r) {
            var s = bt.mainContext;
            if (s.bindFramebuffer(36160, this.bitmap.frameBuffer), 36053 !== s.checkFramebufferStatus(36160)) return s.bindFramebuffer(36160, null), 
            null;
            var a = new Uint8Array(this._w * this._h * 4);
            return s.readPixels(t, e, i, r, this._surfaceFormat, this._surfaceType, a), s.bindFramebuffer(36160, null), 
            a;
            ...
            var u = e.POOL.pop();
            return u || (u = new e(t, i)), u.bitmap && u._w == t && u._h == i && u._surfaceFormat == r && u._surfaceType == s && u._depthStencilFormat == a && u._mipMap == n && u._repeat == h && u._minFifter == l && u._magFifter == o || (u._w = t, 
            u._h = i, u._surfaceFormat = r, u._surfaceType = s, u._depthStencilFormat = a, A.isConchWebGL && 34041 === u._depthStencilFormat && (u._depthStencilFormat = 33189), 
            u._mipMap = n, u._repeat = h, u._minFifter = l, u._magFifter = o, u.release(), u._createWebGLRenderTarget()), 
            u;
        }, e.TYPE2D = 1, e.TYPE3D = 2, e.POOL = [], e;
    }(F), Ot = function(t) {
        function e() {
            this._glBuffer = null, this._buffer = null, this._bufferType = 0, this._bufferUsage = 0, 
            this._byteLength = 0, e.__super.call(this), e._gl = bt.mainContext;
        }
        ...
        return s(e, "laya.webgl.shader.d2.value.Color2dSV", Et), e.prototype.setValue = function(t) {
        ...
        function e(t) {
            ...
            this.u_TexRange = [ 0, 1, 0, 1 ], this.u_offset = [ 0, 0 ], this.texcoord = Et._TEXCOORD, 
        ...
        function e(t) {
            ...
            this.colorAlpha = null, this.texcoord = Et._TEXCOORD, void 0 === t && (t = 0), e.__super.call(this, 1, t);
        }
        ...
        function e(t) {
            this.a_color = null, this.u_pos = [ 0, 0 ], e.__super.call(this, 4, 0), this.position = [ 2, 5126, !1, 5 * mt.BYTES_PE, 0 ], 
        ...
        return i.recreateResource = function() {
            var t = bt.mainContext, e = this._source = t.createTexture(), i = yt.curBindTexTarget, r = yt.curBindTexValue;
            yt.bindTexture(t, 3553, e), t.texImage2D(3553, 0, 6408, this._w, this._h, 0, 6408, 5121, null), 
            t.texParameteri(3553, 10241, 9729), t.texParameteri(3553, 10240, 9729), t.texParameteri(3553, 10242, 33071), 
            t.texParameteri(3553, 10243, 33071), i && r && yt.bindTexture(t, i, r), this.memorySize = this._w * this._h * 4, 
            this.completeCreate();
        }, i.disposeResource = function() {
            this._source && (bt.mainContext.deleteTexture(this._source), this._source = null, 
            this.memorySize = 0);
            ...
            if (A.isFlash) {
                ...
                var s = bt.mainContext, a = yt.curBindTexTarget, n = yt.curBindTexValue;
                yt.bindTexture(s, 3553, this._source), A.isConchWebGL ? (i !== ConchTextCanvas && (t - 1 >= 0 && s.texSubImage2DEx(!0, 3553, 0, t - 1, e, 6408, 5121, i), 
                ...
                s.texSubImage2D(3553, 0, t, e, 6408, 5121, i), s.pixelStorei(37441, !1)), a && n && yt.bindTexture(s, a, n);
            }
        }, i.texSubImage2DPixel = function(t, e, i, r, s) {
            var a = bt.mainContext, n = yt.curBindTexTarget, h = yt.curBindTexValue;
            yt.bindTexture(a, 3553, this._source);
            var l = new Uint8Array(s.data);
            A.isConchWebGL ? a.texSubImage2DEx(!0, 3553, 0, t, e, i, r, 6408, 5121, l) : (a.pixelStorei(37441, !0), 
            a.texSubImage2D(3553, 0, t, e, i, r, 6408, 5121, l), a.pixelStorei(37441, !1)), 
        ...
        return i.getCanvas = function() {
            ...
            this.iscpuSource = !1;
            var r = yt.curBindTexTarget, s = yt.curBindTexValue;
            yt.bindTexture(t, 3553, i), t.pixelStorei(37440, this.flipY ? 1 : 0), A.isConchWebGL ? t.texImage2DEx(e.premulAlpha, 3553, 0, 6408, 6408, 5121, this._imgData) : (e.premulAlpha && t.pixelStorei(37441, !0), 
            ...
            var i = yt.curBindTexTarget, r = yt.curBindTexValue;
            yt.bindTexture(t, 3553, this._source), A.isConchWebGL ? t.texImage2DEx(e.premulAlpha, 3553, 0, 6408, 6408, 5121, this._imgData) : (e.premulAlpha && t.pixelStorei(37441, !0), 
            t.texImage2D(3553, 0, 6408, 6408, 5121, this._imgData), e.premulAlpha && t.pixelStorei(37441, !1)), 
            t.pixelStorei(37440, 0), i && r && yt.bindTexture(t, i, r);
        }, i.texSubImage2D = function(t, e, i) {
            var r = bt.mainContext, s = yt.curBindTexTarget, a = yt.curBindTexValue;
            yt.bindTexture(r, 3553, this._source), A.isConchWebGL ? r.texSubImage2DEx(!0, 3553, 0, e, i, 6408, 5121, t._source) : (r.pixelStorei(37441, !0), 
            r.texSubImage2D(3553, 0, e, i, 6408, 5121, t._source), r.pixelStorei(37441, !1)), 
        ...
        function e(t, i) {
            ...
            s ? ((r = ConchTextCanvas)._source = ConchTextCanvas, r._source.canvas = ConchTextCanvas) : r = u.canvas.source, 
            this.canvas = r, this._enableMerageInAtlas = !0, this._ctx = s ? r : this.canvas.getContext("2d", void 0);
            var a = B.measureText(this.char, this.font);
            this.cw = a.width * this.xs, this.ch = (a.height || this.fontSize) * this.ys, this.onresize(this.cw + 2 * this.CborderSize, this.ch + 2 * this.CborderSize), 
        ...
        return i.imps(r, {
            ...
            this.canvas && (this.canvas.height = this._h, this.canvas.width = this._w), t) {
                ...
                r = r.replace(e._fontSizeReg, i), this.borderColor && (r += " 1 " + this.borderColor), 
                this._ctx.font = r, this._ctx.textBaseline = "top", this._ctx.fillStyle = this.fillColor, 
                this._ctx.fillText(this.char, this.CborderSize, this.CborderSize, null, null, null);
            } else {
                if (this._ctx.save(), this._ctx.lineJoin = "round", this._ctx.clearRect(0, 0, this.cw + 2 * this.CborderSize, this.ch + 2 * this.CborderSize), 
        ...
        function e(t, i, r, s, a, n, h, l, o) {
            void 0 === r && (r = 6408), void 0 === s && (s = 5121), void 0 === a && (a = 34041), 
            void 0 === n && (n = !1), void 0 === h && (h = !1), void 0 === l && (l = -1), void 0 === o && (o = 1), 
            e.__super.call(this), this._w = t, this._h = i, this._surfaceFormat = r, this._surfaceType = s, 
            this._depthStencilFormat = a, A.isConchWebGL && 34041 === this._depthStencilFormat && (this._depthStencilFormat = 33189), 
            this._mipMap = n, this._repeat = h, this._minFifter = l, this._magFifter = o;
        }
        ...
        return i.recreateResource = function() {
            ...
            var e = yt.curBindTexTarget, i = yt.curBindTexValue;
            yt.bindTexture(t, 3553, this._source), t.texImage2D(3553, 0, 6408, this._w, this._h, 0, this._surfaceFormat, this._surfaceType, null);
            var r = this._minFifter, s = this._magFifter, a = this._repeat ? 10497 : 33071, n = h.isPOT(this._w, this._h);
            if (n ? (this._mipMap ? -1 !== r || (r = 9987) : -1 !== r || (r = 9729), -1 !== s || (s = 9729), 
            t.texParameteri(3553, 10241, r), t.texParameteri(3553, 10240, s), t.texParameteri(3553, 10242, a), 
            t.texParameteri(3553, 10243, a), this._mipMap && t.generateMipmap(3553)) : (-1 !== r || (r = 9729), 
            -1 !== s || (s = 9729), t.texParameteri(3553, 10241, r), t.texParameteri(3553, 10240, s), 
            ...
            t.bindFramebuffer(36160, null), e && i && yt.bindTexture(t, e, i), t.bindRenderbuffer(36161, null), 
            n && this._mipMap ? this.memorySize = this._w * this._h * 4 * (1 + 1 / 3) : this.memorySize = this._w * this._h * 4, 
            this.completeCreate();
        }, i.disposeResource = function() {
            this._frameBuffer && (bt.mainContext.deleteTexture(this._source), bt.mainContext.deleteFramebuffer(this._frameBuffer), 
            bt.mainContext.deleteRenderbuffer(this._depthStencilBuffer), this._source = null, 
        ...
        function e(t, i, r, s, a, n, h) {
            ...
            this.offsetY = r, this.src = h, this._enableMerageInAtlas = !0, k.enabled && this._w < k.atlasLimitWidth && this._h < k.atlasLimitHeight ? this._allowMerageInAtlas = !0 : this._allowMerageInAtlas = !1;
        }
        ...
        return i.imps(r, {
            ...
            var e = this._source = t.createTexture(), i = yt.curBindTexTarget, r = yt.curBindTexValue;
            yt.bindTexture(t, 3553, e), A.isConchWebGL ? t.texImage2DEx(!0, 3553, 0, 6408, 6408, 5121, this.canvas) : (t.pixelStorei(37441, !0), 
            t.texImage2D(3553, 0, 6408, 6408, 5121, this.canvas), t.pixelStorei(37441, !1));
            var s = this.minFifter, a = this.magFifter, n = this.repeat ? 10497 : 33071, l = h.isPOT(this.width, this.height);
            l ? (this.mipmap ? -1 !== s || (s = 9987) : -1 !== s || (s = 9729), -1 !== a || (a = 9729), 
            t.texParameteri(3553, 10240, a), t.texParameteri(3553, 10241, s), t.texParameteri(3553, 10242, n), 
            t.texParameteri(3553, 10243, n), this.mipmap && t.generateMipmap(3553)) : (-1 !== s || (s = 9729), 
            -1 !== a || (a = 9729), t.texParameteri(3553, 10241, s), t.texParameteri(3553, 10240, a), 
            t.texParameteri(3553, 10242, 33071), t.texParameteri(3553, 10243, 33071)), i && r && yt.bindTexture(t, i, r), 
            this.canvas = null, l && this.mipmap ? this.memorySize = this._w * this._h * 4 * (1 + 1 / 3) : this.memorySize = this._w * this._h * 4;
        }, r.disposeResource = function() {
            k.enabled && this._allowMerageInAtlas || !this._source || (bt.mainContext.deleteTexture(this._source), 
            this._source = null, this.memorySize = 0);
        }, r.clearAtlasSource = function() {}, a(0, r, "allowMerageInAtlas", function() {
            return this._allowMerageInAtlas;
        }), a(0, r, "atlasSource", function() {
        ...
        return i.recreateResource = function() {
            ...
            if (this._vs && this._ps && !this._params) {
                ...
                var t = [ this._vs, this._ps ], i = bt.mainContext;
                ...
                i.attachShader(this._program, this._pshader), i.linkProgram(this._program), !A.isConchApp && !i.getProgramParameter(this._program, 35714)) throw i.getProgramInfoLog(this._program);
                var r, s = 0, a = 0, n = 0;
                for (n = A.isConchApp ? i.getProgramParameterEx(this._vs, this._ps, "", 35721) : i.getProgramParameter(this._program, 35721), 
                s = 0; s < n; s++) {
                    var h = null;
                    r = {
                        vartype: "attribute",
                ...
                var l = 0;
                for (l = A.isConchApp ? i.getProgramParameterEx(this._vs, this._ps, "", 35718) : i.getProgramParameter(this._program, 35718), 
                s = 0; s < l; s++) {
                    var o = null;
                    o = A.isConchApp ? i.getActiveUniformEx(this._vs, this._ps, "", s) : i.getActiveUniform(this._program, s), 
                    (r = {
                        vartype: "uniform",
                        glfun: null,
                        ivartype: 1,
                ...
                for (s = 0, a = this._params.length; s < a; s++) if (r = this._params[s], r.indexOfParams = s, 
                r.index = 1, r.value = [ r.location, null ], r.codename = r.name, r.name = this._nameMap[r.codename] ? this._nameMap[r.codename] : r.codename, 
                this._paramsMap[r.name] = r, r._this = this, r.uploadedValue = [], "attribute" !== r.vartype) switch (r.type) {
                  case 5124:
            ...
            var i = bt.mainContext, r = Ot._enableAtributes, s = t.location;
            return r[s] || i.enableVertexAttribArray(s), i.vertexAttribPointer(s, e[0], e[1], e[2], e[3], e[4] + this._offset), 
            r[s] = Ot._bindVertexBuffer, 1;
            ...
            var r = bt.mainContext, s = t.uploadedValue;
            return null == s[0] ? (s[0] = this._curActTexIndex, r.uniform1i(t.location, this._curActTexIndex), 
            r.activeTexture(e._TEXTURES[this._curActTexIndex]), yt.bindTexture(r, 3553, i), 
            this._curActTexIndex++, 1) : (r.activeTexture(e._TEXTURES[s[0]]), yt.bindTexture(r, 3553, i), 
            0);
        }, i._uniform_samplerCube = function(t, i) {
            var r = bt.mainContext, s = t.uploadedValue;
            return null == s[0] ? (s[0] = this._curActTexIndex, r.uniform1i(t.location, this._curActTexIndex), 
            r.activeTexture(e._TEXTURES[this._curActTexIndex]), yt.bindTexture(r, 34067, i), 
            this._curActTexIndex++, 1) : (r.activeTexture(e._TEXTURES[s[0]]), yt.bindTexture(r, 34067, i), 
            0);
            ...
            Bt.activeShader = Bt.bindShader = this, this._lastUseFrameCount === C.loopCount || this.activeResource(), 
            yt.UseProgram(this._program), this._reCompile ? (e = this._params, this._reCompile = !1) : e = e || this._params, 
            bt.mainContext;
            ...
            this._params;
            for (var r, s, a = 0, n = e - 2; n >= 0; n -= 2) (s = this._paramsMap[t[n]]) && null != (r = t[n + 1]) && (i && i[s.name] && i[s.name].bind(), 
        ...
        e.sharders.length = 32, e.sharders), r(e, [ "nameKey", function() {
        ...
        return i.needSize = function(t) {
            ...
            this._maxsize = Math.max(this._maxsize, this._byteLength), C.loopCount % 30 == 0 && (this._buffer.byteLength > this._maxsize + 64 && (this.memorySize = this._buffer.byteLength, 
            ...
            C.loopCount % 30 == 0 && (this._buffer.byteLength > this._maxsize + 64 && (this.memorySize = this._buffer.byteLength, 
            this._buffer = this._buffer.slice(0, this._maxsize + 64), this._checkArrayUse()), 
            this._maxsize = this._byteLength), this._uploadSize < this._buffer.byteLength && (this._uploadSize = this._buffer.byteLength, 
            Ot._gl.bufferData(this._bufferType, this._uploadSize, this._bufferUsage), this.memorySize = this._uploadSize), 
            e || i) {
        ...
        function e(t, i, r, s) {
            ...
            this._shaderValueHeight = NaN, e.__super.call(this, t, i, r, s);
        }
        ...
        function e(t) {
            ...
            e.__super.call(this), this._bufferUsage = t, this._bufferType = 34963, A.isFlash || (this._buffer = new ArrayBuffer(8));
        }
        ...
        function e(t, i) {
            ...
            this._bufferUsage = i, this._bufferType = 34962, A.isFlash || (this._buffer = new ArrayBuffer(8)), 
        ...
        function e(t, i, r, s) {
            ...
            this.repeat = !1, this._image = null, this.minFifter = 0, this.magFifter = 0, void 0 === r && (r = 6408), 
            void 0 === s && (s = !0), e.__super.call(this, t, i), this._format = r, this._mipmap = s, 
            ...
            t && (this._image.src = t); else if (t instanceof ArrayBuffer) {
                ...
                var a = new _(t);
                a.readUTFBytes(4), a.readUTFBytes(2), a.getInt16(), a.endian = "bigEndian", this._w = a.getInt16(), 
                this._h = a.getInt16(), a.getInt16(), a.getInt16(), this._image = new Uint8Array(t, a.pos), 
                this._format = bt.compressEtc1.COMPRESSED_RGB_ETC1_WEBGL, k.enabled && this._w < k.atlasLimitWidth && this._h < k.atlasLimitHeight ? this._allowMerageInAtlas = !0 : this._allowMerageInAtlas = !1;
        ...
        return i.imps(r, {
            ...
            var s = this.minFifter, a = this.magFifter, n = this.repeat ? 10497 : 33071, l = h.isPOT(this._w, this._h);
            l ? (this.mipmap ? -1 !== s || (s = 9987) : -1 !== s || (s = 9729), -1 !== a || (a = 9729), 
            t.texParameteri(3553, 10241, s), t.texParameteri(3553, 10240, a), t.texParameteri(3553, 10242, n), 
            t.texParameteri(3553, 10243, n), this.mipmap && t.generateMipmap(3553)) : (-1 !== s || (s = 9729), 
            -1 !== a || (a = 9729), t.texParameteri(3553, 10241, s), t.texParameteri(3553, 10240, a), 
            t.texParameteri(3553, 10242, 33071), t.texParameteri(3553, 10243, 33071)), i && r && yt.bindTexture(t, i, r), 
            this._image.onload = null, this._image = null, l && this.mipmap ? this.memorySize = this._w * this._h * 4 * (1 + 1 / 3) : this.memorySize = this._w * this._h * 4, 
            ...
            this._recreateLock && (this._needReleaseAgain = !0), this._source && (bt.mainContext.deleteTexture(this._source), 
