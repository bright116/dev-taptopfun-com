function strEnc(r, e, a, n) {
    var t, s, o, c, f, i, m = r.length,
        u = "";
    if (null != e && "" != e && (c = (t = getKeyBytes(e)).length), null != a && "" != a && (f = (s = getKeyBytes(a)).length),
        null != n && "" != n && (i = (o = getKeyBytes(n)).length), m > 0)
        if (m < 4) {
            var l = strToBt(r);
...
function strDec(r, e, a, n) {
    var t, s, o, c, f, i, m = r.length,
        u = "";
    null != e && "" != e && (c = (t = getKeyBytes(e)).length), null != a && "" != a && (f = (s = getKeyBytes(a)).length),
        null != n && "" != n && (i = (o = getKeyBytes(n)).length);
    var l = parseInt(m / 16),
        b = 0;
    for (b = 0; b < l; b++) {
        ...
        if (null != e && "" != e && null != a && "" != a && null != n && "" != n) {
            for (g = v, A = i - 1; A >= 0; A--) g = dec(g, o[A]);
            for (B = f - 1; B >= 0; B--) g = dec(g, s[B]);
            for (x = c - 1; x >= 0; x--) g = dec(g, t[x]);
            k = g;
        } else if (null != e && "" != e && null != a && "" != a) {
            for (g = v, A = f - 1; A >= 0; A--) g = dec(g, s[A]);
            for (B = c - 1; B >= 0; B--) g = dec(g, t[B]);
            k = g;
        } else if (null != e && "" != e) {
            var g, A, B, x;
            for (g = v, A = c - 1; A >= 0; A--) g = dec(g, t[A]);
            k = g;
        }
        u += byteToString(k);
    }
