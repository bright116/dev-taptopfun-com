! function(t, e, i) {
    var a = (i.un, i.uns, i["static"]),
        ...
        y = (laya.renders.Render, laya.resource.Resource),
        x = (laya.media.SoundChannel,
            laya.media.SoundManager),
        g = laya.display.Sprite,
        v = laya.utils.Stat,
        M = laya.resource.Texture,
        D = (laya.resource.Texture2D,
            laya.utils.Timer, laya.net.URL, laya.utils.Utils),
        I = function() {
            function t() {
            ...
            return e.getDisplayByName = function(t) {
                for (var e, i = 0, a = this.displayArr.length; a > i; i++)
                    if (e = this.displayArr[i],
                ...
                for (var t, e = this.target.resultMatrix.a, i = this.target.resultMatrix.b, a = this.target.resultMatrix.c, r = this.target.resultMatrix.d, s = 0, n = this._bones.length; n > s; s++) {
                    ...
                    if (this.translateMix && (this._temp[0] = this._data.offsetX, this._temp[1] = this._data.offsetY,
                        ...
                        var d = Math.sqrt(t.resultMatrix.a * t.resultMatrix.a + t.resultMatrix.c * t.resultMatrix.c),
                            f = Math.sqrt(e * e + a * a),
                            m = d > 1e-5 ? (d + (f - d + this._data.offsetScaleX) * this.scaleMix) / d : 0;
            ...
            return r(t, "laya.ani.AnimationParser01"), t.parse = function(t, e) {
                ...
                for (m > 0 && (t._publicExtData = i.slice(m, i.byteLength)), t._useParent = !!e.getUint8(),
                    ...
                    for (x.totalKeyframeDatasLength = 0, r = 0; v > r; r++) {
                        ...
                        M.childs = [];
                        var D = e.getInt16();
                        D >= 0 && (M.name = p[D], x.bone3DMap[M.name] = r), M.keyFrame = new Array(), M.parentIndex = e.getInt16(), -1 == M.parentIndex ? M.parent = null : M.parent = x.nodes[M.parentIndex], M.lerpType = e.getUint8();
                        var I = e.getUint32();
                        y.pos = I;
                        var A = M.keyframeWidth = y.getUint16();
                        if (x.totalKeyframeDatasLength += A, 0 === M.lerpType || 1 === M.lerpType)
                            for (M.interpolationMethod = [],
        ...
        U = function() {
            ...
            return e.apply = function() {
                ...
                var s = e.parentBone,
                    n = 1 / (s.resultMatrix.a * s.resultMatrix.d - s.resultMatrix.b * s.resultMatrix.c),
                ...
                if (0 != h) {
                    ...
                    var T = 1 / (M * A - D * I),
                        S = r - N.resultMatrix.tx,
                        C = s - N.resultMatrix.ty,
                        F = (S * A - C * D) * T - l,
                        w = (C * M - S * I) * T - o;
                    ...
                    var rt = Math.atan2(y, m) * f,
                        st = e.resultTransform.skX;
                ...
                if (void 0 === i && (i = 1), t += .05, !(this.timeList.length <= 0)) {
                    ...
                    if (!(r > t)) {
                        var s = this.vectices[0].length,
                            n = [],
                            h = this.binarySearch1(this.timeList, t);
                        if (this.frameIndex = h, t >= this.timeList[this.timeList.length - 1]) {
                            var l = this.vectices[this.vectices.length - 1];
                            if (1 > i)
                                for (a = 0; s > a; a++) n[a] += (l[a] - n[a]) * i;
                            else
                                for (a = 0; s > a; a++) n[a] = l[a];
                            return void(this.deformData = n);
                        }
                        var o = (this.tweenKeyList[this.frameIndex], this.vectices[this.frameIndex - 1]),
        ...
        O = function() {
            ...
            return e.showSlotData = function(t, e) {
                ...
                if (t.useSameMatrixAndVerticle && this._preGraphicMatrix && t.isSameMatrix(e, this._preGraphicMatrix)) e = this._preGraphicMatrix;
                else {
                    var i = e.clone();
                ...
                var n, h, l, o = this.currDisplayData.weights,
        ...
        Y = function() {
            ...
            return e.apply = function(t, e) {
                ...
                var h = (t.currDisplayData.bones, t.currDisplayData.weights, t.currDisplayData.triangles, []),
                    ...
                    D = NaN,
                    I = NaN;
                if (d) o += 2, _[o - 2] = _[0], _[o - 1] = _[1];
                else {
                    if (f--, o -= 4, this.computeWorldVertices2(t, e, 2, o, h, 0), this._debugKey)
                ...
                for (l = 0, x = 0, g = 0, W = 0; a > l; l++, x += 3) {
                    if (M = c[l], u += M, v = u, d) v %= y, 0 > v && (v += y), g = 0;
                    else {
                        if (0 > v) {
        ...
        W = function() {
            ...
            return r(t, "laya.ani.math.BezierLerp"), t.getBezierRate = function(e, i, a, r, s) {
                ...
                var l = t._getBezierPoints(i, a, r, s, n),
                    o = 0,
                    u = 0;
                for (u = l.length, o = 0; u > o; o += 2)
                    if (e <= l[o]) return t._bezierResultCache[h] = l[o + 1],
                        l[o + 1];
        ...
        G = function() {
            ...
            return e.setTempMatrix = function(t) {
                ...
                var e;
                if (t) e = this.resultTransform.getMatrix(), f.mul(e, t, this.resultMatrix), this.resultRotation = this.rotation;
                    ...
                    if (this.inheritRotation && this.inheritScale) e = this.resultTransform.getMatrix(),
                        f.mul(e, this.parentBone.resultMatrix, this.resultMatrix);
                    else {
                ...
                var e, i, a = 0,
                    r = 0;
                for (a = 0, r = this._children.length; r > a; a++)
        ...
        $ = function(t) {
            ...
            return i.parse = function(t) {
                    ...
                    a[e] = a[0];
                    for (var r = 0; e > r; r++)
                        for (var s = a[r], n = 0; i > n; n++) s.dData[n] = 0 === s.duration ? 0 : (a[r + 1].data[n] - s.data[n]) / s.duration,
                    ...
                    var l = 0;
                    if (h > 0) {
                        for (i += .01, l = a + 1; r > l; l++)
                            if (s = t[l], s.startTime <= i && s.startTime + s.duration > i) return this._boneCurKeyFrm[e] = l,
                                l;
                        return r - 1;
                    }
                    for (l = 0; a > l; l++)
        ...
        j = (function(t) {
            ...
            return a.init = function(t, e) {
                ...
                var i = 0,
                    a = 0;
                if (1 == e)
                    for (this._graphicsCache = [], i = 0, a = t.getAnimationCount(); a > i; i++) this._graphicsCache.push([]);
                ...
                if (t.tfArr.length > 0)
                    for (this._tfArr = [], i = 0, a = t.tfArr.length; a > i; i++) this._tfArr.push(new T(t.tfArr[i], this._boneList));
                ...
                if (i && this._eventIndex < i.length)
                    for (; this._eventIndex < i.length; this._eventIndex++) t = i[this._eventIndex],
                ...
                var a = this._templet.eventAniArr,
                    r = a[this._player.currentAnimationClipIndex];
                if (r) {
                    var s, n = 0,
                        h = 0;
                ...
                var e, i = t * this._player.cacheFrameRateInterval,
                    a = this._templet.drawOrderAniArr,
                    r = a[this._aniClipIndex];
                if (r && r.length > 0)
                    for (this._drawOrderIndex = 0, e = r[this._drawOrderIndex]; i >= e.time && (this._drawOrder = e.drawOrder,
                ...
                var l, u, c, _, p = this._aniSectionDic[this._aniClipIndex],
                    d = 0,
                    m = 0,
                    y = 0,
                    x = 0,
                ...
                if (this._pathDic) {
                    var S;
                    for (g += p[3]; g > m; m++)
                        if (I = n[m], S = this._pathDic[I.name]) {
                ...
                if (this._pathDic)
                    for (var w in this._pathDic) S = this._pathDic[w], S.apply(this._boneList, s);
                if (this._tfArr) {
                    var k;
                    for (m = 0, x = this._tfArr.length; x > m; m++) k = this._tfArr[m], k.apply();
                }
                for (m = 0, x = this._boneList.length; x > m; m++)
                    if (_ = this._boneList[m], u = this._bindBoneBoneSlotDic[_.name],
                        _.resultMatrix.copyTo(this._boneMatrixArray[m]), u)
                        for (y = 0, g = u.length; g > y; y++) l = u[y],
                ...
                var V, E, O;
                if (this._drawOrder)
                    for (m = 0, g = this._drawOrder.length; g > m; m++) l = this._boneSlotArray[this._drawOrder[m]],
                        ...
                        isNaN(E) ? l.draw(s, this._boneMatrixArray, 2 == this._aniMode) : l.draw(s, this._boneMatrixArray, 2 == this._aniMode, E), !isNaN(E);
                else
                    for (m = 0, g = this._boneSlotArray.length; g > m; m++) l = this._boneSlotArray[m],
                        V = A[l.name], E = b[l.name], !isNaN(E), isNaN(V) || -2 == V || (this._templet.attachmentNames ? l.showDisplayByName(this._templet.attachmentNames[V]) : l.showDisplayByIndex(V)),
                ...
                if (t) {
                    var r, s, n, h = 0,
                        ...
                        o = 0;
                    if (t)
                        for (h = 0, l = t.deformSlotDataList.length; l > h; h++)
                ...
                if (1 == this._aniMode)
                    for (var t = 0, e = this._graphicsCache.length; e > t; t++) {
                ...
                if (o = e ? 2147483647 : 0, "string" == typeof t)
                    for (var u = 0, c = this._templet.getAnimationCount(); c > u; u++) {
                ...
                if (!this._pause) {
                    if (this._pause = !0, this._player && (this._player.paused = !0), this._soundChannelArr.length > 0)
                        for (var t, e = this._soundChannelArr.length, i = 0; e > i; i++) t = this._soundChannelArr[i],
                            t.isStopped || t.pause();
                    this.timer.clear(this, this._update);
                }
            }, a.resume = function() {
        ...
        J = function(t) {
            ...
            return a.loadAni = function(t) {
                    ...
                    var n, h, l = new o(this.getPublicExtData()),
                        ...
                        A = D.split("\n");
                    for (t = 0; v > t; t++) {
                        if (n = this._mainTexture, h = this._path + A[2 * t], D = A[2 * t + 1], null == this._mainTexture && (n = this._textureDic[h]), !n) return this.event("error", this), void(this.isParseFail = !0);
                    ...
                    var W, H = l.getUint16(),
                        Q = Math.floor(H / this.tMatrixDataLen),
                    ...
                    for (t = 0; yt > t; t++) {
                        ...
                        for (var vt = 0; xt > vt; vt++)
                            for (ht = new R(), ht.skinName = l.getUTFString(),
                                gt[ht.skinName] = ht, ct = l.getInt16(), e = 0; ct > e; e++)
                                for (lt = new F(),
                                    ht.deformSlotDataList.push(lt), _t = l.getInt16(), i = 0; _t > i; i++)
                                    for (ot = new E(),
                                        lt.deformSlotDisplayList.push(ot), ot.slotIndex = pt = l.getInt16(), ot.attachment = nt = l.getUTFString(),
                                        dt = l.getInt16(), a = 0; dt > a; a++)
                                        for (1 == l.getByte() ? ot.tweenKeyList.push(!0) : ot.tweenKeyList.push(!1),
                                            ft = l.getFloat32(), ot.timeList.push(ft), ut = [], ot.vectices.push(ut), mt = l.getInt16(),
                                            r = 0; mt > r; r++) ut.push(l.getFloat32());
                    }
                    var Mt, Dt, It = l.getInt16(),
                        At = 0,
                        bt = 0;
                    for (t = 0; It > t; t++) {
                    ...
                    var Ft = l.getInt16();
                    if (Ft > 0)
                        for (this.attachmentNames = [], t = 0; Ft > t; t++) this.attachmentNames.push(l.getUTFString());
                    ...
                    var Ut, Bt, Lt, Rt = l.readUTFString(),
                        Vt = Rt.split("\n"),
                        Et = 0,
                        Ot = l.getUint8(),
                        Yt = 0,
                        ...
                        for (Ut = new P(), Ut.name = Vt[Et++], Yt = l.getUint8(), e = 0; Yt > e; e++) {
                            for (Bt = new I(), Bt.name = Vt[Et++], wt = this.boneSlotDic[Bt.name], Kt = l.getUint8(),
                                ...
                                if (Lt = new V(), this.skinSlotDisplayDataArr.push(Lt), Lt.name = Vt[Et++], Lt.attachmentName = Vt[Et++],
                                    ...
                                    L > 0)
                                    for (Lt.bones = [], a = 0; L > a; a++) {
                                        var Ht = l.getUint16();
                                        Lt.bones.push(Ht);
                                    }
                                if (Xt = l.getUint16(), Xt > 0)
                                    for (Lt.uvs = [], a = 0; Xt > a; a++) Lt.uvs.push(l.getFloat32());
                                if (Wt = l.getUint16(), Wt > 0)
                                    for (Lt.weights = [], a = 0; Wt > a; a++) Lt.weights.push(l.getFloat32());
                                if (Gt = l.getUint16(), Gt > 0)
                                    for (Lt.triangles = [], a = 0; Gt > a; a++) Lt.triangles.push(l.getUint16());
                                if (zt = l.getUint16(), zt > 0)
                                    for (Lt.vertices = [], a = 0; zt > a; a++) Lt.vertices.push(l.getFloat32());
                                if (qt = l.getUint16(), qt > 0)
                                    for (Lt.lengths = [], a = 0; qt > a; a++) Lt.lengths.push(l.getFloat32());
                            }
                            Ut.slotArr.push(Bt);
                        }
                    ...
                    for (var e, i = 0, a = this.skinDataArray.length; a > i; i++)
                        if (e = this.skinDataArray[i],
                            e.name == t) return i;
                    return -1;
