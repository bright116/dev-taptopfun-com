!function () {
    ...
    class platform {
        ...
        addGameList1(){
            ...
            prefab.json   = json;
            if (this.appList1 == null) {
                this.appList1 = prefab.create();
                this.appList1.zOrder = 10000;
                console.log("appList",this.appList1);
                
    
                platform.getInstance().initList(this.appList1);
            } 

            if (this.appList1.parent == null) {
                Laya.stage.addChild(this.appList1);
            }
        }
