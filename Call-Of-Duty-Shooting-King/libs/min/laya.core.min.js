...
function(r, e, b) {
    ...
    var h = b.static,
        ...
        u = b.getset;
    b.__newvec;
    b.interface("laya.runtime.IMarket"), b.interface("laya.filters.IFilter"), b.interface("laya.display.ILayout"), b.interface("laya.resource.IDispose"), b.interface("laya.runtime.IPlatform"), b.interface("laya.resource.IDestroy"), b.interface("laya.runtime.IConchNode"), b.interface("laya.filters.IFilterAction"), b.interface("laya.runtime.ICPlatformClass"), b.interface("laya.resource.ICreateResource"), b.interface("laya.runtime.IConchRenderObject"), b.interface("laya.runtime.IPlatformClass", "laya.runtime.IPlatform");
    var A = (p(o, "laya.utils.RunDriver"), o.FILTER_ACTIONS = [], o.pixelRatio = -1, o._charSizeTestDiv = null, o.now = function() {
        return Date.now()
        ...
        if (o.pixelRatio < 0) {
            ...
            (o.pixelRatio = (Q.window.devicePixelRatio || 1) / e) < 1 && (o.pixelRatio = 1)
        }
        return o.pixelRatio
    }, o.getIncludeStr = function(t) {
        return null
    }, o.createShaderCondition = function(t) {
        var e = "(function() {return " + t + ";})";
        return b._runScript(e)
    }, o.fontMap = [], o.measureText = function(t, e) {
        var i = o.hanzi.test(t);
        if (i && o.fontMap[e]) return o.fontMap[e];
        var n = Q.context;
        n.font = e;
        var s = n.measureText(t);
        return i && (o.fontMap[e] = s), s
    }, o.getWebGLContext = function(t) {}, o.beginFlush = function() {}, o.endFinish = function() {}, o.addToAtlas = null, o.flashFlushImage = function(t) {}, o.drawToCanvas = function(t, e, i, n, s, r) {
        var o = Ht.create("2D"),
            a = new X(i, n, o);
        return $.renders[e]._fun(t, a, s, r), o
    }, o.createParticleTemplate2D = null, o.createGLTextur = null, o.createWebGLContext2D = null, o.changeWebGLSize = function(t, e) {}, o.createRenderSprite = function(t, e) {
        return new $(t, e)
    ...
    }, o.cancelLoadByUrl = function(t) {}, o.clearAtlas = function(t) {}, o.isAtlas = function(t) {
        return !1
    }, o.addTextureToAtlas = function(t) {}, o.getTexturePixels = function(t, e, i, n, s) {
        return null
    }, o.skinAniSprite = function() {
        return null
    }, o.update3DLoop = function() {}, h(o, ["hanzi", function() {
        return this.hanzi = new RegExp("^[一-龥]$")
    }]), o);

    function o() {}
    u(1, b, "alertGlobalError", null, function(t) {
        var r = 0;
        ...
        if (!b._isinit) {
            ArrayBuffer.prototype.slice || (ArrayBuffer.prototype.slice = b._arrayBufferSlice), b._isinit = !0, Q.__init__(), j.__init__(), _.__init__(), b.timer = new gt, b.scaleTimer = new gt, b.loader = new Lt, xt.__init__(), s = 0;
            for (var o = n.length; s < o; s++) n[s].enable && n[s].enable();
            return d.__init__(), a.__init__(), K.__init__(), tt.beginCheck(), b._currentStage = b.stage = new Ut, b.stage.conchModel && b.stage.conchModel.setRootNode(), b._getUrlPath(), b.render = new V(0, 0), b.stage.size(t, e), $.__init__(), m.__init__(), x.instance.__init__(b.stage, V.canvas), Xt.__init__(), N.autoStopMusic = !0, W.__init__(), V.canvas
        }
    }, b._getUrlPath = function() {
        var t = Q.window.location,
            e = t.pathname;
        e = ":" == e.charAt(2) ? e.substring(1) : e, Y.rootPath = Y.basePath = Y.getPath("file:" == t.protocol ? e : t.protocol + "//" + t.host + t.pathname)
    }, b._arrayBufferSlice = function(t, e) {
        var i = new Uint8Array(this, t, e - t),
            n = new Uint8Array(i.length);
        return n.set(i), n.buffer
    }, b._runScript = function(t) {
        return Q.window[b._evcode](t)
    }, b.stage = null, b.timer = null, b.scaleTimer = null, b.loader = null, b.version = "1.8.5", b.render = null, b._currentStage = null, b._isinit = !1, b.MiniAdpter = {
        init: function() {
    ...
    var g = (p(t, "Config"), t.WebGLTextCacheCount = 500, t.atlasEnable = !1, t.showCanvasMark = !1, t.animationInterval = 50, t.isAntialias = !1, t.isAlpha = !1, t.premultipliedAlpha = !0, t.isStencil = !0, t.preserveDrawingBuffer = !1, t.useRetinalCanvas = !1, t.CborderSize = 12, t);
    ...
    var l = function() {
            ...
            p(e, "laya.events.EventDispatcher");
            var t = e.prototype;
            return t.hasListener = function(t) {
                ...
                Object.defineProperty(laya.events.EventDispatcher.prototype, "_events", {
                    enumerable: !1,
                    writable: !0
                }), p(s, "", v), s.prototype.recover = function() {
            ...
            return e.loadFont = function(t, e) {
                ...
                if (null != t && null != e) {
                    ...
                    for (r = 0; r < n.length; r++) {
                        ...
                        var _ = Dt.create(e, c.x, c.y, c.width, c.height, h, l);
        ...
        n = (p(i, "laya.display.css.TransformInfo"), i);
    ...
    var _ = function() {
            function c() {
                if (this._one = null, this._cmds = null, this._render = this._renderEmpty, V.isConchNode) {
                    this._nativeObj = new r._conchGraphics, this.id = this._nativeObj.conchID
                }
            }
            p(c, "laya.display.Graphics");
            var t = c.prototype;
            return t.destroy = function() {
                ...
                if (t) {
                    var n = this._one;
                    if (this._cmds) {
                        for (i = this._cmds.length, e = 0; e < i; e++) !(n = this._cmds[e]) || n.callee !== V._context._drawTexture && n.callee !== V._context._drawTextureWithTransform || (n[0] = null, c._cache.push(n));
                        this._cmds.length = 0
                    } else n && (!n || n.callee !== V._context._drawTexture && n.callee !== V._context._drawTextureWithTransform || (n[0] = null, c._cache.push(n)))
                ...
                this._graphicBounds || (this._graphicBounds = new s, this._graphicBounds._graphics = this)
            }, t._repaint = function() {
                ...
                if (void 0 === n && (n = 0), void 0 === s && (s = 0), void 0 === r && (r = "repeat"), t) {
                    var a = [t, e, i, n, s, r, o || k.EMPTY, {}];
                    t.loaded || t.once("loaded", this, this._textureLoaded, [t, a]), this._saveToCmd(V._context._fillTexture, a)
                }
                ...
                void 0 === a && (a = 1), this._saveToCmd(V._context.drawTriangles, [t, e, i, n, s, r, o, a, h, l])
                ...
                void 0 === o && (o = 0), this._saveToCmd(V._context._fillText, [t, e, i, n || d.defaultFont, s, r])
            }, t.fillBorderText = function(t, e, i, n, s, r, o, a) {
                this._saveToCmd(V._context._fillBorderText, [t, e, i, n || d.defaultFont, s, r, o, a])
            }, t.strokeText = function(t, e, i, n, s, r, o) {
                this._saveToCmd(V._context._strokeText, [t, e, i, n || d.defaultFont, s, r, o])
            }, t.alpha = function(t) {
                t = t < 0 ? 0 : 1 < t ? 1 : t, this._saveToCmd(V._context._alpha, [t])
            }, t.setAlpha = function(t) {
                t = t < 0 ? 0 : 1 < t ? 1 : t, this._saveToCmd(V._context._setAlpha, [t])
            }, t.transform = function(t, e, i) {
                void 0 === e && (e = 0), void 0 === i && (i = 0), this._saveToCmd(V._context._transform, [t, e, i])
            }, t.rotate = function(t, e, i) {
                void 0 === e && (e = 0), void 0 === i && (i = 0), this._saveToCmd(V._context._rotate, [t, e, i])
            }, t.scale = function(t, e, i, n) {
                void 0 === i && (i = 0), void 0 === n && (n = 0), this._saveToCmd(V._context._scale, [t, e, i, n])
                ...
                this._saveToCmd(V._context._drawLine, h)
            }, t.drawLines = function(t, e, i, n, s) {
                void 0 === s && (s = 1);
                var r = 0;
                if (i && !(i.length < 4)) {
                    V.isWebGL && (r = wt.getInstance().getId(), null == this._vectorgraphArray && (this._vectorgraphArray = []), this._vectorgraphArray.push(r));
                    var o = s % 2 == 0 ? 0 : .5,
                        a = [t + o, e + o, i, n, s, r];
                    this._saveToCmd(V._context._drawLines, a)
                }
            }, t.drawCurves = function(t, e, i, n, s) {
                void 0 === s && (s = 1);
                var r = [t, e, i, n, s];
                this._saveToCmd(V._context._drawCurves, r)
            }, t.drawRect = function(t, e, i, n, s, r, o) {
                void 0 === o && (o = 1);
                var a = r ? o / 2 : 0,
                    h = r ? o : 0,
                    l = [t + a, e + a, i - h, n - h, s, r, o];
                this._saveToCmd(V._context._drawRect, l)
            }, t.drawCircle = function(t, e, i, n, s, r) {
                void 0 === r && (r = 1);
                var o = s ? r / 2 : 0,
                    a = 0;
                V.isWebGL && (a = wt.getInstance().getId(), null == this._vectorgraphArray && (this._vectorgraphArray = []), this._vectorgraphArray.push(a));
                var h = [t, e, i - o, n, s, r, a];
                this._saveToCmd(V._context._drawCircle, h)
            }, t.drawPie = function(t, e, i, n, s, r, o, a) {
                void 0 === a && (a = 1);
                var h = o ? a / 2 : 0,
                    l = o ? a : 0,
                    u = 0;
                V.isWebGL && (u = wt.getInstance().getId(), null == this._vectorgraphArray && (this._vectorgraphArray = []), this._vectorgraphArray.push(u));
                ...
                this._saveToCmd(V._context._drawPoly, l)
            }, t.drawPath = function(t, e, i, n, s) {
                var r = [t, e, i, n, s];
                this._saveToCmd(V._context._drawPath, r)
            }, u(0, t, "cmds", function() {
                return this._cmds
            }, function(t) {
                ...
                if (V.isConchNode) {
                    for (var t = laya.display.Graphics.prototype, e = Q.window.ConchGraphics.prototype, i = ["clear", "destroy", "alpha", "rotate", "transform", "scale", "translate", "save", "restore", "clipRect", "blendMode", "fillText", "fillBorderText", "_fands", "drawRect", "drawCircle", "drawPie", "drawPoly", "drawPath", "drawImageM", "drawLine", "drawLines", "_drawPs", "drawCurves", "replaceText", "replaceTextColor", "_fillImage", "fillTexture", "setSkinMesh", "drawParticle", "drawImageS"], n = 0, s = i.length; n <= s; n++) {
                        var r = i[n];
                        t[r] = e[r]
                    }
                    t._saveToCmd = null, e.drawImageS && (t.drawTextures = function(t, e) {
                            ...
                            if (t.loaded) {
                                if (t.loaded && t.bitmap && t.source && (n || (n = t.sourceWidth), s || (s = t.sourceHeight), o = o < 0 ? 0 : 1 < o ? 1 : o, n = n - t.sourceWidth + t.width, s = s - t.sourceHeight + t.height, !(n <= 0 || s <= 0))) {
                                    ...
                                    var a = t.uv,
                                        h = t.bitmap.width,
                                        l = t.bitmap.height;
                                    a[4] < a[0] && a[5] < a[1] ? this.drawImageM(t.bitmap.source, a[4] * h, a[5] * l, (a[0] - a[4]) * h, (a[1] - a[5]) * l, e, i, n, s, r, o) : this.drawImageM(t.bitmap.source, a[0] * h, a[1] * l, (a[2] - a[0]) * h, (a[5] - a[3]) * l, e, i, n, s, r, o), this._repaint()
                                }
                        ...
                        if (void 0 === n && (n = 0), void 0 === s && (s = 0), void 0 === r && (r = "repeat"), t && t.loaded) {
                            var a, h = V._context.ctx,
                                l = t.bitmap.width,
                                u = t.bitmap.height,
                                c = t.uv;
                            a = t.uv != Dt.DEF_UV ? h.createPattern(t.bitmap.source, r, c[0] * l, c[1] * u, (c[2] - c[0]) * l, (c[5] - c[3]) * u) : h.createPattern(t.bitmap.source, r);
                            var _ = 0,
                                d = 0;
        ...
        s = function() {
            ...
            p(y, "laya.display.GraphicsBounds");
            var t = y.prototype;
            return t.destroy = function() {
                ...
                for (var o, a, h = y._tempMatrix, l = NaN, u = NaN, c = NaN, _ = NaN, d = NaN, f = NaN, p = 0, g = s.length; p < g; p++)
                    if ((o = s[p]).callee) switch (o.callee) {
                        ...
                        case 16:
                        case 24:
                            y._addPointArrToRst(e, O._getBoundPointS(o[0], o[1], o[2], o[3]), r);
                            break;
                        case 17:
                            r.copyTo(h), h.concat(o[4]), y._addPointArrToRst(e, O._getBoundPointS(o[0], o[1], o[2], o[3]), h);
                            break;
                        case n._drawTexture:
                            a = o[0], t ? o[3] && o[4] ? y._addPointArrToRst(e, O._getBoundPointS(o[1], o[2], o[3], o[4]), r) : (a = o[0], y._addPointArrToRst(e, O._getBoundPointS(o[1], o[2], a.width, a.height), r)) : (l = (o[3] || a.sourceWidth) / a.width, u = (o[4] || a.sourceHeight) / a.height, c = l * a.sourceWidth, _ = u * a.sourceHeight, d = 0 < a.offsetX ? a.offsetX : 0, f = 0 < a.offsetY ? a.offsetY : 0, d *= l, f *= u, y._addPointArrToRst(e, O._getBoundPointS(o[1] - d, o[2] - f, c, _), r));
                            break;
                        case n._fillTexture:
                            o[3] && o[4] ? y._addPointArrToRst(e, O._getBoundPointS(o[1], o[2], o[3], o[4]), r) : (a = o[0], y._addPointArrToRst(e, O._getBoundPointS(o[1], o[2], a.width, a.height), r));
                            break;
                        case n._drawTextureWithTransform:
                            var m;
                            m = o[5] ? (r.copyTo(h), h.concat(o[5]), h) : r, t ? o[3] && o[4] ? y._addPointArrToRst(e, O._getBoundPointS(o[1], o[2], o[3], o[4]), m) : (a = o[0], y._addPointArrToRst(e, O._getBoundPointS(o[1], o[2], a.width, a.height), m)) : (a = o[0], l = (o[3] || a.sourceWidth) / a.width, u = (o[4] || a.sourceHeight) / a.height, c = l * a.sourceWidth, _ = u * a.sourceHeight, d = 0 < a.offsetX ? a.offsetX : 0, f = 0 < a.offsetY ? a.offsetY : 0, d *= l, f *= u, y._addPointArrToRst(e, O._getBoundPointS(o[1] - d, o[2] - f, c, _), m));
                            break;
                        case n._drawRect:
                        case 13:
                            y._addPointArrToRst(e, O._getBoundPointS(o[0], o[1], o[2], o[3]), r);
                        ...
                        case n._fillCircle:
                        case 14:
                            y._addPointArrToRst(e, O._getBoundPointS(o[0] - o[2], o[1] - o[2], o[2] + o[2], o[2] + o[2]), r);
                            break;
                        case n._drawLine:
                        case 20:
                        ...
                        case n._drawCurves:
                        case 22:
                            y._addPointArrToRst(e, E.I.getBezierPoints(o[2]), r, o[0], o[1]);
                            break;
                        case n._drawPoly:
                        case n._drawLines:
                        case 18:
                ...
                return 200 < e.length ? e = vt.copyArray(e, O._getWrapRec(e)._getBoundPoints()) : 8 < e.length && (e = I.scanPList(e)), e
    ...
    var m = (p(y, "laya.events.KeyBoardManager"), y.__init__ = function() {
        ...
        if (y.enabled) {
            ...
            for (var i = b.stage.focus && null != b.stage.focus.event && b.stage.focus.displayedInStage ? b.stage.focus : b.stage, n = i; n;) n.event(e, y._event.setTo(e, n, i)), n = n.parent
        }
    }, y.hasKeyDown = function(t) {
        return y._pressKeys[t]
    }, y._pressKeys = {}, y.enabled = !0, h(y, ["_event", function() {
        return this._event = new c
    }]), y);

    function y() {}
    p(w, "laya.events.KeyLocation"), w.STANDARD = 0, w.LEFT = 1, w.RIGHT = 2, w.NUM_PAD = 3;

    function w() {}
    var x = function() {
            function u() {
                this.mouseX = 0, this.mouseY = 0, this.disableMouseEvent = !1, this.mouseDownTime = 0, this.mouseMoveAccuracy = 2, this._stage = null, this._target = null, this._lastMoveTimer = 0, this._isLeftMouse = !1, this._eventList = [], this._touchIDs = {}, this._id = 1, this._tTouchID = 0, this._event = new c, this._matrix = new F, this._point = new k, this._rect = new O, this._prePoint = new k, this._curTouchID = NaN
            }
            p(u, "laya.events.MouseManager");
            var t = u.prototype;
            return t.__init__ = function(t, e) {
                ...
                e.oncontextmenu = function(t) {
                    ...
                    u.enabled && (Q.onIE || t.preventDefault(), s.push(t), n.mouseDownTime = Q.now())
                }), e.addEventListener("mouseup", function(t) {
                    u.enabled && (t.preventDefault(), s.push(t), n.mouseDownTime = -Q.now())
                    ...
                    u.enabled && (s.push(t), u._isFirstTouch || Xt.isInputting || t.preventDefault(), n.mouseDownTime = Q.now())
                }), e.addEventListener("touchend", function(t) {
                    u.enabled ? (u._isFirstTouch || Xt.isInputting || t.preventDefault(), u._isFirstTouch = !1, s.push(t), n.mouseDownTime = -Q.now()) : i._curTouchID = NaN
                ...
                for (var e = T.I.getLastOvers(), i = 0, n = e.length; i < n; i++) {
                    var s = e[i];
                    s.event("mousewheel", this._event.setTo("mousewheel", s, this._target))
                }
            }, t.onMouseMove = function(t) {
                T.I.onMouseMove(t, this._tTouchID)
                ...
                T.I.onMouseDown(t, this._tTouchID, this._isLeftMouse)
            }, t.onMouseUp = function(t) {
                T.I.onMouseUp(t, this._tTouchID, this._isLeftMouse)
        ...
        T = function() {
            function f() {
                this.preOvers = [], this.preDowns = [], this.preRightDowns = [], this.enable = !0, this._lastClickTime = 0, this._event = new c
            }
            p(f, "laya.events.TouchManager");
            var t = f.prototype;
            return t._clearTempArrs = function() {
                ...
                var i;
                return (i = _t.getItem("TouchData") || {}).id = e, i.tar = t, i
                ...
                if (void 0 === i && (i = !1), this.enable) {
                    ...
                    if (s = this.getEles(t, null, f._tEleArr), this.sendEvents(s, i ? "mouseup" : "rightmouseup"), h = i ? this.preDowns : this.preRightDowns, n = this.getTouchFromArr(e, h)) {
                        ...
                        0 < a.length && this.sendEvents(a, i ? "click" : "rightclick"), i && _ && this.sendEvents(a, "doubleclick"), this.removeTouchFromArr(e, h), n.tar = null, _t.recover("TouchData", n)
                    } else;
        ...
        M = function() {
            ...
            p(t, "laya.filters.ColorFilterAction");
            var e = t.prototype;
            return b.imps(e, {
    ...
    p(S, "laya.maths.Arith"), S.formatR = function(t) {
        return t > Math.PI && (t -= 2 * Math.PI), t < -Math.PI && (t += 2 * Math.PI), t
    }, S.isPOT = function(t, e) {
        return 0 < t && 0 == (t & t - 1) && 0 < e && 0 == (e & e - 1)
    }, S.setMatToArray = function(t, e) {
    ...
    var E = function() {
        ...
        I = (p(L, "laya.maths.GrahamScan"), L.multiply = function(t, e, i) {
            ...
            for (a = i.length, vt.copyArray(t, i), s = 1; s < a; s++)(t[s].y < t[o].y || t[s].y == t[o].y && t[s].x < t[o].x) && (o = s);
            ...
            if ((i = L._temArr).length = 0, t.length < 3) return vt.copyArray(i, t);
    ...
    function L() {}
    var R = (p(D, "laya.maths.MathUtil"), D.subtractVector3 = function(t, e, i) {
        ...
        var n;
        return void 0 === t && (t = !1), void 0 === e && (e = !0), n = t ? e ? D.sortNumBigFirst : D.sortBigFirst : e ? D.sortNumSmallFirst : D.sortSmallFirst,
            function(t, e) {
                return n(t[i], e[i])
            }
    }, D);
    ...
    var F = function() {
        ...
        N = (p(B, "laya.media.SoundManager"), u(1, B, "useAudioMusic", function() {
            return B._useAudioMusic
        }, function(t) {
            B._useAudioMusic = t, B._musicClass = t ? Mt : null
        }), u(1, B, "autoStopMusic", function() {
            return B._autoStopMusic
        }, function(t) {
            b.stage.off("blur", null, B._stageOnBlur), b.stage.off("focus", null, B._stageOnFocus), b.stage.off("visibilitychange", null, B._visibilityChange), (B._autoStopMusic = t) && (b.stage.on("blur", null, B._stageOnBlur), b.stage.on("focus", null, B._stageOnFocus), b.stage.on("visibilitychange", null, B._visibilityChange))
        }), u(1, B, "muted", function() {
            return B._muted
        }, function(t) {
            t != B._muted && (t && B.stopAllSound(), B.musicMuted = t, B._muted = t)
        }), u(1, B, "musicMuted", function() {
            ...
            var e = 0;
            for (e = B._channels.length - 1; 0 <= e; e--) B._channels[e] == t && B._channels.splice(e, 1)
        }, B.disposeSoundIfNotUsed = function(t) {
            var e = 0;
            for (e = B._channels.length - 1; 0 <= e; e--)
                if (B._channels[e].url == t) return;
            B.destroySound(t)
        }, B._visibilityChange = function() {
            b.stage.isVisibility ? B._stageOnFocus() : B._stageOnBlur()
        }, B._stageOnBlur = function() {
            B._isActive = !1, B._musicChannel && (B._musicChannel.isStopped || (B._blurPaused = !0, B._musicChannel.pause())), B.stopAllSound(), b.stage.once("mousedown", null, B._stageOnFocus)
        }, B._recoverWebAudio = function() {
            Et.ctx && "running" != Et.ctx.state && Et.ctx.resume && Et.ctx.resume()
        }, B._stageOnFocus = function() {
            B._isActive = !0, B._recoverWebAudio(), b.stage.off("mousedown", null, B._stageOnFocus), B._blurPaused && B._musicChannel && B._musicChannel.isStopped && (B._blurPaused = !1, B._musicChannel.resume())
            ...
            t = Y.formatURL(t);
            var e, i = 0;
            for (i = B._channels.length - 1; 0 <= i; i--)(e = B._channels[i]).url == t && e.stop()
        }, B.stopAll = function() {
            B._tMusic = null;
            var t = 0;
            for (t = B._channels.length - 1; 0 <= t; t--) B._channels[t].stop()
        }, B.stopAllSound = function() {
            var t, e = 0;
            for (e = B._channels.length - 1; 0 <= e; e--)(t = B._channels[e]).url != B._tMusic && t.stop()
            ...
            if (e) e = Y.formatURL(e), B._setVolume(e, t);
                ...
                B.soundVolume = t;
                var i, n = 0;
                for (n = B._channels.length - 1; 0 <= n; n--)(i = B._channels[n]).url != B._tMusic && (i.volume = t)
            }
            ...
            t = Y.formatURL(t);
            var i, n = 0;
            for (n = B._channels.length - 1; 0 <= n; n--)(i = B._channels[n]).url == t && (i.volume = e)
    ...
    function B() {}
    var G, W = (p(U, "laya.net.LocalStorage"), U.__init__ = function() {
    ...
    function U() {}
    p(z, "laya.net.ResourceVersion"), z.enable = function(t, e, i) {
        void 0 === i && (i = 2), laya.net.ResourceVersion.type = i, b.loader.load(t, v.create(null, z.onManifestLoaded, [e]), null, "json"), Y.customFormat = z.addVersionPrefix
    }, z.onManifestLoaded = function(t, e) {
        z.manifest = e, t.run(), e || console.warn("资源版本清单文件不存在，不使用资源版本管理。忽略ERR_FILE_NOT_FOUND错误。")
    ...
    var H = function() {
            ...
            return e.load = function(t) {
                ...
                this.fontName = e[e.length - 1], Q.window.conch ? this._loadConch() : Q.window.FontFace ? this._loadWithFontFace() : this._loadWithCSS()
                ...
                e.type = "text/css", Q.document.body.appendChild(e), e.textContent = "@font-face { font-family:'" + this.fontName + "'; src:url('" + this._url + "');}", this._fontTxt = "40px " + this.fontName, this._txtWidth = A.measureText("LayaTTFFont", this._fontTxt).width;
                var i = this;
                e.onload = function() {
        ...
        V = function() {
            function s(t, e) {
                ...
                s._mainCanvas.source.width = t, s._mainCanvas.source.height = e, n && s.WebGL.init(s._mainCanvas, t, e), Q.onKGMiniGame || Q.container.appendChild(s._mainCanvas.source), (s._context = new X(t, e, n ? null : s._mainCanvas)).ctx.setIsMainContext(), Q.window.requestAnimationFrame(function t(e) {
                    b.stage._loop();
                    Q.window.requestAnimationFrame(t)
                }), b.stage.on("visibilitychange", this, this._onVisibilitychange)
            }
            p(s, "laya.renders.Render");
            var t = s.prototype;
            return t._onVisibilitychange = function() {
                b.stage.isVisibility ? 0 != this._timeId && Q.window.clearInterval(this._timeId) : this._timeId = Q.window.setInterval(this._enterFrame, 1e3)
                ...
                r.ConchRenderType = r.ConchRenderType || 1, r.ConchRenderType |= r.conch ? 4 : 0, s.isConchNode = 5 == (5 & r.ConchRenderType), s.isConchApp = 4 == (4 & r.ConchRenderType), s.isConchWebGL = 6 == r.ConchRenderType
            }, s
        }(),
        X = function() {
            function o(t, e, i) {
                ...
                }, i ? this.ctx = i.getContext("2d") : (i = Ht.create("3D"), this.ctx = A.createWebGLContext2D(i), i._setContext(this.ctx)), i.size(t, e), this.canvas = i
            }
            p(o, "laya.renders.RenderContext");
            var t = o.prototype;
            return t.destroy = function() {
        ...
        $ = function() {
            ...
            return t.onCreate = function(t) {}, t._style = function(t, e, i, n) {
                ...
                if (s) {
                    "bitmap" === s.type ? ft.canvasBitmap++ : ft.canvasNormal++;
                    var r = s.ctx;
                ...
                if (s) {
                    var o, a, h, l, u = s.ctx,
                        c = t._needRepaint() || !u,
                        _ = s.type;
                    if ("bitmap" === _ ? ft.canvasBitmap++ : ft.canvasNormal++, c) {
                        var d, f;
                        s._cacheRec || (s._cacheRec = new O), V.isWebGL && "bitmap" !== _ ? s._cacheRec.setTo(-t.pivotX, -t.pivotY, 1, 1) : ((l = t.getSelfBounds()).x = l.x - t.pivotX, l.y = l.y - t.pivotY, l.x = l.x - 16, l.y = l.y - 16, l.width = l.width + 32, l.height = l.height + 32, l.x = Math.floor(l.x + i) - i, l.y = Math.floor(l.y + n) - n, l.width = Math.floor(l.width), l.height = Math.floor(l.height), s._cacheRec.copyFrom(l)), l = s._cacheRec;
                        var p, g = V.isWebGL ? 1 : Q.pixelRatio * b.stage.clientScaleX,
                            m = V.isWebGL ? 1 : Q.pixelRatio * b.stage.clientScaleY;
                        if (!V.isWebGL) {
                            var v, y = 1,
                                w = 1;
                            for (v = t; v && v != b.stage;) y *= v.scaleX, w *= v.scaleY, v = v.parent;
                            V.isWebGL ? (y < 1 && (g *= y), w < 1 && (m *= w)) : (1 < y && (g *= y), 1 < w && (m *= w))
                        }
                        if (t.scrollRect) {
                            var x = t.scrollRect;
                            l.x -= x.x, l.y -= x.y
                        }
                        if (d = l.width * g, f = l.height * m, a = l.x, h = l.y, V.isWebGL && "bitmap" === _ && (2048 < d || 2048 < f)) return console.warn("cache bitmap size larger than 2048,cache ignored"), s.ctx && (_t.recover("RenderContext", s.ctx), s.ctx.canvas.size(0, 0), s.ctx = null), void r._fun.call(r, t, e, i, n);
                        if (u || (u = s.ctx = _t.getItem("RenderContext") || new X(d, f, Ht.create("AUTO"))), u.ctx.sprite = t, (o = u.canvas).clear(), o.width == d && o.height == f || o.size(d, f), "bitmap" === _ ? o.context.asBitmap = !0 : "normal" === _ && (o.context.asBitmap = !1), 1 != g || 1 != m) {
                            var T = u.ctx;
                            T.save(), T.scale(g, m), !V.isConchWebGL && V.isConchApp && (p = t._$P.cf) && T.setFilterMatrix && T.setFilterMatrix(p._mat, p._alpha), r._fun.call(r, t, u, -a, -h), T.restore(), V.isConchApp && !V.isConchWebGL || t._applyFilters()
                        } else T = u.ctx, !V.isConchWebGL && V.isConchApp && (p = t._$P.cf) && T.setFilterMatrix && T.setFilterMatrix(p._mat, p._alpha), r._fun.call(r, t, u, -a, -h), V.isConchApp && !V.isConchWebGL || t._applyFilters();
                        t._$P.staticCache && (s.reCache = !1), ft.canvasReCache++
                    } else a = (l = s._cacheRec).x, h = l.y, o = u.canvas;
                    e.drawCanvas(o, i + a, n + h, l.width, l.height)
                } else r._fun.call(r, t, u, i, n)
            }, o.__init__ = function() {
                var t, e, i = 0;
                for (e = A.createRenderSprite(69905, null), t = o.renders.length = 4096, i = 0; i < t; i++) o.renders[i] = e;
                o.renders[0] = A.createRenderSprite(0, null),
                    function(t, e) {
                        for (var i = 0, n = 0; n < t.length; n++) i |= t[n], o.renders[i] = e
                    }([1, 512, 4, 2], new o(1, null)), o.renders[513] = A.createRenderSprite(513, null), o.renders[517] = new o(517, null)
            }, o._initRenderFun = function(t, e, i, n) {
                var s = t._renderType;
                (o.renders[s] = o._getTypeRender(s))._fun(t, e, i, n)
            }, o._getTypeRender = function(t) {
                for (var e = null, i = 2048; 1 < i;) i & t && (e = A.createRenderSprite(i, e)), i >>= 1;
                return e
        ...
        j = function() {
            ...
            return t.replaceReset = function() {
                ...
                ft.drawCall++, 3 < arguments.length && null != n && (this.font = n, this.fillStyle = s, this.textAlign = r, this.textBaseline = "top"), this.__fillText(t, e, i)
            }, t.fillBorderText = function(t, e, i, n, s, r, o, a) {
                ...
                ft.drawCall++, 3 < arguments.length && null != n && (this.font = n, this.strokeStyle = s, this.lineWidth = r, this.textAlign = o, this.textBaseline = "top"), this.__strokeText(t, e, i)
            }, t.transformByMatrix = function(t) {
                ...
                if (!a.pat) {
                    if (t.uv != Dt.DEF_UV) {
                        var h = new Ht("2D");
                        h.getContext("2d"), h.size(t.width, t.height), h.context.drawTexture(t, 0, 0, t.width, t.height, 0, 0), t = new Dt(h)
                    }
                ...
                if (a) {
                    var S = (w + x + T) / 3,
                        ...
                        A = b - P,
                        I = Math.sqrt(E * E + A * A);
                    w = S + E / I * (I + 1), b = P + A / I * (I + 1), A = C - P, x = S + (E = x - S) / (I = Math.sqrt(E * E + A * A)) * (I + 1), C = P + A / I * (I + 1), A = M - P, T = S + (E = T - S) / (I = Math.sqrt(E * E + A * A)) * (I + 1), M = P + A / I * (I + 1)
                }
        ...
        K = function() {
            ...
            p(r, "laya.resource.ResourceManager");
            var t = r.prototype;
            return b.imps(t, {
    ...
    p(q, "laya.system.System"), q.changeDefinition = function(t, e) {
        b[t] = e;
        var i = t + "=classObj";
        b._runScript(i)
    }, q.__init__ = function() {
    ...
    function q() {}
    var Q = (p(J, "laya.utils.Browser"), u(1, J, "pixelRatio", function() {
        return J.__init__(), -1 < J.userAgent.indexOf("Mozilla/6.0(Linux; Android 6.0; HUAWEI NXT-AL10 Build/HUAWEINXT-AL10)") ? 2 : A.getPixelRatio()
    }), u(1, J, "height", function() {
        return J.__init__(), (b.stage && b.stage.canvasRotation ? J.clientWidth : J.clientHeight) * J.pixelRatio
    }), u(1, J, "clientWidth", function() {
        return J.__init__(), J.window.innerWidth || J.document.body.clientWidth
    }), u(1, J, "window", function() {
        return J.__init__(), J._window
    }), u(1, J, "clientHeight", function() {
        ...
        return J.__init__(), (b.stage && b.stage.canvasRotation ? J.clientHeight : J.clientWidth) * J.pixelRatio
    }), u(1, J, "container", function() {
        ...
        J._container = t
    }), u(1, J, "document", function() {
        return J.__init__(), J._document
    }), J.__init__ = function() {
        if (!J._window) {
            J._window = A.getWindow(), J._document = J.window.document, J._window.addEventListener("message", function(t) {
        ...
        return A.now()
    }, J._window = null, J._document = null, J._container = null, J.userAgent = null, J.u = null, J.onIOS = !1, J.onMac = !1, J.onMobile = !1, J.onIPhone = !1, J.onIPad = !1, J.onAndroid = !1, J.onWP = !1, J.onQQBrowser = !1, J.onMQQBrowser = !1, J.onSafari = !1, J.onFirefox = !1, J.onEdge = !1, J.onIE = !1, J.onWeiXin = !1, J.onMiniGame = !1, J.onTTMiniGame = !1, J.onBDMiniGame = !1, J.onKGMiniGame = !1, J.onQGMiniGame = !1, J.onVVMiniGame = !1, J.onQQMiniGame = !1, J.onLimixiu = !1, J.onBLMiniGame = !1, J.onAlipayMiniGame = !1, J.onPC = !1, J.httpProtocol = !1, J.webAudioEnabled = !1, J.soundType = null, J.enableTouch = !1, J.canvas = null, J.context = null, J.onIPhoneX = !1, J.__init$ = function() {}, J);
    ...
    var Z = function() {
        ...
        tt = (p(et, "laya.utils.CacheManager"), et.regCacheByFunction = function(t, e) {
            var i;
            et.unRegCacheByFunction(t, e), i = {
                tryDispose: t,
                getCacheList: e
            }, et._cacheList.push(i)
        }, et.unRegCacheByFunction = function(t, e) {
            var i, n = 0;
            for (i = et._cacheList.length, n = 0; n < i; n++)
                if (et._cacheList[n].tryDispose == t && et._cacheList[n].getCacheList == e) return void et._cacheList.splice(n, 1)
        }, et.forceDispose = function() {
            var t = 0,
                e = et._cacheList.length;
            for (t = 0; t < e; t++) et._cacheList[t].tryDispose(!0)
        }, et.beginCheck = function(t) {
            void 0 === t && (t = 15e3), b.timer.loop(t, null, et._checkLoop)
        }, et.stopCheck = function() {
            b.timer.clear(null, et._checkLoop)
        }, et._checkLoop = function() {
            var t = et._cacheList;
            if (!(t.length < 1)) {
                var e, i = Q.now(),
                    n = 0;
                for (e = n = t.length; 0 < n && (t[et._index = ++et._index % e].tryDispose(!1), !(Q.now() - i > et.loopTimeLimit));) n--
            }
        }, et.loopTimeLimit = 2, et._cacheList = [], et._index = 0, et);

    function et() {}
    var it = (p(nt, "laya.utils.ClassUtils"), nt.regClass = function(t, e) {
        nt._classMap[t] = e
        ...
        if (o)
            for (var a = 0, h = o.length; a < h; a++) {
                ...
                if ("render" !== l.props.name && "render" !== l.props.renderType || !e._$set_itemRender)
                    if ("Graphic" == l.type) nt.addGraphicsToSprite(l, e);
                    else if (nt.isDrawType(l.type)) nt.addGraphicToSprite(l, e, !0);
                else {
                    var u = nt.createByJson(l, null, i, n, s);
        ...
        if ((i = t.child) && !(i.length < 1)) {
            var n;
            n = nt._getGraphicsFromSprite(t, e);
            var s = 0,
                r = 0;
            t.props && (s = nt._getObjVar(t.props, "x", 0), r = nt._getObjVar(t.props, "y", 0)), 0 != s && 0 != r && n.translate(s, r);
            var o, a = 0;
            for (o = i.length, a = 0; a < o; a++) nt._addGraphicToGraphics(i[a], n);
            0 != s && 0 != r && n.translate(-s, -r)
        }
    }, nt.addGraphicToSprite = function(t, e, i) {
        var n;
        void 0 === i && (i = !1), n = i ? nt._getGraphicsFromSprite(t, e) : e.graphics, nt._addGraphicToGraphics(t, n)
        ...
        switch (n = t.props.renderType) {
            ...
            case "unHit":
                var s;
                e.hitArea || (e.hitArea = new lt), (s = e.hitArea)[n] || (s[n] = new _), i = s[n]
        }
        ...
        return nt._getObjVar(t, "skewX", 0), nt._getObjVar(t, "skewY", 0), 1 == i && 1 == n && 0 == s || ((e = e || new F).scale(i, n), e.rotate(.0174532922222222 * s)), e
    }, nt._addGraphicToGraphics = function(t, e) {
        var i, n;
        if ((i = t.props) && (n = nt.DrawTypeDic[t.type])) {
            var s, r;
            s = e;
            var o = nt._getParams(i, n[1], n[2], n[3]);
            !(r = nt._tM) && 1 == nt._alpha || (s.save(), r && s.transform(r), 1 != nt._alpha && s.alpha(nt._alpha)), s[n[0]].apply(s, o), !r && 1 == nt._alpha || s.restore()
        }
        ...
        var r, o, a = 0;
        for (r = e.length, a = 0; a < r; a++) s[a] = nt._getObjVar(t, e[a][0], e[a][1]);
        return nt._alpha = nt._getObjVar(t, "alpha", 1), o = nt._getTransformData(t), nt._tM = o ? (i || (i = 0), o.translate(s[i], s[i + 1]), s[i] = s[i + 1] = 0, o) : null, n && nt[n] && (s = nt[n](s)), s
        ...
        var e = nt._classMap[t] || t;
        return "string" == typeof e ? b.__classmap[e] : e
    }, nt._tM = null, nt._alpha = NaN, h(nt, ["DrawTypeDic", function() {
    ...
    function nt() {}
    var st = (p(rt, "laya.utils.Color"), rt._initDefault = function() {
    ...
    var ot = function() {
            ...
            return e.start = function(t, e, i, n, s, r, o, a) {
                ...
                this._dragging && (x.instance.disableMouseEvent = !1, b.stage.off("mouseup", this, this.onStageMouseUp), b.stage.off("mouseout", this, this.onStageMouseUp), this._dragging = !1, this.target && this.area && this.backToArea(), this.clear())
            }, e.loop = function() {
                ...
                if (x.instance.disableMouseEvent = !1, b.stage.off("mouseup", this, this.onStageMouseUp), b.stage.off("mouseout", this, this.onStageMouseUp), b.timer.clear(this, this.loop), !this._clickOnly && this.target)
                    if (this.hasInertia) {
                ...
                if (this.target.x < this.area.x ? t = this.area.x : this.target.x > this.area.x + this.area.width && (t = this.area.x + this.area.width), this.target.y < this.area.y ? e = this.area.y : this.target.y > this.area.y + this.area.height && (e = this.area.y + this.area.height), isNaN(t) && isNaN(e)) this.clear();
                    ...
                    var i = {};
                    isNaN(t) || (i.x = t), isNaN(e) || (i.y = e), this._tween = mt.to(this.target, i, this.elasticBackTime, at.sineOut, v.create(this, this.clear), 0, !1, !1)
                }
        ...
        at = (p(ht, "laya.utils.Ease"), ht.linearNone = function(t, e, i, n) {
            return i * t / n + e
            ...
            var o;
            return void 0 === s && (s = 0), void 0 === r && (r = 0), 0 == t ? e : 1 == (t /= n) ? e + i : (r || (r = .3 * n), o = !s || 0 < i && s < i || i < 0 && s < -i ? (s = i, r / 4) : r / ht.PI2 * Math.asin(i / s), -s * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * n - o) * ht.PI2 / r) + e)
        }, ht.elasticInOut = function(t, e, i, n, s, r) {
            var o;
            return void 0 === s && (s = 0), void 0 === r && (r = 0), 0 == t ? e : 2 == (t /= .5 * n) ? e + i : (r || (r = n * (.3 * 1.5)), o = !s || 0 < i && s < i || i < 0 && s < -i ? (s = i, r / 4) : r / ht.PI2 * Math.asin(i / s), t < 1 ? s * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * n - o) * ht.PI2 / r) * -.5 + e : s * Math.pow(2, -10 * (t -= 1)) * Math.sin((t * n - o) * ht.PI2 / r) * .5 + i + e)
        }, ht.elasticOut = function(t, e, i, n, s, r) {
            var o;
            return void 0 === s && (s = 0), void 0 === r && (r = 0), 0 == t ? e : 1 == (t /= n) ? e + i : (r || (r = .3 * n), o = !s || 0 < i && s < i || i < 0 && s < -i ? (s = i, r / 4) : r / ht.PI2 * Math.asin(i / s), s * Math.pow(2, -10 * t) * Math.sin((t * n - o) * ht.PI2 / r) + i + e)
    ...
    })(), p(ut, "laya.utils.Log"), ut.enable = function() {
        ut._logdiv || (ut._logdiv = Q.window.document.createElement("div"), Q.window.document.body.appendChild(ut._logdiv), ut._logdiv.style.cssText = "pointer-events:none;border:white;overflow:hidden;z-index:1000000;background:rgba(100,100,100,0.6);color:white;position: absolute;left:0px;top:0px;width:50%;height:50%;")
    }, ut.toggle = function() {
        var t = ut._logdiv.style;
        "1px" == t.width ? t.width = t.height = "50%" : t.width = t.height = "1px"
    }, ut.print = function(t) {
        ut._logdiv && (ut.maxCount <= ut._count && ut.clear(), ut._count++, ut._logdiv.innerText += t + "\n", ut._logdiv.scrollTop = ut._logdiv.scrollHeight)
    }, ut.clear = function() {
        ut._logdiv.innerText = "", ut._count = 0
    }, ut._logdiv = null, ut._count = 0, ut.maxCount = 20;

    function ut() {}
    p(ct, "laya.utils.Mouse"), u(1, ct, "cursor", function() {
        return ct._style.cursor
    }, function(t) {
        ct._style.cursor = t
    }), ct.hide = function() {
        "none" != ct.cursor && (ct._preCursor = ct.cursor, ct.cursor = "none")
    }, ct.show = function() {
        "none" == ct.cursor && (ct.cursor = ct._preCursor ? ct._preCursor : "auto")
    }, ct._preCursor = null, h(ct, ["_style", function() {
        return this._style = Q.document.body.style
    }]);

    function ct() {}
    var _t = (p(dt, "laya.utils.Pool"), dt.getPoolBySign = function(t) {
    ...
    function dt() {}! function() {
        ...
        p(n, "laya.utils.PoolCache");
        var t = n.prototype;
        t.getCacheList = function() {
            return _t.getPoolBySign(this.sign)
        }, t.tryDispose = function(t) {
            var e;
            (e = _t.getPoolBySign(this.sign)).length > this.maxCount && e.splice(this.maxCount, e.length - this.maxCount)
    ...
    var ft = (p(pt, "laya.utils.Stat"), u(1, pt, "onclick", null, function(t) {
        ...
        void 0 === t && (t = 0), void 0 === e && (e = 0), !V.isConchApp || V.isConchWebGL ? (V.isConchWebGL || Q.onMiniGame || Q.onLimixiu || Q.onKGMiniGame || Q.onBDMiniGame || Q.onTTMiniGame || Q.onQGMiniGame || Q.onVVMiniGame || Q.onBLMiniGame || Q.onAlipayMiniGame || Q.onQQMiniGame || (pt._useCanvas = !0), pt._show = !0, pt._fpsData.length = 60, pt._view[0] = {
            title: "FPS(Canvas)",
            value: "_fpsStr",
            color: "yellow",
            units: "int"
        ...
        var i = Q.pixelRatio;
        b.stage.useRetinalCanvas && (i = 3), pt._width = 130 * i, pt._vx = 75 * i, pt._height = i * (12 * pt._view.length + 3 * i) + 4, pt._fontSize = 12 * i;
        ...
        var i = pt._sp,
            n = Q.pixelRatio;
        b.stage.useRetinalCanvas && (n = 3), i || (i = new kt, (pt._leftText = new Wt).pos(5, 5), pt._leftText.color = "#ffffff", i.addChild(pt._leftText), (pt._txt = new Wt).pos(80 * n, 5), pt._txt.color = "#ffffff", i.addChild(pt._txt), pt._sp = i), i.pos(t, e);
        for (var s = "", r = 0; r < pt._view.length; r++) s += pt._view[r].title + "\n";
        pt._leftText.text = s;
        var o = 138 * n,
            a = n * (12 * pt._view.length + 3 * n) + 4;
        pt._txt.fontSize = pt._fontSize * n, pt._leftText.fontSize = pt._fontSize * n, i.size(o, a), i.graphics.clear(), i.graphics.setAlpha(.5), i.graphics.drawRect(0, 0, o, a, "#999999"), i.graphics.setAlpha(1), pt.loop()
    }, pt.enable = function() {
        b.timer.frameLoop(1, pt, pt.loop)
    }, pt.hide = function() {
        pt._show = !1, b.timer.clear(pt, pt.loop), pt._canvas && Q.removeElement(pt._canvas.source)
    }, pt.clear = function() {
    ...
    var gt = function() {
            ...
            return t._init = function() {
                ...
                var i = t ? t.$_GID || (t.$_GID = vt.getGID()) : 0,
        ...
        mt = function() {
            ...
            return t.to = function(t, e, i, n, s, r, o) {
                ...
                this.pause(), b.scaleTimer.clear(this, this.firstStart), this._complete = null, this._target = null, this._ease = null, this._props = null, this._delayParam = null, this._usedPool && (this.update = null, _t.recover("tween", this))
            }, t.recover = function() {
                ...
                if (this.pause(), this._usedTimer = 0, this._startTimer = Q.now(), this._delayParam) b.scaleTimer.once(this._delay, this, this.firstStart, this._delayParam);
                else {
                ...
                this._usedTimer >= this._duration || (this._startTimer = Q.now() - this._usedTimer - this._delay, this._delayParam ? this._usedTimer < 0 ? b.scaleTimer.once(-this._usedTimer, this, this.firstStart, this._delayParam) : this.firstStart.apply(this, this._delayParam) : this._beginLoop())
            }, u(0, t, "progress", null, function(t) {
                var e = t * this._duration;
                this._startTimer = Q.now() - this._delay - e
        ...
        vt = (p(yt, "laya.utils.Utils"), yt.toRadian = function(t) {
            return t * yt._pi2
            ...
            var r, o;
            return r = new k(e, i), r = t.localToGlobal(r), o = new k(n, s), o = t.localToGlobal(o), O._getWrapRec([r.x, r.y, o.x, o.y])
            ...
            var o = yt.getTransformRelativeToWindow(e, i, n);
    ...
    var wt = function() {
        ...
        xt = function() {
            ...
            return t.set = function(t, e) {
                if (null != t)
                    ...
                    } else "string" == typeof t || "number" == typeof t ? this._obj[t] = e : (t.$_GID || (t.$_GID = vt.getGID()), this._obj[t.$_GID] = e)
            }, t.get = function(t) {
                ...
                (n.supportWeakMap = null != Q.window.WeakMap) || b.timer.loop(n.delInterval, null, n.clearCache)
        ...
        bt = function(t) {
            function o() {
                this._bits = 0, this._displayedInStage = !1, this._parent = null, this.conchModel = null, this.name = "", this._destroyed = !1, o.__super.call(this), this._childs = o.ARRAY_EMPTY, this._$P = o.PROP_EMPTY, this.timer = b.scaleTimer, this.conchModel = V.isConchNode ? this.createConchModel() : null
            }
            p(o, "laya.display.Node", l);
            var e = o.prototype;
        ...
        Ct = function(t) {
            ...
            p(_, "laya.display.css.CSSStyle", t);
            var e = _.prototype;
        ...
        Mt = function(t) {
            ...
            p(o, "laya.media.h5audio.AudioSound", l);
            var e = o.prototype;
            return e.dispose = function() {
                ...
                var e;
                if (t = Y.formatURL(t), (this.url = t) == N._tMusic ? (o._initMusicAudio(), (e = o._musicAudio).src != t && (o._audioCache[e.src] = null, e = null)) : e = o._audioCache[t], e && 2 <= e.readyState) this.event("complete");
                else {
                    e || (e = t == N._tMusic ? (o._initMusicAudio(), o._musicAudio) : Q.createElement("audio"), (o._audioCache[t] = e).src = t), e.addEventListener("canplaythrough", n), e.addEventListener("error", s);
                    var i = this;
                ...
                var i, n;
                if (!(i = this.url == N._tMusic ? o._musicAudio : o._audioCache[this.url])) return null;
                ...
                var s = new Ot(n);
                return s.url = this.url, s.loops = e, s.startTime = t, s.play(), N.addChannel(s), s
        ...
        Et = function(t) {
            ...
            p(s, "laya.media.webaudio.WebAudioSound", l);
            var e = s.prototype;
            return e.load = function(t) {
                var e = this;
                if (t = Y.formatURL(t), this.url = t, this.audioBuffer = s._dataCache[t], this.audioBuffer) this._loaded(this.audioBuffer);
                else if (s.e.on("loaded:" + t, this, this._loaded), s.e.on("err:" + t, this, this._err), !s.__loadingSound[t]) {
                    s.__loadingSound[t] = !0;
                    var i = new Q.window.XMLHttpRequest;
                    i.open("GET", t, !0), i.responseType = "arraybuffer", i.onload = function() {
                        e._disposed ? e._removeLoadEvents() : (e.data = i.response, s.buffs.push({
                            buffer: e.data,
                            url: e.url
                        }), s.decode())
                ...
                if (this._removeLoadEvents(), s.__loadingSound[this.url] = !1, this.event("error"), this.__toPlays) {
                    var t, e, i, n = 0;
                    for (t = (e = this.__toPlays).length, n = 0; n < t; n++)(i = e[n])[2] && !i[2].isStopped && i[2].event("error");
                ...
                if (null != s.ctx) {
                    ...
                    t.buffer = s._miniBuffer, t.connect(s.ctx.destination), t.start(0, 0, 0)
                }
            }, s._unlock = function() {
            ...
            }, s._dataCache = {}, s.buffs = [], s.isDecoding = !1, s._unlocked = !1, s.tInfo = null, s.__loadingSound = {}, h(s, ["window", function() {
        ...
        At = function(t) {
            function e() {
                this._responseType = null, this._data = null, e.__super.call(this), this._http = new Q.window.XMLHttpRequest
            }
            p(e, "laya.net.HttpRequest", l);
            var i = e.prototype;
            return i.send = function(t, e, i, n, s) {
                void 0 === i && (i = "get"), void 0 === n && (n = "text"), this._responseType = n, this._data = null, (Q.onQGMiniGame || Q.onVVMiniGame || Q.onQQMiniGame || Q.onBDMiniGame) && (t = encodeURI(t));
                var r = this,
                    o = this._http;
                if (o.open(i, t, !0), s)
                ...
                o.responseType = h, o.dataType && (o.dataType = h), o.onerror = function(t) {
                    r._onError(t)
        ...
        It = function(t) {
            function S() {
                this._data = null, this._class = null, this._url = null, this._type = null, this._cache = !1, this._http = null, this._customParse = !1, S.__super.call(this)
            }
            p(S, "laya.net.Loader", l);
            var e = S.prototype;
            return e.load = function(t, e, i, n, s) {
                if (void 0 === i && (i = !0), void 0 === s && (s = !1), 0 === (this._url = t).indexOf("data:image") ? this._type = e = "image" : (this._type = e || (e = this.getTypeFromUrl(t)), t = Y.formatURL(t)), this._cache = i, this._data = null, !s && S.loadedMap[t]) return this._data = S.loadedMap[t], this.event("progress", 1), void this.event("complete", this._data);
                if (n && S.setGroup(t, n), null != S.parserMap[e]) return this._customParse = !0, void(S.parserMap[e] instanceof laya.utils.Handler ? S.parserMap[e].runWith(this) : S.parserMap[e].call(null, this));
                ...
                S.preLoadedMap[t] ? this.onLoaded(S.preLoadedMap[t]) : (Q.onVVMiniGame ? this._http = new At : this._http || (this._http = new At), this._http.on("progress", this, this.onProgress), this._http.on("error", this, this.onError), this._http.on("complete", this, this.onLoaded), this._http.send(t, null, "get", r))
            }, e.getTypeFromUrl = function(t) {
                var e = vt.getFileExtension(t);
                return e ? S.typeMap[e] : (console.warn("Not recognize the resources suffix", t), "text")
                ...
                function n() {
                    i.onload = null, i.onerror = null, delete S.imgCache[e]
                }
                ...
                "nativeimage" === this._type ? ((i = new Q.window.Image).crossOrigin = "", i.onload = s, i.onerror = r, i.src = e, S.imgCache[e] = i) : new $t.create(e, {
                    onload: s,
                    onerror: r,
                    onCreate: function(t) {
                        i = t, S.imgCache[e] = t
                ...
                if ("plf" == e) this.parsePLFData(t), this.complete(t);
                    ...
                    var l = this._data.frames,
                        ...
                        _ = this._data.pics,
                        d = Y.formatURL(this._url),
                        f = S.atlasMap[d] || (S.atlasMap[d] = []);
                    f.dir = c;
                    var p = 1;
                    if (this._data.meta && this._data.meta.scale && 1 != this._data.meta.scale)
                        for (var g in p = parseFloat(this._data.meta.scale), l) {
                            var m, v = l[g],
                                y = _[v.frame.idx ? v.frame.idx : 0],
                                w = Y.formatURL(c + g);
                            y.scaleRate = p, m = Dt.create(y, v.frame.x, v.frame.y, v.frame.w, v.frame.h, v.spriteSourceSize.x, v.spriteSourceSize.y, v.sourceSize.w, v.sourceSize.h), S.cacheRes(w, m), m.url = w, f.push(w)
                        } else
                            for (g in l) y = _[(v = l[g]).frame.idx ? v.frame.idx : 0], w = Y.formatURL(c + g), S.cacheRes(w, Dt.create(y, v.frame.x, v.frame.y, v.frame.w, v.frame.h, v.spriteSourceSize.x, v.spriteSourceSize.y, v.sourceSize.w, v.sourceSize.h)), S.loadedMap[w].url = w, f.push(w);
                    ...
                    var T = this._url.split(".fnt")[0].split("/"),
                        b = T[T.length - 1];
                    Wt.registerBitmapFont(b, x), this._data = x, this.complete(this._data)
                } else if ("pkm" == e) {
                    var C = $t.create(t, this._url),
                        M = new Dt(C);
                ...
                for (e in t) switch (n = t[e], e) {
                    case "json":
                    case "text":
                        for (i in n) S.preLoadedMap[Y.formatURL(i)] = n[i];
                        break;
                    default:
                        for (i in n) S.preLoadedMap[Y.formatURL(i)] = n[i]
                }
            }, e.complete = function(t) {
                this._data = t, this._customParse ? this.event("loaded", t instanceof Array ? [t] : t) : (S._loaders.push(this), S._isWorking || S.checkNext())
            }, e.endLoad = function(t) {
                t && (this._data = t), this._cache && S.cacheRes(this._url, this._data), this.event("progress", 1), this.event("complete", this.data instanceof Array ? [this.data] : this.data)
            }, u(0, e, "url", function() {
                return this._url
            }), u(0, e, "data", function() {
                return this._data
                ...
                return this._type
            }), S.checkNext = function() {
                S._isWorking = !0;
                for (var t = Q.now(); S._startIndex < S._loaders.length;)
                    if (Q.now(), S._loaders[S._startIndex].endLoad(), S._startIndex++, Q.now() - t > S.maxTimeOut) return console.warn("loader callback cost a long time:" + (Q.now() - t) + " url=" + S._loaders[S._startIndex - 1].url), void b.timer.frameOnce(1, null, S.checkNext);
                S._loaders.length = 0, S._startIndex = 0, S._isWorking = !1
                ...
                if (i) {
                    for (var n = 0, s = i.length; n < s; n++) {
                        var r = i[n],
                            o = S.getRes(r);
                        delete S.loadedMap[r], o && o.destroy(e)
                    }
                    i.length = 0, delete S.atlasMap[t], delete S.loadedMap[t]
                } else {
                    var a = S.loadedMap[t];
                    a && (delete S.loadedMap[t], a instanceof laya.resource.Texture && a.bitmap && a.destroy(e))
                }
                ...
                i && i.bitmap && (V.isConchApp && !V.isConchWebGL ? i.bitmap.source.releaseTexture && i.bitmap.source.releaseTexture() : null == i.bitmap._atlaser && i.bitmap.releaseResource(!0))
            }, S.getRes = function(t) {
                return S.loadedMap[Y.formatURL(t)]
            }, S.getAtlas = function(t) {
                return S.atlasMap[Y.formatURL(t)]
            }, S.cacheRes = function(t, e) {
                t = Y.formatURL(t), null != S.loadedMap[t] ? console.warn("Resources already exist,is repeated loading:", t) : S.loadedMap[t] = e
            }, S.setGroup = function(t, e) {
                S.groupMap[e] || (S.groupMap[e] = []), S.groupMap[e].push(t)
            }, S.clearResByGroup = function(t) {
                if (S.groupMap[t]) {
                    var e = S.groupMap[t],
                        i = 0,
                        n = e.length;
                    for (i = 0; i < n; i++) S.clearRes(e[i]);
                    e.length = 0
                }
            }, S.TEXT = "text", S.JSON = "json", S.XML = "xml", S.BUFFER = "arraybuffer", S.IMAGE = "image", S.SOUND = "sound", S.ATLAS = "atlas", S.FONT = "font", S.TTF = "ttf", S.PLF = "plf", S.PKM = "pkm", S.typeMap = {
                png: "image",
                jpg: "image",
                jpeg: "image",
                txt: "text",
                ...
                ani: "json",
                sk: "arraybuffer"
            }, S.parserMap = {}, S.groupMap = {}, S.maxTimeOut = 100, S.loadedMap = {}, S.preLoadedMap = {}, S.atlasMap = {}, S._loaders = [], S._isWorking = !1, S._startIndex = 0, S.imgCache = {}, S
        }(),
        Lt = function(t) {
            var _;
            ...
            return e.create = function(t, i, e, n, s, r, o, a) {
                ...
                if (l) !l.hasOwnProperty("loaded") || l.loaded ? (t && t.runWith(1), i && i.run()) : i && b.loader._createListener(e, i.caller, i.method, i.args, !0, !1);
                    ...
                    if ("atlas" == u) this.load(e, i, t, _, r, o);
                        ...
                        n === Dt && (_ = "htmlimage"), (l = n ? new n : null).hasOwnProperty("_loaded") && (l._loaded = !1), l._setUrl(e), a && l._setGroup(a), this._createLoad(l, e, v.create(null, function(t) {
        ...
        Rt = (function(t) {
            ...
            p(s, "laya.filters.ColorFilter", C);
            var e = s.prototype;
            b.imps(e, {
                "laya.filters.IFilter": !0
            ...
            p(n, "laya.net.Socket", l);
            var e = n.prototype;
            e.connect = function(t, e) {
                var i = "ws://" + t + ":" + e;
                i = "https:" == Q.window.location.protocol ? "wss://" + t + ":" + e : "ws://" + t + ":" + e, this.connectByUrl(i)
            ...
            e.workerMessage = function(t) {
                ...
                s.disableJSDecode && !Q.window.createImageBitmap || (s._enable = t) && null == s._preLoadFun && (s._enable = s.__init__())
            }), s.__init__ = function() {
            ...
            function a() {
                a.__super.call(this), this._$1__id = ++a._uniqueIDCounter, this.__loaded = !0, this._destroyed = !1, this._referenceCount = 0, (a._idResourcesMap[this.id] = this)._released = !0, this.lock = !1, this._memorySize = 0, this._lastUseFrameCount = -1, K.currentResourceManager && K.currentResourceManager.addResource(this)
            }
            p(a, "laya.resource.Resource", l);
            var e = a.prototype;
            return b.imps(e, {
                ...
                var t;
                this._destroyed || (null !== this._resourceManager && this._resourceManager.removeResource(this), this._destroyed = !0, this.lock = !1, this.releaseResource(), delete a._idResourcesMap[this.id], this._url && ((t = a._urlResourcesMap[this._url]) && (t.splice(t.indexOf(this), 1), 0 === t.length && delete a._urlResourcesMap[this.url]), It.clearRes(this._url), this.__loaded || A.cancelLoadByUrl(this._url)), this._group && ((t = a._groupResourcesMap[this._group]).splice(t.indexOf(this), 1), 0 === t.length && delete a._groupResourcesMap[this.url]))
        ...
        Dt = function(t) {
            ...
            return e._setUrl = function(t) {
                ...
                var i = this.bitmap || (this.bitmap = $t.create(t));
                i && i._addReference();
                var n = this;
                i.onload = function() {
                    i.onload = null, n._loaded = !0, e.sourceWidth = e._w = i.width, e.sourceHeight = e._h = i.height, n.event("loaded", this), A.addToAtlas && A.addToAtlas(n)
                }
                ...
                return V.isWebGL ? A.getTexturePixels(this, t, e, i, n) : (Q.canvas.size(i, n), Q.canvas.clear(), Q.context.drawTexture(this, -t, -e, this.width, this.height, 0, 0), Q.context.getImageData(0, 0, i, n).data)
                ...
                var r = t.scaleRate;
                1 != r && (e *= r, i *= r, n *= r, s *= r);
                var o = O.TEMP.setTo(e - t.offsetX, i - t.offsetY, n, s),
            ...
            }, S.DEF_UV = [0, 0, 1, 0, 1, 1, 0, 1], S.INV_UV = [0, 1, 1, 1, 1, 0, 0, 0], S._rect1 = new O, S._rect2 = new O, S
        }(),
        Ft = function(t) {
            var a;
            ...
            return e.to = function(t, e, i, n, s) {
                ...
                if (null != this._tweenDataList && 0 != this._tweenDataList.length) {
                    ...
                    if (this._index = 0, this._gidIndex = 0, this._currTime = t, this._lastTime = Q.now(), null == this._endTweenDataList || this._endTimeSort) {
                ...
                if (void 0 === t && (t = 0), void 0 === e && (e = !1), this._tweenDataList) {
                    ...
                    "string" == typeof t ? this.gotoLabel(t) : this.gotoTime(t), this._loopKey = e, this._lastTime = Q.now(), b.timer.frameLoop(1, this, this._update)
                }
            }, e._update = function() {
                ...
                if (0 != this._tweenDataList.length && this._index < this._tweenDataList.length) {
                    ...
                    s >= r.startTime && (this._index++, 0 == r.type ? (this._gidIndex++, (e = _t.getItemByClass("tween", mt))._create(r.target, r.data, r.duration, r.ease, v.create(this, this._animComplete, [this._gidIndex]), 0, !1, r.isTo, !0, !1), e.setStartTime(s), e.gid = this._gidIndex, (this._tweenDic[this._gidIndex] = e)._updateEase(s)) : this.event("label", r.data))
                }
                ...
                p(t, ""), t.prototype.destroy = function() {
        ...
        kt = function(s) {
            ...
            return b.imps(t, {
                ...
                return this._$P.uBounds ? this._$P.uBounds : (this._$P.mBounds || this._set$P("mBounds", new O), O._getWrapRec(this._getBoundPointsM(!1), this._$P.mBounds))
                ...
                for (var n, s, r, o = this._graphics ? this._graphics.getBoundPoints() : vt.clearArray(this._$P.temBM), a = 0, h = (r = this._childs).length; a < h; a++)(n = r[a]) instanceof laya.display.Sprite && 1 == n.visible && (s = n._boundPointsToParent(t)) && (o = o ? vt.concatArray(o, s) : s);
                return o
            }, t.getStyle = function() {
                ...
                var t;
                if (!V.isWebGL && ((t = this._$P.filters) && !(t.length < 1)))
                ...
                if (this._$P) {
                    ...
                    t && t.ctx && (_t.recover("RenderContext", t.ctx), t.ctx.canvas.size(0, 0), t.ctx = null);
                ...
                return t = i.x, e = i.y, (this._$P.hitArea ? this._$P.hitArea : 0 < this._width && 0 < this._height ? O.TEMP.setTo(0, 0, this._width, this._height) : this.getSelfBounds()).contains(t, e)
            }, t.getMousePoint = function() {
                return this.globalToLocal(k.TEMP.setTo(b.stage.mouseX, b.stage.mouseY))
                ...
                if (t && (this._renderType |= 1024, V.isConchNode)) {
                    i.CustomList.push(this);
                    var e = new Ht("2d");
                    e._setContext(new CanvasRenderingContext2D), this.customContext = new X(0, 0, e), e.context.setCanvasType && e.context.setCanvasType(2), this.conchModel.custom(e.context)
                }
                ...
                if (t !== (e ? e.type : "none")) {
                    if ("none" !== t) this._getBit(1) || this._setUpNoticeType(1), e || (e = this._set$P("cacheCanvas", _t.getItemByClass("cacheCanvas", Object))), e.type = t, e.reCache = !0, this._renderType |= 16, "bitmap" == t && this.conchModel && this.conchModel.cacheAs(1), this._set$P("cacheForFilters", !1);
                    else if (this._$P._mask);
                    else if (this._$P.hasFilter) this._set$P("cacheForFilters", !0);
                    else {
                        if (e) {
                            var i = e;
                            i && i.ctx && (_t.recover("RenderContext", i.ctx), i.ctx.canvas.size(0, 0), i.ctx = null), _t.recover("cacheCanvas", e)
                        }
                ...
                t && 0 === t.length && (t = null), this._$P.filters != t && (this._set$P("filters", t ? t.slice() : null), V.isConchApp && (this.conchModel && (i.RUNTIMEVERION < "0.9.1" ? this.conchModel.removeType(16) : this.conchModel.removeType(32)), this._$P.filters && 1 == this._$P.filters.length && this._$P.filters[0].callNative(this)), V.isWebGL && (t && t.length ? this._renderType |= 32 : this._renderType &= -33), t && 0 < t.length ? (this._getBit(1) || this._setUpNoticeType(1), V.isWebGL && 1 == t.length && t[0] instanceof laya.filters.ColorFilter || ("bitmap" != this.cacheAs && (V.isConchNode || (this.cacheAs = "bitmap"), this._set$P("cacheForFilters", !0)), this._set$P("hasFilter", !0))) : (this._set$P("hasFilter", !1), this._$P.cacheForFilters && "bitmap" == this.cacheAs && (this.cacheAs = "none")), this.repaint())
            }), u(0, t, "parent", s.prototype._$get_parent, function(t) {
                b.superSet(bt, this, "parent", t), t && this._getBit(2) && this._$2__onDisplay()
            }), u(0, t, "mask", function() {
        ...
        Ot = function(t) {
            ...
            p(e, "laya.media.h5audio.AudioSoundChannel", St);
            var i = e.prototype;
        ...
        Nt = function(t) {
            ...
            return i.play = function() {
                ...
                t.prototype.stop.call(this), this._clearBufferSource(), this.audioBuffer = null, this.gain && this.gain.disconnect(), this.isStopped = !0, N.removeChannel(this), this.completeHandler = null, N.autoReleaseSound && b.timer.once(5e3, null, N.disposeSoundIfNotUsed, [this.url], !1)
            }, i.pause = function() {
                this.isStopped || (this._pauseTime = this.position), this._clearBufferSource(), this.gain && this.gain.disconnect(), this.isStopped = !0, N.removeChannel(this), N.autoReleaseSound && b.timer.once(5e3, null, N.disposeSoundIfNotUsed, [this.url], !1)
            }, i.resume = function() {
        ...
        Gt = function(e) {
            function t() {
                this.loop = !1, this.wrapMode = 0, this._index = 0, this._count = 0, this._isPlaying = !1, this._labels = null, this._isReverse = !1, this._frameRateChanged = !1, this._controlNode = null, this._actionName = null, t.__super.call(this), this._interval = g.animationInterval, this._setUpNoticeType(1)
            }
            p(t, "laya.display.AnimationPlayerBase", e);
            var i = t.prototype;
        ...
        Wt = function(e) {
            ...
            return t.destroy = function(t) {
                ...
                for (var m = 0, v = 0, y = Math.min(this._lines.length, e + t) || 1, w = t; w < y; w++) {
                    ...
                    if (void 0 === T && (T = ""), m = r - (this._clipPoint ? this._clipPoint.x : 0), v = u + h * w - (this._clipPoint ? this._clipPoint.y : 0), this.underline && this.drawUnderline(o, m, v, w), l) {
                        var M = this.width;
                        l.autoScaleSize && (M = this.width * d), l.drawText(T, this, m, v, this.align, M)
                    } else V.isWebGL ? (this._words || (this._words = []), (x = this._words.length > w - t ? this._words[w - t] : new Tt).setText(T)) : x = T, _.stroke ? i.fillBorderText(x, m, v, n, this.color, _.strokeColor, _.stroke, o) : i.fillText(x, m, v, n, this.color, o)
                }
                ...
                if (V.isConchApp) {
                    ...
                    this._getCSSStyle().stroke && this._getCSSStyle().strokeColor && (t += " 1 " + this._getCSSStyle().strokeColor), Q.context.font = t
                } else Q.context.font = this._getCSSStyle().font;
                this._lines.length = 0, this._lineWidths.length = 0, this._isPassWordMode() ? this.parseLines(this._getPassWordTxt(this._text)) : this.parseLines(this._text), this.evalTextSize(), this.checkEnabledViewportOrNot() ? this._clipPoint || (this._clipPoint = new k(0, 0)) : this._clipPoint = null;
                var e = this._lines.length;
                if (this.overflow != d.VISIBLE) {
                    var i = this.overflow == d.HIDDEN ? Math.floor : Math.ceil;
                    e = Math.min(e, i((this.height - this.padding[0] - this.padding[2]) / (this.leading + this._charSize.height)))
                }
                var n = this.scrollY / (this._charSize.height + this.leading) | 0;
                this.renderText(n, e), this.repaint()
                ...
                if (this._currBitmapFont) this._charSize.width = this._currBitmapFont.getMaxWidth(), this._charSize.height = this._currBitmapFont.getMaxHeight();
                    ...
                    var n = Q.context.measureText(d._testWord);
                    V.isConchApp && 0 === n.width && 0 === n.height && (n = Q.context.measureText("W")), this._charSize.width = n.width, this._charSize.height = n.height || this.fontSize
                }
                ...
                var t = this.padding,
                    e = NaN;
                return (e = this._currBitmapFont && this._currBitmapFont.autoScaleSize ? this._width * (this._currBitmapFont.fontSize / this.fontSize) : this._width) <= 0 && (e = this.wordWrap ? 100 : Q.width), e <= 0 && (e = 100), e - t[3] - t[1]
                ...
                return (e || new k).setTo(this._startX + l - (this._clipPoint ? this._clipPoint.x : 0), this._startY + a * (this._charSize.height + this.leading) - (this._clipPoint ? this._clipPoint.y : 0))
            }, u(0, t, "width", function() {
                return this._width ? this._width : this.textWidth + this.padding[1] + this.padding[3]
            }, function(t) {
                t != this._width && (b.superSet(kt, this, "width", t), this.isChanged = !0)
            }), u(0, t, "textWidth", function() {
                return this._isChanged && b.timer.runCallLater(this, this.typeset), this._textWidth
            }), u(0, t, "height", function() {
                return this._height ? this._height : this.textHeight
            }, function(t) {
                t != this._height && (b.superSet(kt, this, "height", t), this.isChanged = !0)
                ...
                var t;
                (t = Q.canvas.source.style).display = "none", t.position = "absolute", t.direction = "rtl", V._mainCanvas.source.style.direction = "rtl", laya.display.Text.RightToLeft = !0, Q.document.body.appendChild(Q.canvas.source)
            }, d.supportFont = function(t) {
                Q.context.font = "10px sans-serif";
                var e = Q.context.measureText("abcji").width;
                Q.context.font = "10px " + t;
                var i = Q.context.measureText("abcji").width;
        ...
        Ut = function(c) {
            function o() {
                ...
                var e = this;
                this.transform = F.create(), this._scenes = [], this.mouseEnabled = !0, this.hitTestPrior = !0, this.autoSize = !1, this._displayedInStage = !0, this._isFocused = !0, this._isVisibility = !0, this.useRetinalCanvas = g.useRetinalCanvas;
                var t = Q.window,
                    i = this;
            ...
            return t._setStageVisible = function(t) {
                ...
                return Q.onMobile && Xt.isInputting
                ...
                var s = V._mainCanvas,
                    ...
                    u = g.useRetinalCanvas ? t : this.designWidth,
                    c = g.useRetinalCanvas ? e : this.designHeight,
                    _ = t,
                    d = e,
                    f = Q.pixelRatio;
                ...
                if (this._renderCount++, V.isFlash && this.repaint(), this._style.visible) {
                    ...
                    if (ft.renderSlow = !s, s || r || V.isConchApp) {
                        var o;
                        ft.loopCount++, x.instance.runEvent(), b.timer._update(), A.update3DLoop();
                        var a = 0,
                            h = 0;
                        if (V.isConchNode)
                ...
                this.designWidth = t, b.superSet(kt, this, "width", t), b.timer.callLater(this, this._changeCanvasSize)
                ...
                this.designHeight = t, b.superSet(kt, this, "height", t), b.timer.callLater(this, this._changeCanvasSize)
            }), u(0, t, "transform", function() {
                ...
                this._bgColor = t, this.conchModel && this.conchModel.bgColor(t), V.isWebGL && (t ? o._wgColor = st.create(t)._color : Q.onMiniGame || Q.onQGMiniGame || Q.onVVMiniGame || (o._wgColor = null)), Q.onLimixiu ? o._wgColor = st.create(t)._color : V.canvas.style.background = t || "none"
            }), u(0, t, "mouseX", function() {
                ...
                this.visible !== t && (b.superSet(kt, this, "visible", t), V._mainCanvas.source.style.visibility = t ? "visible" : "hidden")
        ...
        zt = (function(t) {
            ...
            p(e, "laya.resource.FileBitmap", Bt);
            var i = e.prototype;
        ...
        Ht = function(t) {
            function i(t, e) {
                ...
                var n = this;
                if (this._source = this, "2D" === t || "AUTO" === t && !V.isWebGL) {
                    this._is2D = !0, this._source = e || Q.createElement("canvas"), this._w = this._source.width, this._h = this._source.height;
                    var s = this;
                    s.getContext = function(t, e) {
                        if (n._ctx) return n._ctx;
                        var i = n._ctx = n._source.getContext(t, e);
                        return i && (i._canvas = s, V.isFlash || Q.onLimixiu || (i.size = function(t, e) {})), i
                    }
                }
                this.lock = !0
            }
            p(i, "laya.resource.HTMLCanvas", Bt);
            var e = i.prototype;
            return e.clear = function() {
                ...
                if (this._source)
                    if (V.isConchApp && this._source.toBase64) this._source.toBase64(t, e, i);
                    else {
    ...
    p(Yt, "laya.resource.HTMLSubImage", Bt), Yt.create = function(t, e, i, n, s, r, o, a) {
        return void 0 === a && (a = !1), new Yt(t, e, i, n, s, r, o, a)
    };
    ...
    function Yt(t, e, i, n, s, r, o, a) {
        ...
        e.destroy = function(t) {
            ...
            if (!t) return null;
            var e, i;
            for (i in e = {}, t) e[i] = vt.copyArray([], t[i]);
            return e
            ...
            return s._setFramesFromCache(n) || (It.getAtlas(e) ? t(e) : b.loader.load(e, v.create(null, t, [e]), null, "atlas")), this
        }, e.loadAnimation = function(t, e, i) {
            this._url = t;
            return this._actionName || (this._actionName = ""), this._setFramesFromCache(this._actionName) ? (this._setFramesFromCache(this._actionName, !0), this.index = 0, e && e.run()) : !i || It.getAtlas(i) ? this._loadAnimationData(t, e, i) : b.loader.load(i, v.create(this, this._loadAnimationData, [t, e, i]), null, "atlas"), this
        }, e._loadAnimationData = function(a, h, t) {
            var l = this;
            if (!t || It.getAtlas(t)) {
                var u = this;
                It.getRes(a) ? e(a) : b.loader.load(a, v.create(null, e, [a]), null, "json"), It.clearRes(a)
            ...
            function e(t) {
                if (It.getRes(t) && a === t) {
                    ...
                    if (c.framesMap[a + "#"]) u._setFramesFromCache(l._actionName, !0), l.index = 0, l._checkResumePlaying();
                        ...
                        var i = u._parseGraphicAnimation(It.getRes(a));
                        if (!i) return;
            ...
            return jt.parseAnimationData(t)
        }, e._parseGraphicAnimationByData = function(t) {
            return jt.parseAnimationByData(t)
            ...
            if ("string" == typeof t) {
                var o = It.getAtlas(t);
                if (o && o.length)
                    for (i = [], s = 0, r = o.length; s < r; s++)(n = new A.createGraphics).drawTexture(It.getRes(o[s]), 0, 0), i.push(n)
            } else if (t instanceof Array)
                for (i = [], s = 0, r = t.length; s < r; s++)(n = new A.createGraphics).loadImage(t[s], 0, 0), i.push(n);
    ...
    var Vt = function(t) {
            ...
            p(r, "laya.display.FrameAnimation", t);
            var e = r.prototype;
        ...
        Xt = function(e) {
            ...
            return t.setSelection = function(t, e) {
                ...
                this.padding;
                if (t.type = this._type, t.value = this._content, t.placeholder = this._prompt, b.stage.off("keydown", this, this._onKeyDown), b.stage.on("keydown", this, this._onKeyDown), (b.stage.focus = this).event("focus"), Q.onPC && t.focus(), !(Q.onMiniGame || Q.onBDMiniGame || Q.onTTMiniGame || Q.onQGMiniGame || Q.onVVMiniGame || Q.onBLMiniGame || Q.onAlipayMiniGame)) {
                    this._text;
                    this._text = null
                }
                this.typeset(), t.setColor(this._originColor), t.setBgColor && t.setBgColor(this.bgColor), t.setFontSize(this.fontSize), t.setFontFace(Q.onIPhone && Wt._fontFamilyMap[this.font] || this.font), V.isConchApp && t.setMultiAble && t.setMultiAble(this._multiline), e.lineHeight = this.leading + this.fontSize + "px", e.fontStyle = this.italic ? "italic" : "normal", e.fontWeight = this.bold ? "bold" : "normal", e.textAlign = this.align, e.padding = "0 0", this._syncInputTransform(), !V.isConchApp && Q.onPC && b.timer.frameLoop(1, this, this._syncInputTransform)
                ...
                laya.display.Input.isInputting = !1, this._focus = !1, this._text = null, this._content = this.nativeInput.value, this._content ? (b.superSet(Wt, this, "text", this._content), b.superSet(Wt, this, "color", this._originColor)) : (b.superSet(Wt, this, "text", this._prompt), b.superSet(Wt, this, "color", this._promptColor)), b.stage.off("keydown", this, this._onKeyDown), b.stage.focus = null, this.event("blur"), V.isConchApp && this.nativeInput.blur(), Q.onPC && b.timer.clear(this, this._syncInputTransform)
                ...
                this._focus && this.nativeInput.setColor(t), b.superSet(Wt, this, "color", this._content ? t : this._promptColor), this._originColor = t
                ...
                b.superSet(Wt, this, "color", this._originColor), t += "", this._focus ? (this.nativeInput.value = t || "", this.event("change")) : (this._multiline || (t = t.replace(/\r?\n/g, "")), (this._content = t) ? b.superSet(Wt, this, "text", t) : (b.superSet(Wt, this, "text", this._prompt), b.superSet(Wt, this, "color", this.promptColor)))
            }), u(0, t, "nativeInput", function() {
                return this._multiline ? s.area : s.input
            }), u(0, t, "prompt", function() {
                return this._prompt
            }, function(t) {
                !this._text && t && b.superSet(Wt, this, "color", this._promptColor), this.promptColor = this._promptColor, this._text ? b.superSet(Wt, this, "text", this._text == this._prompt ? t : this._text) : b.superSet(Wt, this, "text", t), this._prompt = Wt.langPacks && Wt.langPacks[t] ? Wt.langPacks[t] : t
                ...
                this._promptColor = t, this._content || b.superSet(Wt, this, "color", t)
            }), u(0, t, "type", function() {
                return this._type
            }, function(t) {
                ...
                if (s._createInputElement(), Q.onMobile) {
                    var t = !1;
                    (Q.onMiniGame || Q.onBDMiniGame || Q.onKGMiniGame || Q.onTTMiniGame || Q.onQGMiniGame || Q.onVVMiniGame || Q.onBLMiniGame || Q.onAlipayMiniGame || Q.onQQMiniGame) && (t = !0), V.canvas.addEventListener(s.IOS_IFRAME ? t ? "touchend" : "click" : "touchend", s._popupInputMethod)
                }
                ...
                s._initInput(s.area = Q.createElement("textarea")), s._initInput(s.input = Q.createElement("input")), (s.inputContainer = Q.createElement("div")).style.position = "absolute", s.inputContainer.style.zIndex = 1e5, Q.container.appendChild(s.inputContainer), s.inputContainer.setPos = function(t, e) {
        ...
        $t = function(t) {
            ...
            p(i, "laya.resource.HTMLImage", zt);
            var e = i.prototype;
            return e._init_ = function(t, e) {
                ...
                if (this._needReleaseAgain = !1, this._source) {
                    ...
                    var e = this;
                    this._source = new Q.window.Image, this._source.crossOrigin = "", this._source.onload = function() {
        ...
        jt = (function(r) {
            ...
            p(t, "laya.display.EffectAnimation", r);
            var e = t.prototype;
            e._onOtherBegin = function(t) {
                ...
                if (this._target) {
                    ...
                    a = t.secondFrames;
                    var _, d, f, p, g = 0;
                    for (u = 0; u < c; u++) r = h[s = l[u]], o = -1 == (g = a[s]) ? this._initData[s] : e < g ? (f = (d = t.keyframes[s])[0]).tween ? (null == (_ = at[f.tweenMethod]) && (_ = at.linearNone), p = d[1], _(e, this._initData[s], p.value - this._initData[s], p.index)) : this._initData[s] : r.length > e ? r[e] : r[r.length - 1], n[s] = o
                }
            }, e._calculateNodeKeyFrames = function(t) {
                ...
                var e, i;
                this._effectClass = it.getClass(t), !this._effectClass || (e = this._effectClass.uiView) && (i = e.animations) && i[0] && (this._setUp({}, i[0]), i[0].nodes && i[0].nodes[0] && (this._aniKeys = i[0].nodes[0].keys))
            ...
            p(E, "laya.utils.GraphicAnimation", e);
            var t = E.prototype;
            return t._parseNodeList = function(t) {
                ...
                var e = A.createGraphics();
                return E._rootMatrix || (E._rootMatrix = new F), this._updateNodeGraphic(this._rootNode, t, E._rootMatrix, e), e
                ...
                i || (i = P.create()), i.transform ? i.transform.identity() : i.transform = F.create();
                ...
                return w && (r = F.mul(r, w, r)), r.translate(a[1], a[2]), i
                ...
                p(t, ""), t.prototype.recover = function() {
