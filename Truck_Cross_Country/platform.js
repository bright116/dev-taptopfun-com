    ...
    class platform {
        ...
        createLogo() {
            ...
            if (!window.yad) {
                ...
                Laya.loader.load("yad.png", Laya.Handler.create(this, () => {
            ...
            Laya.loader.load("cnf.json", Laya.Handler.create(this, (res) => {
                YYGGames.startupByYad({
                    ...
                    complete: () => {
                        ...
                        window.scrollList.scaleX = 0.86;
                        window.scrollList.scaleY = 0.86;
                        window.scrollList.bottom = 30;


                        window.box_adTwo.bottom = 180;

                        window.box_adTwo.setSize(200, 150);
                        window.box_adTwo.setSpaceX(120);
                        window.box_adTwo.scaleX = 0.8;
                        window.box_adTwo.scaleY = 0.8;
            ...
            if (!this._scrollList) {
                ...
                class scrollListScript extends Laya.Script {
                    ...
                    onEnable() {
                        ...
                        // window.scrollListOwner = this.owner;
                        // window.scrollListImg_ListBg = this.img_ListBg;


                        // window.scrollListOwner && (window.scrollListOwner.width = 1560);
                        // window.scrollListImg_ListBg && (window.scrollListImg_ListBg.width = 1560);
                        this.owner.width = 1560;
                        this.img_ListBg.width = 1580;
                    }
