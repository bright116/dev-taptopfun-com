function aldJs() {
    ...
    function c(e, t) {
        ...
        S++, e.as = b, e.at = I, e.rq_c = S, e.ifo = p, e.ak = g.app_key, e.uu = m, e.v = l,
            e.st = Date.now(), e.ev = t, e.wsr = x, "" !== u(e.ufo) && (e.ufo = e.ufo), e.ec = y,
            wx.Queue.push(n);
    }
    ...
    var P = {
        aldSendEvent: function(e, t) {
            ...
            "" !== e && "string" == typeof e && e.length <= 255 ? (n.tp = e, "string" == typeof t && t.length <= 255 ? (n.ct = String(t),
                c(n, "event")) : "object" == typeof t ? (JSON.stringify(t).length >= 255 && console.error("自定义事件参数不能超过255个字符"),
        ...
        aldOnShareAppMessage: function(e) {
            wx.onShareAppMessage(function() {
                ...
                n = void 0 !== x.query.ald_share_src ? void 0 !== t.query ? (x.query.ald_share_src.indexOf(m),
                    ...
                    "undefined" != s(t.ald_desc) && (n += "&ald_desc=" + t.ald_desc), t.query = n;
                var r = d(v);
        ...
        aldShareAppMessage: function(e) {
            ...
            n = void 0 !== x.query.ald_share_src ? void 0 !== t.query ? (x.query.ald_share_src.indexOf(m),
                ...
                "ald_share_src=" + x.query.ald_share_src + "," + m) : void 0 !== t.query ? t.query + "&ald_share_src=" + m : "ald_share_src=" + m;
            var r = d(v);
            "undefined" != s(t.ald_desc) && (n += "&ald_desc=" + t.ald_desc), t.query = n, r.ct = t,
                r.tp = "ald_share_chain", c(r, "event"), wx.shareAppMessage(t);
        },
