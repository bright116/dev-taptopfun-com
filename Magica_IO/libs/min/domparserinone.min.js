            ...
            switch (m > p && appendText(m), e.charAt(m + 1)) {
                ...
                default:
                    ...
                    var S = new ElementAttributes(),
                        ...
                        v = (h = parseElementStartPart(e, m, S, A, entityReplacer, o),
                            S.length);
...
function DOMException(e, n) {
    ...
    else r = this, Error.call(this, ExceptionMessage[e]),
        ...
        case ELEMENT_NODE:
            ...
            if (c || r && !/^(?:meta|link|img|br|hr|input)$/i.test(u)) {
                if (n.push(">"), r && /^script$/i.test(u))
                    for (; c;) c.data ? n.push(c.data) : serializeToString(c, n, r, i, o),
                        c = c.nextSibling;
                else
...
function importNode(e, n, r) {
    ...
    if (i || (i = n.cloneNode(!1)), i.ownerDocument = e, i.parentNode = null, r)
        for (var o = n.firstChild; o;) i.appendChild(importNode(e, o, r)),
            o = o.nextSibling;
    return i;
}
