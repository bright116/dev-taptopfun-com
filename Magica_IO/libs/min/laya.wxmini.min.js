window.wxMiniGame = function(e, t) {
    ...
    class i {
        static isLocalNativeFile(e) {
            for (var t = 0, i = r.nativefiles.length; t < i; t++)
                if (-1 != e.indexOf(r.nativefiles[t])) return !0;
            return !1;
        }
        static isNetFile(e) {
    ...
    class n extends t.EventDispatcher {
        ...
        load(e) {
            ...
            if (this.url = e, this.readyUrl = e, r.autoCacheFile && i.getFileInfo(e)) this.onDownLoadCallBack(e, 0);
            else if (r.autoCacheFile)
                if (i.isLocalNativeFile(e)) {
                    if (r.subNativeFiles && 0 == r.subNativeheads.length)
                        for (var n in r.subNativeFiles) {
    ...
    class s {
        ...
        static _createInputElement() {
            ...
            var e = r.systemInfo.model,
                i = r.systemInfo.system; -
    ...
    class o extends t.EventDispatcher {
        ...
        static onReadNativeCallBack(e, i = null, a = null, n = 0, s = null) {
            var o;
            n ? 1 == n && a._loadHttpRequest(e, i, a, a.onLoaded, a, a.onProgress, a, a.onError) : (o = i == t.Loader.JSON || i == t.Loader.ATLAS || i == t.Loader.PREFAB || i == t.Loader.PLF ? r.getJson(s.data) : i == t.Loader.XML ? t.Utils.parseXMLFromString(s.data) : s.data, !r.isZiYu && r.isPosMsgYu && i != t.Loader.BUFFER && r.window.wx.postMessage({
                url: e,
                data: o,
                isLoad: "filedata"
            }), a.onLoaded(o));
        ...
        static _transformImgUrl(e, a, n) {
            if (r.isZiYu || i.isLocalNativeFile(e)) n._loadImage(e, !1);
            else if (r.autoCacheFile) {
                var s = t.URL.formatURL(e);
    ...
    class r {
        ...
        static sendAtlasToOpenDataContext(e) {
            if (!r.isZiYu) {
                ...
                if (i.meta && i.meta.image)
                    for (var a = i.meta.image.split(","), n = e.indexOf("/") >= 0 ? "/" : "\\", s = e.lastIndexOf(n), o = s >= 0 ? e.substr(0, s + 1) : "", l = 0, d = a.length; l < d; l++) a[l] = o + a[l];
        ...
        static postInfoToContext(e, a, n) {
            var s = {
                ...
                o = a,
                l = i.getFileInfo(t.URL.formatURL(a));
            if (l) var d = l.tempFilePath || i.getFileNativePath(l.md5);
            else d = o;
