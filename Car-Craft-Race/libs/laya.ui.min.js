!function() {
    ...
    var _createForOfIteratorHelper2 = require("../../runtime/helpers/createForOfIteratorHelper");
    ...
    !function (t, e) {
        ...
        var h = /*#__PURE__*/function (_e$Graphics) {
            ...
            _createClass2(h, [{
                ...
                value: function changeSource() {
                    ...
                    if (t && t.bitmap) {
                        var e = this.width,
                            ...
                            _h = t.sourceWidth,
                            a = t.sourceHeight;
                        if (i && (_h !== e || a !== s)) return this.clear(), this.draw9Grid(t, 0, 0, e, s, i), void this._repaint();
                ...
                value: function getTexture(t, s, i, _h3, a) {
                    var r;
                    return _h3 <= 0 && (_h3 = 1), a <= 0 && (a = 1), t.$_GID || (t.$_GID = e.Utils.getGID()), r && r._getSource() || (r = e.Texture.createFromTexture(t, s, i, _h3, a)), r;
                }
            }]);
        ...
        var n = /*#__PURE__*/function (_e$Sprite) {
            ...
            _createClass2(n, [{
                ...
                value: function set_scaleX(t) {
                    _get2(_getPrototypeOf2(n.prototype), "get_scaleX", this).call(this) != t && (_get2(_getPrototypeOf2(n.prototype), "set_scaleX", this).call(this, t), this.event(e.Event.RESIZE));
                }
            }, {
                key: "scaleY",
                get: function get() {
                ...
                value: function set_scaleY(t) {
                    _get2(_getPrototypeOf2(n.prototype), "get_scaleY", this).call(this) != t && (_get2(_getPrototypeOf2(n.prototype), "set_scaleY", this).call(this, t), this.event(e.Event.RESIZE));
                }
            }, {
                key: "onCompResize",
        ...
        var v = /*#__PURE__*/function (_n7) {
            ...
            _createClass2(v, [{
                ...
                value: function destroy() {
                    var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !0;
                    _get2(_getPrototypeOf2(v.prototype), "destroy", this).call(this, t), this._bg && this._bg.destroy(t), this._bar && this._bar.destroy(t), this._progress && this._progress.destroy(t), this._bg = null, this._bar = null, this._progress = null, this.changeHandler = null;
                }
            }, {
                key: "createChildren",
                value: function createChildren() {
                ...
                key: "_sizeChanged",
                value: function _sizeChanged() {
                    _get2(_getPrototypeOf2(v.prototype), "_sizeChanged", this).call(this), this.isVertical ? this._bg.height = this.height : this._bg.width = this.width, this.setBarPoint(), this.changeValue();
                }
            }, {
                key: "sizeGrid",
                get: function get() {
        ...
        var m = /*#__PURE__*/function (_n8) {
            ...
            _createClass2(m, [{
                ...
                value: function destroy() {
                    var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !0;
                    this.stopScroll(), this.target = null, _get2(_getPrototypeOf2(m.prototype), "destroy", this).call(this, t), this.upButton && this.upButton.destroy(t), this.downButton && this.downButton.destroy(t), this.slider && this.slider.destroy(t), this.upButton = this.downButton = null, this.slider = null, this.changeHandler = null, this._offsets = null;
                }
            }, {
                key: "createChildren",
                value: function createChildren() {
                ...
                key: "_sizeChanged",
                value: function _sizeChanged() {
                    _get2(_getPrototypeOf2(m.prototype), "_sizeChanged", this).call(this), this.repaint(), this.resetPositions(), this.event(e.Event.CHANGE), this.changeHandler && this.changeHandler.runWith(this.value);
                }
            }, {
                key: "resetPositions",
        ...
        var b = /*#__PURE__*/function (_c) {
            ...
            _createClass2(b, [{
                ...
                value: function destroy() {
                    var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !0;
                    this._content && this._content.destroy(t), this._scrollBar && this._scrollBar.destroy(t), _get2(_getPrototypeOf2(b.prototype), "destroy", this).call(this, t), this._content = null, this._scrollBar = null, this._itemRender = null, this._cells = null, this._array = null, this.selectHandler = this.renderHandler = this.mouseHandler = null;
                }
            }, {
                key: "createChildren",
                value: function createChildren() {
                ...
                set: function set(t) {
                    _set2(_getPrototypeOf2(b.prototype), "cacheAs", t, this, true), this._scrollBar && (this._usedCache = null, "none" !== t ? this._scrollBar.on(e.Event.START, this, this.onScrollStart) : this._scrollBar.off(e.Event.START, this, this.onScrollStart));
                }
            }, {
                key: "onScrollStart",
                value: function onScrollStart() {
                    this._usedCache || (this._usedCache = _get2(_getPrototypeOf2(b.prototype), "cacheAs", this)), _set2(_getPrototypeOf2(b.prototype), "cacheAs", "none", this, true), this._scrollBar.once(e.Event.END, this, this.onScrollEnd);
                }
            }, {
                key: "onScrollEnd",
                ...
                set: function set(t) {
                    t != this._width && (_set2(_getPrototypeOf2(b.prototype), "width", t, this, true), this._setCellChanged());
                }
            }, {
                key: "height",
                get: function get() {
                ...
                set: function set(t) {
                    t != this._height && (_set2(_getPrototypeOf2(b.prototype), "height", t, this, true), this._setCellChanged());
                }
            }, {
                key: "repeatX",
                get: function get() {
                ...
                key: "_sizeChanged",
                value: function _sizeChanged() {
                    _get2(_getPrototypeOf2(b.prototype), "_sizeChanged", this).call(this), this.setContentSize(this.width, this.height), this._scrollBar && this.callLater(this.onScrollBarChange);
                }
            }, {
        ...
        var y = /*#__PURE__*/function (_n9) {
            ...
            _createClass2(y, [{
                ...
                value: function destroy() {
                    var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !0;
                    _get2(_getPrototypeOf2(y.prototype), "destroy", this).call(this, t), this._button && this._button.destroy(t), this._list && this._list.destroy(t), this._button = null, this._list = null, this._itemColors = null, this._labels = null, this._selectHandler = null;
                }
            }, {
                key: "createChildren",
                value: function createChildren() {
                ...
                set: function set(t) {
                    _set2(_getPrototypeOf2(y.prototype), "width", t, this, true), this._button.width = this._width, this._itemChanged = !0, this._listChanged = !0;
                }
            }, {
                key: "height",
                get: function get() {
        ...
        var X = /*#__PURE__*/function (_e$Sprite2) {
            ...
            function X() {
                ...
                }, _this28.popupEffectHandler = new e.Handler(_assertThisInitialized2(_this28), _this28.popupEffect), _this28.closeEffectHandler = new e.Handler(_assertThisInitialized2(_this28), _this28.closeEffect), _this28.mouseEnabled = _this28.maskLayer.mouseEnabled = !0, _this28.zOrder = 1e3, e.ILaya.stage.addChild(_assertThisInitialized2(_this28)), e.ILaya.stage.on(e.Event.RESIZE, _assertThisInitialized2(_this28), _this28._onResize), s.closeDialogOnSide && _this28.maskLayer.on("click", _assertThisInitialized2(_this28), _this28._closeOnSide), _this28._onResize(null);
                return _this28;
            }
        ...
        var G = /*#__PURE__*/function (_Y) {
            ...
            function G() {
                ...
                _this29 = _super38.call(this), _this29.isShowEffect = !0, _this29.isPopupCenter = !0, _this29.popupEffect = G.manager.popupEffectHandler, _this29.closeEffect = G.manager.closeEffectHandler, _this29._dealDragArea(), _this29.on(e.Event.CLICK, _assertThisInitialized2(_this29), _this29._onClick);
                return _this29;
            }
        ...
        var W = /*#__PURE__*/function (_n11) {
            ...
            function W() {
                ...
                _this30 = _super39.call(this), _this30._tipBox = new n(), _this30._tipBox.addChild(_this30._tipText = new e.Text()), _this30._tipText.x = _this30._tipText.y = 5, _this30._tipText.color = W.tipTextColor, _this30._defaultTipHandler = _this30._showDefaultTip, e.ILaya.stage.on(r.SHOW_TIP, _assertThisInitialized2(_this30), _this30._onStageShowTip), e.ILaya.stage.on(r.HIDE_TIP, _assertThisInitialized2(_this30), _this30._onStageHideTip), _this30.zOrder = 1100;
                return _this30;
            }
