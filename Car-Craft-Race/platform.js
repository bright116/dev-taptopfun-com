		...
		scrollList() {
			...
			if (!this._scrollList) {
				let scrollListJson = {
					...
					"props": { "y": 0, "x": 0, "width": 880, "repeatY": 1, "presetID": 1, "preset": "laya/pages/prefab/scrollList.prefab", "name": "scrollAdList", "isPresetRoot": true, "height": 170, "hScrollBarSkin": " ", "anchorY": 0.5, "anchorX": 0.5 },
					"nodeParent": -1,
					"maxID": 145,
					"label": "scrollAdList",
					"isOpen": true,
					...
					"child": [
						...
						},
						{
							...
							"type": "Box",
							"searchKey": "Box",
							"props": { "x": 0, "width": 220, "renderType": "render", "presetID": 3, "preset": "laya/pages/prefab/scrollList.prefab", "height": 170 },
							"nodeParent": 144,
							...
							"child": [
								{
									...
									"props": { "width": 200, "presetID": 4, "preset": "laya/pages/prefab/scrollList.prefab", "name": "thumb", "height": 150, "centerY": 0, "centerX": 0, "anchorY": 0.5, "anchorX": 0.5 },
									"nodeParent": 119,
									"label": "thumb",
									"isOpen": true,
									"isDirectory": true,
				...
				class scrollListScript extends Laya.Script {
					...
					onEnable() {
						...
						!this.owner.renderHandler && (this.owner.renderHandler = new Laya.Handler(this, this.itemRenderFun))
					...
					itemRenderFun(e, index) {
						...
						if (this.sizeTran[2]) {
							...
							let scaleNum = 200 / this.sizeTran[0] < 150 / this.sizeTran[1] ? 200 / this.sizeTran[0] : 150 / this.sizeTran[1];
		...
		box_adTwo() {
			...
			if (!this._box_adTwo) {
				let box_adTwoJSON = {
					...
					"props": { "y": 0, "x": 0, "width": 1, "presetID": 1, "preset": "laya/pages/prefab/box_adTwo.prefab", "name": "box_adTwo", "isPresetRoot": true, "height": 1, "centerX": 0, "anchorY": 0.5, "anchorX": 0.5 },
					"nodeParent": -1,
					"maxID": 153,
					"label": "box_adTwo",
					"isOpen": true,
							...
							"child": [
								{
									...
									"props": { "width": 200, "presetID": 3, "preset": "laya/pages/prefab/box_adTwo.prefab", "name": "img_adImg", "height": 150, "centerY": 0, "centerX": 0 },
									"nodeParent": 147,
									"label": "img_adImg",
									"isOpen": true,
									"isDirectory": true,
							...
							"child": [
								{
									...
									"type": "Image",
									"searchKey": "Image,img_adImg",
									"props": { "width": 200, "presetID": 6, "preset": "laya/pages/prefab/box_adTwo.prefab", "name": "img_adImg", "height": 150, "centerY": 0, "centerX": 0 },
									"nodeParent": 148,
									"label": "img_adImg",
									"isOpen": true,
									"isDirectory": true,
