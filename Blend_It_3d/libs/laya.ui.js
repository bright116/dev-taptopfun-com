! function(t, e) {
    ...
    class o extends n {
        ...
        set skin(t) {
            if (this._skin != t && !this.destroyed) {
                if (this._skin = t, t) {
        ...
        setSource(t, e = null) {
            t === this._skin && e && !this.destroyed && (this.source = e, this.onCompResize())
        }
        measureWidth() {
    ...
    class m extends n {
        ...
        _skinLoaded() {
            this.slider && (this.slider.skin = this._skin, this.callLater(this.changeScrollBar), this._sizeChanged(), this.event(e.Event.LOADED))
        }
        changeScrollBar() {
    ...
    class w extends n {
        ...
        _skinLoaded() {
            this._bg && (this._bg.skin = this._skin, this._bar.skin = this._skin.replace(".png", "$bar.png"), this.callLater(this.changeValue), this._sizeChanged(), this.event(e.Event.LOADED))
        }
        measureWidth() {
