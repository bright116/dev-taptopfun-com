window.zs = window.zs || {}, window.zs.laya = window.zs.laya || {}, function(t, e) {
    ...
    class s extends e.Script {
        ...
        applyLayout() {
            ...
            this.topUI && (this.topUI.top = this.applyStatusBar ? zs.laya.DeviceService.statusBarHeight() * e.stage.height / zs.laya.DeviceService.screenHeight() : 0, 
    ...
    class i extends a {
        ...
        onAwake() {
            super.onAwake(), this.owner.addComponent(s).initLayout(!0);
        }
        onEnable() {
            super.onEnable();
