self.Box2DWasmModule = function(Box2D) {
    ...
    if (ea) {
        ...
        console.warn(a)
    })) : b.print || (b.print = function() {}), da && (b.load = importScripts), "undefined" === typeof b.setWindowTitle && (b.setWindowTitle = function(a) {
        document.title = a
    });
                    ...
                    a: {
                        ...
                        if (16 < l - g && d.subarray && Ka) g = Ka.decode(d.subarray(g, l));
                            ...
                            for (var m, D, G, na, wa, V, l = "";;) {
                                ...
                                m & 128 ? (D = d[g++] & 63, 192 == (m & 224) ? l += String.fromCharCode((m & 31) << 6 | D) : (G = d[g++] & 63, 224 == (m & 240) ? m = (m & 15) << 12 | D << 6 | G : (na = d[g++] & 63, 240 == (m & 248) ? m = (m & 7) << 18 | D << 12 | G << 6 | na : (wa = d[g++] & 63, 248 == (m & 252) ? m = (m & 3) << 24 | D << 18 | G << 12 | na << 6 | wa : (V = d[g++] & 63, m = (m & 1) << 30 | D << 24 | G << 18 | na << 12 | wa << 6 | V))), 65536 > m ? l += String.fromCharCode(m) : (m -= 65536, l += String.fromCharCode(55296 | m >> 10, 56320 | m & 1023)))) : l += String.fromCharCode(m)
                            }
                    }
                    e(g);
                    d.length = 0
    ...
    function ex(a) {
        ...
        if (!(0 < tb)) {
            ...
            hb(ib);
            0 < tb || b.calledRun || (b.setStatus ? (b.setStatus("Running..."), setTimeout(function() {
                setTimeout(function() {
                    b.setStatus("")
                }, 1);
                c()
