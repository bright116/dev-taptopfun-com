    ...
    class platform {
        ...
        prompt(msg, duration) {
            if (!this.prompt_) {
                ...
                this.prompt_.style.cssText = "overflow: hidden;word-break: break-all;word-wrap: break-word;font-family:siyuan;padding:8px 10px 10px 18px;min-height:20px;color: rgb(255, 255, 255);line-height: 20px;text-align:center;border-radius: 4px;position: fixed;top: 40%;left: 50%;transform: translate(-50%, -50%);z-index: 999999;background: rgba(0, 0, 0,.7);font-size: 15px;";
