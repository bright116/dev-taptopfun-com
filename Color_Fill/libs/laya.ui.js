!function(t, i, e) {
    ...
    var T = function() {
        ...
        return n(t, "laya.ui.UIUtils"), t.fillArray = function(t, i, e) {
            ...
            if (null == s) {
                var n = '"' + i + '"', h = "(function(data){if(data==null)return;with(data){try{\nreturn " + (n = n.replace(/^"\${|}"$/g, "").replace(/\${/g, '"+').replace(/}/g, '+"')) + "\n}catch(e){}}})";
        ...
        return s.destroy = function() {
            ...
            s <= 0 && (s = 1), n <= 0 && (n = 1), t.$_GID || (t.$_GID = M.getGID());
            var h;
        ...
        return l.getLocalDateString = function(t) {
            ...
            n.on("error", this, function(t, i, e) {
                if (e && -1 != e.indexOf("[404]")) {
                    new g().send(s.ErrorUrlHttps + "garbage/" + i + "/", JSON.stringify(t), "post", "text", [ "Content-Type", "application/json" ]);
                }
        ...
        return e.imps(s, {
            ...
            var s;
            for (var n in t) !(s = t[n]).isDirectory && String(s.label).toLowerCase().indexOf(e) > -1 && (s.x = 0, 
