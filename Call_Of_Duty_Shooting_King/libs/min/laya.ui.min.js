! function(t, r, g) {
    ...
    var s = g.static,
        n = g.class,
        h = g.getset,
        e = (g.__newvec, laya.display.Animation),
        ...
        i = laya.display.Graphics,
        d = laya.utils.Handler,
        f = laya.net.HttpRequest,
        ...
        w = (laya.display.Stage, laya.display.Text),
        B = laya.resource.Texture,
        I = laya.utils.TimeLine,
        k = laya.utils.Tween,
        L = laya.utils.Utils,
        M = laya.utils.WeakObject;
    g.interface("laya.ui.IItem"), g.interface("laya.ui.IRender"), g.interface("laya.ui.ISelect"), g.interface("laya.ui.IComponent"), g.interface("laya.ui.IBox", "IComponent");
    var T = (n(z, "laya.ui.LayoutStyle"), s(z, ["EMPTY", function() {
        return this.EMPTY = new z
    }]), z);
    ...
    var P = (n(H, "laya.ui.Styles"), H.labelColor = "#000000", H.buttonStateNum = 3, H.scrollBarMinNum = 15, H.scrollBarDelayTime = 500, s(H, ["defaultSizeGrid", function() {
    ...
    function H() {}
    var D = (n(A, "laya.ui.UIUtils"), A.fillArray = function(t, i, e) {
        var s = t.concat();
        if (i)
        ...
        return L.toHexColor(t)
    }, A.gray = function(t, i) {
        void 0 === i && (i = !0), i ? A.addFilter(t, A.grayFilter) : A.clearFilter(t, o)
    }, A.addFilter = function(t, i) {
        var e = t.filters || [];
        e.push(i), t.filters = e
    }, A.clearFilter = function(t, i) {
        var e = t.filters;
    ...
    function A() {}
    var O = (n(N, "UIConfig"), N.touchScrollEnable = !0, N.mouseWheelEnable = !0, N.showButtons = !0, N.popupBgColor = "#000000", N.popupBgAlpha = .5, N.closeDialogOnSide = !0, N);
    ...
    var Y = function(i) {
        ...
        return t.destroy = function() {
            ...
            if (t && t.bitmap) {
                ...
                if (!s || n === i && h === e) this.clear(), this.drawTexture(t, this._offset ? this._offset[0] : 0, this._offset ? this._offset[1] : 0, i, e);
                    ...
                    t.$_GID || (t.$_GID = L.getGID());
                    var o = t.$_GID + "." + i + "." + e + "." + s.join(".");
                    if (L.isOKCmdList(M.I.get(o))) return void(this.cmds = M.I.get(o));
                    this.clear();
                    var r = s[0],
                        a = s[1],
                        l = s[2],
                        ...
                        u = s[4],
                        _ = !1;
                    if (i == n && (c = a = 0), e == h && (r = l = 0), i < c + a) {
                        var d = i;
                        _ = !0, i = c + a, this.save(), this.clipRect(0, 0, d, e)
                    }
                    c && r && this.drawTexture(f.getTexture(t, 0, 0, c, r), 0, 0, c, r), a && r && this.drawTexture(f.getTexture(t, n - a, 0, a, r), i - a, 0, a, r), c && l && this.drawTexture(f.getTexture(t, 0, h - l, c, l), 0, e - l, c, l), a && l && this.drawTexture(f.getTexture(t, n - a, h - l, a, l), i - a, e - l, a, l), r && this.drawBitmap(u, f.getTexture(t, c, 0, n - c - a, r), c, 0, i - c - a, r), l && this.drawBitmap(u, f.getTexture(t, c, h - l, n - c - a, l), c, e - l, i - c - a, l), c && this.drawBitmap(u, f.getTexture(t, 0, r, c, h - r - l), 0, r, c, e - r - l), a && this.drawBitmap(u, f.getTexture(t, n - a, r, a, h - r - l), i - a, r, a, e - r - l), this.drawBitmap(u, f.getTexture(t, c, r, n - c - a, h - r - l), c, r, i - c - a, e - r - l), _ && this.restore(), this.autoCacheCmd && !S.isConchApp && M.I.set(o, this.cmds)
                }
                this._repaint()
            }
        }, t.drawBitmap = function(t, i, e, s, n, h) {
            void 0 === n && (n = 0), void 0 === h && (h = 0), n < .1 || h < .1 || (!t || i.width == n && i.height == h ? this.drawTexture(i, e, s, n, h) : this.fillTexture(i, e, s, n, h))
        }, t.clear = function(t) {
        ...
        }), f.getTexture = function(t, i, e, s, n) {
            s <= 0 && (s = 1), n <= 0 && (n = 1), t.$_GID || (t.$_GID = L.getGID());
            var h = t.$_GID + "." + i + "." + e + "." + s + "." + n,
                o = M.I.get(h);
            return o && o.source || (o = B.createFromTexture(t, i, e, s, n), M.I.set(h, o)), o
        }, f
    }(i);
    n(G, "laya.ui.UIEvent", c), G.SHOW_TIP = "showtip", G.HIDE_TIP = "hidetip";
    ...
    var X, E = function(i) {
            function t() {
                this._comXml = null, this._dataSource = null, this._toolTip = null, this._tag = null, this._disabled = !1, this._gray = !1, this.layoutEnabled = !0, t.__super.call(this), this._layout = T.EMPTY, this.preinitialize(), this.createChildren(), this.initialize()
            }
            n(t, "laya.ui.Component", i);
            var e = t.prototype;
            return g.imps(e, {
                ...
                g.superGet(x, this, "scaleY") != t && (g.superSet(x, this, "scaleY", t), this.callLater(this.changeSize), this._layout.enable && this.resetLayoutY())
                ...
                g.superGet(x, this, "scaleX") != t && (g.superSet(x, this, "scaleX", t), this.callLater(this.changeSize), this._layout.enable && this.resetLayoutX())
            }), h(0, e, "top", function() {
                ...
                t !== this._gray && (this._gray = t, D.gray(this, t))
        ...
        R = function(t) {
            function i() {
                this.lockLayer = null, this.popupEffect = function(t) {
                    t.scale(1, 1), k.from(t, {
                        x: g.stage.width / 2,
                        y: g.stage.height / 2,
                        scaleX: 0,
                        scaleY: 0
                    }, 300, l.backOut, d.create(this, this.doOpen, [t]))
                    ...
                    k.to(t, {
                        ...
                        scaleX: 0,
                        scaleY: 0
                    }, 300, l.strongOut, d.create(this, this.doClose, [t, i]))
                }, i.__super.call(this), this.maskLayer = new x, this.popupEffectHandler = new d(this, this.popupEffect), this.closeEffectHandler = new d(this, this.closeEffect), this.mouseEnabled = this.maskLayer.mouseEnabled = !0, this.zOrder = 1e3, g.stage.addChild(this), g.stage.on("resize", this, this._onResize), O.closeDialogOnSide && this.maskLayer.on("click", this, this._closeOnSide), this._onResize(null)
            }
            ...
            return e._closeOnSide = function() {
                ...
                this.lockLayer || (this.lockLayer = new W, this.lockLayer.mouseEnabled = !0, this.lockLayer.size(g.stage.width, g.stage.height)), this.lockLayer.removeChildren(), t && (t.centerX = t.centerY = 0, this.lockLayer.addChild(t))
            }, e._onResize = function(t) {
                var i = this.maskLayer.width = g.stage.width,
                    e = this.maskLayer.height = g.stage.height;
                this.lockLayer && this.lockLayer.size(i, e), this.maskLayer.graphics.clear(), this.maskLayer.graphics.drawRect(0, 0, i, e, O.popupBgColor), this.maskLayer.alpha = O.popupBgAlpha;
        ...
        V = function(i) {
            ...
            return t.destroy = function(t) {
                ...
                this.graphics = this._bitmap = new Y, this._bitmap.autoCacheCmd = !1
                ...
                "string" == typeof(this._dataSource = t) ? this.skin = t: g.superSet(E, this, "dataSource", t)
                ...
                if (this._skin != t)
                    if (this._skin = t) {
                        var i = v.getRes(t);
                        i ? (this.source = i, this.onCompResize()) : g.loader.load(this._skin, d.create(this, this.setSource, [this._skin]), null, "image", 1, !0, this._group)
                ...
                this._bitmap.sizeGrid = D.fillArray(P.defaultSizeGrid, t, Number)
            }), h(0, t, "measureWidth", function() {
                return this._bitmap.width
            }), h(0, t, "width", i.prototype._$get_width, function(t) {
                g.superSet(E, this, "width", t), this._bitmap.width = 0 == t ? 1e-7 : t
            }), h(0, t, "height", i.prototype._$get_height, function(t) {
                g.superSet(E, this, "height", t), this._bitmap.height = 0 == t ? 1e-7 : t
            }), e
        }(E),
        W = function(t) {
            function i() {
        ...
        $ = function(i) {
            ...
            return g.imps(t, {
                ...
                this.graphics = this._bitmap = new Y
            }, t.createText = function() {
                this._text || (this._text = new w, this._text.overflow = w.HIDDEN, this._text.align = "center", this._text.valign = "middle", this._text.width = this._width, this._text.height = this._height)
                ...
                if (t) {
                    ...
                    var s = t.$_GID + "-" + this._stateNum,
                        n = M.I.get(s);
                    if (L.isOkTextureList(n) || (n = null), n) this._sources = n;
                    else {
                        if (this._sources = [], 1 === this._stateNum) this._sources.push(t);
                        else
                            for (var h = 0; h < this._stateNum; h++) this._sources.push(B.createFromTexture(t, 0, e * h, i, e));
                ...
                this._strokeColors = D.fillArray(P.buttonLabelColors, t, String), this._setStateChanged()
            }), h(0, t, "labelColors", function() {
                return this._labelColors.join(",")
            }, function(t) {
                this._labelColors = D.fillArray(P.buttonLabelColors, t, String), this._setStateChanged()
            }), h(0, t, "measureWidth", function() {
                ...
                this.createText(), this._text.padding = D.fillArray(P.labelPadding, t, Number)
                ...
                g.superSet(E, this, "width", t), this._autoSize && (this._bitmap.width = t, this._text && (this._text.width = t))
            }), h(0, t, "height", i.prototype._$get_height, function(t) {
                g.superSet(E, this, "height", t), this._autoSize && (this._bitmap.height = t, this._text && (this._text.height = t))
            }), h(0, t, "dataSource", i.prototype._$get_dataSource, function(t) {
                "number" == typeof(this._dataSource = t) || "string" == typeof t ? this.label = t + "" : g.superSet(E, this, "dataSource", t)
            }), h(0, t, "iconOffset", function() {
                return this._bitmap._offset ? this._bitmap._offset.join(",") : null
            }, function(t) {
                this._bitmap._offset = t ? D.fillArray([1, 1], t, Number) : []
        ...
        U = function(i) {
            ...
            return t.destroy = function(t) {
                ...
                if (this._clipChanged = !1, this._skin) {
                    var t = v.getRes(this._skin);
                    t ? this.loadComplete(this._skin, t) : g.loader.load(this._skin, d.create(this, this.loadComplete, [this._skin]))
                }
                ...
                if (t === this._skin && i) {
                    var e = this._clipWidth || Math.ceil(i.sourceWidth / this._clipX),
                        ...
                        n = this._skin + e + s,
                        h = M.I.get(n);
                    if (L.isOkTextureList(h) || (h = null), h) this._sources = h;
                    else {
                        this._sources = [];
                ...
                g.superSet(E, this, "width", t), this._bitmap.width = t
            }), h(0, t, "height", i.prototype._$get_height, function(t) {
                g.superSet(E, this, "height", t), this._bitmap.height = t
            }), h(0, t, "measureWidth", function() {
                ...
                "number" == typeof(this._dataSource = t) && Math.floor(t) == t || "string" == typeof t ? this.index = parseInt(t) : g.superSet(E, this, "dataSource", t)
        ...
        F = function(i) {
            ...
            return e.destroy = function(t) {
                ...
                this.addChild(this._colorButton = new $), this._colorPanel = new W, this._colorPanel.size(230, 166), this._colorPanel.addChild(this._colorTiles = new x), this._colorPanel.addChild(this._colorBlock = new x), this._colorPanel.addChild(this._colorInput = new m)
                ...
                e = e + this._colorPanel.height <= g.stage.height ? e : t.y - this._colorPanel.height, this._colorPanel.pos(i, e), this._colorPanel.zOrder = 1001, g._currentStage.addChild(this._colorPanel), g.stage.on("mousedown", this, this.removeColorBox)
            }, e.close = function() {
        ...
        j = function(i) {
            function e(t, i) {
                this._visibleNum = 6, this._button = null, this._list = null, this._isOpen = !1, this._itemSize = 12, this._labels = [], this._selectedIndex = -1, this._selectHandler = null, this._itemHeight = NaN, this._listHeight = NaN, this._listChanged = !1, this._itemChanged = !1, this._scrollBarSkin = null, this._isCustomList = !1, this.itemRender = null, e.__super.call(this), this._itemColors = P.comboBoxItemColors, this.skin = t, this.labels = i
            }
            n(e, "laya.ui.ComboBox", i);
            var t = e.prototype;
            return t.destroy = function(t) {
                ...
                this.addChild(this._button = new $), this._button.text.align = "left", this._button.labelPadding = "0,0,0,5", this._button.on("mousedown", this, this.onButtonMouseDown)
                ...
                this._list.selectEnable = !0, this._list.on("mousedown", this, this.onListDown), this._list.mouseHandler = d.create(this, this.onlistItemMouse, null, !1), this._list.scrollBar && this._list.scrollBar.on("mousedown", this, this.onScrollBarDown)
                ...
                this._selectedIndex != t && (this._selectedIndex = t, 0 < this._labels.length ? this.changeSelected() : this.callLater(this.changeSelected), this.event("change", [c.EMPTY.setTo("change", this, this)]), this._selectHandler && this._selectHandler.runWith(this._selectedIndex))
            }), h(0, t, "measureHeight", function() {
                ...
                g.superSet(E, this, "width", t), this._button.width = this._width, this._itemChanged = !0, this._listChanged = !0
                ...
                g.superSet(E, this, "height", t), this._button.height = this._height
                ...
                this._itemColors = D.fillArray(this._itemColors, t, String), this._listChanged = !0
                ...
                if (this._isOpen != t)
                    if (this._isOpen = t, this._button.selected = this._isOpen, this._isOpen) {
                        ...
                        e = e + this._listHeight <= g.stage.height ? e : i.y - this._listHeight, this._list.pos(i.x, e), this._list.zOrder = 1001, g._currentStage.addChild(this._list), g.stage.once("mousedown", this, this.removeList), g.stage.on("mousewheel", this, this._onStageMouseWheel), this._list.selectedIndex = this._selectedIndex
                ...
                "number" == typeof(this._dataSource = t) && Math.floor(t) == t || "string" == typeof t ? this.selectedIndex = parseInt(t) : t instanceof Array ? this.labels = t.join(",") : g.superSet(E, this, "dataSource", t)
            }), h(0, t, "labelColors", function() {
                ...
                this._button.text.padding = D.fillArray(P.labelPadding, t, Number)
            }), h(0, t, "labelSize", function() {
        ...
        q = function(i) {
            ...
            return t.destroy = function(t) {
                ...
                this.addChild(this.slider = new J), this.addChild(this.upButton = new $), this.addChild(this.downButton = new $)
            }, t.initialize = function() {
                ...
                this.slide(i), g.timer.once(P.scrollBarDelayTime, this, this.startLoop, [i]), g.stage.once("mouseup", this, this.onStageMouseUp)
                ...
                this._clickOnly = !0, this._lastOffset = 0, this._checkElastic = !1, this._lastPoint || (this._lastPoint = new C), this._lastPoint.setTo(g.stage.mouseX, g.stage.mouseY), g.timer.clear(this, this.tweenMove), k.clearTween(this), g.stage.once("mouseup", this, this.onStageMouseUp2), g.stage.once("mouseout", this, this.onStageMouseUp2), g.timer.frameLoop(1, this, this.loop)
            }, t.loop = function() {
                ...
                if (g.stage.off("mouseup", this, this.onStageMouseUp2), g.stage.off("mouseout", this, this.onStageMouseUp2), g.timer.clear(this, this.loop), !(this._clickOnly && this._value >= this.min && this._value <= this.max))
                    if (this._target.mouseEnabled = !0, this._isElastic) this._value < this.min ? k.to(this, {
                        value: this.min
                    }, this.elasticBackTime, l.sineOut, d.create(this, this.elasticOver)) : this._value > this.max && k.to(this, {
                        value: this.max
                    }, this.elasticBackTime, l.sineOut, d.create(this, this.elasticOver));
                    else {
                        ...
                        g.timer.frameLoop(1, this, this.tweenMove, [n])
                    }
                ...
                if (0 < t && (0 < this._lastOffset && this.value <= this.min ? (this._isElastic = !0, i = .5 * -(this.min - t - this.value), this._lastOffset > i && (this._lastOffset = i)) : this._lastOffset < 0 && this.value >= this.max && (this._isElastic = !0, i = .5 * -(this.max + t - this.value), this._lastOffset < i && (this._lastOffset = i))), this.value -= this._lastOffset, Math.abs(this._lastOffset) < 1) {
                    if (g.timer.clear(this, this.tweenMove), this._isElastic) return void(this._value < this.min ? k.to(this, {
                        value: this.min
                    }, this.elasticBackTime, l.sineOut, d.create(this, this.elasticOver)) : this._value > this.max ? k.to(this, {
                        value: this.max
                    }, this.elasticBackTime, l.sineOut, d.create(this, this.elasticOver)) : this.elasticOver());
                    this.event("end"), !this.hide && this.autoHide && k.to(this, {
                        alpha: 0
                    }, 500)
                }
            }, t.stopScroll = function() {
                this.onStageMouseUp2(null), g.timer.clear(this, this.tweenMove), k.clearTween(this)
            }, h(0, t, "measureHeight", function() {
                ...
                "number" == typeof(this._dataSource = t) || "string" == typeof t ? this.value = Number(t) : g.superSet(E, this, "dataSource", t)
            }), h(0, t, "thumbPercent", function() {
                return this._thumbPercent
            }, function(t) {
                this.runCallLater(this.changeScrollBar), this.runCallLater(this.changeSize), t = 1 <= t ? .99 : t, this._thumbPercent = t, this.scaleBar && (this.slider.isVertical ? this.slider.bar.height = Math.max(this.slider.height * t, P.scrollBarMinNum) : this.slider.bar.width = Math.max(this.slider.width * t, P.scrollBarMinNum))
        ...
        J = function(i) {
            ...
            return t.destroy = function(t) {
                ...
                this.addChild(this._bg = new V), this.addChild(this._bar = new $)
            }, t.initialize = function() {
                ...
                if (this._skin != t) {
                    ...
                    v.getRes(i) && (this._progress || (this.addChild(this._progress = new V), this._progress.sizeGrid = this._bar.sizeGrid, this.setChildIndex(this._progress, 1)), this._progress.skin = i), this.setBarPoint(), this.callLater(this.changeValue)
                }
                ...
                return this.label = new K
            }]), e
        }(E),
        K = function(i) {
            function e(t) {
                this._tf = null, e.__super.call(this), void 0 === t && (t = ""), u.defaultColor = P.labelColor, this.text = t
            }
            n(e, "laya.ui.Label", i);
            var t = e.prototype;
            return t.destroy = function(t) {
                ...
                this._tf.padding = D.fillArray(P.labelPadding, t, Number)
            }), h(0, t, "bold", function() {
                ...
                this._tf.text != t && (t && (t = D.adptString(t + "")), this._tf.text = t, this.event("change"), this._width && this._height || this.onCompResize())
                ...
                "number" == typeof(this._dataSource = t) || "string" == typeof t ? this.text = t + "" : g.superSet(E, this, "dataSource", t)
                ...
                return this._width || this._tf.text ? g.superGet(E, this, "width") : 0
            }, function(t) {
                g.superSet(E, this, "width", t), this._tf.width = t
            }), h(0, t, "height", function() {
                return this._height || this._tf.text ? g.superGet(E, this, "height") : 0
            }, function(t) {
                g.superSet(E, this, "height", t), this._tf.height = t
        ...
        Z = function(i) {
            ...
            return t.destroy = function(t) {
                ...
                g.superSet(E, this, "height", t), this._bg.height = this._height, this._bar.height = this._height
            }), h(0, t, "bar", function() {
                return this._bar
            }), h(0, t, "value", function() {
                return this._value
                ...
                g.superSet(E, this, "width", t), this._bg.width = this._width, this.callLater(this.changeValue)
            }), h(0, t, "dataSource", i.prototype._$get_dataSource, function(t) {
                "number" == typeof(this._dataSource = t) || "string" == typeof t ? this.value = Number(t) : g.superSet(E, this, "dataSource", t)
            }), e
        }(E),
        Q = (function(t) {
            ...
            i._onStageHideTip = function(t) {
                ...
                g.stage.on("mousemove", this, this._onStageMouseMove), g.stage.on("mousedown", this, this._onStageMouseDown), this._onStageMouseMove(null)
                ...
                i.clear(), i.drawRect(0, 0, this._tipText.width + 10, this._tipText.height + 10, e.tipBackColor), this.addChild(this._tipBox), this._showToStage(this), g._currentStage.addChild(this)
            ...
            function e(t) {
                this.advsListArr = [], this.resUrl = "https://unioncdn.layabox.com/config/iconlist.json", this._data = [], this._resquestTime = 36e4, this._appid = null, this._appCodeImgStr = null, this._playIndex = 0, this._lunboTime = 5e3, e.__super.call(this), this._http = new a.window.XMLHttpRequest, this.skin = t, this.init(), this.size(120, 120)
            }
            n(e, "laya.ui.AdvImage", i);
            var t = e.prototype;
            t.init = function() {
                a.onMiniGame && this.isSupportJump ? (g.timer.loop(this._resquestTime, this, this.onGetAdvsListData), this.onGetAdvsListData(), this.initEvent()) : this.visible = !1
                ...
                var t = this;
                a.onMiniGame && this.isSupportJump && wx.navigateToMiniProgram({
                    appId: this._appid,
                    path: "",
                    extraData: "",
                    envVersion: "release",
            ...
            return i.createView = function(t) {
                ...
                if (n)
                    for (var h = i instanceof laya.ui.List, o = 0, r = n.length; o < r; o++) {
                        var a = n[o];
                        if (!i.hasOwnProperty("itemRender") || "render" != a.props.name && "render" !== a.props.renderType)
                            if ("Graphic" == a.type) p.addGraphicsToSprite(a, i);
                            else if (p.isDrawType(a.type)) p.addGraphicToSprite(a, i, !0);
                        else {
                            if (h) {
                                var l = [],
                                    c = f.createComp(a, null, e, l);
                                l.length && (c._$bindData = l)
                            } else c = f.createComp(a, null, e, s);
                            "Script" == a.type ? "owner" in c ? c.owner = i : "target" in c && (c.target = i) : "mask" == a.props.renderType || "mask" == a.props.name ? i.mask = c : c instanceof laya.display.Sprite && i.addChild(c)
                        } else i.itemRender = a
                    }
                var u = t.props;
                for (var _ in u) {
                ...
                if ("string" == typeof e && -1 < e.indexOf("${")) {
                    if (f._sheet || (f._sheet = p.getClass("laya.data.Table")), !f._sheet) return void console.warn("Can not find class Sheet");
                    if (n) n.push(t, i, e);
                    else if (s) {
                        -1 == e.indexOf("].") && (e = e.replace(".", "[0]."));
                        var h, o, r = new d(t, i, e);
                        r.exe(s);
                        for (var a = e.replace(/\[.*?\]\./g, "."); null != (h = f._parseWatchData.exec(a));) {
                            for (var l = h[1]; null != (o = f._parseKeyWord.exec(l));) {
                                var c = o[0],
                                    u = s._watchMap[c] || (s._watchMap[c] = []);
                                u.push(r), f._sheet.I.notifer.on(c, s, s.changeData, [c])
                            }(u = s._watchMap[l] || (s._watchMap[l] = [])).push(r), f._sheet.I.notifer.on(l, s, s.changeData, [l])
                        }
                    }
                } else if ("var" === i && s) s[e] = t;
                else if ("onClick" == i) {
                    var _ = g._runScript("(function(){" + e + "})");
                    t.on("click", s, _)
                } else t[i] = "true" === e || "false" !== e && e
            }, f.getCompInstance = function(t) {
                var i, e = t.props ? t.props.runtime : null;
                return i = e ? f.viewClassMap[e] || f.uiClassMap[e] || g.__classmap[e] : f.uiClassMap[t.type], t.props && t.props.hasOwnProperty("renderType") && "instance" == t.props.renderType ? i.instance : i ? new i : null
                ...
                f._regs(), n(t, ""), t.prototype.exe = function(t) {
                    var i = D.getBindFun(this.value);
        ...
        tt = function(t) {
            ...
            return i.preinitialize = function() {
                ...
                "boolean" == typeof(this._dataSource = t) ? this.selected = t: "string" == typeof t ? this.selected = "true" === t : g.superSet($, this, "dataSource", t)
            }), e
        }($),
        it = function(t) {
            function i() {
        ...
        et = function(i) {
            ...
            n(e, "laya.ui.FontClip", i);
            var t = e.prototype;
            return t.createChildren = function() {
                this._bitmap = new Y, this.on("loaded", this, this._onClipLoaded)
                ...
                g.superSet(U, this, "height", t), this.callLater(this.changeValue)
                ...
                g.superSet(U, this, "width", t), this.callLater(this.changeValue)
        ...
        st = function(t) {
            ...
            return g.imps(e, {
                ...
                this._$P.cacheAs || (this._$P.cacheAs = g.superGet(W, this, "cacheAs")), g.superSet(W, this, "cacheAs", "none"), this._scrollBar.once("end", this, this.onScrollEnd)
            }, e.onScrollEnd = function() {
                g.superSet(W, this, "cacheAs", this._$P.cacheAs)
                ...
                if (this._cellChanged = !1, this._itemRender) {
                    ...
                    this._cellSize = this._isVertical ? e : i, this._cellOffset = this._isVertical ? e * Math.max(this._repeatY2, this._repeatY) - n - this._spaceY : i * Math.max(this._repeatX2, this._repeatX) - s - this._spaceX, this._isVertical && this._scrollBar ? this._scrollBar.height = n : !this._isVertical && this._scrollBar && (this._scrollBar.width = s), this.setContentSize(s, n);
                ...
                else i = Q.createComp(this._itemRender, null, null, t);
                ...
                this._content.width = t, this._content.height = i, !this._scrollBar && 0 == this._offset.x && 0 == this._offset.y || (this._content.scrollRect || (this._content.scrollRect = new b), this._content.scrollRect.setTo(-this._offset.x, -this._offset.y, t, i), this._content.scrollRect = this._content.scrollRect), this.event("resize")
                ...
                g.superSet(W, this, "cacheAs", t), this._scrollBar && (this._$P.cacheAs = null, "none" !== t ? this._scrollBar.on("start", this, this.onScrollStart) : this._scrollBar.off("start", this, this.onScrollStart))
            }), h(0, e, "content", function() {
                return this._content
            }), h(0, e, "height", t.prototype._$get_height, function(t) {
                t != this._height && (g.superSet(W, this, "height", t), this._setCellChanged())
                ...
                t != this._width && (g.superSet(W, this, "width", t), this._setCellChanged())
                ...
                if (this.totalPage = Math.ceil(i / (this.repeatX * this.repeatY)), this._selectedIndex = this._selectedIndex < i ? this._selectedIndex : i - 1, this.startIndex = this._startIndex, this._scrollBar) {
                    ...
                    var e = this._isVertical ? this.repeatX : this.repeatY,
                        s = this._isVertical ? this.repeatY : this.repeatX,
                        n = Math.ceil(i / e);
                    1 < (0 < this._cellOffset ? this.totalPage + 1 : this.totalPage) ? (this._scrollBar.scrollSize = this._cellSize, this._scrollBar.thumbPercent = s / n, this._scrollBar.setScroll(0, (n - s) * this._cellSize + this._cellOffset, this._scrollBar.value)) : this._scrollBar.setScroll(0, 0, 0), this._scrollBar.target = this._content
                }
            }), h(0, e, "dataSource", t.prototype._$get_dataSource, function(t) {
                "number" == typeof(this._dataSource = t) && Math.floor(t) == t || "string" == typeof t ? this.selectedIndex = parseInt(t) : t instanceof Array ? this.array = t : g.superSet(W, this, "dataSource", t)
            }), h(0, e, "cells", function() {
                return this.runCallLater(this.changeCells), this._cells
            }), i
        }(W),
        nt = (n(ht, "laya.ui.HScrollBar", X = q), ht.prototype.initialize = function() {
            X.prototype.initialize.call(this), this.slider.isVertical = !1
        }, ht);

    function ht() {
        ht.__super.call(this)
    }
    var ot = function(t) {
            function i() {
            ...
            return e.destroy = function(t) {
                ...
                var e = this._content;
                e.width = t, e.height = i, e.scrollRect || (e.scrollRect = new b), e.scrollRect.setTo(0, 0, t, i), e.scrollRect = e.scrollRect
            }, e.onScrollBarChange = function(t) {
                ...
                this._$P.cacheAs || (this._$P.cacheAs = g.superGet(W, this, "cacheAs")), g.superSet(W, this, "cacheAs", "none"), this._hScrollBar && this._hScrollBar.once("end", this, this.onScrollEnd), this._vScrollBar && this._vScrollBar.once("end", this, this.onScrollEnd)
            }, e.onScrollEnd = function() {
                g.superSet(W, this, "cacheAs", this._$P.cacheAs)
                ...
                null == this._hScrollBar && (laya.display.Node.prototype.addChild.call(this, this._hScrollBar = new nt), this._hScrollBar.on("change", this, this.onScrollBarChange, [this._hScrollBar]), this._hScrollBar.target = this._content, this._setScrollChanged()), this._hScrollBar.skin = t
                ...
                g.superSet(W, this, "width", t), this._setScrollChanged()
            }), h(0, e, "hScrollBar", function() {
                return this._hScrollBar
            }), h(0, e, "content", function() {
                return this._content
            }), h(0, e, "height", t.prototype._$get_height, function(t) {
                g.superSet(W, this, "height", t), this._setScrollChanged()
            }), h(0, e, "vScrollBarSkin", function() {
                return this._vScrollBar ? this._vScrollBar.skin : null
            }, function(t) {
                null == this._vScrollBar && (laya.display.Node.prototype.addChild.call(this, this._vScrollBar = new dt), this._vScrollBar.on("change", this, this.onScrollBarChange, [this._vScrollBar]), this._vScrollBar.target = this._content, this._setScrollChanged()), this._vScrollBar.skin = t
            }), h(0, e, "vScrollBar", function() {
                return this._vScrollBar
            }), h(0, e, "cacheAs", t.prototype._$get_cacheAs, function(t) {
                g.superSet(W, this, "cacheAs", t), this._$P.cacheAs = null, "none" !== t ? (this._hScrollBar && this._hScrollBar.on("start", this, this.onScrollStart), this._vScrollBar && this._vScrollBar.on("start", this, this.onScrollStart)) : (this._hScrollBar && this._hScrollBar.off("start", this, this.onScrollStart), this._vScrollBar && this._vScrollBar.off("start", this, this.onScrollStart))
            }), i
        }(W),
        rt = (n(at, "laya.ui.HSlider", J), at);

    function at(t) {
        at.__super.call(this, t), this.isVertical = !1
    }
    var lt = function(i) {
            function e(t, i) {
        ...
        ct = function(t) {
            ...
            return g.imps(i, {
                ...
                if (e.name = "item" + s, this.addChild(e), this.initItems(), i && 0 < s) {
                    ...
                    "horizontal" == this._direction ? e.x = n.x + n.width + this._space : e.y = n.y + n.height + this._space
                } else i && (e.x = 0, e.y = 0);
                return s
                ...
                for (var t = this._items.length = 0; t < 1e4; t++) {
                    ...
                    if (null == i) break;
                    this._items.push(i), i.selected = t === this._selectedIndex, i.clickHandler = d.create(this, this.itemClick, [t], !1)
                }
                ...
                "number" == typeof(this._dataSource = t) && Math.floor(t) == t || "string" == typeof t ? this.selectedIndex = parseInt(t) : t instanceof Array ? this.labels = t.join(",") : g.superSet(W, this, "dataSource", t)
            }), e
        }(W),
        ut = function(t) {
            function i() {
            ...
            return g.imps(e, {
                ...
                this.addChild(this._list = new st), this._list.renderHandler = d.create(this, this.renderItem, null, !1), this._list.repeatX = 1, this._list.on("change", this, this.onListChange)
                ...
                this._dataSource = t, g.superSet(W, this, "dataSource", t)
                ...
                g.superSet(W, this, "width", t), this._list.width = t
            }), h(0, e, "height", t.prototype._$get_height, function(t) {
                g.superSet(W, this, "height", t), this._list.height = t
        ...
        _t = function(t) {
            function i() {
                this._items = null, this._selectedIndex = 0, i.__super.call(this), this._setIndexHandler = d.create(this, this.setIndex, null, !1)
            }
    ...
    var gt = function(i) {
            ...
            return t.preinitialize = function() {
                ...
                this.addChild(this._tf = new m), this._tf.padding = P.inputLabelPadding, this._tf.on("input", this, this._onInput), this._tf.on("enter", this, this._onEnter), this._tf.on("blur", this, this._onBlur), this._tf.on("focus", this, this._onFocus)
            }, t._onFocus = function() {
                ...
                this._skin != t && (this._skin = t, this._bg || (this.graphics = this._bg = new Y), this._bg.source = v.getRes(this._skin), this._width && (this._bg.width = this._width), this._height && (this._bg.height = this._height))
            }), h(0, t, "sizeGrid", function() {
                return this._bg && this._bg.sizeGrid ? this._bg.sizeGrid.join(",") : null
            }, function(t) {
                this._bg || (this.graphics = this._bg = new Y), this._bg.sizeGrid = D.fillArray(P.defaultSizeGrid, t, Number)
            }), h(0, t, "inputElementXAdjuster", function() {
                return this._tf.inputElementXAdjuster
            }, function(t) {
                this._tf.inputElementXAdjuster = t
            }), h(0, t, "width", i.prototype._$get_width, function(t) {
                g.superSet(K, this, "width", t), this._bg && (this._bg.width = t)
            }), h(0, t, "height", i.prototype._$get_height, function(t) {
                g.superSet(K, this, "height", t), this._bg && (this._bg.height = t)
        ...
        pt = (n(mt, "laya.ui.VSlider", J), mt);

    function mt() {
        mt.__super.call(this)
    }
    var vt = function(t) {
            function s() {
            ...
            return i.initialize = function() {
                ...
                if (t) {
                    var i = D.fillArray([0, 0, 0, 0], t, Number);
                ...
                g.superSet(Q, this, "zOrder", t), s.manager._checkMask()
            }), h(1, s, "manager", function() {
                return s._manager = s._manager || new R
            }, function(t) {
                s._manager = t
        ...
        yt = function(t) {
            ...
            return e.sortItem = function(t) {
                ...
                for (var t = [], i = 0, e = 0, s = this.numChildren; e < s; e++) {
                    ...
                    n && n.layoutEnabled && (t.push(n), i = this._height ? this._height : Math.max(i, n.height * n.scaleY))
                }
                this.sortItem(t);
                var h = 0;
                ...
                this._height != t && (g.superSet(it, this, "height", t), this.callLater(this.changeItems))
        ...
        Ct = function(t) {
            ...
            return i.getLocalDateString = function(t) {
                ...
                n.on("error", this, function(t, i, e) {
                    e && -1 != e.indexOf("[404]") && (new f).send(s.ErrorUrlHttps + "garbage/" + i + "/", JSON.stringify(t), "post", "text", ["Content-Type", "application/json"])
                }, [t, e]), a.onBDMiniGame && (t.gameurl = ""), n.send(this.ErrorUrlHttps + i, JSON.stringify(t), "post", "text", ["Content-Type", "application/json"])
                ...
                if (this._moreBox) this._moreBox.visible = !0;
                    ...
                    this._moreBox = new W, g.stage.addChild(this._moreBox), this._moreBox.zOrder = 99999, this._moreBox.left = this._moreBox.right = this._moreBox.top = this._moreBox.bottom = 0;
                    ...
                    var s = new st;
                    this._moreBox.addChild(s), s.itemRender = c, s.selectEnable = !0, s.vScrollBarSkin = "", s.scrollBar.autoHide = !0, s.scrollBar.elasticDistance = 250, s.renderHandler = new d(this, this.onGameListRender);
                    ...
                    this.screenType && (s.spaceY = 10, s.width = 690, this.isQMP() ? s.height = g.stage.height + 130 : s.height = 1139, s.y = 139, s.centerX = 0), this.onStageResize()
                }
                ...
                var t = !1,
                    i = 0;
                if (i = "horizontal" == g.stage.screenMode ? a.height % 9 : a.width % 9, a.onAndroid && 0 == i) {
                    var e = 0;
                    e = "horizontal" == g.stage.screenMode ? a.width : a.height, -1 != [2280, 2160, 2244, 3120, 2248, 2340, 2310].indexOf(e) && (t = !0)
                }
                var s = /iPhone/gi.test(a.window.navigator.userAgent) && 375 == Math.min(a.clientHeight, a.clientWidth) && 812 == Math.max(a.clientHeight, a.clientWidth),
                    n = 414 == Math.min(a.clientHeight, a.clientWidth) && 896 == Math.max(a.clientHeight, a.clientWidth);
                return !a.onMiniGame && !a.onBDMiniGame || a.onAndroid || !s && !n || (t = !0), t
                ...
                if (!(i < 0 || i > e.length - 1)) {
                    var s = e[i];
                    t.init(s, this.screenType, new d(this, this.onItemClickCallBack))
                }
                ...
                var t = -1 < a.window.navigator.userAgent.indexOf("SwanGame");
            ...
            }, u._moreGameData = null, s(u, ["_http", function() {
                return this._http = new a.window.XMLHttpRequest
            }]), u.__init$ = function() {
                c = function(t) {
                    function i() {
        ...
        bt = function(t) {
            ...
            return e.changeItems = function() {
                ...
                for (var t = [], i = 0, e = 0, s = this.numChildren; e < s; e++) {
                    var n = this.getChildAt(e);
                    n && n.layoutEnabled && (t.push(n), i = this._width ? this._width : Math.max(i, n.width * n.scaleX))
                }
                this.sortItem(t);
                var h = 0;
                ...
                this._width != t && (g.superSet(it, this, "width", t), this.callLater(this.changeItems))
            }), i.NONE = "none", i.LEFT = "left", i.CENTER = "center", i.RIGHT = "right", i
        }(it),
        St = (n(xt, "laya.ui.RadioGroup", ct), xt.prototype.createItem = function(t, i) {
            return new lt(t, i)
        }, xt);
    ...
    var wt = (n(Bt, "laya.ui.Tab", ct), Bt.prototype.createItem = function(t, i) {
        return new $(t, i)
    }, Bt);
    ...
    var It = function(i) {
        ...
        return t.destroy = function(t) {
            ...
            var t = this._vScrollBar && 0 < this._tf.maxScrollY,
                ...
                n = this._tf.padding || P.labelPadding;
            ...
            g.superSet(gt, this, "width", t), this.callLater(this.changeScroll)
        }), h(0, t, "hScrollBar", function() {
            return this._hScrollBar
        }), h(0, t, "height", i.prototype._$get_height, function(t) {
            g.superSet(gt, this, "height", t), this.callLater(this.changeScroll)
        }), h(0, t, "maxScrollX", function() {
            return this._tf.maxScrollX
        }), h(0, t, "vScrollBarSkin", function() {
            return this._vScrollBar ? this._vScrollBar.skin : null
        }, function(t) {
            null == this._vScrollBar && (this.addChild(this._vScrollBar = new dt), this._vScrollBar.on("change", this, this.onVBarChanged), this._vScrollBar.target = this._tf, this.callLater(this.changeScroll)), this._vScrollBar.skin = t
        }), h(0, t, "hScrollBarSkin", function() {
            return this._hScrollBar ? this._hScrollBar.skin : null
        }, function(t) {
            null == this._hScrollBar && (this.addChild(this._hScrollBar = new nt), this._hScrollBar.on("change", this, this.onHBarChanged), this._hScrollBar.mouseWheelEnable = !1, this._hScrollBar.target = this._tf, this.callLater(this.changeScroll)), this._hScrollBar.skin = t
    ...
    ! function(t) {
        ...
        n(i, "laya.ui.AsynDialog", vt);
        var e = i.prototype;
        e.createView = function(t) {
            this._uiView = t
        }, e._open = function(t, i, e) {
            this.isModal = t, this.isCloseOther = i, vt.manager.lock(!0), this._uiView ? this.onCreated() : this.onOpen()
            ...
            vt.manager.open(this, this.isCloseOther), vt.manager.lock(!1)
        }, e.close = function(t, i) {
            void 0 === i && (i = !0), vt.manager.close(this), this.onClose()
