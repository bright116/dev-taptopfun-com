! function(t, e, st) {
    ...
    var i = st.static,
        ...
        St = laya.utils.Byte,
        s = (laya.events.Event, laya.events.EventDispatcher),
        r = laya.display.Graphics,
        l = laya.resource.HTMLCanvas,
        u = laya.utils.Handler,
        o = laya.net.Loader,
        c = laya.maths.MathUtil,
        wt = laya.maths.Matrix,
        _ = (laya.display.Node, laya.maths.Point, laya.maths.Rectangle),
        m = laya.renders.Render,
        p = (laya.renders.RenderContext, laya.resource.Resource),
        y = laya.utils.RunDriver,
        x = (laya.media.SoundChannel, laya.media.SoundManager),
        rt = laya.display.Sprite,
        g = laya.utils.Stat,
        Ft = laya.resource.Texture,
        v = (laya.net.URL, laya.utils.Utils),
        w = (n(M, "laya.ani.AnimationContent"), M);

    function M() {
        this.nodes = null, this.name = null, this.playTime = NaN, this.bone3DMap = null, this.totalKeyframeDatasLength = 0
    }
    var F = (n(D, "laya.ani.AnimationNodeContent"), D);
    ...
    var I = (n(N, "laya.ani.AnimationParser01"), N.parse = function(t, e) {
        var i = e.__getBuffer(),
            a = 0,
            s = 0,
            r = 0,
        ...
        for (0 < f && (t._publicExtData = i.slice(f, i.byteLength)), t._useParent = !!e.getUint8(), t._anis.length = _, a = 0; a < _; a++) {
            ...
            for (s = y.totalKeyframeDatasLength = 0; s < g; s++) {
                ...
                v.childs = [];
                var M = e.getInt16();
                0 <= M && (v.name = d[M], y.bone3DMap[v.name] = s), v.keyFrame = new Array, v.parentIndex = e.getInt16(), -1 == v.parentIndex ? v.parent = null : v.parent = y.nodes[v.parentIndex], v.lerpType = e.getUint8();
                var D = e.getUint32();
                m.pos = D;
                var I = v.keyframeWidth = m.getUint16();
                if (y.totalKeyframeDatasLength += I, 0 === v.lerpType || 1 === v.lerpType)
                    for (v.interpolationMethod = [], v.interpolationMethod.length = I, r = 0; r < I; r++) v.interpolationMethod[r] = nt.interpolation[m.getUint8()];
                null != v.parent && v.parent.childs.push(v);
                var N = e.getUint16();
                0 < N && (v.extenData = i.slice(e.pos, e.pos + N), e.pos += N);
                var b, A = e.getUint16(),
                    T = 0;
                for (r = 0, n = v.keyFrame.length = A; r < n; r++) {
                    if ((b = v.keyFrame[r] = new Z).duration = e.getFloat32(), b.startTime = T, 2 === v.lerpType) {
                        b.interpolationData = [];
                        var C, S = e.getUint8();
                        switch (C = e.getFloat32()) {
                            ...
                            case 255:
                                ...
                                break;
                            default:
                                for (b.interpolationData.push(C), l = 1; l < S; l++) b.interpolationData.push(e.getFloat32())
                        }
                    }
                    for (b.data = new Float32Array(I), h = 0; h < I; h++) b.data[h] = e.getFloat32(), -1e-8 < b.data[h] && b.data[h] < 1e-8 && (b.data[h] = 0);
                    T += b.duration
                }
                b.startTime = y.playTime, v.playTime = y.playTime, t._calculateKeyFrame(v, A, I)
            }
        }
    }, N);

    function N() {}
    var b = (n(A, "laya.ani.AnimationParser02"), A.READ_DATA = function() {
        A._DATA.offset = A._reader.getUint32(), A._DATA.size = A._reader.getUint32()
    }, A.READ_BLOCK = function() {
        for (var t = A._BLOCK.count = A._reader.getUint16(), e = A._BLOCK.blockStarts = [], i = A._BLOCK.blockLengths = [], a = 0; a < t; a++) e.push(A._reader.getUint32()), i.push(A._reader.getUint32())
    }, A.READ_STRINGS = function() {
        var t = A._reader.getUint32(),
            e = A._reader.getUint16(),
            i = A._reader.pos;
        A._reader.pos = t + A._DATA.offset;
        for (var a = 0; a < e; a++) A._strings[a] = A._reader.readUTFString();
        A._reader.pos = i
    }, A.parse = function(t, e) {
        A._templet = t, (A._reader = e).__getBuffer(), A.READ_DATA(), A.READ_BLOCK(), A.READ_STRINGS();
        for (var i = 0, a = A._BLOCK.count; i < a; i++) {
            var s = e.getUint16(),
                r = A._strings[s],
                n = A["READ_" + r];
        ...
        var t = A._reader,
            ...
            n = t.getUint16(),
            h = [];
        for (h.length = n, i = 0; i < n; i++) h[i] = nt.interpolation[t.getByte()];
        var l = t.getUint8();
        for (A._templet._anis.length = l, i = 0; i < l; i++) {
            var o = A._templet._anis[i] = {};
            o.nodes = new Array;
            var u = o.name = A._strings[t.getUint16()];
            A._templet._aniMap[u] = i, o.bone3DMap = {}, o.playTime = t.getFloat32();
            var c = o.nodes.length = t.getInt16();
            for (a = o.totalKeyframeDatasLength = 0; a < c; a++) {
                var d = o.nodes[a] = {};
                d.keyframeWidth = n, d.childs = [];
                var _ = t.getUint16();
                0 <= _ && (d.name = A._strings[_], o.bone3DMap[d.name] = a), d.keyFrame = new Array, d.parentIndex = t.getInt16(), -1 == d.parentIndex ? d.parent = null : d.parent = o.nodes[d.parentIndex], o.totalKeyframeDatasLength += n, d.interpolationMethod = h, null != d.parent && d.parent.childs.push(d);
                var p = t.getUint16(),
                    f = null,
                    m = null;
                for (s = 0, r = d.keyFrame.length = p; s < r; s++) {
                    (f = d.keyFrame[s] = {}).startTime = t.getFloat32(), m && (m.duration = f.startTime - m.startTime);
                    var y = A._DATA.offset,
                        x = t.getUint32(),
                        g = 4 * n,
                        v = e.slice(y + x, y + x + g);
                    f.data = new Float32Array(v), m = f
                }
                f.duration = 0, d.playTime = o.playTime, A._templet._calculateKeyFrame(d, p, n)
            }
        }
    }, A._templet = null, A._reader = null, A._strings = [], i(A, ["_BLOCK", function() {
        return this._BLOCK = {
            count: 0
        }
    }, "_DATA", function() {
    ...
    var kt = function() {
            function s() {
                this.name = null, this.root = null, this.parentBone = null, this.length = 10, this.transform = null, this.inheritScale = !0, this.inheritRotation = !0, this.rotation = NaN, this.resultRotation = NaN, this.d = -1, this._tempMatrix = null, this._sprite = null, this.resultTransform = new zt, this.resultMatrix = new wt, this._children = []
            }
            n(s, "laya.ani.bone.Bone");
            var t = s.prototype;
        ...
        Pt = function() {
            function f() {
                this.name = null, this.parent = null, this.attachmentName = null, this.srcDisplayIndex = -1, this.type = "src", this.templet = null, this.currSlotData = null, this.currTexture = null, this.currDisplayData = null, this.displayIndex = -1, this.originalIndex = -1, this._diyTexture = null, this._parentMatrix = null, this._resultMatrix = null, this._replaceDic = {}, this._curDiyUV = null, this._curDiyVS = null, this._skinSprite = null, this.deformData = null, this._mVerticleArr = null
            }
            n(f, "laya.ani.bone.BoneSlot");
            var t = f.prototype;
            return t.showSlotData = function(t, e) {
                        ...
                        case 0:
                            if (t) {
                                ...
                                if (this._parentMatrix) {
                                    ...
                                    if (n) {
                                        var l;
                                        if (wt.mul(n, this._parentMatrix, wt.TEMP), l = i ? (null == this._resultMatrix && (this._resultMatrix = new wt), this._resultMatrix) : new wt, !m.isWebGL && this.currDisplayData.uvs || m.isWebGL && this._diyTexture && this.currDisplayData.uvs) {
                                            var o = f._tempMatrix;
                            ...
                            break;
                        case 1:
                            if (null == (s = i ? (null == this._skinSprite && (this._skinSprite = f.createSkinMesh()), this._skinSprite) : f.createSkinMesh())) return;
                            var u;
                            if (null == this.currDisplayData.bones) {
                                var c, d = this.currDisplayData.weights;
                                this.deformData && (d = this.deformData), c = this._diyTexture ? (this._curDiyUV || (this._curDiyUV = []), 0 == this._curDiyUV.length && (this._curDiyUV = H.getRelativeUV(this.currTexture.uv, this.currDisplayData.uvs, this._curDiyUV), this._curDiyUV = H.getAbsoluteUV(this._diyTexture.uv, this._curDiyUV, this._curDiyUV)), this._curDiyUV) : this.currDisplayData.uvs, this._mVerticleArr = d;
                                ...
                                if (this._parentMatrix)
                                    if (p) wt.mul(p, this._parentMatrix, wt.TEMP), _ = i ? (null == this._resultMatrix && (this._resultMatrix = new wt), this._resultMatrix) : new wt, wt.TEMP.copyTo(_), s.transform = _
                ...
                a = this._diyTexture ? (s = this._diyTexture, this._curDiyUV || (this._curDiyUV = []), 0 == this._curDiyUV.length && (this._curDiyUV = H.getRelativeUV(this.currTexture.uv, this.currDisplayData.uvs, this._curDiyUV), this._curDiyUV = H.getAbsoluteUV(this._diyTexture.uv, this._curDiyUV, this._curDiyUV)), this._curDiyUV) : this.currDisplayData.uvs;
                ...
                return m.isWebGL || m.isConchApp ? y.skinAniSprite() : m.isWebGL ? null : lt.useSimpleMeshInCanvas ? new ht : new at
            ...
            return e.renderToContext = function(t) {
                ...
                if (0 < t.canvasPadding) {
                    var T = t.canvasPadding,
                        ...
                        k = N - w,
                        P = Math.sqrt(F * F + k * k);
                    M = S + F / P * (P + T), N = w + k / P * (P + C), k = b - w, D = S + (F = D - S) / (P = Math.sqrt(F * F + k * k)) * (P + T), b = w + k / P * (P + C), k = A - w, I = S + (F = I - S) / (P = Math.sqrt(F * F + k * k)) * (P + T), A = w + k / P * (P + C)
                }
                if (s.save(), this.transform) {
                    var B = this.transform;
                    s.transform(B.a, B.b, B.c, B.d, B.tx, B.ty)
                }
                s.beginPath(), s.moveTo(M, N), s.lineTo(D, b), s.lineTo(I, A), s.closePath(), s.clip();
                var U = 1 / (p * x + y * m + f * g - x * m - y * f - p * g),
                    L = M * x + y * I + D * g - x * I - y * D - M * g,
                    R = p * D + M * m + f * I - D * m - M * f - p * I,
                    O = p * x * I + y * D * m + M * f * g - M * x * m - y * f * I - p * D * g,
                    E = N * x + y * A + b * g - x * A - y * b - N * g,
                    V = p * b + N * m + f * A - b * m - N * f - p * A,
                    K = p * x * A + y * b * m + N * f * g - N * x * m - y * f * A - p * b * g;
                s.transform(L * U, E * U, R * U, V * U, O * U, K * U), s.drawImage(o, h.uv[0] * d, h.uv[1] * _, u, c, h.uv[0] * d, h.uv[1] * _, u, c), s.restore()
            }, t
        }(),
        S = (n(k, "laya.ani.bone.canvasmesh.MeshData"), k.prototype.getBounds = function() {
    ...
    var Bt = (n(P, "laya.ani.bone.DeformAniData"), P);

    function P() {
        this.skinName = null, this.deformSlotDataList = []
    }
    var Ut = (n(B, "laya.ani.bone.DeformSlotData"), B);
    ...
    var Lt = function() {
        ...
        Rt = (n(U, "laya.ani.bone.DrawOrderData"), U);

    function U() {
        this.time = NaN, this.drawOrder = []
    }
    var Ot = (n(L, "laya.ani.bone.EventData"), L);
    ...
    var R = function() {
            ...
            n(at, "laya.ani.bone.IkConstraint");
            var t = at.prototype;
            return t.apply = function() {
                ...
                if (0 != r) {
                    var n = t.resultTransform.x,
                        ...
                        d = 0,
                        _ = 0;
                    _ = l < 0 ? (l = -l, c = 180, -1) : (c = 0, 1), o < 0 && (o = -o, _ = -_), d = u < 0 ? (u = -u, 180) : 0;
                    var p = e.resultTransform.x,
                        ...
                        M = t.resultMatrix.d,
                        D = Math.abs(l - o) <= 1e-4;
                    y = D ? (m = x * p + g * (f = e.resultTransform.y) + t.resultMatrix.tx, v * p + M * f + t.resultMatrix.ty) : (f = 0, m = x * p + t.resultMatrix.tx, v * p + t.resultMatrix.ty), this.isDebug && (this._sp || (this._sp = new rt, st.stage.addChild(this._sp)), this._sp.graphics.clear(), this._sp.graphics.drawCircle(i, a, 15, "#ffff00"), this._sp.graphics.drawCircle(m, y, 15, "#ff00ff")), t.setRotation(Math.atan2(y - t.resultMatrix.ty, m - t.resultMatrix.tx));
                    var I = t.parentBone;
                    x = I.resultMatrix.a, g = I.resultMatrix.c, v = I.resultMatrix.b;
                    var N = 1 / (x * (M = I.resultMatrix.d) - g * v),
                        b = i - I.resultMatrix.tx,
                        A = a - I.resultMatrix.ty,
                        T = (b * M - A * g) * N - n,
                        C = (A * x - b * v) * N - h,
                        S = ((b = m - I.resultMatrix.tx) * M - (A = y - I.resultMatrix.ty) * g) * N - n,
                        w = (A * x - b * v) * N - h,
                        F = Math.sqrt(S * S + w * w),
                        k = e.length * u,
                        P = NaN,
                        B = NaN;
                    if (D) {
                        var U = (T * T + C * C - F * F - (k *= l) * k) / (2 * F * k);
                        U < -1 ? U = -1 : 1 < U && (U = 1), B = Math.acos(U) * s, x = F + k * U, g = k * Math.sin(B), P = Math.atan2(C * x - T * g, T * x + C * g)
                    } else {
                        var L = (x = l * k) * x,
                            R = (g = o * k) * g,
                            O = T * T + C * C,
                            ...
                            V = -2 * R * F,
                            K = R - L;
                        if (0 < (M = V * V - 4 * K * (v = R * F * F + L * O - L * R))) {
                            var Y = Math.sqrt(M);
                            V < 0 && (Y = -Y);
                            var W = (Y = -(V + Y) / 2) / K,
                                X = v / Y,
                                z = Math.abs(W) < Math.abs(X) ? W : X;
                            z * z <= O && (A = Math.sqrt(O - z * z) * s, P = E - Math.atan2(A, z), B = Math.atan2(A / o, (z - F) / l))
                        }
                        var q = 0,
                            G = Number.MAX_VALUE,
                            H = 0,
                            ...
                            $ = 0,
                            J = 0;
                        j < (M = (b = F + x) * b) && (Z = 0, j = M, $ = b), (M = (b = F - x) * b) < G && (q = Math.PI, G = M, H = b);
                        var tt = Math.acos(-x * F / (L - R));
                        (M = (b = x * Math.cos(tt) + F) * b + (A = g * Math.sin(tt)) * A) < G && (q = tt, G = M, H = b, Q = A), j < M && (Z = tt, j = M, $ = b, J = A), B = O <= (G + j) / 2 ? (P = E - Math.atan2(Q * s, H), q * s) : (P = E - Math.atan2(J * s, $), Z * s)
                    }
                ...
                if (0 != r) {
                    var n, h, l = e.resultMatrix.a * e.length,
                        ...
                        M = Math.sqrt(v);
                    if (c + g <= M || M + c <= g || M + g <= c) {
                        var D = NaN;
                        p = d + (D = c + g <= M ? 1 : -1) * (i - d) * g / M, f = _ + D * (a - _) * g / M
                    } else {
                        var I = (x - u + v) / (2 * v),
                            N = Math.sqrt(x - I * I * v) / M,
                            b = d + m * I,
                            A = _ + y * I,
                            T = -y * N,
                            C = m * N;
                        f = 0 < s ? (p = b - T, A - C) : (p = b + T, A + C)
                    }
                    ...
                    var S, w;
                    S = Math.atan2(h - t.resultMatrix.ty, n - t.resultMatrix.tx), t.setRotation(S), (w = at._tempMatrix).identity(), w.rotate(S), w.scale(t.resultMatrix.getScaleX(), t.resultMatrix.getScaleY()), w.translate(t.resultMatrix.tx, t.resultMatrix.ty), w.copyTo(t.resultMatrix), t.updateChild();
                    var F, k;
                    F = Math.atan2(a - h, i - n), e.setRotation(F), (k = at._tempMatrix).identity(), k.rotate(F), k.scale(e.resultMatrix.getScaleX(), e.resultMatrix.getScaleY()), k.translate(n, h), w.copyTo(e.resultMatrix), e.updateChild()
                }
        ...
        Et = (n(O, "laya.ani.bone.IkConstraintData"), O);
    ...
    var E = (n(V, "laya.ani.bone.MeshTools"), V.findEdge = function(t, e, i) {
        void 0 === e && (e = 0), void 0 === i && (i = !0);
        var a, s = 0,
            r = 0;
        for (a = t.length, r = -1, s = 0; s < a; s += 2)(r < 0 || i == t[r + e] < t[s + e]) && (r = s);
        return r
    }, V.findBestTriangle = function(t) {
        var e, i, a, s, r;
        return e = V.findEdge(t, 1, !0), i = V.findEdge(t, 1, !1), a = V.findEdge(t, 0, !0), s = V.findEdge(t, 0, !1), (r = V._bestTriangle).length = 0, r.push(a, s), r.indexOf(e) < 0 && r.push(e), r.indexOf(i) < 0 && r.push(i), r
    }, V.solveMesh = function(t, e) {
        var i, a, s, r, n, h, l;
        return (e = e || []).length = 0, i = t.uvs, a = t.vertices, n = (r = V.findBestTriangle(i))[0], h = r[1], l = r[2], V._absArr.length = 0, V.isNormalUV(t.texture.uv) && V.adptTexture(t), s = V.solvePoints(t.texture.uv, i[n], i[n + 1], i[h] - i[n], i[h + 1] - i[n + 1], i[l] - i[n], i[l + 1] - i[n + 1], V._absArr), V.transPoints(s, a[n], a[n + 1], a[h] - a[n], a[h + 1] - a[n + 1], a[l] - a[n], a[l + 1] - a[n + 1], e)
    }, V.findWrapRect = function(t) {
        var e, i, a, s, r, n, h, l;
        return e = V.findEdge(t, 1, !0), i = V.findEdge(t, 1, !1), a = V.findEdge(t, 0, !0), s = V.findEdge(t, 0, !1), r = t[a], n = t[s], h = t[e + 1], [n, l = t[i + 1], r - n, h - l]
    }, V.adptTexture = function(t) {
        var e, i, a;
        e = V.findWrapRect(t.uvs);
        var s = (i = t.texture).width,
            r = i.height;
        a = Ft.create(i, e[0] * s, e[1] * r, e[2] * s, e[3] * r), t.texture = a
    }, V.isNormalUV = function(t) {
        return 0 == t[0] && 0 == t[1] && 1 == t[4] && 1 == t[5]
    }, V.solvePoints = function(t, e, i, a, s, r, n, h) {
        h = h || [];
        var l, o, u = 0;
        for (l = t.length, u = 0; u < l; u += 2) o = V.solve2(t[u], t[u + 1], e, i, a, s, r, n), h.push(o[0], o[1]);
        return h
    }, V.transPoints = function(t, e, i, a, s, r, n, h) {
        h = h || [];
        var l, o = 0;
        for (l = t.length, o = 0; o < l; o += 2) V.transPoint(t[o], t[o + 1], e, i, a, s, r, n, h);
        return h
    }, V.transPoint = function(t, e, i, a, s, r, n, h, l) {
        var o, u;
        return o = i + s * t + n * e, u = a + r * t + h * e, (l = l || []).push(o, u), l
    }, V.solve2 = function(t, e, i, a, s, r, n, h, l, o) {
        var u, c, d;
        return void 0 === l && (l = !1), o = o || [], 0 == s ? V.solve2(t, e, i, a, n, h, s, r, !0, o) : (u = ((d = t - i) - (c = (e - a - d * r / s) / (h - n * r / s)) * n) / s, l ? o.push(c, u) : o.push(u, c), o)
    }, V.solve = function(t, e, i, a) {
        return V.solve2(t.x, t.y, e.x, e.y, i.x, i.y, a.x, a.y)
    }, V._bestTriangle = [], V._absArr = [], V);
    ...
    var K = function() {
            ...
            n(k, "laya.ani.bone.PathConstraint");
            var t = k.prototype;
            return t.apply = function(t, e) {
                if (this.target) {
                    ...
                    for (f = 0, T = 3; f < c; f++, T += 3) {
                        ...
                        var C = (g = M[T]) - I,
                            S = (v = M[T + 1]) - N;
                        if (o && 0 != (x = u[f])) {
                            var w = (Math.sqrt(C * C + S * S) / x - 1) * a + 1;
                ...
                if (null != l) {
                    ...
                    for (f = r, m = 3 * _; f < a; f += 2) {
                        for (x = y = 0, p = l[d++], p += d; d < p; d++, m += 3) {
                            n = D[l[d]].resultMatrix, g = o[m], v = o[m + 1];
                            var I = o[m + 2];
                    ...
                    var N, b;
                    if (u || (u = o), t.deformData && (u = t.deformData), N = t.parent, e)
                    ...
                    var A = b.tx,
                        ...
                        w = b.c,
                        F = b.d;
                    for (h && (F *= h.d), d = i, f = r; f < a; d += 2, f += 2) g = u[d], v = u[d + 1], s[f] = g * C + v * S + A, s[f + 1] = -(g * w + v * F + T)
                }
                ...
                var I = this._curves,
                    ...
                    E = NaN,
                    V = 0;
                for (l = 0, V = 2; l < p; l++, V += 6) A = d[V], T = d[V + 1], C = d[V + 2], S = d[V + 3], L = 2 * (k = .1875 * (N - 2 * A + C)) + (B = .09375 * (3 * (A - C) - N + (w = d[V + 4]))), R = 2 * (P = .1875 * (b - 2 * T + S)) + (U = .09375 * (3 * (T - S) - b + (F = d[V + 5]))), O = .75 * (A - N) + k + .16666667 * B, E = .75 * (T - b) + P + .16666667 * U, m += Math.sqrt(O * O + E * E), O += L, E += R, L += B, R += U, m += Math.sqrt(O * O + E * E), O += L, E += R, m += Math.sqrt(O * O + E * E), O += L + B, E += R + U, m += Math.sqrt(O * O + E * E), I[l] = m, N = w, b = F;
                if (r && (u *= m), n)
                    for (l = 0; l < a; l++) c[l] *= m;
                ...
                for (W = x = y = l = 0; l < a; l++, y += 3)
                    ...
                    if (x != f) {
                        var X = 6 * (f = x);
                        for (N = d[X], b = d[X + 1], A = d[X + 2], T = d[X + 3], C = d[X + 4], S = d[X + 5], L = 2 * (k = .03 * (N - 2 * A + C)) + (B = .006 * (3 * (A - C) - N + (w = d[X + 6]))), R = 2 * (P = .03 * (b - 2 * T + S)) + (U = .006 * (3 * (T - S) - b + (F = d[X + 7]))), O = .3 * (A - N) + k + .16666667 * B, E = .3 * (T - b) + P + .16666667 * U, Y = Math.sqrt(O * O + E * E), K[0] = Y, X = 1; X < 8; X++) O += L, E += R, L += B, R += U, Y += Math.sqrt(O * O + E * E), K[X] = Y;
                        O += L, E += R, Y += Math.sqrt(O * O + E * E), K[8] = Y, O += L + B, E += R + U, Y += Math.sqrt(O * O + E * E), K[9] = Y, W = 0
                    }
                    for (g *= Y;; W++)
                        if (!((D = K[W]) < g)) {
                            0 == W ? g /= D : g = W + (g - (M = K[W - 1])) / (D - M);
                            break
                        }
                    this.addCurvePosition(.1 * g, N, b, A, T, C, S, w, F, _, y, s || 0 < l && 0 == v)
                }
                return _
        ...
        Vt = (n(Y, "laya.ani.bone.PathConstraintData"), Y);
    ...
    var Kt = (n(W, "laya.ani.bone.SkinData"), W);
    ...
    var Yt = function() {
        ...
        Wt = (n(X, "laya.ani.bone.SlotData"), X.prototype.getDisplayByName = function(t) {
    ...
    var z = (n(q, "laya.ani.bone.TfConstraint"), q.prototype.apply = function() {
    ...
    var Xt = (n(G, "laya.ani.bone.TfConstraintData"), G);
    ...
    var zt = function() {
        ...
        H = (n(Q, "laya.ani.bone.UVTools"), Q.getRelativeUV = function(t, e, i) {
            var a = t[0],
                s = t[2] - t[0],
                r = t[1],
                n = t[5] - t[1];
            ...
            return i
        }, Q.getAbsoluteUV = function(t, e, i) {
    ...
    function Q() {}
    var Z = (n(j, "laya.ani.KeyFramesContent"), j);

    function j() {
        this.startTime = NaN, this.duration = NaN, this.interpolationData = null, this.data = null, this.nextData = null
    }
    var $ = (n(J, "laya.ani.math.BezierLerp"), J.getBezierRate = function(t, e, i, a, s) {
        var r = J._getBezierParamKey(e, i, a, s),
            n = 100 * r + t;
        if (J._bezierResultCache[n]) return J._bezierResultCache[n];
        var h, l = J._getBezierPoints(e, i, a, s, r),
            o = 0;
        for (h = l.length, o = 0; o < h; o += 2)
            if (t <= l[o]) return J._bezierResultCache[n] = l[o + 1], l[o + 1];
        return J._bezierResultCache[n] = 1
    }, J._getBezierParamKey = function(t, e, i, a) {
        return 100 * (100 * (100 * (100 * t + e) + i) + a)
    }, J._getBezierPoints = function(t, e, i, a, s) {
        return J._bezierPointsCache[s] ? J._bezierPointsCache[s] : (r = [0, 0, t, e, i, a, 1, 1], n = (new h).getBezierPoints(r, 100, 3), J._bezierPointsCache[s] = n);
        var r, n
    }, J._bezierResultCache = {}, J._bezierPointsCache = {}, J);
    ...
    var tt = function(t) {
            ...
            n(e, "laya.ani.AnimationPlayer", s);
            var i = e.prototype;
            return st.imps(i, {
                ...
                var a = 0 < i ? i : t;
                this._currentKeyframeIndex = Math.max(Math.floor(a / e + .01), 0), this._currentFrameTime = this._currentKeyframeIndex * e, this._currentAnimationClipIndex = -1
                ...
                if (-1 !== this._currentAnimationClipIndex && !this._paused && this._templet && this._templet.loaded) {
                    var e = this._cacheFrameRateInterval * this._cachePlayRate,
                        i = 0;
                    this._startUpdateLoopCount !== g.loopCount && (i = t * this.playbackRate, this._elapsedPlaybackTime += i);
                    var a = this.playDuration;
                    if (i += this._currentTime, 0 !== this._overallDuration && this._elapsedPlaybackTime >= this._overallDuration || 0 === this._overallDuration && this._elapsedPlaybackTime >= a || 0 === this._overallDuration && i >= this.playEnd) return this._setPlayParamsWhenStop(a, e, this.playEnd), void this.event("stopped");
                    if (0 < a)
                        if (a <= i)
                            do {
                ...
                this._currentTime = 0, this._currentFrameTime = 0, this._elapsedPlaybackTime = 0, this.playbackRate = e, this._overallDuration = i, this._playStart = a, this._playEnd = s, this._paused = !1, this._currentAnimationClipIndex = t, this._currentKeyframeIndex = 0, this._startUpdateLoopCount = g.loopCount, this.event("played"), this._templet.loaded ? this._calculatePlayDuration() : this._templet.once("loaded", this, this._onAnimationTempletLoaded), this._update(0)
                ...
                if (-1 !== this._currentAnimationClipIndex && this._templet && this._templet.loaded) {
                    ...
                    this._startUpdateLoopCount = g.loopCount;
                    var e = this._cacheFrameRateInterval * this._cachePlayRate;
        ...
        et = (n(it, "laya.ani.GraphicsAni", r), it.prototype.drawSkin = function(t) {
            var e = [t];
            this._saveToCmd(m._context._drawSkin, e)
        }, it.create = function() {
            return it._caches.pop() || new it
        }, it.recycle = function(t) {
            t.clear(), it._caches.push(t)
        }, it._caches = [], it);

    function it() {
        it.__super.call(this), m.isConchNode && (this.drawSkin = function(t) {
            t.transform || (t.transform = wt.EMPTY), this._addCmd([t]), this.setSkinMesh && this.setSkinMesh(t._ps, t.mVBData, t.mEleNum, 0, t.mTexture, t.transform)
        })
    }
    var at = function(t) {
            function a() {
                a.__super.call(this), this.mesh = new S
            }
            n(a, "laya.ani.bone.canvasmesh.SkinMeshCanvas", C);
            var e = a.prototype;
        ...
        nt = function(t) {
            ...
            n(x, "laya.ani.AnimationTemplet", p);
            var e = x.prototype;
            return e.parse = function(t) {
                ...
                var u = 0 === h ? 0 : r / h;
                return c.slerpQuaternionArray(s, e, l, e, u, i, a), 4
        ...
        ht = (function(t) {
            ...
            n(a, "laya.ani.bone.canvasmesh.CacheAbleSkinMesh", at);
            var e = a.prototype;
            e.getCanvasPic = function() {
                ...
                this.mesh.texture && (this.isCached || (this.isCached = !0, this.tex = this.getCanvasPic()), this.transform ? (this.transform.translate(e, i), this._renderTextureToContext(t), this.transform.translate(-e, -i)) : (this.transform = at._tempMatrix, this.transform.identity(), this.transform.translate(e, i), this._renderTextureToContext(t), this.transform.translate(-e, -i), this.transform = null))
                ...
                return this.tempMt = new wt
            }])
        }(), function(r) {
            function t() {
                this.cacheOK = !1, this.cacheCmdOK = !1, this.transformCmds = [], this.drawCmds = [], t.__super.call(this), this.tempMesh = new S
            }
            n(t, "laya.ani.bone.canvasmesh.SimpleSkinMeshCanvas", r);
            var e = t.prototype;
            return e.init2 = function(t, e, i, a, s) {
                ...
                if (this.context = t.ctx || t, this.mesh) {
                    ...
                    this.cacheOK || (this.tempMesh.texture = this.mesh.texture, this.tempMesh.uvs = this.mesh.texture.uv, this.tempMesh.vertices = E.solveMesh(this.mesh, this.tempMesh.vertices), this.cacheOK = !0), 0 == this.mode ? this._renderWithIndexes(this.tempMesh) : this._renderNoIndexes(this.tempMesh)
                }
            }, e._renderWithIndexes = function(t) {
                ...
                var M = n[e],
                    ...
                    b = n[i + 1],
                    A = n[a + 1],
                    T = 1 / (p * x + y * m + f * g - x * m - y * f - p * g),
                    C = M * x + y * I + D * g - x * I - y * D - M * g,
                    S = p * D + M * m + f * I - D * m - M * f - p * I,
                    w = p * x * I + y * D * m + M * f * g - M * x * m - y * f * I - p * D * g,
                    F = N * x + y * A + b * g - x * A - y * b - N * g,
                    k = p * b + N * m + f * A - b * m - N * f - p * A,
                    P = p * x * A + y * b * m + N * f * g - N * x * m - y * f * A - p * b * g;
        ...
        lt = function(e) {
            ...
            return t.init = function(t, e) {
                ...
                if (this._yReverseMatrix = t.yReverseMatrix, this._aniMode = e, this._templet = t, this._player = new tt, this._player.cacheFrameRate = t.rate, this._player.templet = t, this._player.play(), this._parseSrcBoneMatrix(), this._boneList = t.mBoneArr, this._rootBone = t.mRootBone, this._aniSectionDic = t.aniSectionDic, 0 < t.ikArr.length)
                    for (this._ikArr = [], r = 0, n = t.ikArr.length; r < n; r++) this._ikArr.push(new R(t.ikArr[r], this._boneList));
                if (0 < t.pathArr.length)
                    for (null == this._pathDic && (this._pathDic = {}), r = 0, n = t.pathArr.length; r < n; r++) i = t.pathArr[r], a = new K(i, this._boneList), (s = this._boneSlotDic[i.name]) && ((a = new K(i, this._boneList)).target = s), this._pathDic[i.name] = a;
                if (0 < t.tfArr.length)
                    for (this._tfArr = [], r = 0, n = t.tfArr.length; r < n; r++) this._tfArr.push(new z(t.tfArr[r], this._boneList));
                ...
                void 0 === i && (i = 0), this._aniPath = t, this._complete = e, this._loadAniMode = i, st.loader.load([{
                    url: t,
                    type: "arraybuffer"
                }], u.create(this, this._onLoaded))
            }, t._onLoaded = function() {
                var t, e = o.getRes(this._aniPath);
                null != e && (null == ot.TEMPLET_DICTIONARY && (ot.TEMPLET_DICTIONARY = {}), (t = ot.TEMPLET_DICTIONARY[this._aniPath]) ? t.isParseFail ? this._parseFail() : t.isParserComplete ? this._parseComplete() : (t.on("complete", this, this._parseComplete), t.on("error", this, this._parseFail)) : ((t = new ot)._setUrl(this._aniPath), (ot.TEMPLET_DICTIONARY[this._aniPath] = t).on("complete", this, this._parseComplete), t.on("error", this, this._parseFail), t.isParserComplete = !1, t.parseData(null, e)))
            }, t._parseComplete = function() {
                var t = ot.TEMPLET_DICTIONARY[this._aniPath];
                ...
                if (void 0 === t && (t = !0), !(this._pause || t && this._indexControl)) {
                    ...
                    if (t ? this._player._update(a) : i = -1, this._lastTime = e, this._player && (this._index = this._clipIndex = this._player.currentKeyframeIndex, !(this._index < 0 || 0 < a && this._clipIndex == i && this._lastUpdateAniClipIndex == this._aniClipIndex))) {
                        ...
                        var r, n, h = this._templet.eventAniArr[this._aniClipIndex];
                        if (h && this._eventIndex < h.length && ((s = h[this._eventIndex]).time >= this._player.playStart && s.time <= this._player.playEnd ? this._player.currentPlayTime >= s.time && (this.event("label", s), this._eventIndex++, this._playAudio && s.audioValue && "null" !== s.audioValue && (r = x.playSound(this._player.templet._path + s.audioValue, 1, u.create(this, this._onAniSoundStoped)), x.playbackRate = this._player.playbackRate, r && this._soundChannelArr.push(r))) : s.time < this._player.playStart && this._playAudio && s.audioValue && "null" !== s.audioValue ? (this._eventIndex++, r = x.playSound(this._player.templet._path + s.audioValue, 1, u.create(this, this._onAniSoundStoped), null, (this._player.currentPlayTime - s.time) / 1e3), x.playbackRate = this._player.playbackRate, r && this._soundChannelArr.push(r)) : this._eventIndex++), 0 == this._aniMode) {
                            ...
                            var l = 0,
                                o = 0;
                            for (o = this._clipIndex; !this._templet.getGrahicsDataWithCache(this._aniClipIndex, o - 1) && 0 < o;) o--;
                            if (o < this._clipIndex)
                                for (l = o; l < this._clipIndex; l++) this._createGraphics(l)
                            ...
                            for (o = this._clipIndex; !this._getGrahicsDataWithCache(this._aniClipIndex, o - 1) && 0 < o;) o--;
                            if (o < this._clipIndex)
                                for (l = o; l < this._clipIndex; l++) this._createGraphics(l)
                        }
                ...
                0 == this._aniMode || 1 == this._aniMode ? this.graphics = et.create() : this.graphics instanceof laya.ani.GraphicsAni ? this.graphics.clear() : this.graphics = et.create(), i = this.graphics;
                ...
                var v, M, D = {},
                    I = {};
                for (f += u[2]; d < f; d++) D[(y = r[d]).name] = this._curOriginalData[c++], I[y.name] = this._curOriginalData[c++], this._curOriginalData[c++], this._curOriginalData[c++], this._curOriginalData[c++], this._curOriginalData[c++];
                if (this._pathDic)
                    for (f += u[3]; d < f; d++) {
                        if (y = r[d], v = this._pathDic[y.name]) switch (new St(y.extenData).getByte()) {
                            case 1:
                ...
                if (this._yReverseMatrix ? this._rootBone.update(this._yReverseMatrix) : this._rootBone.update(wt.TEMP.identity()), this._ikArr)
                    for (d = 0, f = this._ikArr.length; d < f; d++) M = this._ikArr[d], D.hasOwnProperty(M.name) && (M.bendDirection = D[M.name]), I.hasOwnProperty(M.name) && (M.mix = I[M.name]), M.apply();
                if (this._pathDic)
                    for (var N in this._pathDic)(v = this._pathDic[N]).apply(this._boneList, i);
                if (this._tfArr)
                ...
                if (w && 0 < w.length) {
                    ...
                    var F, k = w[this._aniClipIndex];
                    for (F in b = k.default, this._setDeform(b, S, this._boneSlotArray, a), k) "default" != F && F != this._skinName && (b = k[F], this._setDeform(b, S, this._boneSlotArray, a));
                    b = k[this._skinName], this._setDeform(b, S, this._boneSlotArray, a)
                }
                if (this._drawOrder)
                    for (d = 0, f = this._drawOrder.length; d < f; d++) A = x[(n = this._boneSlotArray[this._drawOrder[d]]).name], T = g[n.name], isNaN(T) || (i.save(), i.alpha(T)), isNaN(A) || -2 == A || (this._templet.attachmentNames ? n.showDisplayByName(this._templet.attachmentNames[A]) : n.showDisplayByIndex(A)), S[this._drawOrder[d]] ? (C = S[this._drawOrder[d]], n.currDisplayData && C[n.currDisplayData.attachmentName] ? n.deformData = C[n.currDisplayData.attachmentName] : n.deformData = null) : n.deformData = null, isNaN(T) ? n.draw(i, this._boneMatrixArray, 2 == this._aniMode) : n.draw(i, this._boneMatrixArray, 2 == this._aniMode, T), isNaN(T) || i.restore();
                else
                    for (d = 0, f = this._boneSlotArray.length; d < f; d++) A = x[(n = this._boneSlotArray[d]).name], T = g[n.name], isNaN(T) || (i.save(), i.alpha(T)), isNaN(A) || -2 == A || (this._templet.attachmentNames ? n.showDisplayByName(this._templet.attachmentNames[A]) : n.showDisplayByIndex(A)), S[d] ? (C = S[d], n.currDisplayData && C[n.currDisplayData.attachmentName] ? n.deformData = C[n.currDisplayData.attachmentName] : n.deformData = null) : n.deformData = null, isNaN(T) ? n.draw(i, this._boneMatrixArray, 2 == this._aniMode) : n.draw(i, this._boneMatrixArray, 2 == this._aniMode, T), isNaN(T) || i.restore();
                ...
                if (1 == this._aniMode)
                    for (var t = 0, e = this._graphicsCache.length; t < e; t++) {
                        for (var i = 0, a = this._graphicsCache[t].length; i < a; i++) {
                            ...
                            s != this.graphics && et.recycle(s)
                        }
                        this._graphicsCache[t].length = 0
                    }
            }, t.play = function(t, e, i, a, s, r, n) {
                void 0 === i && (i = !0), void 0 === a && (a = 0), void 0 === s && (s = 0), void 0 === r && (r = !0), void 0 === n && (n = !0), this._playAudio = n, this._indexControl = !1;
                var h = -1,
                    l = NaN;
                if (l = e ? 2147483647 : 0, "string" == typeof t)
                    ...
                    } else h = t; - 1 < h && h < this.getAnimNum() && (this._aniClipIndex = h, (i || this._pause || this._currAniIndex != h) && (this._currAniIndex = h, this._curOriginalData = new Float32Array(this._templet.getTotalkeyframesLength(h)), this._drawOrder = null, this._eventIndex = 0, this._player.play(h, this._player.playbackRate, l, a, s), r && this._templet.showSkinByIndex(this._boneSlotDic, this._skinIndex), this._pause && (this._pause = !1, this._lastTime = d.now(), this.timer.frameLoop(1, this, this._update, null, !0)), this._update()))
            }, t.stop = function() {
                ...
                if (!this._pause) {
                    if (this._pause = !0, this._player && (this._player.paused = !0), 0 < this._soundChannelArr.length)
                ...
                if (this._indexControl = !1, this._pause) {
                    if (this._pause = !1, this._player && (this._player.paused = !1), 0 < this._soundChannelArr.length)
                        for (var t, e = this._soundChannelArr.length, i = 0; i < e; i++)(t = this._soundChannelArr[i]).audioBuffer && t.resume();
                    this._lastTime = d.now(), this.timer.frameLoop(1, this, this._update, null, !0)
                }
                ...
                void 0 === t && (t = !0), e.prototype.destroy.call(this, t), this._templet = null, this._player && this._player.offAll(), this._player = null, this._curOriginalData = null, this._boneMatrixArray.length = 0, this._lastTime = 0, this.timer.clear(this, this._update), 0 < this._soundChannelArr.length && this._onAniSoundStoped(!0)
            }, a(0, t, "url", function() {
        ...
        ot = (function(e) {
            ...
            t.destroy = function(t) {
                ...
                var i;
                for (i in this._atlasPath && o.clearRes(this._atlasPath), this._loadedImage) this._loadedImage[i] && (o.clearRes(i), this._loadedImage[i] = !1);
                ...
                for (this._ended && this._reset(), o.pos = this._Pos, this._ended = !1, this._playIndex = t, this._curIndex > t && t < this._preIndex && (this._reset(!0), o.pos = this._Pos); this._curIndex <= t && !this._ended;) switch (o.getUint16()) {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        var p = (i = l[o.getUint16()]).transform || wt.create();
                ...
                void 0 === e && (e = !1), this._url = t, e && (this._atlasPath = i || t.split(".swf")[0] + ".json"), this.stop(), this._clear(), this._movieClipList = [this], a = [{
                    ...
                    url: this._atlasPath,
                    type: "atlas"
                }), st.loader.load(a, u.create(this, this._onLoaded))
            }, t._onLoaded = function() {
                var t;
                (t = o.getRes(this._url)) ? !this._atlasPath || o.getAtlas(this._atlasPath) ? (this.basePath = this._atlasPath ? o.getAtlas(this._atlasPath).dir : this._url.split(".swf")[0] + "/image/", this._initData(t)) : this.event("error", "Atlas not find"): this.event("error", "file not find")
            ...
            n(s, "laya.ani.bone.Templet", e);
            var t = s.prototype;
            return t.loadAni = function(t) {
                this._skBufferUrl = t, st.loader.load(t, u.create(this, this.onComplete), null, "arraybuffer")
            }, t.onComplete = function(t) {
                if (this._isDestroyed) this.destroy();
                else {
                    var e = o.getRes(this._skBufferUrl);
                ...
                return void 0 === t && (t = 0), new lt(this, t)
            }, t.parse = function(t) {
                ...
                if (this._isDestroyed) this.destroy();
                    ...
                    var t = 0;
                    this._loadList = [];
                    var e, i = new St(this.getPublicExtData()),
                        a = 0,
                        s = 0,
                        r = 0,
                        n = i.getInt32(),
                    ...
                    st.loader.load(this._loadList, u.create(this, this._textureComplete))
                }
            }, t._textureComplete = function() {
                for (var t, e, i = 0, a = this._loadList.length; i < a; i++) e = this._loadList[i], t = this._textureDic[e] = o.getRes(e), m.isWebGL && t && t.bitmap && (t.bitmap.enableMerageInAtlas = !1);
                ...
                var n, h, l = new St(this.getPublicExtData()),
                    o = 0,
                    u = 0,
                    c = 0,
                    d = 0,
                ...
                this._mainTexture = n;
                var M, D, I, N, b, A = l.getUint16();
                for (t = 0; t < A; t++)(M = []).push(l.getUint16()), M.push(l.getUint16()), M.push(l.getUint16()), M.push(l.getUint16()), this.aniSectionDic[t] = M;
                var T, C = l.getInt16(),
                    S = {};
                for (t = 0; t < C; t++) D = new kt, 0 == t ? T = D : D.root = T, D.d = r ? -1 : 1, N = l.readUTFString(), b = l.readUTFString(), D.length = l.getFloat32(), 1 == l.getByte() && (D.inheritRotation = !1), 1 == l.getByte() && (D.inheritScale = !1), D.name = N, b && ((I = S[b]) ? I.addChild(D) : this.mRootBone = D), S[N] = D, this.mBoneArr.push(D);
                this.tMatrixDataLen = l.getUint16();
                var w, F, k = l.getUint16(),
                    P = Math.floor(k / this.tMatrixDataLen),
                    B = this.srcBoneMatrixArr;
                for (t = 0; t < P; t++)(w = new zt).scX = l.getFloat32(), w.skX = l.getFloat32(), w.skY = l.getFloat32(), w.scY = l.getFloat32(), w.x = l.getFloat32(), w.y = l.getFloat32(), 8 === this.tMatrixDataLen && (w.skewX = l.getFloat32(), w.skewY = l.getFloat32()), B.push(w), (D = this.mBoneArr[t]).transform = w;
                var U, L = l.getUint16(),
                    R = 0;
                for (t = 0; t < L; t++) {
                ...
                var O, E = l.getUint16(),
                    V = 0;
                for (t = 0; t < E; t++) {
                    for (U = new Xt, V = l.getUint16(), e = 0; e < V; e++) U.boneIndexs.push(l.getInt16());
                ...
                var K = l.getUint16(),
                    Y = 0;
                for (t = 0; t < K; t++) {
                    for ((O = new Vt).name = l.readUTFString(), Y = l.getUint16(), e = 0; e < Y; e++) O.bones.push(l.getInt16());
                ...
                var lt, ot = l.getInt16(),
                    ut = 0;
                for (t = 0; t < ot; t++) {
                    for (ut = l.getInt16(), st = [], e = 0; e < ut; e++)(lt = new Ot).name = l.getUTFString(), this._isParseAudio && (lt.audioValue = l.getUTFString()), lt.intValue = l.getInt32(), lt.floatValue = l.getFloat32(), lt.stringValue = l.getUTFString(), lt.time = l.getFloat32(), st.push(lt);
                ...
                for (t = 0; t < vt; t++) {
                    for ((ft = new Kt).name = xt[gt++], Mt = l.getUint8(), e = 0; e < Mt; e++) {
                        for ((mt = new Wt).name = xt[gt++], dt = this.boneSlotDic[mt.name], Dt = l.getUint8(), i = 0; i < Dt; i++) {
                            ...
                            if (0 < (Nt = l.getUint16()))
                                for (yt.weights = [], a = 0; a < Nt; a++) yt.weights.push(l.getFloat32());
                            if (0 < (bt = l.getUint16()))
                                for (yt.triangles = [], a = 0; a < bt; a++) yt.triangles.push(l.getUint16());
                            if (0 < (At = l.getUint16()))
                                for (yt.vertices = [], a = 0; a < At; a++) yt.vertices.push(l.getFloat32());
                            if (0 < (Tt = l.getUint16()))
                ...
                this._rate = t
            }), s.LAYA_ANIMATION_160_VISION = "LAYAANIMATION:1.6.0", s.LAYA_ANIMATION_VISION = "LAYAANIMATION:1.7.0", s.TEMPLET_DICTIONARY = null, s
        }(nt))
