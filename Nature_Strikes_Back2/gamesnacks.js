	...
	function (e, t, n) {
		...
		var a,
			...
			l = function (e, t, n, a) {
				return (
					typeof e[t] === n ||
					a + ' expects "' + t + '" property of type "' + n + '".'
				);
			},
			c =
				((a = function (e, t) {
			...
			f = (function (e) {
				function t() {
					...
					return (
						(t.validateOrReturnError = function (e, t) {
							return 'object' != typeof e
								? t + ' expects parameter of type "object".'
								: u(e, A, t);
						}),
						t
					);
						...
						return (
							(t.validateOrReturnError = function (e, t) {
								if ('object' != typeof e)
									return (
										t +
										' expects parameter of type "object".'
									);
								var n = u(e, p, t);
								return !0 !== n
									? n
									: 'GAMESNACKS_ADS_INITIALIZE' !== e.type
									? t +
									  ' expects property "type" to be "GAMESNACKS_ADS_INITIALIZE"'
									: f.instance.validateOrReturnError(
											e.value,
											t
									  );
							}),
				...
				function e(e) {
					...
					(this.environment = 'production'),
						...
						(this.listenAndDelegateMessages = function () {
							t.postMessageHandler.listen(
								'GAMESNACKS_AUDIO_UPDATE',
								t.handleAudioUpdates
							),
								t.postMessageHandler.listen(
									'GAMESNACKS_ADS_INITIALIZE',
									t._initializeAds
								),
								t.postMessageHandler.listen(
									'GAMESNACKS_ADS_AD_BREAK',
									t._adBreak
								),
								t.postMessageHandler.listen(
									'GAMESNACKS_ALLOW_REWARDED_ADS',
									t._handleRewardedAdsAllowed
								),
								t.postMessageHandler.listen(
									'GAMESNACKS_DECLARE_TEST_ENVIRONMENT',
									t._testEnvironment
								),
								t.postMessageHandler.listen(
									'GAMESNACKS_DECLARE_VERBOSE_MODE',
									t._handleVerboseMode
								);
						}),
						...
						(this._initializeAds = function (e) {
							var n = e.value;
							f.instance.isType(n, 'GAMESNACKS_ADS_INITIALIZE')
								? t._initializeAdsWithValidatedConfig(n)
								: t._logIfVerbose(
										'Malformatted GS SDK request: initializeAds.'
								  );
						}),
							...
							if (
								...
								n.setAttribute('src', a),
									...
									n.setAttribute(
										...
										e.dataAdFrequencyHint
									),
									'on' === e.dataAdbreakTest &&
										n.setAttribute(
											'data-adbreak-test',
											'on'
										),
									...
									e.dataTagForChildDirectedTreatment &&
										n.setAttribute(
						...
						(this._adBreak = function (e) {
							...
							t._logIfVerbose(
								'Calling adbreak with this object: ' +
						...
						(this._afterBreak = function () {
							t.postMessageHandler.send({
								...
								(t.isAdInProgress = !1),
								t._changeAudioAndUpdateSubscribers(
									t.shouldAudioBeEnabledAfterAd
								);
						}),
						(this._adBreakDone = function (e) {
							t._logIfVerbose(
								'adbreakDone called with placementInfo: ' +
									JSON.stringify(e)
							),
								t.postMessageHandler.send({
						...
						(this._checkEnvironmentAttribute = function () {
							...
							'string' == typeof e &&
								(i.includes(e) ||
									console.warn(
										'GameSnacks SDK: Invalid value for data-environment attrbute: ' +
											e
									),
						...
						(this._testEnvironment = function () {
							(t.environment = 'test'),
								t._logIfVerbose(
									'GameSnacks SDK is running in a test environment.'
								),
								t._initializeAdsWithValidatedConfig(o),
								t._handleRewardedAdsAllowed(r),
								t.postMessageHandler.send({
						...
						(this.rewardedAdOpportunity = function (e) {
							if (
								g.instance.isType(e, 'rewardedAdOpportunity') &&
								t.rewardedAdsAllowed
							) {
								var n = t,
									a = {
										type: 'reward',
										...
										beforeReward: function (t) {
											n._logIfVerbose(
												'AFG called beforeReward'
											);
											e.beforeReward(function () {
												n._logIfVerbose(
													'Game called showAdFn'
												),
													t(),
										...
										adBreakDone: function (e) {
											n._logIfVerbose(
												'AFG called adBreakDone called with placementInfo: ' +
													JSON.stringify(e)
											),
												n.postMessageHandler.send({
						...
						(this.handleAudioUpdates = function (e) {
							var n;
							'boolean' == typeof e.isAudioEnabled &&
								(n = e.isAudioEnabled),
								'object' == typeof e.value &&
									'boolean' ==
										typeof e.value.isAudioEnabled &&
									(n = e.value.isAudioEnabled),
								t.isAdInProgress
									? (t.shouldAudioBeEnabledAfterAd = n)
									: (t._changeAudioAndUpdateSubscribers(n),
									  window.adConfig &&
											window.adConfig({
						...
						(this._subscribeToGhostData = function (e) {
							...
							window.addEventListener(
								...
								function (e) {
									e &&
										e.data &&
										'GAMESNACKS_RECEIVE_GHOST_DATA' ===
											e.data.type &&
										n.ghostDataSubscriber(e.data.value);
								},
								!1
							),
								t.postMessageHandler.send({
			...
			h = function () {};
		if ('object' == typeof window.GAMESNACKS)
			console.log('GAMESNACKS defined. Skipping legacy export.');
		else {
			console.log(
				'window.GAMESNACKS not yet defined, using legacy export.'
			);
