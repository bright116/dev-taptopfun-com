(() => {
	var e,
		...
		r = {
							...
							(s.report = (function () {
								...
								function l(t, i, n, r, o) {
									if (d)
										...
										(l.func =
											s.computeStackTrace.guessFunctionName(
												l.url,
												l.line
											)),
											(l.context =
										...
										if (
											((s = (function (e) {
												...
												var a,
													...
													A =
														/^\s*Line (\d+) of function script\s*$/i,
													p = [],
													h =
														i &&
														i.document &&
				...
				const n = {
					...
					tracking: {
						...
						screen: {
							...
							gameLoadingFinished:
								'pokiTrackingScreenGameLoadingFinished',
							commercialBreak:
								'pokiTrackingScreenCommercialBreak',
						...
						ads: {
							status: {
								...
								prebidRequested:
									'pokiTrackingAdsStatusPrebidRequested',
							...
							display: {
								requested:
									'pokiTrackingScreenDisplayAdRequested',
								impression:
									'pokiTrackingScreenDisplayAdImpression',
							},
							rewardedWeb: {
								...
								closedGranted:
									'pokiTrackingRewardedWebClosedGranted',
								closedDeclined:
									'pokiTrackingRewardedWebclosedDeclined',
			...
			889: (e, t, i) => {
				...
				var b = function () {
					...
					w = function () {
						window.__tcfapi &&
							window.__tcfapi('ping', 2, function () {
								console.debug(
									'GDPR - __tcfapi callback received'
								),
									(k = !0),
									clearInterval(Z);
							});
					...
					I = function () {
						window.__uspapi &&
							window.__uspapi('uspPing', 1, function () {
								console.debug(
									'USPrivacy - __uspapi callback received'
								),
									(y = !0),
									clearInterval(E);
							});
					...
					S = function () {
						s.Z.gdprApplies &&
							...
							((!s.Z.gdprApplies && !s.Z.ccpaApplies) ||
								d.Z.debug) &&
								(clearInterval(Z), clearInterval(E));
					},
					x = function () {
				...
				const j = function () {
					for (
						var e = Math.floor(Date.now() / 1e3), t = '', i = 0;
						i < 4;
						i++
					)
				...
				const R = (function () {
					...
					return (
						...
						(e.prototype.requestPossible = function () {
							return (
								!this.timers.timeBetweenAds &&
								!this.timers.startAdsAfter
							);
						}),
				...
				var ie = function () {
						var e;
						return (
							(null === (e = Object.keys(window.pbjs)) ||
							void 0 === e
								? void 0
								: e.length) > 1
						);
					...
					ce = function (e, t) {
						if (ie()) {
							...
							window.pbjs.que.push(function () {
								...
								var o = function (e, t) {
									return (
										640 !== t.width && (e *= 0.95), te(e, t)
									);
								};
								window.pbjs.bidderSettings = {
									standard: { storageAllowed: !0 },
									appnexus: { bidCpmAdjustment: te },
									openx: { bidCpmAdjustment: te },
									spotx: { bidCpmAdjustment: te },
									ix: { bidCpmAdjustment: o },
									richaudience: { bidCpmAdjustment: o },
									onetag: { bidCpmAdjustment: te },
									rubicon: { bidCpmAdjustment: te },
									pubmatic: { bidCpmAdjustment: o },
									'33across': { bidCpmAdjustment: te },
									sharethrough: { bidCpmAdjustment: o },
									triplelift: { bidCpmAdjustment: te },
								};
							});
						}
					},
						...
						var l,
							...
							g = function () {
								...
								if (!(--m > 0))
									try {
										M.Z.dispatchEvent(
											o.Z.ads.prebidRequested
										);
										var g = window.pbjs.adUnits.filter(
											function (e) {
												return e.code === h;
											}
										)[0];
										...
										var v =
												window.pbjs.adServers.dfp.buildVideoUrl(
													{
														adUnit: g,
														params: {
															iu: (0, L.Z)(
										...
										if (
											...
											b &&
												...
												void 0 === r
													? void 0
													: r.length) > 0 &&
												M.Z.setVideoDataAnnotations({
													adDomain:
														b.meta.advertiserDomains.join(
															','
														),
												}),
											a)
					...
					var e,
						t =
							(null ===
								...
								? void 0
								: e.hostname) || '';
					return 'yes' === (0, L.Z)('poki-ad-server')
					...
					be = function (e) {
						'desktop' !== ve
							? window.googletag.cmd.push(function () {
									a.Z.track(
										o.Z.tracking.ads.rewardedWeb.request
									),
										(function (e) {
							...
							: M.Z.dispatchEvent(o.Z.ads.video.startHouseAdFlow);
					},
					ke = (function () {
						function e(e, t) {
							var i = this;
							void 0 === t && (t = {}),
								...
								(this.totalRetries =
									t.totalRetries || O.waterfallRetries || 1),
								(this.timing = t.timing || new R(O.adTiming)),
								M.Z.addEventListener(
									o.Z.ads.video.error,
									this.moveThroughWaterfall.bind(this)
								),
								M.Z.addEventListener(
									o.Z.ads.video.loaderError,
									this.moveThroughWaterfall.bind(this)
								),
								M.Z.addEventListener(
									o.Z.ads.ready,
									this.timing.stopWaterfallTimer.bind(
										this.timing
									)
								),
								M.Z.addEventListener(
								...
								M.Z.addEventListener(
									o.Z.ads.video.startHouseAdFlow,
									function () {
										i.startHouseAdFlow();
									}
								);
						...
						return (
							(e.prototype.moveThroughWaterfall = function () {
								if (this.runningBackfill)
									return (
										...
										void M.Z.dispatchEvent(o.Z.ads.error, {
								...
								if (!1 !== this.running) {
									...
									(this.running = !1),
										...
										this.rewarded
											? be(this.criteria)
											: M.Z.dispatchEvent(o.Z.ads.error, {
													message: 'No ads',
											  });
								}
							}),
							...
							(e.prototype.buildAdUnitPaths = function (e) {
								...
								if (d.Z.debug) {
									...
									return e === o.Z.ads.position.rewarded
										? [n + 'debug-video-rewarded']
										: e === o.Z.ads.position.preroll
										? [n + 'debug-video-preroll']
										: [n + 'debug-video-midroll'];
								}
								e === o.Z.ads.position.rewarded &&
									(i = 'rewarded');
								var r = '/21682198607/';
							...
							(e.prototype.start = function (e, t) {
								void 0 === e && (e = {}),
									...
									this.timing.resetWaterfallTimerIdx(),
									(this.rewarded =
										t === o.Z.ads.position.rewarded),
									(this.adUnitPaths =
										this.buildAdUnitPaths(t)),
									this.requestAd();
							}),
								...
								var r,
									...
									d =
										...
										'&cust_params=' +
											...
											'&');
								s.Z.childDirected && (d += '&tfcd=1'),
									s.Z.nonPersonalized && (d += '&npa=1'),
									M.Z.setVideoDataAnnotations({
										adUnitPath: t,
										adTagUrl: d,
									...
									M.Z.dispatchEvent(o.Z.ads.requested),
						...
						function e(e) {
							...
							if (
								((this.hideElement = function (e) {
									e.classList.add(Ee), e.classList.remove(je);
								}),
								(this.showElement = function (e) {
									e.classList.add(je), e.classList.remove(Ee);
								}),
						...
						return (
								...
								this.showElement(this.pauseButton),
									this.monetization &&
										this.pauseButton.addEventListener(
											'click',
											this.monetization.resumeAd.bind(
												this.monetization
											)
										);
							}),
								...
								this.showElement(this.startAdButton),
									this.monetization &&
										this.startAdButton.addEventListener(
											'click',
											this.monetization.startAdClicked.bind(
												this.monetization
											)
										);
							}),
							...
							(e.prototype.createElements = function (e) {
								...
								(this.containerDiv =
									...
									(this.containerDiv.className = we),
									(this.insideContainer.className = Se),
									(this.pauseButton.className = xe),
									(this.pauseButtonBG.className = Ce),
									this.pauseButton.appendChild(
										this.pauseButtonBG
									),
									(this.startAdButton.className = _e),
									(this.startAdButton.innerHTML =
										'Tap anywhere to play ad'),
									(this.progressBar.className = Te),
									(this.progressContainer.className = Pe),
									(this.spinnerContainer.className = Be),
									(this.adContainer.className = ze),
									(this.videoContainer.className = De),
									this.hide(),
									...
									this.containerDiv.appendChild(
										this.insideContainer
									),
									this.containerDiv.appendChild(
										this.spinnerContainer
									),
									this.insideContainer.appendChild(
										this.progressContainer
									),
									this.insideContainer.appendChild(
										this.videoContainer
								...
								var i = e || null,
									n = function () {
										if ((i || (i = document.body), i))
											if (
												(i.appendChild(t.containerDiv),
												i === document.body)
											)
												t.containerDiv.classList.add(
													Ze
												);
											else {
												var e =
				...
				var Le = (function () {
						...
						return (
							(e.prototype.queueFakeProgress = function (
								e,
								t,
								i
							) {
								...
								this.storedQueue.push({
									...
									M.Z.addEventListener(i, function () {
										(n.eventWatcher[i] = !0),
											(n.currentProgress =
												n.startProgress + e),
											(n.startProgress =
				...
				const qe = (function () {
					...
					return (
						...
						(e.prototype.onAdsManagerLoaded = function (e) {
							...
							(t.enablePreloading = !0),
								...
								this.allowedToPlayAd
									? (this.attachAdEvents(),
									  M.Z.dispatchEvent(o.Z.ads.ready))
									: this.tearDown();
						}),
						...
						(e.prototype.stopPlayback = function () {
							M.Z.dispatchEvent(o.Z.ads.stopped), this.tearDown();
						}),
						(e.prototype.resumeAd = function () {
							M.Z.dispatchEvent(o.Z.ads.video.resumed),
							...
							switch (e.type) {
								...
								case google.ima.AdEvent.Type.STARTED:
									(e.remainingTime =
										...
										M.Z.dispatchEvent(o.Z.ads.started, {
								...
								case google.ima.AdEvent.Type.COMPLETE:
									this.completeOnce &&
										((this.completeOnce = !1),
										M.Z.dispatchEvent(o.Z.ads.completed, {
								...
								case google.ima.AdEvent.Type.PAUSED:
									this.adsManager.pause(),
										M.Z.dispatchEvent(o.Z.ads.video.paused);
									break;
								case google.ima.AdEvent.Type.AD_BUFFERING:
									M.Z.dispatchEvent(o.Z.ads.video.buffering);
									break;
								case google.ima.AdEvent.Type.CLICK:
									M.Z.dispatchEvent(o.Z.ads.video.clicked);
									break;
								case google.ima.AdEvent.Type.SKIPPED:
									M.Z.dispatchEvent(o.Z.ads.skipped),
										this.completeOnce &&
											((this.completeOnce = !1),
											M.Z.dispatchEvent(
												o.Z.ads.completed,
								...
								case google.ima.AdEvent.Type.IMPRESSION:
									M.Z.dispatchEvent(o.Z.ads.impression, {
										creativeId: i.getCreativeId(),
									});
							}
						}),
						(e.prototype.onAdLoaderError = function (e) {
							...
							var t = null == e ? void 0 : e.getError(),
								i =
									...
									'Unknown',
								n =
									(null == t ? void 0 : t.getErrorCode()) ||
									0;
							M.Z.dispatchEvent(o.Z.ads.video.loaderError, {
								message: i,
								errorCode: n,
							});
						}),
						(e.prototype.onAdError = function (e) {
							...
							var t = null == e ? void 0 : e.getError(),
								...
								n =
									(null == t ? void 0 : t.getErrorCode()) ||
									0;
							M.Z.dispatchEvent(o.Z.ads.video.error, {
								message: i,
								errorCode: n,
							});
						}),
							...
							switch (r.label) {
								...
								case 2:
									return (
										...
										(t = e.ISO),
										(i = e.ccpaApplies),
										[2, { ISO: t, ccpaApplies: i }]
									);
								case 3:
									return (
										(n = r.sent()),
										console.error(n),
										[2, { ISO: Ge.D, ccpaApplies: !1 }]
									);
								case 4:
									return [2];
							}
				...
				var et = (function () {
					...
					return (
						...
						(e.prototype.setupSlotRenderEndedListener =
							function () {
								var e = this;
								window.googletag.cmd.push(function () {
									window.googletag
										...
										.addEventListener(
											...
											function (t) {
												...
												if (l && l.gptSlot) {
													...
													l.onDisplayRendered &&
														l.onDisplayRendered(w),
														w &&
															e.callOnCanDestroy(
																l.id
															),
														w && l.backfillHouseads
															? e.requestHouseAd(
																	l,
																	I
															  )
						...
						(e.prototype.getDisplaySlotConfig = function (e, t, i) {
							var n = s.Z.device,
								r = t.split('x').map(function (e) {
									return parseInt(e, 10);
								}),
								o = this.getDisplaySlotID(e);
							if (o) {
								var a = this.slotMap.get(o);
								if (a && a.width === r[0] && a.height === r[1])
									return a.refreshNumber++, a;
								this.clearAd(e);
							}
							var c =
								'/21682198607/debug-display/debug-display-' + t;
							d.Z.debug ||
								(c = s.Z.isPokiIframe
									? '/21682198607/' +
									  n +
							...
							return (
								...
								(A.style.width = r[0] + 'px'),
								(A.style.height = r[1] + 'px'),
						...
						(e.prototype.renderAd = function (e) {
							...
							(k.backfillHouseads = v),
								...
								(k.onCanDestroy = p);
							var y = null;
							k.refreshNumber > 0 && (y = k.innerAdContainer),
								y ||
									(n.appendChild(k.innerAdContainer),
									n.setAttribute('data-poki-ad-id', k.id)),
								...
								null === (t = k.intersectionObserver) ||
									void 0 === t ||
									t.disconnect(),
								k.intersectionObserver.observe(
									k.innerAdContainer
								);
						}),
						...
						(e.prototype.clearAd = function (e) {
							...
							if (i) {
								...
								console.error(
									'destroyAd called on a container without ad'
								);
						}),
					...
					rt = (function (e) {
						function t() {
							...
							return (
								...
								(t.setupSlotRenderEndedListener =
									function () {}),
								t
							);
						}
							...
							(t.prototype.allBidsBack = function (e) {
								...
								if (d) {
									...
									if (l) {
										...
										var f = !p;
										a.Z.track(
											o.Z.tracking.ads.display.impression,
											{
												size: d.size,
											...
											f
												...
												: ((d.intersectionObserver =
												  ...
												  d.intersectionObserver.observe(
														l
												  ));
									} else
										console.error(
											'Display error - container not found',
											e
										);
								}
							}),
							(t.prototype.renderPrebidAd = function (e, t, i) {
								...
								if (n)
									return n.pbjsTargetting.hb_adid
										? void window.pbjs.renderAd(
												i,
												n.pbjsTargetting.hb_adid
										  )
										: (console.error(
						...
						function e() {
							(this.autoStartOnReady = !1),
								...
								(this.sdkNotBootedButCalled = function () {
									console.error(
										'The Poki SDK has not yet been initialized'
									);
								}),
								(this.genericCriteria = function () {
									...
									return (
										...
										(e.tag_site =
											s.Z.tag + '|' + s.Z.siteID),
										(e.site_id = encodeURIComponent(
											s.Z.siteID
										)),
										(e.experiment = encodeURIComponent(
											s.Z.experiment
										)),
										(e.categories = encodeURIComponent(
											s.Z.categories
										)),
										(e.p4d_game_id = s.Z.gameID),
										e
									);
								}),
						...
						return (
							(e.prototype.init = function (e) {
								if (
									...
									return (
										...
										this.isInitialized
											? console.error(
													'Poki SDK has already been initialized'
											  )
							...
							(e.prototype.loadMonetizationCore = function () {
								...
								var C = s.Z.ccpaApplies,
									...
									j = We,
									z = (
										this.initOptions.country || s.Z.country
									).toUpperCase();
								z &&
									void 0 !== D &&
									(j = function () {
								...
								var R = [x(), j()],
									L = st(st([], R, !0), [Ye()], !1),
									G = s.Z.referrer.includes('kiloo.com');
								return (
									L.push(
										(0, _.Z)(
									...
									G || E
										...
										: L.push(
												(0, _.Z)(
													'https://a.poki.com/prebid/prebid7.22.0.js'
												),
												(0, _.Z)(
									...
									Promise.allSettled(L)
										...
										.catch(function () {
											M.Z.dispatchEvent(o.Z.adblocked);
										})
								);
							}),
							(e.prototype.requestAd = function (e) {
								...
								var t = e.autoStart,
									...
									l = e.position,
									A = void 0 === l ? null : l,
									u = { opportunityId: j(), position: A };
								if (
									(a.Z.track(
										A === o.Z.ads.position.rewarded
											? o.Z.tracking.screen.rewardedBreak
											: o.Z.tracking.screen
													.commercialBreak,
										at(at({}, e.rewardedKVs), u)
									),
									...
									if (
										...
										M.Z.dispatchEvent(
											...
											at(at({}, u), {
												message:
													'Interstitials are disabled on mobile',
											})
										);
								} else
									M.Z.dispatchEvent(
									...
									if (t)
										if (void 0 !== window.googletag)
											if (
												...
												if (
													!this.display.validateDisplaySettings(
														i
													)
												)
													return M.Z.dispatchEvent(
														o.Z.ads.error,
														{
															reason:
																'Display size ' +
							...
							(e.prototype.destroyAd = function (e) {
								if (!this.sdkBooted)
									return (
										console.error(
											'Attempting destroyAd on unbooted SDK'
										),
										void this.sdkNotBootedButCalled()
									);
							...
							(e.prototype.resumeAd = function () {
								...
								this.sdkImaError ||
									this.displayOnly ||
									(this.playerSkin.hidePauseButton(),
									this.ima.resumeAd());
							}),
							...
							(e.prototype.enableSettings = function (e) {
								(this.criteria = at({}, e.customCriteria)),
									(this.adTimings = new R(e.adTiming));
							}),
							...
							(e.prototype.setupDefaultEvents = function () {
								var e = this;
								M.Z.addEventListener(o.Z.ready, function () {
									(e.sdkBooted = !0),
									...
									[
										...
										M.Z.addEventListener(t, function () {
				...
				function mt() {
					return (
						ht ||
							((ht = Math.random().toString(36).substr(2, 9)),
							A(ut, ht)),
						ht
					);
				}
				...
				'undefined' != typeof window &&
					((r().remoteFetching = !1),
					r().report.subscribe(function (e) {
						if (
							'Script error.' === e.message &&
							window.pokiLastCatch
						) {
						...
						function e() {
							...
							(this.gameStarted = !1),
								...
								(this.gameLoadingFinished = function () {
									...
									a.Z.track(
										o.Z.tracking.screen.gameLoadingFinished,
										{
											transferSize: i,
											trackers: ((n = window),
											(r = []),
											...
											n.mixpanel &&
												'function' ==
													typeof n.mixpanel.track &&
												r.push('mixpanel'),
											'function' ==
												typeof n.GameAnalytics &&
												r.push('gameanalytics'),
											(n.kongregateAPI || n.kongregate) &&
												r.push('kongregate'),
								...
								(this.gameplayStart = function (e) {
									(t.duringGameplay = !0),
										t.gameStarted ||
											((t.gameStarted = !0),
											a.Z.track(
												o.Z.tracking.screen.firstRound
											),
											t.monetization.startStartAdsAfterTimer()),
										a.Z.track(
											o.Z.tracking.screen.gameplayStart,
											vt({}, e)
										),
										clearTimeout(t.playerActiveTimeout),
										(t.playerActiveTimeout = setTimeout(
											function () {
												window.addEventListener(
													'pointermove',
								...
								(this.gameplayStop = function (e) {
									(t.duringGameplay = !1),
										a.Z.track(
											o.Z.tracking.screen.gameplayStop,
											vt({}, e)
										),
										clearTimeout(t.playerActiveTimeout),
								...
								(this.roundStart = function (e) {
									void 0 === e && (e = ''),
										(e = String(e)),
										a.Z.track(
											o.Z.tracking.screen.roundStart,
											{ identifier: e }
										);
								}),
								...
								(this.playerIsActiveEvent = function () {
									window.removeEventListener(
										...
										a.Z.track(
											o.Z.tracking.screen.playerActive
										),
										(t.playerActiveTimeout = setTimeout(
											function () {
												window.addEventListener(
								...
								(this.setDebugTouchOverlayController =
									function () {}),
								...
								(this.__pokiInternal__playgroundPlatformAd =
									function (e, i, n, r) {
										var s = j();
										a.Z.track(
											o.Z.tracking.screen.displayAd,
											{
												size: n,
												opportunityId: s,
												platformAd: !0,
								...
								(this.__pokiInternal__setRuntimeInformation =
									function (e) {
										void 0 === e && (e = {}),
					...
					return (
						(e.sendMessage = function (e, t) {
							...
							if (!(0, r.Z)(e, n.Z.message)) {
								var a = Object.keys(n.Z.message).map(function (
									e
								) {
							...
							o.Z.gameID &&
								...
								i.postMessage({ type: e, content: s }, '*');
						}),
						e
					);
				})();
						...
						(e.dispatchEvent = function (e, t) {
							void 0 === t && (t = {}),
								!n.Z.debug ||
									...
									console.info(e, t);
							for (
								var i = Object.keys(this.listeners), o = 0;
								o < i.length;
								o++
							) {
								var a = i[o];
								if (e === a)
									for (
										var s = this.listeners[a], d = 0;
										d < s.length;
										d++
									)
										s[d](r(r({}, this.dataAnnotations), t));
							}
						}),
						(e.setVideoDataAnnotations = function (e) {
							this.dataAnnotations = r(
								r({}, this.dataAnnotations),
								e
							);
						}),
			...
			453: (e, t, i) => {
				...
				window._pokiUserGlobalName =
					window._pokiUserGlobalName || 'user';
				var s = 'poki_session';
				function d(e) {
					return !(
						!e ||
					...
					I = (function () {
						...
						return (
							(e.track = function (t, i) {
								...
								var n = k.Z.getVideoDataAnnotations();
								...
								if (
									(t.includes('pokiTrackingRewardedWeb') &&
										(i = n),
									h.Z.log)
								) {
									if (
							...
							(e.setupDefaultEvents = function () {
								var t,
									i =
										(((t = {})[u.Z.ready] =
											u.Z.tracking.sdk.status.initialized),
										(t[u.Z.adblocked] =
											u.Z.tracking.sdk.status.failed),
										(t[u.Z.ads.busy] =
											u.Z.tracking.ads.status.busy),
										(t[u.Z.ads.completed] =
											u.Z.tracking.ads.status.completed),
										(t[u.Z.ads.error] =
											u.Z.tracking.ads.status.error),
										(t[u.Z.ads.impression] =
											u.Z.tracking.ads.status.impression),
										(t[u.Z.ads.limit] =
											u.Z.tracking.ads.status.limit),
										(t[u.Z.ads.ready] =
											u.Z.tracking.ads.status.ready),
										(t[u.Z.ads.requested] =
											u.Z.tracking.ads.status.requested),
										(t[u.Z.ads.prebidRequested] =
											u.Z.tracking.ads.status.prebidRequested),
										(t[u.Z.ads.skipped] =
											u.Z.tracking.ads.status.skipped),
										(t[u.Z.ads.started] =
											u.Z.tracking.ads.status.started),
										(t[u.Z.ads.video.clicked] =
											u.Z.tracking.ads.video.clicked),
										(t[u.Z.ads.video.error] =
											u.Z.tracking.ads.video.error),
										(t[u.Z.ads.video.loaderError] =
											u.Z.tracking.ads.video.loaderError),
										(t[u.Z.ads.video.buffering] =
											u.Z.tracking.ads.status.buffering),
										(t[u.Z.ads.video.progress] =
											u.Z.tracking.ads.video.progress),
										(t[u.Z.ads.video.paused] =
											u.Z.tracking.ads.video.paused),
										(t[u.Z.ads.video.resumed] =
											u.Z.tracking.ads.video.resumed),
										(t[u.Z.tracking.screen.gameplayStart] =
											u.Z.tracking.screen.gameplayStart),
										(t[u.Z.tracking.screen.gameplayStop] =
											u.Z.tracking.screen.gameplayStop),
										(t[
											u.Z.tracking.screen.commercialBreak
										] =
											u.Z.tracking.screen.commercialBreak),
										(t[u.Z.tracking.screen.rewardedBreak] =
											u.Z.tracking.screen.rewardedBreak),
										t);
							...
							(e.setupObserver = function () {
								(Z._pokiSessionGlobalName = 'pokiSession'),
									...
									(function (e, t, i) {
										var u = c();
										d(u)
											? ((u.previous_page.path =
													u.page.path),
											  (u.previous_page.type =
													u.page.type),
											  (u.previous_page.id = u.page.id),
											  (u.previous_page.start =
													u.page.start),
											  (u.page.path = e),
											  (u.page.type = t),
											  (u.page.id = i),
											...
											: (u = (function (e, t, i) {
													try {
														...
														if (d(c))
															return (
																(c.previous_page.path =
																	c.page.path),
																(c.previous_page.type =
																	c.page.type),
																(c.previous_page.id =
																	c.page.id),
																(c.previous_page.start =
																	c.page.start),
																(c.page.path =
																	e),
																(c.page.type =
									...
									(Z.pokiGTM = Z.pokiGTM || []),
									(0, f.Z)(
										'https://a.poki.com/observer/t2.js'
									),
									(e.logToObserver = !0);
							}),
							(e.logToObserver = !1),
	...
	(a.m = r),
		...
		(a.e = (e) =>
			Promise.all(
				Object.keys(a.f).reduce((t, i) => (a.f[i](e, t), t), [])
			)),
		(a.u = (e) => e + '-v2.324.0.js'),
		(a.g = (function () {
				...
				if (void 0 !== r)
					for (
						...
						if (
							...
							A.getAttribute('data-webpack') == n + r
						) {
							s = A;
							break;
						}
