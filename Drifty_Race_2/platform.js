!function(){
    class platform {
        constructor() {
            ...
            this.canMainNavigateActive_ = false;
            this.screen_ = "";
            this.action_ = "";
            this.to_ = "";
            this.prompt_ = null;
        ...
        onNavigate_() {
            ...
            //     YYGSDK.forgamesNavigate(this.screen_, this.action_, this.to_);
            // }
            // this.canNavigateActive_ = false;
            // if (this.canMainNavigateActive_) {
            //     YYGSDK.forceNavigate(this.screen_, this.action_, this.to_);
            // }
            // this.canMainNavigateActive_ = false;
        }
        ...
        mainNavigate(screen_, action_, to_) {
            if (this.canMainNavigateActive_ === false) {
                this.screen_ = screen_;
                this.action_ = action_;
                this.to_ = to_;
                this.canMainNavigateActive_ = true;
            }
        }
