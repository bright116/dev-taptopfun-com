!function(t, e, i) {
    ...
    var z = function() {
        ...
        return e.addRect = function(t, e, i, r) {
            ...
            for (var r = -1, _ = -1, a = this._width, n = this._height, s = this._cells, o = 0; o < n; o++) {
                if (!(this._rowInfo[o] < t)) for (var h = 0; h < a; ) {
                    var l = 3 * (o * a + h);
            ...
            if (t > 0) for (s = 0; s < r; ++s) {
                ...
                for (o = l; o > 0; --o) {
                    this._cells[3 * ((e + s) * a + t - o) + 1] = o, this._check(o > 0);
                }
            }
            if (e > 0) for (o = t; o < t + i; ++o) {
                for (l = 0, s = e - 1; s >= 0 && 0 == this._cells[3 * (o + s * a)]; --s, l++) {}
                for (s = l; s > 0; --s) {
                    this._cells[3 * (o + (e - s) * a) + 2] = s, this._check(s > 0);
                }
            }
        ...
        return e.cloneWithNewVB = function() {
            ...
            for (var e = this._ib.getUint16Array(), i = 0, r = 0, _ = 0; _ < t; _++) {
                e[i++] = r, e[i++] = r + 2, e[i++] = r + 1, e[i++] = r, e[i++] = r + 3, e[i++] = r + 2, 
                r += 4;
            }
        ...
        return e.setFont = function(e) {
            ...
            for (var e in t) {
                for (var i = t[e], r = 0, _ = i.length; r < _; r++) {
                    var a = i[r].ri;
            ...
            for (this.textAtlases.length = r, r = this.isoTextures.length, i = 0; i < r; i++) {
                o = this.isoTextures[i], F.loopCount - o.lastTouchTm > t.destroyUnusedTextureDt && (o.ri.deleted = !0, 
                o.ri.tex = null, o.destroy(), this.isoTextures[i] = this.isoTextures[r - 1], r--, 
                i--);
            }
            ...
            for (var _ = t.width * e + i, a = i; a < r; a++) {
        ...
        _(t, "laya.webgl.utils.MatirxArray"), t.ArrayMul = function(e, i, r) {
            if (e) {
                if (i) for (var _ = NaN, a = NaN, n = NaN, s = NaN, o = 0; o < 4; o++) {
                    _ = e[o], a = e[o + 4], n = e[o + 8], s = e[o + 12], r[o] = _ * i[0] + a * i[1] + n * i[2] + s * i[3], 
                    r[o + 4] = _ * i[4] + a * i[5] + n * i[6] + s * i[7], r[o + 8] = _ * i[8] + a * i[9] + n * i[10] + s * i[11], 
                    r[o + 12] = _ * i[12] + a * i[13] + n * i[14] + s * i[15];
        ...
        var _ = function _(e) {
            ...
            this.gl = e, function(t) {
                ...
                t.getError = function() {
                    ...
                    for (var r in i) {
                        if (i[r]) return delete i[r], parseInt(r);
                    }
                    return t.NO_ERROR;
                };
            }(e);
        ...
        e.characterMapContains = function(e) {
            ...
            for (r = 0; r < t.length; ++r) {
                i = t.charCodeAt(r), e += this.getOriginalCharsFromCode(i);
            }
            return e;
        ...
        e.recover = function() {
            ...
            this._vertices = t;
            for (var e = this.vbBuffer._float32Data, i = 0, r = 0; r < this._verticesNum; r++) {
                e[i++] = this._x + t[2 * r], e[i++] = this._y + t[2 * r + 1], i++, i++, i++, i++;
            }
            ...
            this._y = t;
            for (var e = this.vbBuffer._float32Data, i = 0, r = 0; r < this._verticesNum; r++) {
                i++, e[i++] = t + this.vertices[2 * r + 1], i++, i++, i++, i++;
            }
            j.syncBufferToRenderThread(this.vbBuffer);
        }), a(0, e, "x", function() {
            return this._x;
            ...
            this._x = t;
            for (var e = this.vbBuffer._float32Data, i = 0, r = 0; r < this._verticesNum; r++) {
                e[i++] = t + this.vertices[2 * r], i++, i++, i++, i++, i++;
            }
            j.syncBufferToRenderThread(this.vbBuffer);
            ...
            this._indices = t;
            for (var e = this.ibBuffer._int16Data, i = 0, r = 0; r < this._ibNum; r++) {
                e[i++] = t[r];
            }
            ...
            for (var T = 0, D = 0; D < f._verticesNum; D++) {
                m[T++] = i / f._matrix.a + _[2 * D], m[T++] = r / f._matrix.d + _[2 * D + 1], m[T++] = a[2 * D], 
                m[T++] = a[2 * D + 1], R[T++] = p, R[T++] = 4294967295;
            }
            f._ibNum = n.length;
            var P = f._ibNum;
            (!f.ibBuffer || f.ibBuffer.getByteLength() < 2 * P) && (f.ibBuffer = new ParamData(2 * P, !0, !0)), 
            f._ibSize = 2 * P;
            for (var g = f.ibBuffer._int16Data, M = 0, y = 0; y < f._ibNum; y++) {
                g[M++] = n[y];
            }
        ...
        return e.add = function(t) {
            ...
            var r = i[t];
            if (r) return r;
            for (var _ = {}, a = 1, n = 0; n < 32 && !((a = 1 << n) > t); n++) {
                if (t & a) {
                    var s = e[a];
                    s && (_[s] = "");
                }
        ...
        return e.setParent = function(t) {
            ...
            if (this.text && e.push(this.text), this.childs.length > 0 && this.childs.forEach(function(r, _, a) {
                r._toscript(t, e, i);
            }), this.includefiles.length > 0 && this.useFuns.length > 0) for (var _, a = 0, n = this.includefiles.length; a < n; a++) {
                this.includefiles[a].curUseID != i && (_ = this.includefiles[a].file.getFunsScript(this.useFuns)).length > 0 && (this.includefiles[a].curUseID = i, 
                e[0] = _ + e[0]);
            }
            return e;
        }, t.__id = 1, t;
        ...
        e.recover = function() {
            ...
            j.syncBufferToRenderThread(this._graphicsCmdEncoder), this._lineColor = e, this._lineColor && this.line_vbBuffer) {
                for (var i = l.create(this._lineColor).numColor, r = this.line_vbBuffer._int32Data, _ = 0, a = 0; a < this._line_vertNum; a++) {
                    _++, _++, r[_++] = i;
                }
            ...
            if (r.length > 0) {
                ...
                for (var _ = this.ibBuffer._int16Data, a = 0, n = 0; n < r.length; n++) {
                    _[a++] = r[n];
                }
            }
            ...
            for (var s = l.create(this._fillColor).numColor, o = this.vbBuffer._float32Data, h = this.vbBuffer._int32Data, u = 0, c = 0; c < this._vertNum; c++) {
                o[u++] = this._points[2 * c] + this._x, o[u++] = this._points[2 * c + 1] + this._y, 
                h[u++] = s;
            }
            ...
            j.syncBufferToRenderThread(this._paramData), this.lineColor) {
                ...
                for (a = 0, n = 0; n < 3 * (this._line_vertNum - 2); n++) {
                    A[a++] = this._line_ibArray[n];
                }
                ...
                for (u = 0, c = 0; c < this._line_vertNum; c++) {
                    m[u++] = this._line_vbArray[2 * c] + this._x, m[u++] = this._line_vbArray[2 * c + 1] + this._y, 
                    R[u++] = E;
                }
            ...
            this._fillColor = t;
            for (var e = l.create(this._fillColor).numColor, i = this.vbBuffer._int32Data, r = 0, _ = 0; _ < this._vertNum; _++) {
                r++, r++, i[r++] = e;
            }
            j.syncBufferToRenderThread(this.vbBuffer);
        }), a(0, e, "x", function() {
            ...
            this._x = t;
            for (var e = this.vbBuffer._float32Data, i = 0, r = 0; r < this._vertNum; r++) {
                e[i++] = this._points[2 * r] + this._x, i++, i++;
            }
            if (this._lineColor) {
                var _ = this.line_vbBuffer._float32Data;
                for (i = 0, r = 0; r < this._line_vertNum; r++) {
                    _[i++] = this._line_vbArray[2 * r] + this._x, i++, i++;
                }
                j.syncBufferToRenderThread(this.line_vbBuffer);
            }
            j.syncBufferToRenderThread(this.vbBuffer);
            ...
            this._y = t;
            for (var e = this.vbBuffer._float32Data, i = 0, r = 0; r < this._vertNum; r++) {
                i++, e[i++] = this._points[2 * r + 1] + this._y, i++;
            }
            if (this._lineColor) {
                var _ = this.line_vbBuffer._float32Data;
                for (i = 0, r = 0; r < this._line_vertNum; r++) {
                    i++, _[i++] = this._line_vbArray[2 * r + 1] + this._y, i++;
                }
                j.syncBufferToRenderThread(this.line_vbBuffer);
            }
            j.syncBufferToRenderThread(this.vbBuffer);
            ...
            for (i = 0; i < this._line_vertNum; i++) {
                r[_++] = this._line_vbArray[2 * i] + this._x, r[_++] = this._line_vbArray[2 * i + 1] + this._y, 
                _++;
            }
            j.syncBufferToRenderThread(this.line_vbBuffer);
            ...
            if (c.length > 0) {
                ...
                for (var f = h.ibBuffer._int16Data, d = 0, A = 0; A < c.length; A++) {
                    f[d++] = c[A];
                }
            }
            ...
            for (var m = h.vbBuffer._float32Data, R = h.vbBuffer._int32Data, p = 0, T = 0; T < h._vertNum; T++) {
                m[p++] = r[2 * T] + e, m[p++] = r[2 * T + 1] + i, R[p++] = E;
            }
            for (T = 0; T < r.length; T++) {
                h._linePoints.push(r[T]);
            }
            if (h._linePoints.push(r[0]), h._linePoints.push(r[1]), a) {
                ...
                for (d = 0, A = 0; A < 3 * (h._line_vertNum - 2); A++) {
                    D[d++] = h._line_ibArray[A];
                }
                ...
                for (p = 0, T = 0; T < h._line_vertNum; T++) {
                    M[p++] = h._line_vbArray[2 * T] + e, M[p++] = h._line_vbArray[2 * T + 1] + i, y[p++] = g;
                }
            } else {
                h._lineWidth = 1;
                ...
                d = 0, A = 0; A < 3 * (h._line_vertNum - 2); A++) {
                    D[d++] = h._line_ibArray[A];
                }
                ...
                M = h.line_vbBuffer._float32Data, y = h.line_vbBuffer._int32Data, p = 0, T = 0; T < h._line_vertNum; T++) {
                    M[p++] = h._line_vbArray[2 * T] + e, M[p++] = h._line_vbArray[2 * T + 1] + i, y[p++] = g;
                }
            }
        ...
        return e.getWidth = function(e) {
            ...
            for (var t, e, i = this.pages.length, r = 0; r < i; r++) {
        ...
        e._arc = function(t, e, i, r, _, a, n) {
            ...
            if (h = _ - r, a) {
                if (Math.abs(h) >= 2 * Math.PI) h = 2 * -Math.PI; else for (;h > 0; ) {
                    h -= 2 * Math.PI;
                }
            } else if (Math.abs(h) >= 2 * Math.PI) h = 2 * Math.PI; else for (;h < 0; ) {
                h += 2 * Math.PI;
            }
            ...
            var R = 0, p = 0;
            for (E = 0; E <= m; E++) {
                o = r + h * (E / m), c = Math.cos(o), A = e + (f = Math.sin(o)) * i, (d = t + c * i) == R && A == p || (s.push(d), 
                s.push(A)), R = d, p = A;
            }
            ...
            this._ibSize = 3 * s * 2;
            for (var o = this.ibBuffer._int16Data, h = 0, u = 0; u < s; u++) {
                o[h++] = 0, o[h++] = u + 1 + 0, o[h++] = u + 2 + 0;
            }
            (!this.vbBuffer || this.vbBuffer.getByteLength() < 3 * this._vertNum * 4) && (this.vbBuffer = new ParamData(3 * n * 4, !0)), 
            this._vbSize = 3 * this._vertNum * 4;
            for (var c = l.create(i).numColor, f = this.vbBuffer._float32Data, d = this.vbBuffer._int32Data, A = 0, E = 0; E < this._vertNum; E++) {
                f[A++] = r[2 * E] + t, f[A++] = r[2 * E + 1] + e, d[A++] = c;
            }
            var m = 0;
            for (this._linePoints.length = 0, this._line_ibArray.length = 0, this._line_vbArray.length = 0, 
            E = 0; E < r.length; E++) {
                this._linePoints.push(r[E]);
            }
            if (this._linePoints.push(r[0]), this._linePoints.push(r[1]), _) {
                ...
                h = 0;
                for (var p = 0; p < 3 * (this._line_vertNum - 2); p++) {
                    R[h++] = this._line_ibArray[p];
                }
                ...
                for (A = 0, E = 0; E < this._line_vertNum; E++) {
                    D[A++] = this._line_vbArray[2 * E] + this._x, D[A++] = this._line_vbArray[2 * E + 1] + this._y, 
                    P[A++] = v;
                }
            } else {
                this._lineWidth = 1;
                ...
                h = 0, p = 0; p < 3 * (this._line_vertNum - 2); p++) {
                    R[h++] = this._line_ibArray[p];
                }
                ...
                D = this.line_vbBuffer._float32Data, P = this.line_vbBuffer._int32Data, A = 0, E = 0; E < this._line_vertNum; E++) {
                    D[A++] = this._line_vbArray[2 * E] + this._x, D[A++] = this._line_vbArray[2 * E + 1] + this._y, 
                    P[A++] = v;
                }
            }
            ...
            this._line_ibSize = 3 * (this._line_vertNum - 2) * 2;
            for (var _ = this.line_ibBuffer._int16Data, a = 0, n = 0; n < 3 * (this._line_vertNum - 2); n++) {
                _[a++] = this._line_ibArray[n];
            }
            ...
            for (i = 0; i < this._line_vertNum; i++) {
                o[u++] = this._line_vbArray[2 * i] + this._x, o[u++] = this._line_vbArray[2 * i + 1] + this._y, 
                h[u++] = s;
            }
        ...
        e.recover = function() {
            ...
            for (var i = this._paramData._int32Data, r = l.create(e).numColor, _ = t._PARAM_LINE_VB_POS_, a = 0; a < this._line_vertNum; a++) {
                _++, _++, i[_++] = r;
            }
            j.syncBufferToRenderThread(this._paramData);
        }), a(0, e, "cmdID", function() {
            ...
            this.lineColor) {
                ...
                this._line_vertNum = this._linePoints.length;
                for (var r = t._PARAM_LINE_VB_POS_, _ = 0; _ < this._line_vertNum; _++) {
                    i[r++] = this._line_vbArray[2 * _], i[r++] = this._line_vbArray[2 * _ + 1], r++;
                }
            }
            j.syncBufferToRenderThread(this._paramData);
        }), a(0, e, "x", function() {
            ...
            yt.createLine2(this._linePoints, this._line_ibArray, this._lineWidth, 0, this._line_vbArray, !1), 
            this._line_vertNum = this._linePoints.length;
            for (var i = this._paramData._float32Data, r = t._PARAM_LINE_VB_POS_, _ = 0; _ < this._line_vertNum; _++) {
                i[r++] = this._line_vbArray[2 * _], i[r++] = this._line_vbArray[2 * _ + 1], r++;
            }
            j.syncBufferToRenderThread(this._paramData);
            ...
            o._linePoints.push(e), o._linePoints.push(i - s / 2), n) {
                ...
                for (var E = 0; E < o._line_vertNum; E++) {
                    u[f++] = o._line_vbArray[2 * E], u[f++] = o._line_vbArray[2 * E + 1], c[f++] = A;
                }
                c[t._PARAM_LINE_IB_SIZE_POS_] = 2 * o._line_ibArray.length;
                var m = o._paramData._int16Data;
                f = 2 * t._PARAM_LINE_IB_POS_;
                for (var R = 0; R < o._line_ibArray.length; R++) {
                    m[f++] = o._line_ibArray[R];
                }
            } else {
                o._lineWidth = 1;
                ...
                f = t._PARAM_LINE_VB_POS_, E = 0; E < o._line_vertNum; E++) {
                    u[f++] = o._line_vbArray[2 * E], u[f++] = o._line_vbArray[2 * E + 1], c[f++] = A;
                }
                for (c[t._PARAM_LINE_IB_SIZE_POS_] = 2 * o._line_ibArray.length, m = o._paramData._int16Data, 
                f = 2 * t._PARAM_LINE_IB_POS_, R = 0; R < o._line_ibArray.length; R++) {
                    m[f++] = o._line_ibArray[R];
                }
            }
        ...
        return e._compileToTree = function(e, i, r, _, a) {
            ...
            for (d = r; d < i.length; d++) {
                if (!((o = i[d]).length < 1) && 0 !== (f = o.indexOf("//"))) {
                    ...
                    (f = o.indexOf("#")) >= 0) {
                        ...
                        switch (n.name = h, h) {
                          ...
                          case "#ifndef":
                            ...
                            e = n, a) for (u = o.substr(E).split(t._splitToWordExps3), E = 0; E < u.length; E++) {
                                (o = u[E]).length && (a[o] = !0);
                            }
                            continue;
                ...
                for (h = 0, l = f.length; h < l; h++) {
                    ...
                    if ("attribute" == d || "uniform" == d) h = t._parseOne(a, n, f, h, d, !0); else {
                        ...
                        if ("#ifdef" == d) {
                            s[c = f[++h]] = s[c] || [];
                            for (h++; h < l; h++) {
                                if ("attribute" == (d = f[h]) || "uniform" == d) h = t._parseOne(a, n, f, h, d, o[c]); else if ("#else" == d) for (h++; h < l; h++) {
                                    if ("attribute" == (d = f[h]) || "uniform" == d) h = t._parseOne(a, n, f, h, d, !o[c]); else if ("#endif" == d) break;
                                }
                            }
                        }
                    }
            ...
            for (var i, r, _ = [], a = -1, n = 0, s = t.length; n < s; n++) {
        ...
        e._getPoints = function(t) {
            ...
            for (var i = 2, r = t.length; i < r; ) {
                this._quadraticCurveTo(e, t[i++], t[i++], t[i++], t[i++]);
            }
            return e;
            ...
            for (var s = 2, o = this.tArray.length; s < o; s++) {
                t.push(this.tArray[s]);
            }
        }, e.recover = function() {
            ...
            this._lineColor = t;
            for (var e = l.create(this._lineColor).numColor, i = this.vbBuffer._int32Data, r = 0, _ = 0; _ < this._vertNum; _++) {
                r++, r++, i[r++] = e;
            }
            j.syncBufferToRenderThread(this.vbBuffer);
        }), a(0, e, "points", function() {
            ...
            this._vbSize = 3 * this._vertNum * 4;
            for (var _ = this.vbBuffer._float32Data, a = this.vbBuffer._int32Data, n = 0, s = 0; s < this._vertNum; s++) {
                _[n++] = this._vbArray[2 * s] + this.x, _[n++] = this._vbArray[2 * s + 1] + this.y, 
                a[n++] = i;
            }
            ...
            for (var o = this.ibBuffer._int16Data, h = 0; h < 3 * (this._vertNum - 2); h++) {
                o[h] = this._ibArray[h];
            }
            ...
            this._x = t;
            for (var e = this.vbBuffer._float32Data, i = 0, r = 0; r < this._vertNum; r++) {
                e[i++] = this._vbArray[2 * r] + this._x, i++, i++;
            }
            j.syncBufferToRenderThread(this.vbBuffer);
        }), a(0, e, "y", function() {
            return this._y;
            ...
            this._y = t;
            for (var e = this.vbBuffer._float32Data, i = 0, r = 0; r < this._vertNum; r++) {
                i++, e[i++] = this._vbArray[2 * r + 1] + this._y, i++;
            }
            j.syncBufferToRenderThread(this.vbBuffer);
        }), a(0, e, "lineWidth", function() {
            return this._lineWidth;
            ...
            for (var e = this.vbBuffer._float32Data, i = 0, r = 0; r < this._vertNum; r++) {
                e[i++] = this._vbArray[2 * r] + this.x, e[i++] = this._vbArray[2 * r + 1] + this.y, 
                i++;
            }
            j.syncBufferToRenderThread(this.vbBuffer);
            ...
            for (var h = n.vbBuffer._float32Data, u = n.vbBuffer._int32Data, c = 0, f = 0; f < n._vertNum; f++) {
                h[c++] = n._vbArray[2 * f] + e, h[c++] = n._vbArray[2 * f + 1] + i, u[c++] = s;
            }
            (!n.ibBuffer || n.ibBuffer.getByteLength() < 3 * (n._vertNum - 2) * 2) && (n.ibBuffer = new ParamData(3 * (o - 2) * 2, !0, !0)), 
            n._ibSize = 3 * (n._vertNum - 2) * 2;
            for (var d = n.ibBuffer._int16Data, A = 0; A < 3 * (n._vertNum - 2); A++) {
                d[A] = n._ibArray[A];
            }
        ...
        return _(t, "laya.layagl.ConchCmdReplace"), t.__init__ = function() {
            ...
            for (t in e) {
                i[t + "Native"] && (e[t].create = i[t + "Native"].create);
            }
        }, t;
    }()), ft = function() {
        function t() {
        ...
        return _(t, "laya.webgl.shapes.Earcut"), t.earcut = function(e, i, r) {
            ...
            if (_ && (n = t.eliminateHoles(e, i, n, r)), e.length > 80 * r) {
                o = l = e[0], h = u = e[1];
                for (var A = r; A < a; A += r) {
                    c = e[A], f = e[A + 1], c < o && (o = c), f < h && (h = f), c > l && (l = c), f > u && (u = f);
                }
            ...
            var n, s;
            if (a === t.signedArea(e, i, r, _) > 0) for (n = i; n < r; n += _) {
                s = t.insertNode(n, e[n], e[n + 1], s);
            } else for (n = r - _; n >= i; n -= _) {
                s = t.insertNode(n, e[n], e[n + 1], s);
            }
            ...
            if (e) {
                ...
                for (var o, h, l = e; e.prev !== e.next; ) {
                    if (o = e.prev, h = e.next, n ? t.isEarHashed(e, _, a, n) : t.isEar(e)) i.push(o.i / r), 
            ...
            for (a = 0, n = i.length; a < n; a++) {
                s = i[a] * _, o = a < n - 1 ? i[a + 1] * _ : e.length, (h = t.linkedList(e, s, o, _, !1)) === h.next && (h.steiner = !0), 
                l.push(t.getLeftmost(h));
            }
            for (l.sort(t.compareX), a = 0; a < l.length; a++) {
                t.eliminateHole(l[a], r), r = t.filterPoints(r, r.next);
            }
            return r;
            ...
            for (_ = r.next; _ !== l; ) {
                a >= _.x && _.x >= u && a !== _.x && t.pointInTriangle(n < c ? a : s, n, u, c, n < c ? s : a, n, _.x, _.y) && ((h = Math.abs(n - _.y) / (a - _.x)) < f || h === f && _.x > r.x) && t.locallyInside(_, e) && (r = _, 
                f = h), _ = _.next;
            }
            return r;
            ...
            do {
                for (i = t, t = null, a = null, n = 0; i; ) {
                    ...
                    for (o = h; s > 0 || o > 0 && r; ) {
                        0 !== s && (0 === o || !r || i.z <= r.z) ? (_ = i, i = i.nextZ, s--) : (_ = r, r = r.nextZ, 
                        o--), a ? a.nextZ = _ : t = _, _.prevZ = a, a = _;
                    }
                    i = r;
                }
                a.nextZ = null, h *= 2;
            ...
            for (var _ = 0, a = e, n = i - r; a < i; a += r) {
                _ += (t[n] - t[a]) * (t[a + 1] + t[n + 1]), n = a;
            }
            return _;
        }, t;
    }(), At = (function() {
        ...
        return _(e, "laya.webgl.WebGL"), e._uint8ArraySlice = function() {
            ...
            if (0 === i.length) for (r = this.length, e = new Uint16Array(r), _ = 0; _ < r; _++) {
                e[_] = this[_];
            } else if (2 === i.length) {
                var a = i[0], n = i[1];
                if (n > a) for (r = n - a, e = new Uint16Array(r), _ = a; _ < n; _++) {
                    e[_ - a] = this[_];
            ...
            M.isWebGL || (M.isWebGL = !0, L.initRender = function(t, i, r) {
                ...
                n.destroy();
                for (var o = new ImageData(i, r), h = 4 * i, l = (new Uint8Array(h), o.data), u = r - 1, c = u * h, f = 0; u >= 0; u--) {
                    l.set(s.subarray(f, f + h), c), c -= h, f += h;
                }
                var d = new p(!0);
                d.size(i, r);
                ...
                if (c) {
                    ...
                    for (a = 4 * e, n = (i + _ - 1) * (u = 4 * h) + 4 * e, s = _ - 1; s >= 0; s--) {
                        f.set(T.slice(n, n + 4 * r), a), a += u, n -= u;
                    }
                    return f;
                }
                var d = new Gt();
                ...
                for (d.destroy(), f = new Uint8Array(r * _ * 4), a = 0, n = (_ - 1) * u, s = _ - 1; s >= 0; s--) {
                    f.set(T.slice(n, n + u), a), a += u, n -= u;
                }
                return f;
        ...
        e._arcTo = function(t) {
            ...
            this._x = t;
            for (var e = this.lines_vbBuffer._float32Data, i = 0, r = 0; r < this._vertNum; r++) {
                e[i++] = this._lines_vbArray[2 * r] + t, i++, i++;
            }
            ...
            this._y = t;
            for (var e = this.lines_vbBuffer._float32Data, i = 0, r = 0; r < this._vertNum; r++) {
                i++, e[i++] = this._lines_vbArray[2 * r + 1] + t, i++;
            }
            j.syncBufferToRenderThread(this.lines_vbBuffer);
            ...
            if (r.length > 0) {
                ...
                for (var _ = this.fill_ibBuffer._int16Data, a = 0, n = 0; n < r.length; n++) {
                    _[a++] = r[n];
                }
            }
            ...
            for (var o = this.fill_vbBuffer._float32Data, h = this.fill_vbBuffer._int32Data, u = 0, c = 0; c < this._vertNum; c++) {
                o[u++] = this._points[2 * c] + this.x, o[u++] = this._points[2 * c + 1] + this.y, 
                h[u++] = s;
            }
            var f = this._paramData._int32Data;
            ...
            for (var _ = this.lines_vbBuffer._float32Data, a = this.lines_vbBuffer._int32Data, n = 0, s = 0; s < this._vertNum; s++) {
                _[n++] = this._lines_vbArray[2 * s] + this.x, _[n++] = this._lines_vbArray[2 * s + 1] + this.y, 
                a[n++] = i;
            }
            ...
            for (var o = this.lines_ibBuffer._int16Data, h = 0; h < 3 * (this._vertNum - 2); h++) {
                o[h] = this._lines_ibArray[h];
            }
            ...
            if (n._vertNum = n._points.length, a) {
                ...
                for (s = 0; s < n._vertNum; s++) {
                    d[E++] = n._lines_vbArray[2 * s] + e, d[E++] = n._lines_vbArray[2 * s + 1] + i, 
                    A[E++] = c;
                }
                ...
                for (var m = n.lines_ibBuffer._int16Data, R = 0; R < 3 * (n._vertNum - 2); R++) {
                    m[R] = n._lines_ibArray[R];
                }
            }
            if (_) {
                f = n._vertNum;
                ...
                for (v = n.fill_vbBuffer._int32Data, E = 0, s = 0; s < n._vertNum; s++) {
                    d[E++] = n._points[2 * s] + e, d[E++] = n._points[2 * s + 1] + i, v[E++] = c;
                }
            }
            n._paramData._float32Data;
        ...
        return _(t, "laya.webgl.shapes.BasePoly"), t.createLine2 = function(e, i, r, _, a, n) {
            ...
            for (h = 2; h < l; h += 2) {
                Math.abs(e[h] - e[h - 2]) + Math.abs(e[h + 1] - e[h - 1]) > .01 && (s[o++] = e[h], 
                s[o++] = e[h + 1]);
            }
            ...
            for (u.push(d - T, A - v, d + T, A + v), h = 1; h < l - 1; h++) {
                d = s[2 * (h - 1)], A = s[2 * (h - 1) + 1], E = s[2 * h], m = s[2 * h + 1], R = s[2 * (h + 1)], 
                p = s[2 * (h + 1) + 1], v = d - E, P = E - R, M = (-(T = (T = -(A - m)) / (L = Math.sqrt(T * T + v * v)) * x) + d) * (-(v = v / L * x) + m) - (-T + E) * (-v + A), 
            ...
            v = v / L * x, u.push(E - T, m - v, E + T, m + v), h = 1; h < l; h++) {
                i.push(_ + 2 * (h - 1), _ + 2 * (h - 1) + 1, _ + 2 * h + 1, _ + 2 * h + 1, _ + 2 * h, _ + 2 * (h - 1));
            }
            return u;
        }, t.createLineTriangle = function(t, e, i, r, _, a, n) {
            var s = t.slice(), o = s.length, h = s[0], l = s[1], u = s[2], c = (s[2], 0), f = 0, d = 0, A = 0, E = o / 2;
            if (!(E <= 1) && 2 != E) {
                for (var m = new Array(4 * E), R = 0, p = 0, T = 0; T < E - 1; T++) {
                    h = s[p++], l = s[p++], u = s[p++], A = s[p++] - l, 0 != (d = u - h) && 0 != A && (c = Math.sqrt(d * d + A * A)) > .001 && (m[f = 4 * R] = h, 
        ...
        return e.clear = function() {
            ...
            if (i) {
                ...
                for (var n = 0; n < i; n += 3) {
                    r.addQuad(this._data[n], this._data[n + 1], this._data[n + 2], !0), t.__posPool[t.__nPosPool++] = this._data[n];
                }
        ...
        e.updateParticle = function() {
            ...
            _[t._PARAM_SIZE_POS_] = -1, _[t._PARAM_SIZE_POS_ + 1] = -1, a = 0; a < 16; a++) {
                _[t._PARAM_MAT_POS_ + a] = -1;
            }
        ...
        e.render = function(e, i, r) {
            ...
            if (void 0 === i && (i = !1), i || !t.showedDic[e]) {
                if (t.showedDic[e] = !0, !t._rendertypeToStrDic[e]) {
                    var r = [], _ = 0;
                    for (_ = 1; _ <= e; ) {
                        _ & e && r.push(t.getMCDName(_ & e)), _ <<= 1;
                    }
            ...
            var e;
            for (e in t._countDic) {
                console.log("count:" + t._countDic[e]), t.showRenderTypeInfo(e, !0);
            }
        ...
        e.recover = function() {
            ...
            for (var u = s.vbBuffer._float32Data, c = s.vbBuffer._int32Data, f = 0, d = 0; d < s._vertNum; d++) {
                u[f++] = s._vbArray[2 * d] + e, u[f++] = s._vbArray[2 * d + 1] + i, c[f++] = o;
            }
            (!s.ibBuffer || s.ibBuffer.getByteLength() < 3 * (s._vertNum - 2) * 2) && (s.ibBuffer = new ParamData(3 * (h - 2) * 2, !0, !0)), 
            s._ibSize = 3 * (s._vertNum - 2) * 2;
            for (var A = s.ibBuffer._int16Data, E = 0; E < 3 * (s._vertNum - 2); E++) {
                A[E] = s._ibArray[E];
            }
        ...
        e._arc = function(t, e, i, r, _) {
            ...
            if (s = 2 * Math.PI - 0, r) {
                if (Math.abs(s) >= 2 * Math.PI) s = 2 * -Math.PI; else for (;s > 0; ) {
                    s -= 2 * Math.PI;
                }
            } else if (Math.abs(s) >= 2 * Math.PI) s = 2 * Math.PI; else for (;s < 0; ) {
                s += 2 * Math.PI;
            }
            o = s / (f = i < 101 ? Math.max(10, s * i / 5) : i < 201 ? Math.max(10, s * i / 20) : Math.max(10, s * i / 40)) / 2, 
            h = Math.abs(4 / 3 * (1 - Math.cos(o)) / Math.sin(o)), r && (h = -h);
            for (c = 0; c <= f; c++) {
                n = 0 + s * (c / f), l = t + Math.cos(n) * i, u = e + Math.sin(n) * i, a.push(l), 
                a.push(u);
            }
            return a;
        }, e.recover = function() {
            ...
            var s = l.create(e).numColor, o = this.line_vbBuffer._float32Data, h = this.line_vbBuffer._int32Data, u = 0;
            for (i = 0; i < this._line_vertNum; i++) {
                o[u++] = this._line_vbArray[2 * i] + this.x, o[u++] = this._line_vbArray[2 * i + 1] + this.y, 
                h[u++] = s;
            }
            var c = this._paramData._int32Data;
            ...
            this._ibSize = 3 * _ * 2;
            for (var a = this.ibBuffer._int16Data, n = 0, s = 0; s < _; s++) {
                a[n++] = 0, a[n++] = s + 1 + 0, a[n++] = s + 2 + 0;
            }
            (!this.vbBuffer || this.vbBuffer.getByteLength() < 3 * this._vertNum * 4) && (this.vbBuffer = new ParamData(3 * i * 4, !0)), 
            this._vbSize = 3 * this._vertNum * 4;
            for (var o = l.create(this._fillColor).numColor, h = this.vbBuffer._float32Data, u = this.vbBuffer._int32Data, c = 0, f = 0; f < this._vertNum; f++) {
                h[c++] = this._points[2 * f] + this._x, h[c++] = this._points[2 * f + 1] + this._y, 
                u[c++] = o;
            }
            if (this._lineColor) {
                for (f = 0; f < this._points.length; f++) {
                    this._linePoints.push(this._points[f]);
                }
                this._linePoints.push(this._points[0]), this._linePoints.push(this._points[1]), 
                yt.createLine2(this._linePoints, this._line_ibArray, this._lineWidth, 0, this._line_vbArray, !1), 
                ...
                n = 0;
                for (var A = 0; A < 3 * (this._line_vertNum - 2); A++) {
                    d[n++] = this._line_ibArray[A];
                }
                (!this.line_vbBuffer || this.line_vbBuffer.getByteLength() < 3 * this._line_vertNum * 4) && (this.line_vbBuffer = new ParamData(3 * r * 4, !0)), 
                this._line_vbSize = 3 * this._line_vertNum * 4;
                var E = l.create(this._lineColor).numColor, m = this.line_vbBuffer._float32Data, R = this.line_vbBuffer._int32Data;
                for (c = 0, f = 0; f < this._line_vertNum; f++) {
                    m[c++] = this._line_vbArray[2 * f] + this._x, m[c++] = this._line_vbArray[2 * f + 1] + this._y, 
                    R[c++] = E;
                }
            }
            ...
            o._ibSize = 3 * u * 2;
            for (var c = o.ibBuffer._int16Data, f = 0, d = 0; d < u; d++) {
                c[f++] = 0, c[f++] = d + 1 + 0, c[f++] = d + 2 + 0;
            }
            ...
            for (var E = o.vbBuffer._float32Data, m = o.vbBuffer._int32Data, R = 0, p = 0; p < o._vertNum; p++) {
                E[R++] = o._points[2 * p] + e, E[R++] = o._points[2 * p + 1] + i, m[R++] = A;
            }
            var T = 0;
            for (p = 0; p < o._points.length; p++) {
                o._linePoints.push(o._points[p]);
            }
            if (o._linePoints.push(o._points[0]), o._linePoints.push(o._points[1]), a) {
                ...
                f = 0;
                for (var D = 0; D < 3 * (o._line_vertNum - 2); D++) {
                    v[f++] = o._line_ibArray[D];
                }
                ...
                for (R = 0, p = 0; p < o._line_vertNum; p++) {
                    M[R++] = o._line_vbArray[2 * p] + e, M[R++] = o._line_vbArray[2 * p + 1] + i, y[R++] = g;
                }
            } else {
                o._lineWidth = 1;
                for (yt.createLine2(o._linePoints, o._line_ibArray, o._lineWidth, 0, o._line_vbArray, !1), 
                ...
                f = 0, D = 0; D < 3 * (o._line_vertNum - 2); D++) {
                    v[f++] = o._line_ibArray[D];
                }
                ...
                M = o.line_vbBuffer._float32Data, y = o.line_vbBuffer._int32Data, R = 0, p = 0; p < o._line_vertNum; p++) {
                    M[R++] = o._line_vbArray[2 * p] + e, M[R++] = o._line_vbArray[2 * p + 1] + i, y[R++] = g;
                }
            }
        ...
        return o.clearBG = function(t, e, i, r) {
            ...
            if (t._getSource()) for (var a = e.length / 2, n = 0, s = 0; s < a; s++) {
                this._inner_drawTexture(t, t.bitmap.id, e[n++] + r, e[n++] + _, 0, 0, null, null, 1, !1);
            } else this.sprite && i.systemTimer.callLater(this, this._repaintSprite);
            ...
            e < 0 && (e = i._length);
            for (var _ = At.RENDERBASE; t < e; ) {
                this._renderNextSubmitIndex = t + 1, i[t] !== At.RENDERBASE ? (At.preRender = _, 
            ...
            for (var _, a = this.mixRGBandAlpha(this.fillStyle.toInt()), n = 0, s = 0, o = e.paths.length; s < o; s++) {
                ...
                if (!(l < 3 || 3 == l && !h.convex)) {
                    ...
                    if (t._bTransform) for (c = 0; c < l; c++) {
                        d = (f = c << 1) + 1, A = u[f], E = u[d], u[f] = t.a * A + t.c * E + t.tx, u[d] = t.b * A + t.d * E + t.ty;
                    } else for (c = 0; c < l; c++) {
                        d = (f = c << 1) + 1, A = u[f], E = u[d], u[f] = A + t.tx, u[d] = E + t.ty;
                    }
                    ...
                    if (h.convex) {
                        ...
                        for (var p = 0, T = 0; T < R; T++) {
                            _[p++] = m, _[p++] = T + 1 + m, _[p++] = T + 2 + m;
                        }
                    } else if (_ = dt.earcut(u, null, 2), m > 0) for (var v = 0; v < _.length; v++) {
                        _[v] += m;
                    }
                ...
                for (var _ = 0, a = 0, n = e.paths.length; a < n; a++) {
                    ...
                    if (!(s.path.length <= 0)) {
                        ...
                        if (!(l < 2)) {
                            ...
                            if (c._bTransform) for (f = 0; f < u; f++) {
                                A = (d = f << 1) + 1, E = h[d], m = h[A], h[d] = c.a * E + c.c * m + c.tx, h[A] = c.b * E + c.d * m + c.ty;
                            } else for (f = 0; f < u; f++) {
                                A = (d = f << 1) + 1, E = h[d], m = h[A], h[d] = E + c.tx, h[A] = m + c.ty;
                            }
            ...
            var T = this._getPath();
            for (d = 0; d <= A; d++) {
                s = r + o * (d / A), u = Math.cos(s), f = e + Math.sin(s) * i, (c = t + u * i) == this._path._lastOriX && f == this._path._lastOriY || T.addPoint(c, f);
            }
            ...
            for (var _ = n.I.getBezierPoints([ this._path._lastOriX, this._path._lastOriY, t, e, i, r ], 30, 2), a = 0, s = _.length / 2; a < s; a++) {
                this.lineTo(_[2 * a], _[2 * a + 1]);
            }
            this.lineTo(i, r);
        ...
        return i.addVertAndIBToMesh = function(t, i, r, _) {
            for (var a = this._vb.needSize(i.length / 2 * e.const_stride) >> 2, n = this._vb._floatArray32 || this._vb.getFloat32Array(), s = this._vb._uint32Array, o = 0, h = i.length / 2, l = 0; l < h; l++) {
                n[a++] = i[o], n[a++] = i[o + 1], o += 2, s[a++] = r;
            }
        ...
        return i.setByteLength = function(t) {
            ...
            for (var i = new Uint16Array(this._buffer, this._byteLength, e), r = 0; r < e; r++) {
                i[r] = t[r];
            }
        ...
        return r.findAGrid = function() {
            ...
            for (var e = 0, i = null, r = 0, _ = this.charMaps.length; r < _; r++) {
            ...
            if (this._gridNum = t, this._used && this._used.length == this._gridNum) {
                if (this._used.fill) this._used.fill(0); else for (var e = 0; e < this._used.length; e++) {
                    this._used[e] = 0;
                }
        ...
        return a.createData = function() {
            ...
            for (var A = 5, E = 0; E < c; E++) {
                n[A++] = u[2 * E], n[A++] = u[2 * E + 1], s[A++] = d;
            }
            A = 70;
            ...
            for (var e = 0, i = this._customCmds.length; e < i; e++) {
                this._customCmds[e].recover();
            }
            ...
            for (var e, i = this._children, r = i.length, _ = 0; _ < r; ++_) {
                (e = i[_])._datai32[5] = t ? 1 : 0, e.setChildrenNativeVisible(t);
            }
        ...
        return i.parentRepaintForNative = function(t) {
            ...
            if (a.viewport) for (var n = a.viewport, s = n.x, o = n.y, h = n.right, l = n.bottom, u = NaN, c = NaN; r < _; ++r) {
                (e = i[r])._visible && (u = e._x) < h && u + e.width > s && (c = e._y) < l && c + e.height > o && e.renderToNative(t);
            } else for (;r < _; ++r) {
                (e = i[r])._visible && e.renderToNative(t);
            }
        }, i._writeBlockChilds = function() {
            var t, e = this._children, i = 0, r = e.length, _ = this._style;
            if (_.viewport) for (var a = _.viewport, n = a.x, s = a.y, o = a.right, h = a.bottom, l = NaN, u = NaN; i < r; ++i) {
                (t = e[i])._visible && (l = t._x) < o && l + t.width > n && (u = t._y) < h && u + t.height > s && t.writeBlockToNative();
            } else for (;i < r; ++i) {
                (t = e[i])._visible && t.writeBlockToNative();
            }
        ...
        return i.recreateResource = function() {
            ...
            if (this._vs && this._ps && !this._params) {
                ...
                for (_ = 0; _ < n; _ += 2) {
                    i.bindAttribLocation(this._program, this._attribInfo[_ + 1], this._attribInfo[_]);
                }
                ...
                for (_ = 0, a = this._params.length; _ < a; _++) {
                    switch (r = this._params[_], r.indexOfParams = _, r.index = 1, r.value = [ r.location, null ], 
                    r.codename = r.name, r.name = this._nameMap[r.codename] ? this._nameMap[r.codename] : r.codename, 
            ...
            for (var r, _, a = e.length, n = 0, s = 0; s < a; s++) {
                null !== (_ = t[(r = e[s]).name]) && (n += r.fun.call(this, r, _));
            }
            F.shaderCall += n;
        }, i.uploadArray = function(t, e, i) {
            ee.activeShader = this, ee.bindShader = this, ot.useProgram(mt.mainContext, this._program);
            this._params;
            for (var r, _, a = 0, n = e - 2; n >= 0; n -= 2) {
                (_ = this._paramsMap[t[n]]) && null != (r = t[n + 1]) && (i && i[_.name] && i[_.name].bind(), 
