    ...
    var M = function() {
        ...
        return s.destroy = function(i) {
            ...
            this._isElastic) this._value < this.min ? k.to(this, {
                ...
                for (var i = 0, s = Math.min(this._offsets.length, 3), h = 0; h < s; h++) {
            ...
            if (t) {
                ...
                if (I.isOkTextureList(h) || (h = null), h) this._sources = h; else {
                    if (this._sources = [], 1 === this._stateNum) this._sources.push(t); else for (var n = 0; n < this._stateNum; n++) {
                        this._sources.push(B.createFromTexture(t, 0, e * n, i, e));
                    }
        ...
        return s.destroy = function(i) {
            ...
            this._isOpen) {
                ...
                this._list.zOrder = 1001, this.parent.addChild(this._list), e.stage.once("mousedown", this, this.removeList), 
                ...
                if (I.isOkTextureList(n) || (n = null), n) this._sources = n; else {
                    ...
                    for (var o = 0; o < this._clipY; o++) {
                        for (var r = 0; r < this._clipX; r++) {
                            this._sources.push(B.createFromTexture(i, e * r, s * o, e, s));
                        }
                    }
        ...
        return e.imps(s, {
            ...
            for (var e in this._source) {
                t = this._source[e], this.getParentOpenStatus(t) && (t.x = this._spaceLeft * this.getDepth(t), 
                i.push(t));
            }
            return i;
            ...
            var s;
            for (var h in t) {
                !(s = t[h]).isDirectory && String(s.label).toLowerCase().indexOf(e) > -1 && (s.x = 0, 
        ...
        return e.imps(s, {
            ...
            for (var u = t; u < e; u++) {
                for (var _ = 0; _ < i; _++) {
                    (h = l && l.length ? l.pop() : this.createItem()).x = (this._isVertical ? _ : u) * n - s._x, 
