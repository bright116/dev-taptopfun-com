...
!function(t, e) {
        ...
        (0, _createClass2.default)(h, [ {
            ...
            value: function changeSource() {
                ...
                if (t && t.bitmap) {
                    ...
                    if (!h || r === s && a === i) {
                        ...
                        var _r = e.Draw9GridTexture.create(t, 0, 0, s, i, h);
                        this._setDrawGridCmd(_r);
                    }
                    this._repaint();
                }
            }
            ...
            value: function _setDrawGridCmd(t) {
                ...
                if (this._one || s && !(s.length <= 0)) {
                    var _e2 = this._one;
                    _e2 ? _e2 == this._drawGridCmd ? this._one = t : (this.clear(), this._saveToCmd(null, t), 
                    this._saveToCmd(null, _e2)) : s.splice(0, 0, t);
            ...
            key: "getTexture",
            value: function getTexture(t, s, i, h, r) {
                var a;
    ...
    var r = /* */ function(_e$Component) {
        (0, _inherits2.default)(r, _e$Component);
    ...
    var a = /* */ function(_e$Event) {
        (0, _inherits2.default)(a, _e$Event);
    ...
    var n = /* */ function(_e$Sprite) {
        ...
        function n() {
            ...
            _this3 = _super4.call(this), _this3._anchorX = NaN, _this3._anchorY = NaN, _this3._widget = r.EMPTY, 
    ...
    var d = /* */ function(_n3) {
        ...
        function d() {
            ...
            _this7 = _super8.call(this), _this7._labelColors = i.buttonLabelColors, _this7._state = 0, 
            _this7._autoSize = !0, _this7._stateNum = i.buttonStateNum, _this7._stateChanged = !1, 
            _this7.skin = t, _this7.label = e;
            return _this7;
        }
            ...
            value: function changeClips() {
                ...
                if (t) {
                    ...
                    if (e.Utils.isOkTextureList(r) || (r = null), r) this._sources = r; else {
                        if (this._sources = [], 1 === this._stateNum) this._sources.push(t); else for (var a = 0; a < this._stateNum; a++) {
                            this._sources.push(e.Texture.createFromTexture(t, 0, i * a, s, i));
                        }
    ...
    var g = /* */ function(_n4) {
        ...
        function g() {
            ...
            _this9 = _super10.call(this), _this9._clipX = 1, _this9._clipY = 1, _this9._clipWidth = 0, 
            _this9._clipHeight = 0, _this9._interval = 50, _this9._index = 0, _this9._toIndex = -1, 
            _this9._clipX = e, _this9._clipY = s, _this9.skin = t;
            return _this9;
        }
    ...
    var p = /* */ function(_n5) {
        ...
        function p() {
            ...
            _this10 = _super11.call(this, !1), _this10._gridSize = 11, _this10._bgColor = "#ffffff", 
            _this10._borderColor = "#000000", _this10._inputColor = "#000000", _this10._inputBgColor = "#efefef", 
            _this10._colors = [], _this10._selectedColor = "#000000", t && (_this10.preinitialize(), 
            _this10.createChildren(), _this10.initialize());
            return _this10;
        }
    ...
    var m = /* */ function(_n7) {
        ...
        function m() {
            ...
            _this12 = _super13.call(this), _this12.isVertical = !0, _this12.showLabel = !0, 
            _this12._max = 100, _this12._min = 0, _this12._tick = 1, _this12._value = 0, m.label || (m.label = new C()), 
            _this12.skin = t;
            return _this12;
        }
        (0, _createClass2.default)(m, [ {
            ...
            value: function destroy() {
                var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !0;
                (0, _get2.default)((0, _getPrototypeOf2.default)(m.prototype), "destroy", this).call(this, t), 
    ...
    var v = /* */ function(_n8) {
        ...
        function v() {
            ...
            _this13 = _super14.call(this), _this13.rollRatio = .97, _this13.scaleBar = !0, _this13.autoHide = !1, 
            _this13.elasticDistance = 0, _this13.elasticBackTime = 500, _this13._showButtons = s.showButtons, 
            _this13._scrollSize = 1, _this13._thumbPercent = 1, _this13._lastOffset = 0, _this13._checkElastic = !1, 
            _this13._isElastic = !1, _this13._hide = !1, _this13._clickOnly = !0, _this13._touchScrollEnable = s.touchScrollEnable, 
            _this13._mouseWheelEnable = s.mouseWheelEnable, _this13.skin = t, _this13.max = 1;
            return _this13;
        }
        (0, _createClass2.default)(v, [ {
            ...
            value: function destroy() {
                var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !0;
                this.stopScroll(), this.target = null, (0, _get2.default)((0, _getPrototypeOf2.default)(v.prototype), "destroy", this).call(this, t), 
    ...
    var y = /* */ function(_c) {
        ...
        function y() {
            ...
            _this14 = _super17.apply(this, arguments), _this14.selectEnable = !1, _this14.totalPage = 0, 
            _this14._$componentType = "List", _this14._repeatX = 0, _this14._repeatY = 0, _this14._repeatX2 = 0, 
            _this14._repeatY2 = 0, _this14._spaceX = 0, _this14._spaceY = 0, _this14._cells = [], 
            _this14._startIndex = 0, _this14._selectedIndex = -1, _this14._page = 0, _this14._isVertical = !0, 
            _this14._cellSize = 20, _this14._cellOffset = 0, _this14._createdLine = 0, _this14._offset = new e.Point(), 
            _this14._usedCache = null, _this14._elasticEnabled = !1, _this14._preLen = 0;
            return _this14;
        }
        (0, _createClass2.default)(y, [ {
            ...
            value: function onScrollStart() {
                this._usedCache || (this._usedCache = (0, _get2.default)((0, _getPrototypeOf2.default)(y.prototype), "cacheAs", this)), 
                (0, _set2.default)((0, _getPrototypeOf2.default)(y.prototype), "cacheAs", "none", this, true), 
            ...
            value: function _createItems(t, e, s) {
                ...
                for (var d = t; d < s; d++) {
                    for (var u = 0; u < e; u++) {
                        (h = n && n.length ? n.pop() : this.createItem()).x = (this._isVertical ? u : d) * r - i._x, 
            ...
            key: "_sizeChanged",
            value: function _sizeChanged() {
                (0, _get2.default)((0, _getPrototypeOf2.default)(y.prototype), "_sizeChanged", this).call(this), 
            ...
            value: function onScrollBarChange() {
                ...
                this.renderItems(this._createdLine * s, 0), this._createdLine += a); else {
                    ...
                    this._isMoved = !0) : r < this._startIndex && (a = this._startIndex - r, _t2 = !1, 
            ...
            key: "cacheAs",
            set: function set(t) {
                (0, _set2.default)((0, _getPrototypeOf2.default)(y.prototype), "cacheAs", t, this, true), 
            ...
            key: "width",
            set: function set(t) {
                t != this._width && ((0, _set2.default)((0, _getPrototypeOf2.default)(y.prototype), "width", t, this, true), 
            ...
            key: "height",
            set: function set(t) {
                t != this._height && ((0, _set2.default)((0, _getPrototypeOf2.default)(y.prototype), "height", t, this, true), 
                this._setCellChanged());
            },
            get: function get() {
    ...
    var b = /* */ function(_n9) {
        ...
        function b() {
            ...
            _this15 = _super18.call(this), _this15._visibleNum = 6, _this15._itemColors = i.comboBoxItemColors, 
            _this15._itemSize = 12, _this15._labels = [], _this15._selectedIndex = -1, _this15.itemRender = null, 
            _this15.skin = t, _this15.labels = e;
            return _this15;
        }
        (0, _createClass2.default)(b, [ {
            ...
            key: "width",
            set: function set(t) {
                (0, _set2.default)((0, _getPrototypeOf2.default)(b.prototype), "width", t, this, true), 
            ...
            key: "height",
            set: function set(t) {
                (0, _set2.default)((0, _getPrototypeOf2.default)(b.prototype), "height", t, this, true), 
    ...
    var L = /* */ function(_c2) {
        ...
        function L() {
            ...
            var e = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
            (0, _classCallCheck2.default)(this, L);
            _this18 = _super21.call(this), _this18._selectedIndex = -1, _this18._direction = "horizontal", 
            _this18._space = 0, _this18.skin = e, _this18.labels = t;
            return _this18;
        }
    ...
    var B = /* */ function(_c3) {
        ...
        function B() {
            var _this19;
            (0, _classCallCheck2.default)(this, B);
            _this19 = _super24.apply(this, arguments), _this19._setIndexHandler = e.Handler.create((0, 
            _assertThisInitialized2.default)(_this19), _this19.setIndex, null, !1);
            return _this19;
        }
        (0, _createClass2.default)(B, [ {
            key: "setItems",
    ...
    var z = /* */ function(_c5) {
        ...
        function z() {
            ...
            _this24 = _super29.call(this), _this24._usedCache = null, _this24._elasticEnabled = !1, 
    ...
    var D = /* */ function(_c6) {
        ...
        function D() {
            var _this25;
            (0, _classCallCheck2.default)(this, D);
            _this25 = _super31.call(this), _this25._spaceLeft = 10, _this25._spaceBottom = 0, 
            _this25._keepStatus = !0, _this25.width = _this25.height = 200;
            return _this25;
        }
        (0, _createClass2.default)(D, [ {
            key: "destroy",
            ...
            value: function parseXml(t, e, s, i) {
                ...
                if (!i) {
                    ...
                    var l = t.attributes;
                    for (var _t4 in l) {
                        var n = l[_t4], o = n.nodeName, _ = n.nodeValue;
    ...
    var H = /* */ function(_c7) {
        ...
        function H() {
            var _this26;
            (0, _classCallCheck2.default)(this, H);
            _this26 = _super32.apply(this, arguments), _this26._space = 0, _this26._align = "none", 
            _this26._itemChanged = !1;
            return _this26;
        }
        (0, _createClass2.default)(H, [ {
            key: "addChild",
        ...
        (0, _createClass2.default)(A, [ {
            ...
            value: function changeItems() {
                ...
                for (s = 0, i = t.length; s < i; s++) {
                    (h = t[s]).x = r, r += h.width * h.scaleX + this._space, this._align == A.TOP ? h.y = 0 : this._align == A.MIDDLE ? h.y = .5 * (e - h.height * h.scaleY) : this._align == A.BOTTOM && (h.y = e - h.height * h.scaleY);
                }
                this._sizeChanged();
            }
        }, {
    ...
    var N = /* */ function(_H2) {
        ...
        (0, _createClass2.default)(N, [ {
            ...
            value: function changeItems() {
                ...
                var r = 0;
                for (s = 0, i = t.length; s < i; s++) {
                    (h = t[s]).y = r, r += h.height * h.scaleY + this._space, this._align == N.LEFT ? h.x = 0 : this._align == N.CENTER ? h.x = .5 * (e - h.width * h.scaleX) : this._align == N.RIGHT && (h.x = e - h.width * h.scaleX);
                }
                this._sizeChanged();
            }
        }, {
    ...
    var P = /* */ function(_g) {
        ...
        function P() {
            ...
            var e = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
            (0, _classCallCheck2.default)(this, P);
            _this28 = _super35.call(this), _this28._valueArr = "", _this28._indexMap = null, 
            _this28._sheet = null, _this28._direction = "horizontal", _this28._spaceX = 0, _this28._spaceY = 0, 
            _this28._align = "left", _this28._wordsW = 0, _this28._wordsH = 0, t && (_this28.skin = t), 
            e && (_this28.sheet = e);
            return _this28;
        }
        (0, _createClass2.default)(P, [ {
    ...
    var Y = /* */ function(_e$Scene) {
        ...
        function Y() {
            var _this29;
            (0, _classCallCheck2.default)(this, Y);
            _this29 = _super36.call(this, !1), _this29._watchMap = {}, _this29._anchorX = NaN, 
            _this29._anchorY = NaN, _this29._widget = r.EMPTY, _this29.createChildren();
            return _this29;
        }
        (0, _createClass2.default)(Y, [ {
            key: "destroy",
    ...
    var X = /* */ function(_e$Sprite2) {
        ...
        function X() {
            ...
            }, _this30.popupEffectHandler = new e.Handler((0, _assertThisInitialized2.default)(_this30), _this30.popupEffect), 
            _this30.closeEffectHandler = new e.Handler((0, _assertThisInitialized2.default)(_this30), _this30.closeEffect), 
            _this30.mouseEnabled = _this30.maskLayer.mouseEnabled = !0, _this30.zOrder = 1e3, 
            e.ILaya.stage.addChild((0, _assertThisInitialized2.default)(_this30)), e.ILaya.stage.on(e.Event.RESIZE, (0, 
            _assertThisInitialized2.default)(_this30), _this30._onResize), s.closeDialogOnSide && _this30.maskLayer.on("click", (0, 
            _assertThisInitialized2.default)(_this30), _this30._closeOnSide), _this30._onResize(null);
            return _this30;
        }
        (0, _createClass2.default)(X, [ {
            key: "_closeOnSide",
    ...
    var G = /* */ function(_Y) {
        ...
        function G() {
            var _this31;
            (0, _classCallCheck2.default)(this, G);
            _this31 = _super38.call(this), _this31.isShowEffect = !0, _this31.isPopupCenter = !0, 
            _this31.popupEffect = G.manager.popupEffectHandler, _this31.closeEffect = G.manager.closeEffectHandler, 
            _this31._dealDragArea(), _this31.on(e.Event.CLICK, (0, _assertThisInitialized2.default)(_this31), _this31._onClick);
            return _this31;
        }
        (0, _createClass2.default)(G, [ {
            key: "_dealDragArea",
    ...
    var W = /* */ function(_n11) {
        ...
        function W() {
            var _this32;
            (0, _classCallCheck2.default)(this, W);
            _this32 = _super39.call(this), _this32._tipBox = new n(), _this32._tipBox.addChild(_this32._tipText = new e.Text()), 
            _this32._tipText.x = _this32._tipText.y = 5, _this32._tipText.color = W.tipTextColor, 
            _this32._defaultTipHandler = _this32._showDefaultTip, e.ILaya.stage.on(a.SHOW_TIP, (0, 
            _assertThisInitialized2.default)(_this32), _this32._onStageShowTip), e.ILaya.stage.on(a.HIDE_TIP, (0, 
            _assertThisInitialized2.default)(_this32), _this32._onStageHideTip), _this32.zOrder = 1100;
            return _this32;
        }
        (0, _createClass2.default)(W, [ {
            key: "_onStageHideTip",
    ...
    t.UIEvent = a, t.UIGroup = L, t.UILib = /* */ function() {
        function _class() {
