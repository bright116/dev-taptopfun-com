...
! function() {
    class _0x3a0dfd {
        ...
        static[_0x3182('0x37')]() {
            ...
            ['showReward'](_0x28a314, _0x9a3122) {
                console.log("请求激励广告");
                ...
                this[_0x3182('0x15')](), YYGSDK['adsManager'][_0x3182('0x31')](YYG[_0x3182('0x27')]['REWARD'], YYG['EventHandler'][_0x3182('0x2')](this, () => {
                    ...
                    // ZL: 下面这行里面有个AD_SKIPPED, 说明是处理失败情况的回调。_0x9a3122在参数表里，说明是失败回调函数。
            ...
            [_0x3182('0x2c')]() {
                ...
                // ZL: 下面有个forgames, 说明这个是getforgames方法
                let _0x2d032c = YYGSDK['forgames'] || [],
                    _0x630bc3 = _0x2d032c[_0x3182('0x3e')]();
                for (let _0x101333 = 0x0, _0x372a85 = _0x630bc3[_0x3182('0x2b')]; _0x101333 < _0x372a85; _0x101333++) {
                    const _0x4d8a22 = Math[_0x3182('0x11')](Math[_0x3182('0x17')]() * (_0x101333 + 0x1)),
                        _0x10ce27 = _0x630bc3[_0x4d8a22];
            ...
            [_0x3182('0x1a')](_0x13775b, _0x3d59f4) {
                ...
                // ZL: 观察下面的语句，应该是初始化startup的。
                // ZL: 再观察函数参数表，函数有两个参数_0x13775b, _0x3d59f4, 
                // ZL: 第一个_0x13775b是游戏名称。第二个_0x3d59f4是个函数，是初始化YYGSDK后继续开始游戏的回调函数
                // this[_0x3182('0x1f')] = !![];
                // YYGGames[_0x3182('0x22')](_0x13775b, ![], YYG[_0x3182('0x34')]['CARGAMES'])[_0x3182('0x21')](_0x3d59f4);
            }
    }
